...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'f2':
      case 'unit':
        sc_exib_ocult_pag('form_normal_laboratory_form0');
        break;
      case 'sc_field_0':
        sc_exib_ocult_pag('form_normal_laboratory_form1');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('change', function() { sc_form_normal_laboratory_id_onchange(this, iSeqRow) });
  $('#id_sc_field_labcode' + iSeqRow).bind('blur', function() { sc_form_normal_laboratory_labcode_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_normal_laboratory_labcode_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_category' + iSeqRow).bind('blur', function() { sc_form_normal_laboratory_category_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_normal_laboratory_category_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_name' + iSeqRow).bind('blur', function() { sc_form_normal_laboratory_name_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_normal_laboratory_name_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_subname' + iSeqRow).bind('blur', function() { sc_form_normal_laboratory_subname_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_normal_laboratory_subname_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_oper' + iSeqRow).bind('blur', function() { sc_form_normal_laboratory_oper_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_normal_laboratory_oper_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_m1' + iSeqRow).bind('blur', function() { sc_form_normal_laboratory_m1_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_form_normal_laboratory_m1_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_m2' + iSeqRow).bind('blur', function() { sc_form_normal_laboratory_m2_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_form_normal_laboratory_m2_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_f1' + iSeqRow).bind('blur', function() { sc_form_normal_laboratory_f1_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_form_normal_laboratory_f1_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_f2' + iSeqRow).bind('blur', function() { sc_form_normal_laboratory_f2_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_form_normal_laboratory_f2_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_unit' + iSeqRow).bind('blur', function() { sc_form_normal_laboratory_unit_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_normal_laboratory_unit_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_rate' + iSeqRow).bind('blur', function() { sc_form_normal_laboratory_rate_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_normal_laboratory_rate_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_resulttype' + iSeqRow).bind('blur', function() { sc_form_normal_laboratory_resulttype_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_normal_laboratory_resulttype_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_normal_laboratory_resulttype_onfocus(this, iSeqRow) });
  $('#id_sc_field_sub' + iSeqRow).bind('change', function() { sc_form_normal_laboratory_sub_onchange(this, iSeqRow) });
  $('#id_sc_field_deleted' + iSeqRow).bind('change', function() { sc_form_normal_laboratory_deleted_onchange(this, iSeqRow) });
  $('#id_sc_field_order' + iSeqRow).bind('blur', function() { sc_form_normal_laboratory_order_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_normal_laboratory_order_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_normal_laboratory_order_onfocus(this, iSeqRow) });
  $('#id_sc_field_ordersub' + iSeqRow).bind('change', function() { sc_form_normal_laboratory_ordersub_onchange(this, iSeqRow) });
  $('#id_sc_field_lastupdated' + iSeqRow).bind('blur', function() { sc_form_normal_laboratory_lastupdated_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_normal_laboratory_lastupdated_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_normal_laboratory_lastupdated_onfocus(this, iSeqRow) });
  $('#id_sc_field_lastupdated_hora' + iSeqRow).bind('blur', function() { sc_form_normal_laboratory_lastupdated_hora_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_normal_laboratory_lastupdated_hora_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_normal_laboratory_lastupdated_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_sc_field_0' + iSeqRow).bind('blur', function() { sc_form_normal_laboratory_sc_field_0_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_normal_laboratory_sc_field_0_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_normal_laboratory_sc_field_0_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_normal_laboratory_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_labcode_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_category_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_subname_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_oper_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_m1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_m2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_f1_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_f2_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_unit_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_rate_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_resulttype_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_sub_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_normal_laboratory_deleted_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_order_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_ordersub_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_lastupdated_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_normal_laboratory_validate_lastupdated();
  scCssBlur(oThis);
}

function sc_form_normal_laboratory_lastupdated_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_normal_laboratory_lastupdated_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_normal_laboratory_lastupdated_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_normal_laboratory_sc_field_0_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function displayChange_field_sc_field_0(row, status) {
	if ("on" == status && typeof $("#nmsc_iframe_liga_form_normal_laboratory_detail")[0].contentWindow.scRecreateSelect2 === "function") {
		$("#nmsc_iframe_liga_form_normal_laboratory_detail")[0].contentWindow.scRecreateSelect2();
	}
}
...
function scHidePage(pageNo) {
	$("#id_form_normal_laboratory_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_lastupdated" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_normal_laboratory_validate_lastupdated(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_normal_laboratory')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
