  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_normal_laboratory_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_normal_laboratory_mob_form();
	}
  ...
  // ---------- Validate labcode
  function do_ajax_form_normal_laboratory_mob_validate_labcode()
  {
    var nomeCampo_labcode = "labcode";
    var var_labcode = scAjaxGetFieldText(nomeCampo_labcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_mob_validate_labcode(var_labcode, var_script_case_init, do_ajax_form_normal_laboratory_mob_validate_labcode_cb);
  } // do_ajax_form_normal_laboratory_mob_validate_labcode

  function do_ajax_form_normal_laboratory_mob_validate_labcode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_mob_validate_labcode_cb

  // ---------- Validate category
  function do_ajax_form_normal_laboratory_mob_validate_category()
  {
    var nomeCampo_category = "category";
    var var_category = scAjaxGetFieldSelect(nomeCampo_category);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_mob_validate_category(var_category, var_script_case_init, do_ajax_form_normal_laboratory_mob_validate_category_cb);
  } // do_ajax_form_normal_laboratory_mob_validate_category

  function do_ajax_form_normal_laboratory_mob_validate_category_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_mob_validate_category_cb

  // ---------- Validate name
  function do_ajax_form_normal_laboratory_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_mob_validate_name(var_name, var_script_case_init, do_ajax_form_normal_laboratory_mob_validate_name_cb);
  } // do_ajax_form_normal_laboratory_mob_validate_name

  function do_ajax_form_normal_laboratory_mob_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_mob_validate_name_cb

  // ---------- Validate subname
  function do_ajax_form_normal_laboratory_mob_validate_subname()
  {
    var nomeCampo_subname = "subname";
    var var_subname = scAjaxGetFieldText(nomeCampo_subname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_mob_validate_subname(var_subname, var_script_case_init, do_ajax_form_normal_laboratory_mob_validate_subname_cb);
  } // do_ajax_form_normal_laboratory_mob_validate_subname

  function do_ajax_form_normal_laboratory_mob_validate_subname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "subname";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_mob_validate_subname_cb

  // ---------- Validate rate
  function do_ajax_form_normal_laboratory_mob_validate_rate()
  {
    var nomeCampo_rate = "rate";
    var var_rate = scAjaxGetFieldText(nomeCampo_rate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_mob_validate_rate(var_rate, var_script_case_init, do_ajax_form_normal_laboratory_mob_validate_rate_cb);
  } // do_ajax_form_normal_laboratory_mob_validate_rate

  function do_ajax_form_normal_laboratory_mob_validate_rate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rate";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_mob_validate_rate_cb

  // ---------- Validate order
  function do_ajax_form_normal_laboratory_mob_validate_order()
  {
    var nomeCampo_order = "order";
    var var_order = scAjaxGetFieldText(nomeCampo_order);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_mob_validate_order(var_order, var_script_case_init, do_ajax_form_normal_laboratory_mob_validate_order_cb);
  } // do_ajax_form_normal_laboratory_mob_validate_order

  function do_ajax_form_normal_laboratory_mob_validate_order_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "order";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_mob_validate_order_cb

  // ---------- Validate lastupdated
  function do_ajax_form_normal_laboratory_mob_validate_lastupdated()
  {
    var nomeCampo_lastupdated = "lastupdated";
    var var_lastupdated = scAjaxGetFieldText(nomeCampo_lastupdated);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_mob_validate_lastupdated(var_lastupdated, var_script_case_init, do_ajax_form_normal_laboratory_mob_validate_lastupdated_cb);
  } // do_ajax_form_normal_laboratory_mob_validate_lastupdated

  function do_ajax_form_normal_laboratory_mob_validate_lastupdated_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_mob_validate_lastupdated_cb

  // ---------- Validate resulttype
  function do_ajax_form_normal_laboratory_mob_validate_resulttype()
  {
    var nomeCampo_resulttype = "resulttype";
    var var_resulttype = scAjaxGetFieldSelect(nomeCampo_resulttype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_mob_validate_resulttype(var_resulttype, var_script_case_init, do_ajax_form_normal_laboratory_mob_validate_resulttype_cb);
  } // do_ajax_form_normal_laboratory_mob_validate_resulttype

  function do_ajax_form_normal_laboratory_mob_validate_resulttype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_mob_validate_resulttype_cb

  // ---------- Validate oper
  function do_ajax_form_normal_laboratory_mob_validate_oper()
  {
    var nomeCampo_oper = "oper";
    var var_oper = scAjaxGetFieldSelect(nomeCampo_oper);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_mob_validate_oper(var_oper, var_script_case_init, do_ajax_form_normal_laboratory_mob_validate_oper_cb);
  } // do_ajax_form_normal_laboratory_mob_validate_oper

  function do_ajax_form_normal_laboratory_mob_validate_oper_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "oper";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_mob_validate_oper_cb

  // ---------- Validate m1
  function do_ajax_form_normal_laboratory_mob_validate_m1()
  {
    var nomeCampo_m1 = "m1";
    var var_m1 = scAjaxGetFieldText(nomeCampo_m1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_mob_validate_m1(var_m1, var_script_case_init, do_ajax_form_normal_laboratory_mob_validate_m1_cb);
  } // do_ajax_form_normal_laboratory_mob_validate_m1

  function do_ajax_form_normal_laboratory_mob_validate_m1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "m1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_mob_validate_m1_cb

  // ---------- Validate m2
  function do_ajax_form_normal_laboratory_mob_validate_m2()
  {
    var nomeCampo_m2 = "m2";
    var var_m2 = scAjaxGetFieldText(nomeCampo_m2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_mob_validate_m2(var_m2, var_script_case_init, do_ajax_form_normal_laboratory_mob_validate_m2_cb);
  } // do_ajax_form_normal_laboratory_mob_validate_m2

  function do_ajax_form_normal_laboratory_mob_validate_m2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "m2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_mob_validate_m2_cb

  // ---------- Validate f1
  function do_ajax_form_normal_laboratory_mob_validate_f1()
  {
    var nomeCampo_f1 = "f1";
    var var_f1 = scAjaxGetFieldText(nomeCampo_f1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_mob_validate_f1(var_f1, var_script_case_init, do_ajax_form_normal_laboratory_mob_validate_f1_cb);
  } // do_ajax_form_normal_laboratory_mob_validate_f1

  function do_ajax_form_normal_laboratory_mob_validate_f1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "f1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_mob_validate_f1_cb

  // ---------- Validate f2
  function do_ajax_form_normal_laboratory_mob_validate_f2()
  {
    var nomeCampo_f2 = "f2";
    var var_f2 = scAjaxGetFieldText(nomeCampo_f2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_mob_validate_f2(var_f2, var_script_case_init, do_ajax_form_normal_laboratory_mob_validate_f2_cb);
  } // do_ajax_form_normal_laboratory_mob_validate_f2

  function do_ajax_form_normal_laboratory_mob_validate_f2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "f2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_mob_validate_f2_cb

  // ---------- Validate unit
  function do_ajax_form_normal_laboratory_mob_validate_unit()
  {
    var nomeCampo_unit = "unit";
    var var_unit = scAjaxGetFieldSelect(nomeCampo_unit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_mob_validate_unit(var_unit, var_script_case_init, do_ajax_form_normal_laboratory_mob_validate_unit_cb);
  } // do_ajax_form_normal_laboratory_mob_validate_unit

  function do_ajax_form_normal_laboratory_mob_validate_unit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "unit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_mob_validate_unit_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_normal_laboratory_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_normal_laboratory_mob_validate_sc_field_0_cb);
  } // do_ajax_form_normal_laboratory_mob_validate_sc_field_0

  function do_ajax_form_normal_laboratory_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_mob_validate_sc_field_0_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_normal_laboratory_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_normal_laboratory_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_normal_laboratory_mob_submit_form(var_labcode, var_category, var_name, var_subname, var_rate, var_order, var_lastupdated, var_resulttype, var_oper, var_m1, var_m2, var_f1, var_f2, var_unit, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_normal_laboratory_mob_submit_form_cb);
  } // do_ajax_form_normal_laboratory_mob_submit_form

  function do_ajax_form_normal_laboratory_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_normal_laboratory_mob_submit_form_cb_after_alert);
  } // do_ajax_form_normal_laboratory_mob_submit_form_cb
  function do_ajax_form_normal_laboratory_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_normal_laboratory_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_normal_laboratory_detail_mob"] = "off";

  function do_ajax_form_normal_laboratory_mob_navigate_form()
  {
    perform_ajax_form_normal_laboratory_mob_navigate_form();
  }

  function perform_ajax_form_normal_laboratory_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_normal_laboratory_detail_mob"] = "on";
    x_ajax_form_normal_laboratory_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_normal_laboratory_mob_navigate_form_cb);
  } // do_ajax_form_normal_laboratory_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_normal_laboratory_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_normal_laboratory_detail_mob"] && "nmsc_iframe_liga_form_normal_laboratory_detail_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_normal_laboratory_detail_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_normal_laboratory_detail_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_normal_laboratory_detail_mob').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_normal_laboratory_detail_mob').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_normal_laboratory_detail_mob').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_normal_laboratory_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_normal_laboratory_mob_navigate_form_cb
  function do_ajax_form_normal_laboratory_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_normal_laboratory_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_normal_laboratory_mob_navigate_form_cb_after_alert
  function sc_hide_form_normal_laboratory_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_normal_laboratory_detail_mob"])
    {
      return true;
    }
    return false;
