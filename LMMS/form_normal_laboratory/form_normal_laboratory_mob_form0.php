...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_normal_laboratory_mob_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_normal_laboratory_mob_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = '';
    $vertical_center = '';
?>
...
if (isset($_SESSION['scriptcase']['form_normal_laboratory']['error_buffer']) && '' != $_SESSION['scriptcase']['form_normal_laboratory']['error_buffer'])
{
    echo $_SESSION['scriptcase']['form_normal_laboratory']['error_buffer'];
}
...
<?php
 include_once("form_normal_laboratory_mob_js0.php");
?>
<script type="text/javascript"> 
...
<form  name="F1" method="post" 
               action="form_normal_laboratory_mob.php" 
               target="_self">
<input type="hidden" name="nmgp_url_saida" value="">
<?php
if ('novo' == $this->nmgp_opcao || 'incluir' == $this->nmgp_opcao)
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_normal_laboratory_mob'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_normal_laboratory_mob'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['fast_search'][2] : "";
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
?>
<script type="text/javascript">
var pag_ativa = "form_normal_laboratory_mob_form0";
</script>
<ul class="scTabLine sc-ui-page-tab-line">
<?php
    $this->tabCssClass = array(
        'form_normal_laboratory_mob_form0' => array(
            'title' => "Main",
            'class' => $nmgp_num_form == "form_normal_laboratory_mob_form0" ? "scTabActive" : "scTabInactive",
        ),
        'form_normal_laboratory_mob_form1' => array(
            'title' => "Detail",
            'class' => $nmgp_num_form == "form_normal_laboratory_mob_form1" ? "scTabActive" : "scTabInactive",
        ),
    );
        if (!empty($this->Ini->nm_hidden_pages)) {
                foreach ($this->Ini->nm_hidden_pages as $pageName => $pageStatus) {
                        if ('Main' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_normal_laboratory_mob_form0']['class'] = 'scTabInactive';
                        }
                        if ('Detail' == $pageName && 'off' == $pageStatus) {
                                $this->tabCssClass['form_normal_laboratory_mob_form1']['class'] = 'scTabInactive';
                        }
                }
...
?>
<?php
    $css_celula = $this->tabCssClass["form_normal_laboratory_mob_form0"]['class'];
?>
   <li id="id_form_normal_laboratory_mob_form0" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_normal_laboratory_mob_form0')">
     Main
    </a>
   </li>
<?php
    $css_celula = $this->tabCssClass["form_normal_laboratory_mob_form1"]['class'];
?>
   <li id="id_form_normal_laboratory_mob_form1" class="<?php echo $css_celula; ?> sc-form-page">
    <a href="javascript: sc_exib_ocult_pag ('form_normal_laboratory_mob_form1')">
     Detail
    </a>
   </li>
</ul>
...
<div id="form_normal_laboratory_mob_form0" style='display: none; width: 1px; height: 0px; overflow: scroll'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_category_line" id="hidden_field_data_category" style="<?php echo $sStyleHidden_category; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_category_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_category_label" style=""><span id="id_label_category"><?php echo $this->nm_new_label['category']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_subname_line" id="hidden_field_data_subname" style="<?php echo $sStyleHidden_subname; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_subname_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_subname_label" style=""><span id="id_label_subname"><?php echo $this->nm_new_label['subname']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_rate_line" id="hidden_field_data_rate" style="<?php echo $sStyleHidden_rate; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_rate_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_rate_label" style=""><span id="id_label_rate"><?php echo $this->nm_new_label['rate']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_order_line" id="hidden_field_data_order" style="<?php echo $sStyleHidden_order; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_order_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_order_label" style=""><span id="id_label_order"><?php echo $this->nm_new_label['order']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_lastupdated_line" id="hidden_field_data_lastupdated" style="<?php echo $sStyleHidden_lastupdated; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_lastupdated_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_lastupdated_label" style=""><span id="id_label_lastupdated"><?php echo $this->nm_new_label['lastupdated']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_resulttype_line" id="hidden_field_data_resulttype" style="<?php echo $sStyleHidden_resulttype; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_resulttype_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_resulttype_label" style=""><span id="id_label_resulttype"><?php echo $this->nm_new_label['resulttype']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['Lookup_resulttype'][] = '0'; ?>
 <option  value="1" <?php  if ($this->resulttype == "1") { echo " selected" ;} ?>>Selection</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['Lookup_resulttype'][] = '1'; ?>
 <option  value="2" <?php  if ($this->resulttype == "2") { echo " selected" ;} ?>>Description</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['Lookup_resulttype'][] = '2'; ?>
 <option  value="3" <?php  if ($this->resulttype == "3") { echo " selected" ;} ?>>Sub Value</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['Lookup_resulttype'][] = '3'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_oper_line" id="hidden_field_data_oper" style="<?php echo $sStyleHidden_oper; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_oper_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_oper_label" style=""><span id="id_label_oper"><?php echo $this->nm_new_label['oper']; ?></span></span><br>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_mob']['Lookup_oper'][] = ''; ?>
 <option value=""></option>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_m1_line" id="hidden_field_data_m1" style="<?php echo $sStyleHidden_m1; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_m1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_m1_label" style=""><span id="id_label_m1"><?php echo $this->nm_new_label['m1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_m2_line" id="hidden_field_data_m2" style="<?php echo $sStyleHidden_m2; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_m2_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_m2_label" style=""><span id="id_label_m2"><?php echo $this->nm_new_label['m2']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_f1_line" id="hidden_field_data_f1" style="<?php echo $sStyleHidden_f1; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_f1_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_f1_label" style=""><span id="id_label_f1"><?php echo $this->nm_new_label['f1']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_unit_line" id="hidden_field_data_unit" style="<?php echo $sStyleHidden_unit; ?>vertical-align: top;"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_unit_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_unit_label" style=""><span id="id_label_unit"><?php echo $this->nm_new_label['unit']; ?></span></span><br>
