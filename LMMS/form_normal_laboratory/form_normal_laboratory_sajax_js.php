  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_normal_laboratory" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_normal_laboratory_form();
	}
  ...
  // ---------- Validate labcode
  function do_ajax_form_normal_laboratory_validate_labcode()
  {
    var nomeCampo_labcode = "labcode";
    var var_labcode = scAjaxGetFieldText(nomeCampo_labcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_validate_labcode(var_labcode, var_script_case_init, do_ajax_form_normal_laboratory_validate_labcode_cb);
  } // do_ajax_form_normal_laboratory_validate_labcode

  function do_ajax_form_normal_laboratory_validate_labcode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_validate_labcode_cb

  // ---------- Validate category
  function do_ajax_form_normal_laboratory_validate_category()
  {
    var nomeCampo_category = "category";
    var var_category = scAjaxGetFieldSelect(nomeCampo_category);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_validate_category(var_category, var_script_case_init, do_ajax_form_normal_laboratory_validate_category_cb);
  } // do_ajax_form_normal_laboratory_validate_category

  function do_ajax_form_normal_laboratory_validate_category_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_validate_category_cb

  // ---------- Validate name
  function do_ajax_form_normal_laboratory_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_validate_name(var_name, var_script_case_init, do_ajax_form_normal_laboratory_validate_name_cb);
  } // do_ajax_form_normal_laboratory_validate_name

  function do_ajax_form_normal_laboratory_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_validate_name_cb

  // ---------- Validate subname
  function do_ajax_form_normal_laboratory_validate_subname()
  {
    var nomeCampo_subname = "subname";
    var var_subname = scAjaxGetFieldText(nomeCampo_subname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_validate_subname(var_subname, var_script_case_init, do_ajax_form_normal_laboratory_validate_subname_cb);
  } // do_ajax_form_normal_laboratory_validate_subname

  function do_ajax_form_normal_laboratory_validate_subname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "subname";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_validate_subname_cb

  // ---------- Validate rate
  function do_ajax_form_normal_laboratory_validate_rate()
  {
    var nomeCampo_rate = "rate";
    var var_rate = scAjaxGetFieldText(nomeCampo_rate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_validate_rate(var_rate, var_script_case_init, do_ajax_form_normal_laboratory_validate_rate_cb);
  } // do_ajax_form_normal_laboratory_validate_rate

  function do_ajax_form_normal_laboratory_validate_rate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "rate";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_validate_rate_cb

  // ---------- Validate order
  function do_ajax_form_normal_laboratory_validate_order()
  {
    var nomeCampo_order = "order";
    var var_order = scAjaxGetFieldText(nomeCampo_order);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_validate_order(var_order, var_script_case_init, do_ajax_form_normal_laboratory_validate_order_cb);
  } // do_ajax_form_normal_laboratory_validate_order

  function do_ajax_form_normal_laboratory_validate_order_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "order";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_validate_order_cb

  // ---------- Validate lastupdated
  function do_ajax_form_normal_laboratory_validate_lastupdated()
  {
    var nomeCampo_lastupdated = "lastupdated";
    var var_lastupdated = scAjaxGetFieldText(nomeCampo_lastupdated);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_validate_lastupdated(var_lastupdated, var_script_case_init, do_ajax_form_normal_laboratory_validate_lastupdated_cb);
  } // do_ajax_form_normal_laboratory_validate_lastupdated

  function do_ajax_form_normal_laboratory_validate_lastupdated_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lastupdated";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_validate_lastupdated_cb

  // ---------- Validate resulttype
  function do_ajax_form_normal_laboratory_validate_resulttype()
  {
    var nomeCampo_resulttype = "resulttype";
    var var_resulttype = scAjaxGetFieldSelect(nomeCampo_resulttype);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_validate_resulttype(var_resulttype, var_script_case_init, do_ajax_form_normal_laboratory_validate_resulttype_cb);
  } // do_ajax_form_normal_laboratory_validate_resulttype

  function do_ajax_form_normal_laboratory_validate_resulttype_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "resulttype";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_validate_resulttype_cb

  // ---------- Validate oper
  function do_ajax_form_normal_laboratory_validate_oper()
  {
    var nomeCampo_oper = "oper";
    var var_oper = scAjaxGetFieldSelect(nomeCampo_oper);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_validate_oper(var_oper, var_script_case_init, do_ajax_form_normal_laboratory_validate_oper_cb);
  } // do_ajax_form_normal_laboratory_validate_oper

  function do_ajax_form_normal_laboratory_validate_oper_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "oper";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_validate_oper_cb

  // ---------- Validate m1
  function do_ajax_form_normal_laboratory_validate_m1()
  {
    var nomeCampo_m1 = "m1";
    var var_m1 = scAjaxGetFieldText(nomeCampo_m1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_validate_m1(var_m1, var_script_case_init, do_ajax_form_normal_laboratory_validate_m1_cb);
  } // do_ajax_form_normal_laboratory_validate_m1

  function do_ajax_form_normal_laboratory_validate_m1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "m1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_validate_m1_cb

  // ---------- Validate m2
  function do_ajax_form_normal_laboratory_validate_m2()
  {
    var nomeCampo_m2 = "m2";
    var var_m2 = scAjaxGetFieldText(nomeCampo_m2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_validate_m2(var_m2, var_script_case_init, do_ajax_form_normal_laboratory_validate_m2_cb);
  } // do_ajax_form_normal_laboratory_validate_m2

  function do_ajax_form_normal_laboratory_validate_m2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "m2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_validate_m2_cb

  // ---------- Validate f1
  function do_ajax_form_normal_laboratory_validate_f1()
  {
    var nomeCampo_f1 = "f1";
    var var_f1 = scAjaxGetFieldText(nomeCampo_f1);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_validate_f1(var_f1, var_script_case_init, do_ajax_form_normal_laboratory_validate_f1_cb);
  } // do_ajax_form_normal_laboratory_validate_f1

  function do_ajax_form_normal_laboratory_validate_f1_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "f1";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_validate_f1_cb

  // ---------- Validate f2
  function do_ajax_form_normal_laboratory_validate_f2()
  {
    var nomeCampo_f2 = "f2";
    var var_f2 = scAjaxGetFieldText(nomeCampo_f2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_validate_f2(var_f2, var_script_case_init, do_ajax_form_normal_laboratory_validate_f2_cb);
  } // do_ajax_form_normal_laboratory_validate_f2

  function do_ajax_form_normal_laboratory_validate_f2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "f2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_validate_f2_cb

  // ---------- Validate unit
  function do_ajax_form_normal_laboratory_validate_unit()
  {
    var nomeCampo_unit = "unit";
    var var_unit = scAjaxGetFieldSelect(nomeCampo_unit);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_validate_unit(var_unit, var_script_case_init, do_ajax_form_normal_laboratory_validate_unit_cb);
  } // do_ajax_form_normal_laboratory_validate_unit

  function do_ajax_form_normal_laboratory_validate_unit_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "unit";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_validate_unit_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_normal_laboratory_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_normal_laboratory_validate_sc_field_0_cb);
  } // do_ajax_form_normal_laboratory_validate_sc_field_0

  function do_ajax_form_normal_laboratory_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_validate_sc_field_0_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_normal_laboratory_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_normal_laboratory_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_labcode = scAjaxGetFieldText("labcode");
    var var_category = scAjaxGetFieldSelect("category");
    var var_name = scAjaxGetFieldText("name");
    var var_subname = scAjaxGetFieldText("subname");
    var var_rate = scAjaxGetFieldText("rate");
    var var_order = scAjaxGetFieldText("order");
    var var_lastupdated = scAjaxGetFieldText("lastupdated");
    var var_resulttype = scAjaxGetFieldSelect("resulttype");
    var var_oper = scAjaxGetFieldSelect("oper");
    var var_m1 = scAjaxGetFieldText("m1");
    var var_m2 = scAjaxGetFieldText("m2");
    var var_f1 = scAjaxGetFieldText("f1");
    var var_f2 = scAjaxGetFieldText("f2");
    var var_unit = scAjaxGetFieldSelect("unit");
    ...
    scAjaxProcOn();
    x_ajax_form_normal_laboratory_submit_form(var_labcode, var_category, var_name, var_subname, var_rate, var_order, var_lastupdated, var_resulttype, var_oper, var_m1, var_m2, var_f1, var_f2, var_unit, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_normal_laboratory_submit_form_cb);
  } // do_ajax_form_normal_laboratory_submit_form

  function do_ajax_form_normal_laboratory_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("labcode");
      scAjaxHideErrorDisplay("category");
      scAjaxHideErrorDisplay("name");
      scAjaxHideErrorDisplay("subname");
      scAjaxHideErrorDisplay("rate");
      scAjaxHideErrorDisplay("order");
      scAjaxHideErrorDisplay("lastupdated");
      scAjaxHideErrorDisplay("resulttype");
      scAjaxHideErrorDisplay("oper");
      scAjaxHideErrorDisplay("m1");
      scAjaxHideErrorDisplay("m2");
      scAjaxHideErrorDisplay("f1");
      scAjaxHideErrorDisplay("f2");
      scAjaxHideErrorDisplay("unit");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_normal_laboratory_submit_form_cb_after_alert);
  } // do_ajax_form_normal_laboratory_submit_form_cb
  function do_ajax_form_normal_laboratory_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_normal_laboratory_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_normal_laboratory_detail"] = "off";

  function do_ajax_form_normal_laboratory_navigate_form()
  {
    perform_ajax_form_normal_laboratory_navigate_form();
  }

  function perform_ajax_form_normal_laboratory_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_normal_laboratory_detail"] = "on";
    x_ajax_form_normal_laboratory_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_normal_laboratory_navigate_form_cb);
  } // do_ajax_form_normal_laboratory_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_normal_laboratory_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_normal_laboratory_detail"] && "nmsc_iframe_liga_form_normal_laboratory_detail" != scMasterDetailIframe["nmsc_iframe_liga_form_normal_laboratory_detail"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_normal_laboratory_detail"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_normal_laboratory_detail').contentWindow.nm_move('apl_detalhe', true);
        document.getElementById('nmsc_iframe_liga_form_normal_laboratory_detail').style.height = "1";
        document.getElementById('nmsc_iframe_liga_form_normal_laboratory_detail').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_normal_laboratory_navigate_form_cb_after_alert);
  } // do_ajax_form_normal_laboratory_navigate_form_cb
  function do_ajax_form_normal_laboratory_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_normal_laboratory_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_normal_laboratory_navigate_form_cb_after_alert
  function sc_hide_form_normal_laboratory_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_normal_laboratory_detail"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "labcode";
  ajax_field_list[1] = "category";
  ajax_field_list[2] = "name";
  ajax_field_list[3] = "subname";
  ajax_field_list[4] = "rate";
  ajax_field_list[5] = "order";
  ajax_field_list[6] = "lastupdated";
  ajax_field_list[7] = "resulttype";
  ajax_field_list[8] = "oper";
  ajax_field_list[9] = "m1";
  ajax_field_list[10] = "m2";
  ajax_field_list[11] = "f1";
  ajax_field_list[12] = "f2";
  ajax_field_list[13] = "unit";
  ajax_field_list[14] = "sc_field_0";
  ...
  var ajax_error_list = {
    "labcode": {"label": "Lab Code", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    ...
    "subname": {"label": "Sub Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "rate": {"label": "Rate / Price", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "order": {"label": "Order", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lastupdated": {"label": "Last Updated", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "resulttype": {"label": "Result Type", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "oper": {"label": "Range Operator", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "m1": {"label": "Value from (Male)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "m2": {"label": "Value until (Male)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "f1": {"label": "Value from (Female)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "f2": {"label": "Value until (Female)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "unit": {"label": "Units Scale", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_0": {"label": "Sub Result", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["labcode"][1] = "labcode";
  ajax_field_mult["category"][1] = "category";
  ajax_field_mult["name"][1] = "name";
  ajax_field_mult["subname"][1] = "subname";
  ajax_field_mult["rate"][1] = "rate";
  ajax_field_mult["order"][1] = "order";
  ajax_field_mult["lastupdated"][1] = "lastupdated";
  ajax_field_mult["resulttype"][1] = "resulttype";
  ajax_field_mult["oper"][1] = "oper";
  ajax_field_mult["m1"][1] = "m1";
  ajax_field_mult["m2"][1] = "m2";
  ajax_field_mult["f1"][1] = "f1";
  ajax_field_mult["f2"][1] = "f2";
  ajax_field_mult["unit"][1] = "unit";
  ajax_field_mult["sc_field_0"][1] = "sc_field_0";

  var ajax_field_id = {
    "labcode": new Array("hidden_field_label_labcode", "hidden_field_data_labcode"),
    ...
    "subname": new Array("hidden_field_label_subname", "hidden_field_data_subname"),
    "rate": new Array("hidden_field_label_rate", "hidden_field_data_rate"),
    "order": new Array("hidden_field_label_order", "hidden_field_data_order"),
    "lastupdated": new Array("hidden_field_label_lastupdated", "hidden_field_data_lastupdated"),
    "resulttype": new Array("hidden_field_label_resulttype", "hidden_field_data_resulttype"),
    "oper": new Array("hidden_field_label_oper", "hidden_field_data_oper"),
    "m1": new Array("hidden_field_label_m1", "hidden_field_data_m1"),
    "m2": new Array("hidden_field_label_m2", "hidden_field_data_m2"),
    "f1": new Array("hidden_field_label_f1", "hidden_field_data_f1"),
    "f2": new Array("hidden_field_label_f2", "hidden_field_data_f2"),
    "unit": new Array("hidden_field_label_unit", "hidden_field_data_unit"),
