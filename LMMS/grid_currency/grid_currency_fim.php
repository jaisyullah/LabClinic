...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LMMS_____grid_currency"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LMMS_____grid_currency"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_currency'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_currency']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_currency']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_currency']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_currency']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_currency']['sc_modal']);
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_currency']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_currency']['embutida_filho'] as $ind => $sc_init)
          {
