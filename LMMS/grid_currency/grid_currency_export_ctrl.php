<?php
@session_start() ;
$_SESSION['scriptcase']['grid_currency']['sc_process_barr'] = true;
require_once('../grid_currency/index.php');
unset($_SESSION['scriptcase']['grid_currency']['sc_process_barr']);
$ExportCtrl = new grid_currency_export_control;
$ExportCtrl->Export_barr();

class grid_currency_export_control
{
