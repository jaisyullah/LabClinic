...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_code_cond" name="code_cond" onChange="nm_campos_between(document.getElementById('id_vis_code'), this, 'code')">
      ...
      <br><span id="id_hide_code"  <?php echo $str_hide_code?>><?php
      if ($code != "")
      {
      $code_look = substr($this->Db->qstr($code), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_symbol_cond" name="symbol_cond" onChange="nm_campos_between(document.getElementById('id_vis_symbol'), this, 'symbol')">
      ...
      <br><span id="id_hide_symbol"  <?php echo $str_hide_symbol?>><?php
      if ($symbol != "")
      {
      $symbol_look = substr($this->Db->qstr($symbol), 1, -1); 
      $nmgp_def_dados = array(); 
