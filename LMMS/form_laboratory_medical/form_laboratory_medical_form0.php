...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_laboratory_medical_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_laboratory_medical_jquery.php');
...
?>
 ...
 function addAutocomplete(elem) {
  ...
  $(".sc-ui-autocomp-icdid", elem).on("focus", function() {
   ...
   width: "300px",
   ajax: {
    url: "form_laboratory_medical.php",
    dataType: "json",
   ...
   var sId = $(this).attr("id").substr(6), sRow = "icdid" != sId ? sId.substr(5) : "";
   sc_form_laboratory_medical_icdid_onfocus("id_sc_field_" + sId, sRow);
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_laboratory_medical_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_laboratory_medical'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_laboratory_medical'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['fast_search'][2] : "";
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<span id="id_read_on_regcode" class="sc-ui-readonly-regcode css_regcode_line" style="<?php echo $sStyleReadLab_regcode; ?>"><?php echo $this->form_format_readonly("regcode", $this->form_encode_input($this->regcode)); ?></span><span id="id_read_off_regcode" class="css_read_off_regcode" style="white-space: nowrap;<?php echo $sStyleReadInp_regcode; ?>">
 ...
 size=15 maxlength=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_laboratory_medical*scout' : '';
   if (isset($this->Ini->sc_lig_md5["select_outpatient_reg"]) && $this->Ini->sc_lig_md5["select_outpatient_reg"] == "S") {
       ...
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_laboratory_medical@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['Lookup_statusid'][] = '1'; ?>
 <option  value="3" <?php  if ($this->statusid == "3") { echo " selected" ;} ?>>Confirmed</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['Lookup_statusid'][] = '3'; ?>
 <option  value="2" <?php  if ($this->statusid == "2") { echo " selected" ;} ?>>Finished</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['Lookup_statusid'][] = '2'; ?>
 <option  value="0" <?php  if ($this->statusid == "0") { echo " selected" ;} ?>>Cancel</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['Lookup_statusid'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Detail'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Detail'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_laboratory_medical_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Detail'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_laboratory_medical_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_laboratory_medical_script_case_init'] ]['form_bill_laboratory_medical']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_laboratory_medical_script_case_init'] ]['form_bill_laboratory_medical']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_laboratory_medical_script_case_init'] ]['form_bill_laboratory_medical']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_laboratory_medical_script_case_init'] ]['form_bill_laboratory_medical']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_laboratory_medical_script_case_init'] ]['form_bill_laboratory_medical']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_laboratory_medical_script_case_init'] ]['form_bill_laboratory_medical']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_laboratory_medical_script_case_init'] ]['form_bill_laboratory_medical']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_laboratory_medical_script_case_init'] ]['form_bill_laboratory_medical']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_laboratory_medical_script_case_init'] ]['form_bill_laboratory_medical']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_laboratory_medical_script_case_init'] ]['form_bill_laboratory_medical']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_laboratory_medical_script_case_init'] ]['form_bill_laboratory_medical']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_laboratory_medical_script_case_init'] ]['form_bill_laboratory_medical']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_laboratory_medical_script_case_init'] ]['form_laboratory_medical']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_laboratory_medical_empty.htm' : $this->Ini->link_form_bill_laboratory_medical_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=850';
if (isset($this->Ini->sc_lig_target['C_@scinf_Detail']) && 'nmsc_iframe_liga_form_bill_laboratory_medical' != $this->Ini->sc_lig_target['C_@scinf_Detail'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_Detail'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_laboratory_medical_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_bill_laboratory_medical"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="850" width="100%" name="nmsc_iframe_liga_form_bill_laboratory_medical"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_0'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_0'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_misc_laboratory_medical_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_0'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_misc_laboratory_medical_script_case_init'] = $this->Ini->sc_page;
 }
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_misc_laboratory_medical_script_case_init'] ]['form_bill_misc_laboratory_medical']['embutida_proc']  = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_misc_laboratory_medical_script_case_init'] ]['form_bill_misc_laboratory_medical']['embutida_form']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_misc_laboratory_medical_script_case_init'] ]['form_bill_misc_laboratory_medical']['embutida_call']  = true;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_misc_laboratory_medical_script_case_init'] ]['form_bill_misc_laboratory_medical']['embutida_multi'] = false;
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_misc_laboratory_medical_script_case_init'] ]['form_bill_misc_laboratory_medical']['embutida_liga_form_insert'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_misc_laboratory_medical_script_case_init'] ]['form_bill_misc_laboratory_medical']['embutida_liga_form_update'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_misc_laboratory_medical_script_case_init'] ]['form_bill_misc_laboratory_medical']['embutida_liga_form_delete'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_misc_laboratory_medical_script_case_init'] ]['form_bill_misc_laboratory_medical']['embutida_liga_form_btn_nav'] = 'off';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_misc_laboratory_medical_script_case_init'] ]['form_bill_misc_laboratory_medical']['embutida_liga_grid_edit'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_misc_laboratory_medical_script_case_init'] ]['form_bill_misc_laboratory_medical']['embutida_liga_grid_edit_link'] = 'on';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_misc_laboratory_medical_script_case_init'] ]['form_bill_misc_laboratory_medical']['embutida_liga_qtd_reg'] = '10';
 $_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_misc_laboratory_medical_script_case_init'] ]['form_bill_misc_laboratory_medical']['embutida_liga_tp_pag'] = 'parcial';
 ...
 if ($_SESSION['sc_session'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_misc_laboratory_medical_script_case_init'] ]['form_laboratory_medical']['total'] < 0)
 {
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_laboratory_medical_empty.htm' : $this->Ini->link_form_bill_misc_laboratory_medical_edit . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=800';
if (isset($this->Ini->sc_lig_target['C_@scinf_sc_field_0']) && 'nmsc_iframe_liga_form_bill_misc_laboratory_medical' != $this->Ini->sc_lig_target['C_@scinf_sc_field_0'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_sc_field_0'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['form_bill_misc_laboratory_medical_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
{
?>
<iframe border="0" id="nmsc_iframe_liga_form_bill_misc_laboratory_medical"  marginWidth="0" marginHeight="0" frameborder="0" valign="top" height="800" width="100%" name="nmsc_iframe_liga_form_bill_misc_laboratory_medical"  scrolling="auto" src="<?php echo $sDetailSrc; ?>"></iframe>
<?php
}
?>
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Result'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Result'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['grid_result_laboratory_medical_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_Result'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['grid_result_laboratory_medical_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_laboratory_medical_empty.htm' : $this->Ini->link_grid_result_laboratory_medical_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y&sc_ifr_height=800' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_Result']) && 'nmsc_iframe_liga_grid_result_laboratory_medical' != $this->Ini->sc_lig_target['C_@scinf_Result'])
{
    if ('novo' != $this->nmgp_opcao)
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_Result'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['grid_result_laboratory_medical_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_laboratory_medical");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_laboratory_medical");
 parent.scAjaxDetailHeight("form_laboratory_medical", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_laboratory_medical']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
