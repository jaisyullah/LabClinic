...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "regDate";$Nm_datas[] = "regDate";$Nm_datas[] = "regTime";$Nm_datas[] = "regTime";$Nm_datas[] = "finishDate";$Nm_datas[] = "finishDate";$Nm_datas[] = "serviceDate";$Nm_datas[] = "serviceDate";$Nm_numeric[] = "id";$Nm_numeric[] = "deptid";$Nm_numeric[] = "doctorid";$Nm_numeric[] = "statusid";$Nm_numeric[] = "paymentid";$Nm_numeric[] = "staffid";$Nm_numeric[] = "institutionid";
...
<HTML>
<HEAD>
 <TITLE> outpatient register</TITLE>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_doctorid_cond" name="doctorid_cond" onChange="nm_campos_between(document.getElementById('id_vis_doctorid'), this, 'doctorid')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_patientid_cond" name="patientid_cond" onChange="nm_campos_between(document.getElementById('id_vis_patientid'), this, 'patientid')">
      ...
      <br><span id="id_hide_patientid"  <?php echo $str_hide_patientid?>><?php
      if ($patientid != "")
      {
      $patientid_look = substr($this->Db->qstr($patientid), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_deptid_cond" name="deptid_cond" onChange="nm_campos_between(document.getElementById('id_vis_deptid'), this, 'deptid')">
