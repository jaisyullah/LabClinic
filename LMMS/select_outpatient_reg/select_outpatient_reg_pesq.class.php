...
class select_outpatient_reg_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search_change_fil")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca'] = array(); 
          foreach ($arr_new_fil as $tp)
          {
              foreach ($tp as $ind => $cada_dado)
              {
                  ...
                  if (is_array($cada_dado['value']))
                  {
                      ...
                      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca'][$field] = $arr_tmp; 
                  }
                  else
                  {
                      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca'][$field] = $cada_dado['value']; 
                  }
              }
          }
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $this->processa_busca();
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . select_outpatient_reg_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . select_outpatient_reg_pack_protect_string($Tipo_filter[0]) . "\">.." . select_outpatient_reg_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_patientid')
      {
          $patientid = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_patientid($patientid);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      if (in_array($campo_join, $Nm_numeric))
      {
          ...
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$campo_join]);
              return;
          }
      ...
      $Nm_datas[] = "regDate";$Nm_datas[] = "regDate";$Nm_datas[] = "regTime";$Nm_datas[] = "regTime";$Nm_datas[] = "finishDate";$Nm_datas[] = "finishDate";$Nm_datas[] = "serviceDate";$Nm_datas[] = "serviceDate";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo];
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                       $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                       $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                       $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $NM_cond;
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
                   $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
                   $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $lang_like . " " . $this->cmp_formatado[$nome_campo];
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo];
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"];
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $cond_descr;
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond;
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_null'];
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nnul'];
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_empty'];
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['label'] = $nmgp_tab_label[$nome_campo];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['descr'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'][$nome_campo]['hint'] = $nmgp_tab_label[$nome_campo] . ": " . $this->Ini->Nm_lang['lang_srch_nempty'];
            break;
         }
      }
   }
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>select_outpatient_reg/select_outpatient_reg_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="select_outpatient_reg_ajax_search.js"></script>
 <script type="text/javascript" src="select_outpatient_reg_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="select_outpatient_reg_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['select_outpatient_reg']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['select_outpatient_reg']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
var nmdg_Form = "F1";
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_doctorid#NMF#' + search_get_text('SC_doctorid') + '@NMF@';
  str_out += 'SC_id_cond#NMF#' + search_get_sel_txt('SC_id_cond') + '@NMF@';
  str_out += 'SC_id#NMF#' + search_get_text('SC_id') + '@NMF@';
  str_out += 'SC_patientid_cond#NMF#' + search_get_sel_txt('SC_patientid_cond') + '@NMF@';
  str_out += 'SC_patientid#NMF#' + search_get_text('SC_patientid') + '@NMF@';
  str_out += 'id_ac_patientid#NMF#' + search_get_text('id_ac_patientid') + '@NMF@';
  str_out += 'SC_deptid_cond#NMF#' + search_get_sel_txt('SC_deptid_cond') + '@NMF@';
  str_out += 'SC_deptid#NMF#' + search_get_text('SC_deptid') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_patientid").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_patientid").autocomplete({
     minLength: 1,
     ...
     $.ajax({
       ...
       data: {
          ...
          nmgp_parms: "NM_ajax_opcao?#?autocomp_patientid",
          max_itens: "10",
          cod_desc: "N",
     ...
     select: function (event, ui) {
       $("#SC_patientid").val(ui.item.value);
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<div class="scFilterHeader" style="height: 54px; padding: 17px 15px; box-sizing: border-box;margin: -1px 0px 0px 0px;width: 100%;">
    <div class="scFilterHeaderFont" style="float: left; text-transform: uppercase;"><?php echo $this->Ini->Nm_lang['lang_othr_grid_titl'] ?> outpatient register</div>
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $id_cond, $id,
             $patientid_cond, $patientid, $patientid_autocomp,
             $deptid_cond, $deptid,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          ...
          $doctorid = $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['doctorid']; 
          $doctorid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['doctorid_cond']; 
          $id = $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['id']; 
          $id_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['id_cond']; 
          $patientid = $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['patientid']; 
          $patientid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['patientid_cond']; 
          $deptid = $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['deptid']; 
          $deptid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['deptid_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['NM_operador']; 
          if (strtoupper($doctorid_cond) != "II" && strtoupper($doctorid_cond) != "QP" && strtoupper($doctorid_cond) != "NP" && strtoupper($doctorid_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($doctorid, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
          ...
          if (strtoupper($deptid_cond) != "II" && strtoupper($deptid_cond) != "QP" && strtoupper($deptid_cond) != "NP" && strtoupper($deptid_cond) != "IN") 
          { 
              nmgp_Form_Num_Val($deptid, $_SESSION['scriptcase']['reg_conf']['grup_num'], $_SESSION['scriptcase']['reg_conf']['dec_num'], "0", "S", "1", "", "N:" . $_SESSION['scriptcase']['reg_conf']['neg_num'] , $_SESSION['scriptcase']['reg_conf']['simb_neg'], $_SESSION['scriptcase']['reg_conf']['num_group_digit']) ; 
          } 
      } 
      if (!isset($doctorid_cond) || empty($doctorid_cond))
      {
         $doctorid_cond = "gt";
      }
      ...
      if (!isset($patientid_cond) || empty($patientid_cond))
      {
         $patientid_cond = "qp";
      }
      if (!isset($deptid_cond) || empty($deptid_cond))
      {
         $deptid_cond = "gt";
      }
      ...
      $str_hide_patientid = (in_array($patientid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_deptid = (in_array($deptid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      {
         $tmp_pos = strpos($patientid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $patientid = substr($patientid, 0, $tmp_pos);
         }
      }
      ...
      {
         $tmp_pos = strpos($deptid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $deptid = substr($deptid, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_doctorid_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['doctorid'])) ? $this->New_label['doctorid'] : "Doctor"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_doctorid_cond" name="doctorid_cond" onChange="nm_campos_between(document.getElementById('id_vis_doctorid'), this, 'doctorid')">
       <OPTION value="gt" <?php if ("gt" == $doctorid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $doctorid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $doctorid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_doctorid" <?php echo $str_hide_doctorid?> valign="top">
...
?>
<INPUT  type="text" id="SC_doctorid" name="doctorid" value="<?php echo NM_encode_input($doctorid) ?>" size=15 alt="{datatype: 'integer', maxLength: 15, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
...
<INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=25 alt="{datatype: 'integer', maxLength: 25, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
      ...
      <TD id='SC_patientid_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['patientid'])) ? $this->New_label['patientid'] : "Patient No"; ?></TD>
     <TD class="scFilterFieldOdd"> 
      <SELECT class="scFilterObjectOdd" id="SC_patientid_cond" name="patientid_cond" onChange="nm_campos_between(document.getElementById('id_vis_patientid'), this, 'patientid')">
       <OPTION value="qp" <?php if ("qp" == $patientid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_like'] ?></OPTION>
       <OPTION value="np" <?php if ("np" == $patientid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_not_like'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $patientid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
       <OPTION value="ep" <?php if ("ep" == $patientid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_empty'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_patientid" <?php echo $str_hide_patientid?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['patientid'])) ? $this->New_label['patientid'] : "Patient No";
 $nmgp_tab_label .= "patientid?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      {
          $sAutocompValue = $patientid;
      }
?>
<INPUT  type="text" id="SC_patientid" name="patientid" value="<?php echo NM_encode_input($patientid) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_patientid" name="patientid_autocomp" size="15"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_deptid_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['deptid'])) ? $this->New_label['deptid'] : "Clinic"; ?></TD>
     <TD class="scFilterFieldEven"> 
      <SELECT class="scFilterObjectEven" id="SC_deptid_cond" name="deptid_cond" onChange="nm_campos_between(document.getElementById('id_vis_deptid'), this, 'deptid')">
       <OPTION value="gt" <?php if ("gt" == $deptid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_grtr'] ?></OPTION>
       <OPTION value="lt" <?php if ("lt" == $deptid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_less'] ?></OPTION>
       <OPTION value="eq" <?php if ("eq" == $deptid_cond) { echo "selected"; } ?>><?php echo $this->Ini->Nm_lang['lang_srch_exac'] ?></OPTION>
      </SELECT>
       </TD>
     <TD  class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_deptid" <?php echo $str_hide_deptid?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
 $SC_Label = (isset($this->New_label['deptid'])) ? $this->New_label['deptid'] : "Clinic";
 $nmgp_tab_label .= "deptid?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
?>
<INPUT  type="text" id="SC_deptid" name="deptid" value="<?php echo NM_encode_input($deptid) ?>" size=15 alt="{datatype: 'integer', maxLength: 15, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
...
<?php
    $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['pesq_tab_label'] = $nmgp_tab_label;
?>
 <?php
     if ($_SESSION['scriptcase']['proc_mobile'])
     {
...
?>
<?php
   if (is_file("select_outpatient_reg_help.txt"))
   {
...
?>
<?php
   if (isset($_SESSION['scriptcase']['sc_apl_conf']['select_outpatient_reg']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['select_outpatient_reg']['start'] == 'filter' && $nm_apl_dependente != 1)
   {
?>
...
?>
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['orig_pesq'] == "grid")
   {
...
?>
 ...
 function limpa_form()
 {
   ...
   document.F1.doctorid_cond.value = 'gt';
   ...
   document.F1.patientid_cond.value = 'qp';
   nm_campos_between(document.getElementById('id_vis_patientid'), document.F1.patientid_cond, 'patientid');
   document.F1.patientid.value = "";
   document.F1.patientid_autocomp.value = "";
   document.F1.deptid_cond.value = 'gt';
   nm_campos_between(document.getElementById('id_vis_deptid'), document.F1.deptid_cond, 'deptid');
   document.F1.deptid.value = "";
 }
...
<?php
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_orig']))
      {
      ...
      {
          $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_orig'];
      }
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "select_outpatient_reg/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_doctorid'] = 'text';
      $tp_fields['SC_id_cond'] = 'cond';
      $tp_fields['SC_id'] = 'text';
      $tp_fields['SC_patientid_cond'] = 'cond';
      $tp_fields['SC_patientid'] = 'text_aut';
      $tp_fields['id_ac_patientid'] = 'text_aut';
      $tp_fields['SC_deptid_cond'] = 'cond';
      $tp_fields['SC_deptid'] = 'text';
   ...
   {
      global $doctorid_cond, $doctorid,
             $id_cond, $id,
             $patientid_cond, $patientid, $patientid_autocomp,
             $deptid_cond, $deptid, $nmgp_tab_label;
      ...
      if ($this->NM_ajax_flag && ($this->NM_ajax_opcao == "ajax_grid_search" || $this->NM_ajax_opcao == "ajax_grid_search_change_fil"))
      {
          ...
          $Temp_Busca  = $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca'];
          if ($_SESSION['scriptcase']['charset'] != "UTF-8" && $this->NM_ajax_opcao != "ajax_grid_search_change_fil")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca'] as $Cmps => $Vals)
          {
              $$Cmps = $Vals;
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq'] = array();
      if (!empty($patientid_autocomp) && empty($patientid))
      {
          $patientid = $patientid_autocomp;
      }
      ...
      $patientid_cond_salva = $patientid_cond; 
      if (!isset($patientid_input_2) || $patientid_input_2 == "")
      {
          $patientid_input_2 = $patientid;
      }
      $deptid_cond_salva = $deptid_cond; 
      if (!isset($deptid_input_2) || $deptid_input_2 == "")
      {
          $deptid_input_2 = $deptid;
      }
      if ($doctorid_cond != "in")
      {
          nm_limpa_numero($doctorid, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      if ($id_cond != "in")
      {
      ...
      if ($deptid_cond != "in")
      {
          nm_limpa_numero($deptid, $_SESSION['scriptcase']['reg_conf']['grup_num']) ; 
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search']  = array(); 
      $I_Grid = 0;
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['doctorid'] = $doctorid; 
      if (is_array($doctorid) && !empty($doctorid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid]['val'][0] = $doctorid;
      }
      elseif ($doctorid_cond_salva == "nu" || $doctorid_cond_salva == "nn" || $doctorid_cond_salva == "ep" || $doctorid_cond_salva == "ne" || !empty($doctorid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid]['val'][0][0] = $doctorid;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['doctorid_cond'] = $doctorid_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid]['cmp'] = "doctorid"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid]['opc'] = $doctorid_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq']['doctorid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['id'] = $id; 
      if (is_array($id) && !empty($id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid]['val'][0] = $id;
      }
      elseif ($id_cond_salva == "nu" || $id_cond_salva == "nn" || $id_cond_salva == "ep" || $id_cond_salva == "ne" || !empty($id))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid]['val'][0][0] = $id;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['id_cond'] = $id_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid]['cmp'] = "id"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid]['opc'] = $id_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq']['id'] = $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['patientid'] = $patientid; 
      if (is_array($patientid) && !empty($patientid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid]['val'][0] = $patientid;
      }
      elseif ($patientid_cond_salva == "nu" || $patientid_cond_salva == "nn" || $patientid_cond_salva == "ep" || $patientid_cond_salva == "ne" || !empty($patientid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid]['val'][0][0] = $patientid;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['patientid_cond'] = $patientid_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid]['cmp'] = "patientid"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid]['opc'] = $patientid_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq']['patientid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $Dyn_ok = false;
      $Grid_ok = false;
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['deptid'] = $deptid; 
      if (is_array($deptid) && !empty($deptid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid]['val'][0] = $deptid;
      }
      elseif ($deptid_cond_salva == "nu" || $deptid_cond_salva == "nn" || $deptid_cond_salva == "ep" || $deptid_cond_salva == "ne" || !empty($deptid))
      {
          $Grid_ok = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid]['val'][0][0] = $deptid;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['deptid_cond'] = $deptid_cond_salva; 
      if ($Grid_ok)
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid]['cmp'] = "deptid"; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid]['opc'] = $deptid_cond_salva; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['grid_pesq']['deptid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['Grid_search'][$I_Grid];
          $I_Grid++;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($patientid != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['patientid'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['patientid'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['patientid'] = $patientid;
      }
      $Conteudo = $deptid;
      if (strtoupper($deptid_cond) != "II" && strtoupper($deptid_cond) != "QP" && strtoupper($deptid_cond) != "NP" && strtoupper($deptid_cond) != "IN") 
      { 
      ...
      $this->cmp_formatado['deptid'] = $Conteudo;

      //----- $doctorid
      $this->Date_part = false;
      if (isset($doctorid) || $doctorid_cond == "nu" || $doctorid_cond == "nn" || $doctorid_cond == "ep" || $doctorid_cond == "ne")
      {
         $this->monta_condicao("doctorID", $doctorid_cond, $doctorid, "", "doctorid");
      }
      ...
      //----- $patientid
      $this->Date_part = false;
      if (isset($patientid) || $patientid_cond == "nu" || $patientid_cond == "nn" || $patientid_cond == "ep" || $patientid_cond == "ne")
      {
         $this->monta_condicao("patientID", $patientid_cond, $patientid, "", "patientid");
      }

      //----- $deptid
      $this->Date_part = false;
      if (isset($deptid) || $deptid_cond == "nu" || $deptid_cond == "nn" || $deptid_cond == "ep" || $deptid_cond == "ne")
      {
         $this->monta_condicao("deptID", $deptid_cond, $deptid, "", "deptid");
      }
   }
   ...
   function finaliza_resultado_ajax()
   {
       ...
       $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_pesq_grid'] = $this->comando;
       ...
       {
           $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_pesq_filtro'] = "( " . $this->comando . " )";
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_orig'])) 
           {
               $this->comando = $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_orig'] . " and (" . $this->comando . ")"; 
           }
           else
           {
               $this->comando = " where " . $this->comando; 
           }
           $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_pesq'] = $this->comando;
       }
       if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_pesq_fast'])) 
       {
           if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_pesq'])) 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_pesq'] .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_pesq_fast'] . ")";
           }
           else 
           {
               $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_pesq'] = " where (" . $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_pesq_fast'] . ")";
           }
       }
   }
   function finaliza_resultado()
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_pesq_grid']    = $this->comando_filtro;
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['select_outpatient_reg']['cond_pesq'] .= $this->NM_operador;
