<?php
@session_start() ;
$_SESSION['scriptcase']['select_outpatient_reg']['sc_process_barr'] = true;
require_once('../select_outpatient_reg/index.php');
unset($_SESSION['scriptcase']['select_outpatient_reg']['sc_process_barr']);
$ExportCtrl = new select_outpatient_reg_export_control;
$ExportCtrl->Export_barr();

class select_outpatient_reg_export_control
{
