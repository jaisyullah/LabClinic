<?php
@session_start() ;
$_SESSION['scriptcase']['lmms_grid_sec_apps']['sc_process_barr'] = true;
require_once('../lmms_grid_sec_apps/index.php');
unset($_SESSION['scriptcase']['lmms_grid_sec_apps']['sc_process_barr']);
$ExportCtrl = new lmms_grid_sec_apps_export_control;
$ExportCtrl->Export_barr();

class lmms_grid_sec_apps_export_control
{
