  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_his_laboratory_medical" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_his_laboratory_medical_form();
	}
  ...
  // ---------- Validate regcode
  function do_ajax_form_his_laboratory_medical_validate_regcode()
  {
    var nomeCampo_regcode = "regcode";
    var var_regcode = scAjaxGetFieldText(nomeCampo_regcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_validate_regcode(var_regcode, var_script_case_init, do_ajax_form_his_laboratory_medical_validate_regcode_cb);
  } // do_ajax_form_his_laboratory_medical_validate_regcode

  function do_ajax_form_his_laboratory_medical_validate_regcode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_validate_regcode_cb

  // ---------- Validate trancode
  function do_ajax_form_his_laboratory_medical_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_his_laboratory_medical_validate_trancode_cb);
  } // do_ajax_form_his_laboratory_medical_validate_trancode

  function do_ajax_form_his_laboratory_medical_validate_trancode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_validate_trancode_cb

  // ---------- Validate trandate
  function do_ajax_form_his_laboratory_medical_validate_trandate()
  {
    var nomeCampo_trandate = "trandate";
    var var_trandate = scAjaxGetFieldText(nomeCampo_trandate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_validate_trandate(var_trandate, var_script_case_init, do_ajax_form_his_laboratory_medical_validate_trandate_cb);
  } // do_ajax_form_his_laboratory_medical_validate_trandate

  function do_ajax_form_his_laboratory_medical_validate_trandate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_validate_trandate_cb

  // ---------- Validate staffid
  function do_ajax_form_his_laboratory_medical_validate_staffid()
  {
    var nomeCampo_staffid = "staffid";
    var var_staffid = scAjaxGetFieldSelect(nomeCampo_staffid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_validate_staffid(var_staffid, var_script_case_init, do_ajax_form_his_laboratory_medical_validate_staffid_cb);
  } // do_ajax_form_his_laboratory_medical_validate_staffid

  function do_ajax_form_his_laboratory_medical_validate_staffid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "staffid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_validate_staffid_cb

  // ---------- Validate patientid
  function do_ajax_form_his_laboratory_medical_validate_patientid()
  {
    var nomeCampo_patientid = "patientid";
    var var_patientid = scAjaxGetFieldSelect(nomeCampo_patientid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_validate_patientid(var_patientid, var_script_case_init, do_ajax_form_his_laboratory_medical_validate_patientid_cb);
  } // do_ajax_form_his_laboratory_medical_validate_patientid

  function do_ajax_form_his_laboratory_medical_validate_patientid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_validate_patientid_cb

  // ---------- Validate birthdate
  function do_ajax_form_his_laboratory_medical_validate_birthdate()
  {
    var nomeCampo_birthdate = "birthdate";
    var var_birthdate = scAjaxGetFieldText(nomeCampo_birthdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_validate_birthdate(var_birthdate, var_script_case_init, do_ajax_form_his_laboratory_medical_validate_birthdate_cb);
  } // do_ajax_form_his_laboratory_medical_validate_birthdate

  function do_ajax_form_his_laboratory_medical_validate_birthdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_validate_birthdate_cb

  // ---------- Validate icdid
  function do_ajax_form_his_laboratory_medical_validate_icdid()
  {
  } // do_ajax_form_his_laboratory_medical_validate_icdid

  function do_ajax_form_his_laboratory_medical_validate_icdid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "icdid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_validate_icdid_cb

  // ---------- Validate notes
  function do_ajax_form_his_laboratory_medical_validate_notes()
  {
    var nomeCampo_notes = "notes";
    var var_notes = scAjaxGetFieldText(nomeCampo_notes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_validate_notes(var_notes, var_script_case_init, do_ajax_form_his_laboratory_medical_validate_notes_cb);
  } // do_ajax_form_his_laboratory_medical_validate_notes

  function do_ajax_form_his_laboratory_medical_validate_notes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "notes";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_validate_notes_cb

  // ---------- Validate statusid
  function do_ajax_form_his_laboratory_medical_validate_statusid()
  {
    var nomeCampo_statusid = "statusid";
    var var_statusid = scAjaxGetFieldSelect(nomeCampo_statusid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_validate_statusid(var_statusid, var_script_case_init, do_ajax_form_his_laboratory_medical_validate_statusid_cb);
  } // do_ajax_form_his_laboratory_medical_validate_statusid

  function do_ajax_form_his_laboratory_medical_validate_statusid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_validate_statusid_cb

  // ---------- Validate confirmdate
  function do_ajax_form_his_laboratory_medical_validate_confirmdate()
  {
    var nomeCampo_confirmdate = "confirmdate";
    var var_confirmdate = scAjaxGetFieldText(nomeCampo_confirmdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_validate_confirmdate(var_confirmdate, var_script_case_init, do_ajax_form_his_laboratory_medical_validate_confirmdate_cb);
  } // do_ajax_form_his_laboratory_medical_validate_confirmdate

  function do_ajax_form_his_laboratory_medical_validate_confirmdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_validate_confirmdate_cb

  // ---------- Validate finishdate
  function do_ajax_form_his_laboratory_medical_validate_finishdate()
  {
    var nomeCampo_finishdate = "finishdate";
    var var_finishdate = scAjaxGetFieldText(nomeCampo_finishdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_validate_finishdate(var_finishdate, var_script_case_init, do_ajax_form_his_laboratory_medical_validate_finishdate_cb);
  } // do_ajax_form_his_laboratory_medical_validate_finishdate

  function do_ajax_form_his_laboratory_medical_validate_finishdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_validate_finishdate_cb

  // ---------- Validate detail
  function do_ajax_form_his_laboratory_medical_validate_detail()
  {
    var nomeCampo_detail = "detail";
    var var_detail = scAjaxGetFieldText(nomeCampo_detail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_validate_detail(var_detail, var_script_case_init, do_ajax_form_his_laboratory_medical_validate_detail_cb);
  } // do_ajax_form_his_laboratory_medical_validate_detail

  function do_ajax_form_his_laboratory_medical_validate_detail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_validate_detail_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_his_laboratory_medical_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_his_laboratory_medical_validate_sc_field_0_cb);
  } // do_ajax_form_his_laboratory_medical_validate_sc_field_0

  function do_ajax_form_his_laboratory_medical_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_validate_sc_field_0_cb

  // ---------- Validate result
  function do_ajax_form_his_laboratory_medical_validate_result()
  {
    var nomeCampo_result = "result";
    var var_result = scAjaxGetFieldText(nomeCampo_result);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_validate_result(var_result, var_script_case_init, do_ajax_form_his_laboratory_medical_validate_result_cb);
  } // do_ajax_form_his_laboratory_medical_validate_result

  function do_ajax_form_his_laboratory_medical_validate_result_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "result";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_validate_result_cb

  // ---------- Event onchange regcode
  function do_ajax_form_his_laboratory_medical_event_regcode_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_his_laboratory_medical_event_regcode_onchange(var_regcode, var_birthdate, var_patientid, var_script_case_init, do_ajax_form_his_laboratory_medical_event_regcode_onchange_cb);
  } // do_ajax_form_his_laboratory_medical_event_regcode_onchange

  function do_ajax_form_his_laboratory_medical_event_regcode_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "regcode";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_his_laboratory_medical_event_regcode_onchange_cb_after_alert);
  } // do_ajax_form_his_laboratory_medical_event_regcode_onchange_cb
  function do_ajax_form_his_laboratory_medical_event_regcode_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_his_laboratory_medical_event_regcode_onchange_cb_after_alert

  // ---------- Event onchange statusid
  function do_ajax_form_his_laboratory_medical_event_statusid_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_his_laboratory_medical_event_statusid_onchange(var_statusid, var_finishdate, var_confirmdate, var_script_case_init, do_ajax_form_his_laboratory_medical_event_statusid_onchange_cb);
  } // do_ajax_form_his_laboratory_medical_event_statusid_onchange

  function do_ajax_form_his_laboratory_medical_event_statusid_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "statusid";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_his_laboratory_medical_event_statusid_onchange_cb_after_alert);
  } // do_ajax_form_his_laboratory_medical_event_statusid_onchange_cb
  function do_ajax_form_his_laboratory_medical_event_statusid_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_his_laboratory_medical_event_statusid_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_his_laboratory_medical_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_his_laboratory_medical_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_regcode = scAjaxGetFieldText("regcode");
    ...
    scAjaxProcOn();
    x_ajax_form_his_laboratory_medical_submit_form(var_regcode, var_trancode, var_trandate, var_staffid, var_patientid, var_birthdate, var_icdid, var_notes, var_statusid, var_confirmdate, var_finishdate, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_his_laboratory_medical_submit_form_cb);
  } // do_ajax_form_his_laboratory_medical_submit_form

  function do_ajax_form_his_laboratory_medical_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_his_laboratory_medical_submit_form_cb_after_alert);
  } // do_ajax_form_his_laboratory_medical_submit_form_cb
  function do_ajax_form_his_laboratory_medical_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_his_laboratory_medical_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_bill_laboratory_medical"] = "off";
  scStatusDetail["form_bill_misc_laboratory_medical"] = "off";
  scStatusDetail["grid_result_laboratory_medical"] = "off";

  function do_ajax_form_his_laboratory_medical_navigate_form()
  {
    perform_ajax_form_his_laboratory_medical_navigate_form();
  }

  function perform_ajax_form_his_laboratory_medical_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_bill_laboratory_medical"] = "on";
    scStatusDetail["form_bill_misc_laboratory_medical"] = "on";
    scStatusDetail["grid_result_laboratory_medical"] = "on";
    x_ajax_form_his_laboratory_medical_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_his_laboratory_medical_navigate_form_cb);
  } // do_ajax_form_his_laboratory_medical_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_laboratory_medical']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_his_laboratory_medical_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_bill_laboratory_medical"] && "nmsc_iframe_liga_form_bill_laboratory_medical" != scMasterDetailIframe["nmsc_iframe_liga_form_bill_laboratory_medical"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_bill_laboratory_medical"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_bill_laboratory_medical').contentWindow.nm_move('apl_detalhe', true, '1000');
        document.getElementById('nmsc_iframe_liga_form_bill_laboratory_medical').style.height = "1000";
        document.getElementById('nmsc_iframe_liga_form_bill_laboratory_medical').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_bill_misc_laboratory_medical"] && "nmsc_iframe_liga_form_bill_misc_laboratory_medical" != scMasterDetailIframe["nmsc_iframe_liga_form_bill_misc_laboratory_medical"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_bill_misc_laboratory_medical"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_bill_misc_laboratory_medical').contentWindow.nm_move('apl_detalhe', true, '1000');
        document.getElementById('nmsc_iframe_liga_form_bill_misc_laboratory_medical').style.height = "1000";
        document.getElementById('nmsc_iframe_liga_form_bill_misc_laboratory_medical').style.display = "none";
    }
    ...
    scAjaxSetBtnVars();
    sc_change_tabs(true, 'hidden_bloco_3', 'id_tabs_3_3');
    sc_change_tabs(false, 'hidden_bloco_4', 'id_tabs_3_4');
    sc_change_tabs(false, 'hidden_bloco_5', 'id_tabs_3_5');
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_his_laboratory_medical_navigate_form_cb_after_alert);
  } // do_ajax_form_his_laboratory_medical_navigate_form_cb
  function do_ajax_form_his_laboratory_medical_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_his_laboratory_medical_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    scAjaxProcOff();
  } // do_ajax_form_his_laboratory_medical_navigate_form_cb_after_alert
  function sc_hide_form_his_laboratory_medical_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_bill_laboratory_medical"] && "off" == scStatusDetail["form_bill_misc_laboratory_medical"] && "off" == scStatusDetail["grid_result_laboratory_medical"])
    {
      return true;
    }
    return false;
  ...
  var ajax_block_tab = {
    ...
    "hidden_bloco_1": "",
    "hidden_bloco_2": "",
    "hidden_bloco_3": "id_tabs_3_3",
    "hidden_bloco_4": "id_tabs_3_4",
    "hidden_bloco_5": "id_tabs_3_5"
  };
