  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_his_laboratory_medical_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_his_laboratory_medical_mob_form();
	}
  ...
  // ---------- Validate regcode
  function do_ajax_form_his_laboratory_medical_mob_validate_regcode()
  {
    var nomeCampo_regcode = "regcode";
    var var_regcode = scAjaxGetFieldText(nomeCampo_regcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_mob_validate_regcode(var_regcode, var_script_case_init, do_ajax_form_his_laboratory_medical_mob_validate_regcode_cb);
  } // do_ajax_form_his_laboratory_medical_mob_validate_regcode

  function do_ajax_form_his_laboratory_medical_mob_validate_regcode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_mob_validate_regcode_cb

  // ---------- Validate trancode
  function do_ajax_form_his_laboratory_medical_mob_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_mob_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_his_laboratory_medical_mob_validate_trancode_cb);
  } // do_ajax_form_his_laboratory_medical_mob_validate_trancode

  function do_ajax_form_his_laboratory_medical_mob_validate_trancode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "trancode";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_mob_validate_trancode_cb

  // ---------- Validate trandate
  function do_ajax_form_his_laboratory_medical_mob_validate_trandate()
  {
    var nomeCampo_trandate = "trandate";
    var var_trandate = scAjaxGetFieldText(nomeCampo_trandate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_mob_validate_trandate(var_trandate, var_script_case_init, do_ajax_form_his_laboratory_medical_mob_validate_trandate_cb);
  } // do_ajax_form_his_laboratory_medical_mob_validate_trandate

  function do_ajax_form_his_laboratory_medical_mob_validate_trandate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "trandate";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_mob_validate_trandate_cb

  // ---------- Validate staffid
  function do_ajax_form_his_laboratory_medical_mob_validate_staffid()
  {
    var nomeCampo_staffid = "staffid";
    var var_staffid = scAjaxGetFieldSelect(nomeCampo_staffid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_mob_validate_staffid(var_staffid, var_script_case_init, do_ajax_form_his_laboratory_medical_mob_validate_staffid_cb);
  } // do_ajax_form_his_laboratory_medical_mob_validate_staffid

  function do_ajax_form_his_laboratory_medical_mob_validate_staffid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "staffid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_mob_validate_staffid_cb

  // ---------- Validate patientid
  function do_ajax_form_his_laboratory_medical_mob_validate_patientid()
  {
    var nomeCampo_patientid = "patientid";
    var var_patientid = scAjaxGetFieldSelect(nomeCampo_patientid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_mob_validate_patientid(var_patientid, var_script_case_init, do_ajax_form_his_laboratory_medical_mob_validate_patientid_cb);
  } // do_ajax_form_his_laboratory_medical_mob_validate_patientid

  function do_ajax_form_his_laboratory_medical_mob_validate_patientid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "patientid";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_mob_validate_patientid_cb

  // ---------- Validate birthdate
  function do_ajax_form_his_laboratory_medical_mob_validate_birthdate()
  {
    var nomeCampo_birthdate = "birthdate";
    var var_birthdate = scAjaxGetFieldText(nomeCampo_birthdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_mob_validate_birthdate(var_birthdate, var_script_case_init, do_ajax_form_his_laboratory_medical_mob_validate_birthdate_cb);
  } // do_ajax_form_his_laboratory_medical_mob_validate_birthdate

  function do_ajax_form_his_laboratory_medical_mob_validate_birthdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_mob_validate_birthdate_cb

  // ---------- Validate icdid
  function do_ajax_form_his_laboratory_medical_mob_validate_icdid()
  {
  } // do_ajax_form_his_laboratory_medical_mob_validate_icdid

  function do_ajax_form_his_laboratory_medical_mob_validate_icdid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "icdid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_mob_validate_icdid_cb

  // ---------- Validate notes
  function do_ajax_form_his_laboratory_medical_mob_validate_notes()
  {
    var nomeCampo_notes = "notes";
    var var_notes = scAjaxGetFieldText(nomeCampo_notes);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_mob_validate_notes(var_notes, var_script_case_init, do_ajax_form_his_laboratory_medical_mob_validate_notes_cb);
  } // do_ajax_form_his_laboratory_medical_mob_validate_notes

  function do_ajax_form_his_laboratory_medical_mob_validate_notes_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "notes";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_mob_validate_notes_cb

  // ---------- Validate statusid
  function do_ajax_form_his_laboratory_medical_mob_validate_statusid()
  {
    var nomeCampo_statusid = "statusid";
    var var_statusid = scAjaxGetFieldSelect(nomeCampo_statusid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_mob_validate_statusid(var_statusid, var_script_case_init, do_ajax_form_his_laboratory_medical_mob_validate_statusid_cb);
  } // do_ajax_form_his_laboratory_medical_mob_validate_statusid

  function do_ajax_form_his_laboratory_medical_mob_validate_statusid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "statusid";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_mob_validate_statusid_cb

  // ---------- Validate confirmdate
  function do_ajax_form_his_laboratory_medical_mob_validate_confirmdate()
  {
    var nomeCampo_confirmdate = "confirmdate";
    var var_confirmdate = scAjaxGetFieldText(nomeCampo_confirmdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_mob_validate_confirmdate(var_confirmdate, var_script_case_init, do_ajax_form_his_laboratory_medical_mob_validate_confirmdate_cb);
  } // do_ajax_form_his_laboratory_medical_mob_validate_confirmdate

  function do_ajax_form_his_laboratory_medical_mob_validate_confirmdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "confirmdate";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_mob_validate_confirmdate_cb

  // ---------- Validate finishdate
  function do_ajax_form_his_laboratory_medical_mob_validate_finishdate()
  {
    var nomeCampo_finishdate = "finishdate";
    var var_finishdate = scAjaxGetFieldText(nomeCampo_finishdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_mob_validate_finishdate(var_finishdate, var_script_case_init, do_ajax_form_his_laboratory_medical_mob_validate_finishdate_cb);
  } // do_ajax_form_his_laboratory_medical_mob_validate_finishdate

  function do_ajax_form_his_laboratory_medical_mob_validate_finishdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "finishdate";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_mob_validate_finishdate_cb

  // ---------- Validate detail
  function do_ajax_form_his_laboratory_medical_mob_validate_detail()
  {
    var nomeCampo_detail = "detail";
    var var_detail = scAjaxGetFieldText(nomeCampo_detail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_mob_validate_detail(var_detail, var_script_case_init, do_ajax_form_his_laboratory_medical_mob_validate_detail_cb);
  } // do_ajax_form_his_laboratory_medical_mob_validate_detail

  function do_ajax_form_his_laboratory_medical_mob_validate_detail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "detail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_mob_validate_detail_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_his_laboratory_medical_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_his_laboratory_medical_mob_validate_sc_field_0_cb);
  } // do_ajax_form_his_laboratory_medical_mob_validate_sc_field_0

  function do_ajax_form_his_laboratory_medical_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_mob_validate_sc_field_0_cb

  // ---------- Validate result
  function do_ajax_form_his_laboratory_medical_mob_validate_result()
  {
    var nomeCampo_result = "result";
    var var_result = scAjaxGetFieldText(nomeCampo_result);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_his_laboratory_medical_mob_validate_result(var_result, var_script_case_init, do_ajax_form_his_laboratory_medical_mob_validate_result_cb);
  } // do_ajax_form_his_laboratory_medical_mob_validate_result

  function do_ajax_form_his_laboratory_medical_mob_validate_result_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "result";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_his_laboratory_medical_mob_validate_result_cb

  // ---------- Event onchange regcode
  function do_ajax_form_his_laboratory_medical_mob_event_regcode_onchange()
  {
    var var_regcode = scAjaxGetFieldText("regcode");
    var var_birthdate = scAjaxGetFieldText("birthdate");
    var var_patientid = scAjaxGetFieldSelect("patientid");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_his_laboratory_medical_mob_event_regcode_onchange(var_regcode, var_birthdate, var_patientid, var_script_case_init, do_ajax_form_his_laboratory_medical_mob_event_regcode_onchange_cb);
  } // do_ajax_form_his_laboratory_medical_mob_event_regcode_onchange

  function do_ajax_form_his_laboratory_medical_mob_event_regcode_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "regcode";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_his_laboratory_medical_mob_event_regcode_onchange_cb_after_alert);
  } // do_ajax_form_his_laboratory_medical_mob_event_regcode_onchange_cb
  function do_ajax_form_his_laboratory_medical_mob_event_regcode_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_his_laboratory_medical_mob_event_regcode_onchange_cb_after_alert

  // ---------- Event onchange statusid
  function do_ajax_form_his_laboratory_medical_mob_event_statusid_onchange()
  {
    var var_statusid = scAjaxGetFieldSelect("statusid");
    var var_finishdate = scAjaxGetFieldText("finishdate");
    var var_confirmdate = scAjaxGetFieldText("confirmdate");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_his_laboratory_medical_mob_event_statusid_onchange(var_statusid, var_finishdate, var_confirmdate, var_script_case_init, do_ajax_form_his_laboratory_medical_mob_event_statusid_onchange_cb);
  } // do_ajax_form_his_laboratory_medical_mob_event_statusid_onchange

  function do_ajax_form_his_laboratory_medical_mob_event_statusid_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "statusid";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_his_laboratory_medical_mob_event_statusid_onchange_cb_after_alert);
  } // do_ajax_form_his_laboratory_medical_mob_event_statusid_onchange_cb
  function do_ajax_form_his_laboratory_medical_mob_event_statusid_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_his_laboratory_medical_mob_event_statusid_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_his_laboratory_medical_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_his_laboratory_medical_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_regcode = scAjaxGetFieldText("regcode");
    var var_trancode = scAjaxGetFieldText("trancode");
    var var_trandate = scAjaxGetFieldText("trandate");
    var var_staffid = scAjaxGetFieldSelect("staffid");
    var var_patientid = scAjaxGetFieldSelect("patientid");
    var var_birthdate = scAjaxGetFieldText("birthdate");
    var var_icdid = scAjaxGetFieldText("icdid");
    var var_notes = scAjaxGetFieldText("notes");
    var var_statusid = scAjaxGetFieldSelect("statusid");
    var var_confirmdate = scAjaxGetFieldText("confirmdate");
    var var_finishdate = scAjaxGetFieldText("finishdate");
    ...
    scAjaxProcOn();
    x_ajax_form_his_laboratory_medical_mob_submit_form(var_regcode, var_trancode, var_trandate, var_staffid, var_patientid, var_birthdate, var_icdid, var_notes, var_statusid, var_confirmdate, var_finishdate, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_his_laboratory_medical_mob_submit_form_cb);
  } // do_ajax_form_his_laboratory_medical_mob_submit_form

  function do_ajax_form_his_laboratory_medical_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("regcode");
      scAjaxHideErrorDisplay("trancode");
      scAjaxHideErrorDisplay("trandate");
      scAjaxHideErrorDisplay("staffid");
      scAjaxHideErrorDisplay("patientid");
      scAjaxHideErrorDisplay("birthdate");
      scAjaxHideErrorDisplay("icdid");
      scAjaxHideErrorDisplay("notes");
      scAjaxHideErrorDisplay("statusid");
      scAjaxHideErrorDisplay("confirmdate");
      scAjaxHideErrorDisplay("finishdate");
      scAjaxHideErrorDisplay("detail");
      scAjaxHideErrorDisplay("sc_field_0");
      scAjaxHideErrorDisplay("result");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_his_laboratory_medical_mob_submit_form_cb_after_alert);
  } // do_ajax_form_his_laboratory_medical_mob_submit_form_cb
  function do_ajax_form_his_laboratory_medical_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_his_laboratory_medical_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_bill_laboratory_medical_mob"] = "off";
  scStatusDetail["form_bill_misc_laboratory_medical_mob"] = "off";
  scStatusDetail["grid_result_laboratory_medical"] = "off";

  function do_ajax_form_his_laboratory_medical_mob_navigate_form()
  {
    perform_ajax_form_his_laboratory_medical_mob_navigate_form();
  }

  function perform_ajax_form_his_laboratory_medical_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    scStatusDetail["form_bill_laboratory_medical_mob"] = "on";
    scStatusDetail["form_bill_misc_laboratory_medical_mob"] = "on";
    scStatusDetail["grid_result_laboratory_medical"] = "on";
    x_ajax_form_his_laboratory_medical_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_his_laboratory_medical_mob_navigate_form_cb);
  } // do_ajax_form_his_laboratory_medical_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_laboratory_medical_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_his_laboratory_medical_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_bill_laboratory_medical_mob"] && "nmsc_iframe_liga_form_bill_laboratory_medical_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_bill_laboratory_medical_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_bill_laboratory_medical_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_bill_laboratory_medical_mob').contentWindow.nm_move('apl_detalhe', true, '1000');
        document.getElementById('nmsc_iframe_liga_form_bill_laboratory_medical_mob').style.height = "1000";
        document.getElementById('nmsc_iframe_liga_form_bill_laboratory_medical_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_bill_misc_laboratory_medical_mob"] && "nmsc_iframe_liga_form_bill_misc_laboratory_medical_mob" != scMasterDetailIframe["nmsc_iframe_liga_form_bill_misc_laboratory_medical_mob"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_bill_misc_laboratory_medical_mob"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_bill_misc_laboratory_medical_mob').contentWindow.nm_move('apl_detalhe', true, '1000');
        document.getElementById('nmsc_iframe_liga_form_bill_misc_laboratory_medical_mob').style.height = "1000";
        document.getElementById('nmsc_iframe_liga_form_bill_misc_laboratory_medical_mob').style.display = "none";
    }
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_grid_result_laboratory_medical"] && "nmsc_iframe_liga_grid_result_laboratory_medical" != scMasterDetailIframe["nmsc_iframe_liga_grid_result_laboratory_medical"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_grid_result_laboratory_medical"]);
    }
    else {
        if (oResp["navSummary"].reg_tot != 0) {
            document.getElementById('nmsc_iframe_liga_grid_result_laboratory_medical').contentWindow.nm_move('apl_detalhe', true, '800');
        }
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_his_laboratory_medical_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_his_laboratory_medical_mob_navigate_form_cb
  function do_ajax_form_his_laboratory_medical_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_his_laboratory_medical_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
    scAjaxProcOff();
  } // do_ajax_form_his_laboratory_medical_mob_navigate_form_cb_after_alert
  function sc_hide_form_his_laboratory_medical_mob_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_bill_laboratory_medical_mob"] && "off" == scStatusDetail["form_bill_misc_laboratory_medical_mob"] && "off" == scStatusDetail["grid_result_laboratory_medical"])
    {
      return true;
    }
    return false;
  ...
  ajax_field_list[0] = "regcode";
  ajax_field_list[1] = "trancode";
  ajax_field_list[2] = "trandate";
  ajax_field_list[3] = "staffid";
  ajax_field_list[4] = "patientid";
  ajax_field_list[5] = "birthdate";
  ajax_field_list[6] = "icdid";
  ajax_field_list[7] = "notes";
  ajax_field_list[8] = "statusid";
  ajax_field_list[9] = "confirmdate";
  ajax_field_list[10] = "finishdate";
  ajax_field_list[11] = "detail";
  ajax_field_list[12] = "sc_field_0";
  ajax_field_list[13] = "result";
  ...
  var ajax_error_list = {
    "regcode": {"label": "Reg Code", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "trancode": {"label": "Transaction Code", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "trandate": {"label": "Transaction Date", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "staffid": {"label": "Staff", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "patientid": {"label": "Patient", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "birthdate": {"label": "Birth Date", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "icdid": {"label": "ICD-10", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "notes": {"label": "Notes", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "statusid": {"label": "Status", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "confirmdate": {"label": "Confirm Date", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "finishdate": {"label": "Finish Date", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "detail": {"label": "Detail", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "sc_field_0": {"label": "Additional Service", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "result": {"label": "Result", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "finishdate": new Array(),
    "detail": new Array(),
    "sc_field_0": new Array(),
    "result": new Array()
  };
  ajax_field_mult["regcode"][1] = "regcode";
  ajax_field_mult["trancode"][1] = "trancode";
  ajax_field_mult["trandate"][1] = "trandate";
  ajax_field_mult["staffid"][1] = "staffid";
  ajax_field_mult["patientid"][1] = "patientid";
  ajax_field_mult["birthdate"][1] = "birthdate";
  ajax_field_mult["icdid"][1] = "icdid";
  ajax_field_mult["notes"][1] = "notes";
  ajax_field_mult["statusid"][1] = "statusid";
  ajax_field_mult["confirmdate"][1] = "confirmdate";
  ajax_field_mult["finishdate"][1] = "finishdate";
  ajax_field_mult["detail"][1] = "detail";
  ajax_field_mult["sc_field_0"][1] = "sc_field_0";
  ajax_field_mult["result"][1] = "result";

  var ajax_field_id = {
    "regcode": new Array("hidden_field_label_regcode", "hidden_field_data_regcode"),
    "trancode": new Array("hidden_field_label_trancode", "hidden_field_data_trancode"),
    "trandate": new Array("hidden_field_label_trandate", "hidden_field_data_trandate"),
    "staffid": new Array("hidden_field_label_staffid", "hidden_field_data_staffid"),
    "patientid": new Array("hidden_field_label_patientid", "hidden_field_data_patientid"),
    "birthdate": new Array("hidden_field_label_birthdate", "hidden_field_data_birthdate"),
    "icdid": new Array("hidden_field_label_icdid", "hidden_field_data_icdid"),
    "notes": new Array("hidden_field_label_notes", "hidden_field_data_notes"),
    "statusid": new Array("hidden_field_label_statusid", "hidden_field_data_statusid"),
    "confirmdate": new Array("hidden_field_label_confirmdate", "hidden_field_data_confirmdate"),
    "finishdate": new Array("hidden_field_label_finishdate", "hidden_field_data_finishdate"),
    ...
    "result": new Array("hidden_field_label_result", "hidden_field_data_result")
  };
