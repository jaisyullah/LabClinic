  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_worldcities_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_worldcities_mob_form();
	}
  ...
  // ---------- Validate city
  function do_ajax_form_worldcities_mob_validate_city()
  {
    var nomeCampo_city = "city";
    var var_city = scAjaxGetFieldText(nomeCampo_city);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_worldcities_mob_validate_city(var_city, var_script_case_init, do_ajax_form_worldcities_mob_validate_city_cb);
  } // do_ajax_form_worldcities_mob_validate_city

  function do_ajax_form_worldcities_mob_validate_city_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_worldcities_mob_validate_city_cb

  // ---------- Validate city_ascii
  function do_ajax_form_worldcities_mob_validate_city_ascii()
  {
    var nomeCampo_city_ascii = "city_ascii";
    var var_city_ascii = scAjaxGetFieldText(nomeCampo_city_ascii);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_worldcities_mob_validate_city_ascii(var_city_ascii, var_script_case_init, do_ajax_form_worldcities_mob_validate_city_ascii_cb);
  } // do_ajax_form_worldcities_mob_validate_city_ascii

  function do_ajax_form_worldcities_mob_validate_city_ascii_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "city_ascii";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_worldcities_mob_validate_city_ascii_cb

  // ---------- Validate lat
  function do_ajax_form_worldcities_mob_validate_lat()
  {
    var nomeCampo_lat = "lat";
    var var_lat = scAjaxGetFieldText(nomeCampo_lat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_worldcities_mob_validate_lat(var_lat, var_script_case_init, do_ajax_form_worldcities_mob_validate_lat_cb);
  } // do_ajax_form_worldcities_mob_validate_lat

  function do_ajax_form_worldcities_mob_validate_lat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_worldcities_mob_validate_lat_cb

  // ---------- Validate lng
  function do_ajax_form_worldcities_mob_validate_lng()
  {
    var nomeCampo_lng = "lng";
    var var_lng = scAjaxGetFieldText(nomeCampo_lng);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_worldcities_mob_validate_lng(var_lng, var_script_case_init, do_ajax_form_worldcities_mob_validate_lng_cb);
  } // do_ajax_form_worldcities_mob_validate_lng

  function do_ajax_form_worldcities_mob_validate_lng_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lng";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_worldcities_mob_validate_lng_cb

  // ---------- Validate country
  function do_ajax_form_worldcities_mob_validate_country()
  {
    var nomeCampo_country = "country";
    var var_country = scAjaxGetFieldText(nomeCampo_country);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_worldcities_mob_validate_country(var_country, var_script_case_init, do_ajax_form_worldcities_mob_validate_country_cb);
  } // do_ajax_form_worldcities_mob_validate_country

  function do_ajax_form_worldcities_mob_validate_country_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "country";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_worldcities_mob_validate_country_cb

  // ---------- Validate iso2
  function do_ajax_form_worldcities_mob_validate_iso2()
  {
    var nomeCampo_iso2 = "iso2";
    var var_iso2 = scAjaxGetFieldText(nomeCampo_iso2);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_worldcities_mob_validate_iso2(var_iso2, var_script_case_init, do_ajax_form_worldcities_mob_validate_iso2_cb);
  } // do_ajax_form_worldcities_mob_validate_iso2

  function do_ajax_form_worldcities_mob_validate_iso2_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "iso2";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_worldcities_mob_validate_iso2_cb

  // ---------- Validate iso3
  function do_ajax_form_worldcities_mob_validate_iso3()
  {
    var nomeCampo_iso3 = "iso3";
    var var_iso3 = scAjaxGetFieldText(nomeCampo_iso3);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_worldcities_mob_validate_iso3(var_iso3, var_script_case_init, do_ajax_form_worldcities_mob_validate_iso3_cb);
  } // do_ajax_form_worldcities_mob_validate_iso3

  function do_ajax_form_worldcities_mob_validate_iso3_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "iso3";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_worldcities_mob_validate_iso3_cb

  // ---------- Validate admin_name
  function do_ajax_form_worldcities_mob_validate_admin_name()
  {
    var nomeCampo_admin_name = "admin_name";
    var var_admin_name = scAjaxGetFieldText(nomeCampo_admin_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_worldcities_mob_validate_admin_name(var_admin_name, var_script_case_init, do_ajax_form_worldcities_mob_validate_admin_name_cb);
  } // do_ajax_form_worldcities_mob_validate_admin_name

  function do_ajax_form_worldcities_mob_validate_admin_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "admin_name";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_worldcities_mob_validate_admin_name_cb

  // ---------- Validate capital
  function do_ajax_form_worldcities_mob_validate_capital()
  {
    var nomeCampo_capital = "capital";
    var var_capital = scAjaxGetFieldText(nomeCampo_capital);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_worldcities_mob_validate_capital(var_capital, var_script_case_init, do_ajax_form_worldcities_mob_validate_capital_cb);
  } // do_ajax_form_worldcities_mob_validate_capital

  function do_ajax_form_worldcities_mob_validate_capital_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "capital";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_worldcities_mob_validate_capital_cb

  // ---------- Validate population
  function do_ajax_form_worldcities_mob_validate_population()
  {
    var nomeCampo_population = "population";
    var var_population = scAjaxGetFieldText(nomeCampo_population);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_worldcities_mob_validate_population(var_population, var_script_case_init, do_ajax_form_worldcities_mob_validate_population_cb);
  } // do_ajax_form_worldcities_mob_validate_population

  function do_ajax_form_worldcities_mob_validate_population_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "population";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_worldcities_mob_validate_population_cb

  // ---------- Validate id
  function do_ajax_form_worldcities_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_worldcities_mob_validate_id(var_id, var_script_case_init, do_ajax_form_worldcities_mob_validate_id_cb);
  } // do_ajax_form_worldcities_mob_validate_id

  function do_ajax_form_worldcities_mob_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_worldcities_mob_validate_id_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_worldcities_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_worldcities_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_city = scAjaxGetFieldText("city");
    var var_city_ascii = scAjaxGetFieldText("city_ascii");
    var var_lat = scAjaxGetFieldText("lat");
    var var_lng = scAjaxGetFieldText("lng");
    var var_country = scAjaxGetFieldText("country");
    var var_iso2 = scAjaxGetFieldText("iso2");
    var var_iso3 = scAjaxGetFieldText("iso3");
    var var_admin_name = scAjaxGetFieldText("admin_name");
    var var_capital = scAjaxGetFieldText("capital");
    var var_population = scAjaxGetFieldText("population");
    ...
    scAjaxProcOn();
    x_ajax_form_worldcities_mob_submit_form(var_city, var_city_ascii, var_lat, var_lng, var_country, var_iso2, var_iso3, var_admin_name, var_capital, var_population, var_id, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_worldcities_mob_submit_form_cb);
  } // do_ajax_form_worldcities_mob_submit_form

  function do_ajax_form_worldcities_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("city_ascii");
      scAjaxHideErrorDisplay("lat");
      scAjaxHideErrorDisplay("lng");
      scAjaxHideErrorDisplay("country");
      scAjaxHideErrorDisplay("iso2");
      scAjaxHideErrorDisplay("iso3");
      scAjaxHideErrorDisplay("admin_name");
      scAjaxHideErrorDisplay("capital");
      scAjaxHideErrorDisplay("population");
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_worldcities_mob_submit_form_cb_after_alert);
  } // do_ajax_form_worldcities_mob_submit_form_cb
  function do_ajax_form_worldcities_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_worldcities_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_worldcities_mob_navigate_form()
  {
    perform_ajax_form_worldcities_mob_navigate_form();
  }

  function perform_ajax_form_worldcities_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("population");
    scAjaxHideErrorDisplay("id");
    var var_city_ascii = document.F2.city_ascii.value;
    ...
    scAjaxProcOn();
    x_ajax_form_worldcities_mob_navigate_form(var_city_ascii, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_worldcities_mob_navigate_form_cb);
  } // do_ajax_form_worldcities_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_worldcities_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_worldcities_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.city_ascii.value = scAjaxGetKeyValue("city_ascii");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_worldcities_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_worldcities_mob_navigate_form_cb
  function do_ajax_form_worldcities_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_worldcities_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_worldcities_mob_navigate_form_cb_after_alert
  function sc_hide_form_worldcities_mob_form()
  {
  ...
  ajax_field_list[0] = "city";
  ajax_field_list[1] = "city_ascii";
  ajax_field_list[2] = "lat";
  ajax_field_list[3] = "lng";
  ajax_field_list[4] = "country";
  ajax_field_list[5] = "iso2";
  ajax_field_list[6] = "iso3";
  ajax_field_list[7] = "admin_name";
  ajax_field_list[8] = "capital";
  ajax_field_list[9] = "population";
  ajax_field_list[10] = "id";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "city": {"label": "City", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "city_ascii": {"label": "City Ascii", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lat": {"label": "Lat", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "lng": {"label": "Lng", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "country": {"label": "Country", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "iso2": {"label": "Iso 2", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "iso3": {"label": "Iso 3", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "admin_name": {"label": "Admin Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "capital": {"label": "Capital", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "population": {"label": "Population", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
  ...
  var ajax_field_mult = {
    "city": new Array(),
    "city_ascii": new Array(),
    "lat": new Array(),
    "lng": new Array(),
    "country": new Array(),
    "iso2": new Array(),
    "iso3": new Array(),
    "admin_name": new Array(),
    "capital": new Array(),
    "population": new Array(),
    "id": new Array()
  };
  ajax_field_mult["city"][1] = "city";
  ajax_field_mult["city_ascii"][1] = "city_ascii";
  ajax_field_mult["lat"][1] = "lat";
  ajax_field_mult["lng"][1] = "lng";
  ajax_field_mult["country"][1] = "country";
  ajax_field_mult["iso2"][1] = "iso2";
  ajax_field_mult["iso3"][1] = "iso3";
  ajax_field_mult["admin_name"][1] = "admin_name";
  ajax_field_mult["capital"][1] = "capital";
  ajax_field_mult["population"][1] = "population";
  ajax_field_mult["id"][1] = "id";

  var ajax_field_id = {
    "city": new Array("hidden_field_label_city", "hidden_field_data_city"),
    "city_ascii": new Array("hidden_field_label_city_ascii", "hidden_field_data_city_ascii"),
    "lat": new Array("hidden_field_label_lat", "hidden_field_data_lat"),
    "lng": new Array("hidden_field_label_lng", "hidden_field_data_lng"),
    "country": new Array("hidden_field_label_country", "hidden_field_data_country"),
    "iso2": new Array("hidden_field_label_iso2", "hidden_field_data_iso2"),
    "iso3": new Array("hidden_field_label_iso3", "hidden_field_data_iso3"),
    "admin_name": new Array("hidden_field_label_admin_name", "hidden_field_data_admin_name"),
    "capital": new Array("hidden_field_label_capital", "hidden_field_data_capital"),
    "population": new Array("hidden_field_label_population", "hidden_field_data_population"),
