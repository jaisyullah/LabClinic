  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_result_laboratory_pbm" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_result_laboratory_pbm_form();
	}
  ...
  // ---------- Validate pbm_
  function do_ajax_form_result_laboratory_pbm_validate_pbm_(iNumLinha)
  {
    var nomeCampo_pbm_ = "pbm_" + iNumLinha;
    var var_pbm_ = scAjaxGetFieldEditorHtml(nomeCampo_pbm_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_pbm_validate_pbm_(var_pbm_, iNumLinha, var_script_case_init, do_ajax_form_result_laboratory_pbm_validate_pbm__cb);
  } // do_ajax_form_result_laboratory_pbm_validate_pbm_

  function do_ajax_form_result_laboratory_pbm_validate_pbm__cb(sResp)
  {
    ...
    if ("" == sFieldErrors)
    {
      ...
      scErrorLineOff(iLineNumber, "pbm_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "pbm_");
    }
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_result_laboratory_pbm_validate_pbm__cb

  // ---------- Validate id_
  function do_ajax_form_result_laboratory_pbm_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_pbm_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_result_laboratory_pbm_validate_id__cb);
  } // do_ajax_form_result_laboratory_pbm_validate_id_

  function do_ajax_form_result_laboratory_pbm_validate_id__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_result_laboratory_pbm_validate_id__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_result_laboratory_pbm_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_result_laboratory_pbm_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_result_laboratory_pbm_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_result_laboratory_pbm_add_new_line_cb);
  } // do_ajax_form_result_laboratory_pbm_add_new_line

  function do_ajax_form_result_laboratory_pbm_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    scAjaxExecFieldEditorHtml('mceAddControl', false, "pbm_" +  iAjaxNewLine);
  } // do_ajax_form_result_laboratory_pbm_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_result_laboratory_pbm_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_pbm_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_result_laboratory_pbm_backup_line_cb);
  } // do_ajax_form_result_laboratory_pbm_backup_line

  function do_ajax_form_result_laboratory_pbm_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_result_laboratory_pbm_backup_line_cb

  function do_ajax_form_result_laboratory_pbm_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_result_laboratory_pbm_cancel_insert

  function do_ajax_form_result_laboratory_pbm_cancel_update(iSeqVert)
  {
    do_ajax_form_result_laboratory_pbm_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_result_laboratory_pbm_cancel_update

  function do_ajax_form_result_laboratory_pbm_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_result_laboratory_pbm_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_result_laboratory_pbm_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_result_laboratory_pbm_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_result_laboratory_pbm_table_refresh_cb);
  } //  do_ajax_form_result_laboratory_pbm_table_refresh

  function do_ajax_form_result_laboratory_pbm_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    {
        scAjaxExecFieldEditorHtml('mceRemoveControl', false, "pbm_" +  i);
    }
    ...
    for (i = 1; i < <?php echo $this->sc_max_reg + 1; ?> ; i++)
    {
        scAjaxExecFieldEditorHtml('mceAddControl', false, "pbm_" +  i);
    }
    ...
    scAjaxAlert(do_ajax_form_result_laboratory_pbm_table_refresh_cb_after_alert);
  } // do_ajax_form_result_laboratory_pbm_table_refresh_cb
  function do_ajax_form_result_laboratory_pbm_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_result_laboratory_pbm_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_result_laboratory_pbm_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_result_laboratory_pbm_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    sc_num_ult_line = iNumLinha;
    sc_num_ult_tr   = indexTR;
    scAjaxHideMessage();
    var var_pbm_ = scAjaxGetFieldEditorHtml("pbm_" + iNumLinha);
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_result_laboratory_pbm_submit_form(var_pbm_, var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_result_laboratory_pbm_submit_form_cb);
  } // do_ajax_form_result_laboratory_pbm_submit_form

  function do_ajax_form_result_laboratory_pbm_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("pbm_" + sc_num_ult_line);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_result_laboratory_pbm_submit_form_cb_after_alert);
  } // do_ajax_form_result_laboratory_pbm_submit_form_cb
  function do_ajax_form_result_laboratory_pbm_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_result_laboratory_pbm_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_result_laboratory_pbm_navigate_form()
  {
    perform_ajax_form_result_laboratory_pbm_navigate_form();
  }

  function perform_ajax_form_result_laboratory_pbm_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_result_laboratory_pbm_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    {
      scAjaxHideErrorDisplay("pbm_" + iNavForm);
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_result_laboratory_pbm_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_result_laboratory_pbm_navigate_form_cb);
  } // do_ajax_form_result_laboratory_pbm_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_result_laboratory_pbm']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_result_laboratory_pbm_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_result_laboratory_pbm_navigate_form_cb_after_alert);
  } // do_ajax_form_result_laboratory_pbm_navigate_form_cb
  function do_ajax_form_result_laboratory_pbm_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_result_laboratory_pbm_navigate_form_cb_after_alert
  function sc_hide_form_result_laboratory_pbm_form()
  {
...
?>
  ...
  {
    ajax_field_list[iTotCampos] = "pbm_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "id_" + iNumLinha;
    iTotCampos++;
    ajax_error_list["pbm_" + iNumLinha] = {"label": "Result<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ...
    ajax_field_mult["pbm_"][iNumLinha] = "pbm_" + iNumLinha;
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_id["pbm_" + iNumLinha] = new Array("hidden_field_label_pbm_", "hidden_field_data_pbm_" + iNumLinha);
    ajax_error_count["pbm_" + iNumLinha] = "off";
    ajax_error_count["id_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["pbm_" + iNumLinha] = "off";
...
{
?>
    ajax_read_only["pbm_" + iNumLinha] = "on";
    ajax_read_only["id_" + iNumLinha] = "on";
<?php
}
?>
  ...
  {
    ajax_error_list["pbm_" + iNumLinha] = null;
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ajax_error_list["pbm_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["pbm_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["pbm_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["pbm_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["pbm_" + iNumLinha]["onfocus"] = new Array();
...
?>
  ...
  {
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['pbm_'])) ? $this->nmgp_cmp_readonly['pbm_'] : 'off';
?>
    scAjaxFieldRead("pbm_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["pbm_" + iRow] || "on" == ajax_error_count["id_" + iRow]))
    {
      $("#hidden_field_data_sc_seq" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_sc_actions" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_pbm_" + iRow).addClass("scFormErrorLine");
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["pbm_" + iRow] && "off" == ajax_error_count["id_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["pbm_" + iRow] = "off";
      ...
      $("#hidden_field_data_pbm_" + iRow).removeClass("scFormErrorLine");
