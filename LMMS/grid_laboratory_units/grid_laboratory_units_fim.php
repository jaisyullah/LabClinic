...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LMMS_____grid_laboratory_units"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LMMS_____grid_laboratory_units"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_laboratory_units'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_laboratory_units']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_laboratory_units']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_laboratory_units']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_laboratory_units']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_laboratory_units']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_laboratory_units</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_laboratory_units']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_laboratory_units']['embutida_filho'] as $ind => $sc_init)
          {
