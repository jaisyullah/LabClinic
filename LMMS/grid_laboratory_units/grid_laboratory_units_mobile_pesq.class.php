...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_units_cond" name="units_cond" onChange="nm_campos_between(document.getElementById('id_vis_units'), this, 'units')">
      ...
      <br><span id="id_hide_units"  <?php echo $str_hide_units?>><?php
      if ($units != "")
      {
      $units_look = substr($this->Db->qstr($units), 1, -1); 
      $nmgp_def_dados = array(); 
