...
$old_error_handler = set_error_handler("lmms_retrieve_pswd_scriptcase_error_handler");

function lmms_retrieve_pswd_scriptcase_error_handler($err_no, $err_msg, $err_file, $err_line, $exibe)
{
    ...
    if (isset($_SESSION['scriptcase']['lmms_retrieve_pswd']['contr_erro']) && $_SESSION['scriptcase']['lmms_retrieve_pswd']['contr_erro'] == 'on')
    {
    ...
    if (in_array($err_no, $errors_handled))
    {
        ...
        if ($bol_flag && $exibe)
        {
            ...
            $inicial_lmms_retrieve_pswd->contr_lmms_retrieve_pswd->Apl_com_erro = true;
            if ($inicial_lmms_retrieve_pswd->contr_lmms_retrieve_pswd->NM_ajax_flag)
            {
                $inicial_lmms_retrieve_pswd->contr_lmms_retrieve_pswd->NM_ajax_info['errList']['geral_lmms_retrieve_pswd'][] = $msg;
                return;
            }
            lmms_retrieve_pswd_scriptcase_error_display($msg, $err_no);
        }
        return;
    }
}

function lmms_retrieve_pswd_scriptcase_error_display($err_msg, $err_no)
{
    ...
    if (!$erro_ja_exibido)
    {
        ...
        $sErrorIcon      = (isset($_SESSION['scriptcase']['error_icon']['lmms_retrieve_pswd'])  && '' != $_SESSION['scriptcase']['error_icon']['lmms_retrieve_pswd'])  ? $_SESSION['scriptcase']['error_icon']['lmms_retrieve_pswd']  : "";
        ...
        $bSpanTitle      = (isset($_SESSION['scriptcase']['error_span_title']['lmms_retrieve_pswd']) && '' != $_SESSION['scriptcase']['error_span_title']['lmms_retrieve_pswd']) ? $_SESSION['scriptcase']['error_span_title']['lmms_retrieve_pswd'] : false;
        $sIconTitle      = (isset($_SESSION['scriptcase']['error_icon_title']['lmms_retrieve_pswd']) && '' != $_SESSION['scriptcase']['error_icon_title']['lmms_retrieve_pswd']) ? $_SESSION['scriptcase']['error_icon_title']['lmms_retrieve_pswd'] : '';
?>
