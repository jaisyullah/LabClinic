...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tranDate";$Nm_datas[] = "tranDate";$Nm_datas[] = "birthDate";$Nm_datas[] = "birthDate";$Nm_datas[] = "finishDate";$Nm_datas[] = "finishDate";$Nm_datas[] = "confirmDate";$Nm_datas[] = "confirmDate";$Nm_numeric[] = "id";$Nm_numeric[] = "statusid";$Nm_numeric[] = "staffid";
...
<HTML>
<HEAD>
 <TITLE> laboratory_medical</TITLE>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_statusid_cond" name="statusid_cond" onChange="nm_campos_between(document.getElementById('id_vis_statusid'), this, 'statusid')">
      ...
      <br><span id="id_hide_statusid"  <?php echo $str_hide_statusid?>><INPUT  type="text" id="SC_statusid" name="statusid" value="<?php echo NM_encode_input($statusid) ?>" size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_id"  <?php echo $str_hide_id?>><INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=25 alt="{datatype: 'integer', maxLength: 25, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
