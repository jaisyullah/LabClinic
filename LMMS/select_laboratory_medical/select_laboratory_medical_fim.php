...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LMMS_____select_laboratory_medical"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LMMS_____select_laboratory_medical"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_laboratory_medical'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['select_laboratory_medical']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['select_laboratory_medical']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['select_laboratory_medical']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['select_laboratory_medical']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['select_laboratory_medical']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>select_laboratory_medical</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['select_laboratory_medical']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['select_laboratory_medical']['embutida_filho'] as $ind => $sc_init)
          {
