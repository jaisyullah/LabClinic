<?php
@session_start() ;
$_SESSION['scriptcase']['select_laboratory_medical']['sc_process_barr'] = true;
require_once('../select_laboratory_medical/index.php');
unset($_SESSION['scriptcase']['select_laboratory_medical']['sc_process_barr']);
$ExportCtrl = new select_laboratory_medical_export_control;
$ExportCtrl->Export_barr();

class select_laboratory_medical_export_control
{
