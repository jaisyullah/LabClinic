...
<?php
   ...
   $Ord_Cmp = new select_laboratory_medical_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class select_laboratory_medical_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["trandate"] : "Transaction Date";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["trancode"] : "Transaction Code";
   $tab_ger_campos['regcode'] = "on";
   $tab_def_campos['regcode'] = "regCode";
   $tab_labels["regcode"]   = (isset($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["regcode"])) ? $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["regcode"] : "Reg Code";
   $tab_ger_campos['patientid'] = "on";
   $tab_def_campos['patientid'] = "patientID";
   $tab_labels["patientid"]   = (isset($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["patientid"])) ? $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["patientid"] : "Patient";
   $tab_ger_campos['birthdate'] = "on";
   $tab_def_campos['birthdate'] = "birthDate";
   $tab_labels["birthdate"]   = (isset($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["birthdate"])) ? $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["birthdate"] : "Birth Date";
   $tab_ger_campos['icdid'] = "on";
   $tab_def_campos['icdid'] = "icdID";
   $tab_labels["icdid"]   = (isset($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["icdid"])) ? $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["icdid"] : "ICD-10";
   $tab_ger_campos['confirmdate'] = "on";
   $tab_def_campos['confirmdate'] = "confirmDate";
   $tab_labels["confirmdate"]   = (isset($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["confirmdate"])) ? $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["confirmdate"] : "Confirm Date";
   $tab_ger_campos['staffid'] = "on";
   $tab_def_campos['staffid'] = "staffID";
   $tab_labels["staffid"]   = (isset($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["staffid"])) ? $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["staffid"] : "Staff";
   $tab_ger_campos['statusid'] = "on";
   $tab_def_campos['statusid'] = "statusID";
   $tab_labels["statusid"]   = (isset($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["statusid"])) ? $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['labels']["statusid"] : "Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "select_laboratory_medical_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['select_laboratory_medical']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
