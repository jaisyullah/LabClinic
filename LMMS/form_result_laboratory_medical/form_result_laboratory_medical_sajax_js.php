  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_result_laboratory_medical" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_result_laboratory_medical_form();
	}
  ...
  // ---------- Validate id
  function do_ajax_form_result_laboratory_medical_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_medical_validate_id(var_id, var_script_case_init, do_ajax_form_result_laboratory_medical_validate_id_cb);
  } // do_ajax_form_result_laboratory_medical_validate_id

  function do_ajax_form_result_laboratory_medical_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_result_laboratory_medical_validate_id_cb

  // ---------- Validate trandate
  function do_ajax_form_result_laboratory_medical_validate_trandate()
  {
    var nomeCampo_trandate = "trandate";
    var var_trandate = scAjaxGetFieldText(nomeCampo_trandate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_medical_validate_trandate(var_trandate, var_script_case_init, do_ajax_form_result_laboratory_medical_validate_trandate_cb);
  } // do_ajax_form_result_laboratory_medical_validate_trandate

  function do_ajax_form_result_laboratory_medical_validate_trandate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_result_laboratory_medical_validate_trandate_cb

  // ---------- Validate serviceid
  function do_ajax_form_result_laboratory_medical_validate_serviceid()
  {
    var nomeCampo_serviceid = "serviceid";
    var var_serviceid = scAjaxGetFieldSelect(nomeCampo_serviceid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_medical_validate_serviceid(var_serviceid, var_script_case_init, do_ajax_form_result_laboratory_medical_validate_serviceid_cb);
  } // do_ajax_form_result_laboratory_medical_validate_serviceid

  function do_ajax_form_result_laboratory_medical_validate_serviceid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_result_laboratory_medical_validate_serviceid_cb

  // ---------- Validate staffid
  function do_ajax_form_result_laboratory_medical_validate_staffid()
  {
    var nomeCampo_staffid = "staffid";
    var var_staffid = scAjaxGetFieldSelect(nomeCampo_staffid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_medical_validate_staffid(var_staffid, var_script_case_init, do_ajax_form_result_laboratory_medical_validate_staffid_cb);
  } // do_ajax_form_result_laboratory_medical_validate_staffid

  function do_ajax_form_result_laboratory_medical_validate_staffid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "staffid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_result_laboratory_medical_validate_staffid_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_result_laboratory_medical_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_medical_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_result_laboratory_medical_validate_sc_field_0_cb);
  } // do_ajax_form_result_laboratory_medical_validate_sc_field_0

  function do_ajax_form_result_laboratory_medical_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_result_laboratory_medical_validate_sc_field_0_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_result_laboratory_medical_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_result_laboratory_medical_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_result_laboratory_medical_submit_form(var_id, var_trandate, var_serviceid, var_staffid, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_result_laboratory_medical_submit_form_cb);
  } // do_ajax_form_result_laboratory_medical_submit_form

  function do_ajax_form_result_laboratory_medical_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_result_laboratory_medical_submit_form_cb_after_alert);
  } // do_ajax_form_result_laboratory_medical_submit_form_cb
  function do_ajax_form_result_laboratory_medical_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_result_laboratory_medical_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["form_result_laboratory_detail"] = "off";

  function do_ajax_form_result_laboratory_medical_navigate_form()
  {
    perform_ajax_form_result_laboratory_medical_navigate_form();
  }

  function perform_ajax_form_result_laboratory_medical_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    scStatusDetail["form_result_laboratory_detail"] = "on";
    x_ajax_form_result_laboratory_medical_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_result_laboratory_medical_navigate_form_cb);
  } // do_ajax_form_result_laboratory_medical_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_result_laboratory_medical']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_result_laboratory_medical_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    if (scMasterDetailIframe && scMasterDetailIframe["nmsc_iframe_liga_form_result_laboratory_detail"] && "nmsc_iframe_liga_form_result_laboratory_detail" != scMasterDetailIframe["nmsc_iframe_liga_form_result_laboratory_detail"]) {
        scMoveMasterDetail(scMasterDetailIframe["nmsc_iframe_liga_form_result_laboratory_detail"]);
    }
    else {
        document.getElementById('nmsc_iframe_liga_form_result_laboratory_detail').contentWindow.nm_move('apl_detalhe', true, '1000');
        document.getElementById('nmsc_iframe_liga_form_result_laboratory_detail').style.height = "1000";
        document.getElementById('nmsc_iframe_liga_form_result_laboratory_detail').style.display = "none";
    }
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_result_laboratory_medical_navigate_form_cb_after_alert);
  } // do_ajax_form_result_laboratory_medical_navigate_form_cb
  function do_ajax_form_result_laboratory_medical_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_result_laboratory_medical_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_result_laboratory_medical_navigate_form_cb_after_alert
  function sc_hide_form_result_laboratory_medical_form()
  {
  ...
  {
    if ("off" == scStatusDetail["form_result_laboratory_detail"])
    {
      return true;
    }
    return false;
