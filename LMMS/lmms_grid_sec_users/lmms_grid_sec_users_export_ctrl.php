<?php
@session_start() ;
$_SESSION['scriptcase']['lmms_grid_sec_users']['sc_process_barr'] = true;
require_once('../lmms_grid_sec_users/index.php');
unset($_SESSION['scriptcase']['lmms_grid_sec_users']['sc_process_barr']);
$ExportCtrl = new lmms_grid_sec_users_export_control;
$ExportCtrl->Export_barr();

class lmms_grid_sec_users_export_control
{
