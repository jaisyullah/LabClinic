...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_image_cond" name="image_cond" onChange="nm_campos_between(document.getElementById('id_vis_image'), this, 'image')">
      ...
      <br><span id="id_hide_image"  <?php echo $str_hide_image?>><?php
      if ($image != "")
      {
      $image_look = substr($this->Db->qstr($image), 1, -1); 
      $nmgp_def_dados = array(); 
