...
<?php
   ...
   $Ord_Cmp = new grid_staff_settings_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_staff_settings_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_staff_settings']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_staff_settings']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["id"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_staff_settings']['labels']["id"])) ? $_SESSION['sc_session'][$sc_init]['grid_staff_settings']['labels']["id"] : "ID";
   $tab_ger_campos['name'] = "on";
   $tab_def_campos['name'] = "name";
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_staff_settings']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['grid_staff_settings']['labels']["name"] : "Name";
   $tab_ger_campos['usr_login'] = "on";
   $tab_def_campos['usr_login'] = "usr_login";
   $tab_labels["usr_login"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_staff_settings']['labels']["usr_login"])) ? $_SESSION['sc_session'][$sc_init]['grid_staff_settings']['labels']["usr_login"] : "User Login";
   $tab_ger_campos['image'] = "on";
   $tab_def_campos['image'] = "image";
   $tab_labels["image"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_staff_settings']['labels']["image"])) ? $_SESSION['sc_session'][$sc_init]['grid_staff_settings']['labels']["image"] : "Image";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_staff_settings']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_staff_settings']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_staff_settings']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_staff_settings']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_staff_settings']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_staff_settings']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_staff_settings']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_staff_settings']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_staff_settings']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_staff_settings']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_staff_settings']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_staff_settings']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_staff_settings_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_staff_settings']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_staff_settings']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_staff_settings']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_staff_settings']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_staff_settings']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
