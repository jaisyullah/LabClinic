...
//-- ajax metodos ---
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_outpatient_reg']['proc_res'])) 
    {
...
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_outpatient_reg']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_his_outpatient_reg').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_his_outpatient_reg').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_his_outpatient_reg').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>';
}
<?php
    }
    else
...
<TABLE align="center" valign="top" width="90%" cellpadding=0 cellspacing=0>
<tr>
<td>
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_regdate"  <?php echo $str_display_regdate; ?> class="scFilterFieldFontOdd">
...
?>
      ...
      <TD id='SC_servicedate_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['servicedate'])) ? $this->New_label['servicedate'] : "Service Date"; ?></TD>
      
      <INPUT type="hidden" id="SC_servicedate_cond" name="servicedate_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_servicedate" <?php echo $str_hide_servicedate?> valign="top">
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_servicedate"  <?php echo $str_display_servicedate; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>
         <BR>
         <?php
...
?>
      ...
      <TD id='SC_finishdate_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['finishdate'])) ? $this->New_label['finishdate'] : "Finish Date"; ?></TD>
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_finishdate"  <?php echo $str_display_finishdate; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>
         <BR>
         <?php
...
?>
      ...
      <TD id='SC_paymentid_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['paymentid'])) ? $this->New_label['paymentid'] : "Payment"; ?></TD>
      
      <INPUT type="hidden" id="SC_paymentid_cond" name="paymentid_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_paymentid" <?php echo $str_hide_paymentid?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<TR>
 ...
 <TD colspan=2>
  ...
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('statusid', 'N'); return false;" style="cursor: pointer">
      ...
      <TD id='SC_institutionid_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['institutionid'])) ? $this->New_label['institutionid'] : "Institution ID"; ?></TD>
      
      <INPUT type="hidden" id="SC_institutionid_cond" name="institutionid_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_institutionid" <?php echo $str_hide_institutionid?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
{
?>
<iframe id="nmsc_iframe_grid_his_outpatient_reg" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_his_outpatient_reg" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>" width="100%"></iframe>
<?php
}
else
{
...
?>
<iframe id="nmsc_iframe_grid_his_outpatient_reg_pesq"  name="nm_iframe_grid_his_outpatient_reg_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_his_outpatient_reg_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_his_outpatient_reg').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
