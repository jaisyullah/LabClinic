  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_currency" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate name
  function do_ajax_form_currency_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_currency_validate_name(var_name, var_script_case_init, do_ajax_form_currency_validate_name_cb);
  } // do_ajax_form_currency_validate_name

  function do_ajax_form_currency_validate_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_currency_validate_name_cb

  // ---------- Validate code
  function do_ajax_form_currency_validate_code()
  {
    var nomeCampo_code = "code";
    var var_code = scAjaxGetFieldText(nomeCampo_code);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_currency_validate_code(var_code, var_script_case_init, do_ajax_form_currency_validate_code_cb);
  } // do_ajax_form_currency_validate_code

  function do_ajax_form_currency_validate_code_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "code";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_currency_validate_code_cb

  // ---------- Validate symbol
  function do_ajax_form_currency_validate_symbol()
  {
    var nomeCampo_symbol = "symbol";
    var var_symbol = scAjaxGetFieldText(nomeCampo_symbol);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_currency_validate_symbol(var_symbol, var_script_case_init, do_ajax_form_currency_validate_symbol_cb);
  } // do_ajax_form_currency_validate_symbol

  function do_ajax_form_currency_validate_symbol_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "symbol";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_currency_validate_symbol_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_currency_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_currency_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_currency_submit_form(var_name, var_code, var_symbol, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_currency_submit_form_cb);
  } // do_ajax_form_currency_submit_form

  function do_ajax_form_currency_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_currency_submit_form_cb_after_alert);
  } // do_ajax_form_currency_submit_form_cb
  function do_ajax_form_currency_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_currency_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_currency_navigate_form()
  {
    perform_ajax_form_currency_navigate_form();
  }

  function perform_ajax_form_currency_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_currency_navigate_form(var_name, var_code, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_currency_navigate_form_cb);
  } // do_ajax_form_currency_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_currency']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_currency_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_currency_navigate_form_cb_after_alert);
  } // do_ajax_form_currency_navigate_form_cb
  function do_ajax_form_currency_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_currency_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_currency_navigate_form_cb_after_alert
  function sc_hide_form_currency_form()
  {
