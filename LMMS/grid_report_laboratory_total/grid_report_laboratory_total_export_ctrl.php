<?php
@session_start() ;
$_SESSION['scriptcase']['grid_report_laboratory_total']['sc_process_barr'] = true;
require_once('../grid_report_laboratory_total/index.php');
unset($_SESSION['scriptcase']['grid_report_laboratory_total']['sc_process_barr']);
$ExportCtrl = new grid_report_laboratory_total_export_control;
$ExportCtrl->Export_barr();

class grid_report_laboratory_total_export_control
{
