...
class grid_report_laboratory_total_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['prim_vez']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['prim_vez'] = "S";
      }
   ...
   function init()
   {
    ...
    {
      $_SESSION['scriptcase']['grid_report_laboratory_total']['contr_erro'] = 'on';
 $this->nmgp_botoes["exit"] = "off";;
$_SESSION['scriptcase']['grid_report_laboratory_total']['contr_erro'] = 'off'; 
      if (isset($trandate_day))
      {
          $trandate_dia = $trandate_day; 
      }
      if (isset($trandate_month))
      {
          $trandate_mes = $trandate_month; 
      }
      if (isset($trandate_year))
      {
          $trandate_ano = $trandate_year; 
      }
      if (isset($trandate))
      {
          $trandate = str_replace("0000", "", $trandate);
          $trandate = str_replace("-00", "-", $trandate);
          $trandateXX = explode("-", $trandate);
          if (isset($trandateXX[2]))
          {
              $trandate_dia = $trandateXX[2]; 
          }
          if (isset($trandateXX[1]))
          {
              $trandate_mes = $trandateXX[1]; 
          }
          if (isset($trandateXX[0]))
          {
              $trandate_ano = $trandateXX[0]; 
          }
      }
      if (isset($trandate_input_2_day))
      {
          $trandate_input_2_dia = $trandate_input_2_day; 
      }
      if (isset($trandate_input_2_month))
      {
          $trandate_input_2_mes = $trandate_input_2_month; 
      }
      if (isset($trandate_input_2_year))
      {
          $trandate_input_2_ano = $trandate_input_2_year; 
      }
      if (isset($trandate_2))
      {
          $trandate_2 = str_replace("0000", "", $trandate_2);
          $trandate_2 = str_replace("-00", "-", $trandate_2);
          $trandateXX = explode("-", $trandate_2);
          if (isset($trandateXX[2]))
          {
              $trandate_input_2_dia = $trandateXX[2]; 
          }
          if (isset($trandateXX[1]))
          {
              $trandate_input_2_mes = $trandateXX[1]; 
          }
          if (isset($trandateXX[0]))
          {
              $trandate_input_2_ano = $trandateXX[0]; 
          }
      }
    }
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_report_laboratory_total_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_report_laboratory_total_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_report_laboratory_total_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_examination')
      {
          $examination = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_examination($examination);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_examination($examination)
   {
      $examination = substr($this->Db->qstr($examination), 1, -1);
            $examination_look = substr($this->Db->qstr($examination), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct d.`name` from " . $this->Ini->nm_tabela . " where  d.`name` like '%" . $examination . "%' order by d.`name`"; 
      unset($cmp1,$cmp2);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "b.tranDate";$Nm_datas[] = "b_tranDate";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['proc_res'])) 
    {
        $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['proc_res'] = false; 
    }
?>
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['prim_vez'] == "N" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_report_laboratory_total').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_report_laboratory_total').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_report_laboratory_total').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>';
}
<?php
    }
    else
...
<?php
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_report_laboratory_total/grid_report_laboratory_total_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_report_laboratory_total_ajax_search.js"></script>
 <script type="text/javascript" src="grid_report_laboratory_total_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_report_laboratory_total_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_report_laboratory_total']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_report_laboratory_total']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_examination_cond#NMF#' + search_get_sel_txt('SC_examination_cond') + '@NMF@';
  str_out += 'SC_examination#NMF#' + search_get_text('SC_examination') + '@NMF@';
  str_out += 'id_ac_examination#NMF#' + search_get_title('select2-id_ac_examination-container') + '@NMF@';
  str_out += 'SC_gender_cond#NMF#' + search_get_sel_txt('SC_gender_cond') + '@NMF@';
  str_out += 'SC_gender#NMF#' + search_get_checkbox('SC_gender') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
  $(".sc-ui-autocomp-examination").on("focus", function() {
  }).on("blur", function() {
   ...
   ajax: {
    ...
    data: function (params) {
     var query = {
      ...
      nmgp_parms: "NM_ajax_opcao?#?autocomp_examination",
      max_itens: "10",
   ...
   $("#SC_examination").val(e.params.data.id);
  });
 });
</script>
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   function monta_form()
   {
      global 
             ...
             $examination_cond, $examination, $examination_autocomp,
             $gender_cond, $gender,
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("grid_report_laboratory_total", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $trandate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['trandate_dia']; 
          $trandate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['trandate_mes']; 
          $trandate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['trandate_ano']; 
          $trandate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['trandate_input_2_dia']; 
          $trandate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['trandate_input_2_mes']; 
          $trandate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['trandate_input_2_ano']; 
          $trandate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['trandate_cond']; 
          $examination = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['examination']; 
          $examination_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['examination_cond']; 
          $gender = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['gender']; 
          $gender_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['gender_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['NM_operador']; 
      } 
      ...
      $str_hide_examination = (in_array($examination_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_examination = ('bw' == $examination_cond) ? $display_aberto : $display_fechado;
 ...
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_trandate_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['trandate'])) ? $this->New_label['trandate'] : "Date of Transaction"; ?></TD>
...
?>
      ...
      <TD id='SC_examination_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['examination'])) ? $this->New_label['examination'] : "Examination"; ?></TD>
      
      <INPUT type="hidden" id="SC_examination_cond" name="examination_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_examination" <?php echo $str_hide_examination?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['examination'])) ? $this->New_label['examination'] : "Examination";
 $nmgp_tab_label .= "examination?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $examination_look = substr($this->Db->qstr($examination), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select distinct d.`name` from " . $this->Ini->nm_tabela . " where d.`name` = '$examination_look' order by d.`name`"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      if (isset($nmgp_def_dados[0][$examination]))
      {
          $sAutocompValue = $nmgp_def_dados[0][$examination];
      }
      else
      {
          $sAutocompValue = $examination;
      }
?>
<INPUT  type="text" id="SC_examination" name="examination" value="<?php echo NM_encode_input($examination) ?>"  size=50 alt="{datatype: 'text', maxLength: 100, allowedChars: '', lettersCase: '', autoTab: false, enterTab: false}" style="display: none">
<select class="sc-js-input scFilterObjectOdd sc-ui-autocomp-examination" id="id_ac_examination" name="examination_autocomp"><?php if ('' !=  $examination) { ?><option value="<?php echo $examination ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>

        </TD>
       </TR>
      </TABLE>
     </TD>
      <TD id='SC_gender_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['gender'])) ? $this->New_label['gender'] : "Gender"; ?></TD>
...
<?php
  if (!isset($gender)) {$gender = explode(";", $gender);}
 ?>
 
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['psq_check_ret']['gender'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['psq_check_ret']['gender'][] = "M";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['psq_check_ret']['gender'][] = "F";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_gender" name="gender[]" value="M##@@Male"  <?php if (in_array("M", $gender))  { echo " checked" ;} ?>>Male</TD>
</TR>
<TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_gender" name="gender[]" value="F##@@Female"  <?php if (in_array("F", $gender))  { echo " checked" ;} ?>>Female</TD>
</TR><TR>
 <TD colspan=1>
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_all.gif" ALIGN="absmiddle" onClick="nm_marca_check('gender', 'N'); return false;" style="cursor: pointer">&nbsp;
  <IMG SRC="<?php echo $this->Ini->path_img_global;?>/img_select_none.gif" ALIGN="absmiddle" onClick="nm_limpa_check('gender', 'N'); return false;" style="cursor: pointer">
 </TD>
</TR></TABLE>
...
?>
<?php
   if (is_file("grid_report_laboratory_total_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['opc_psq'])
   {
       if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['sc_modal'])
       {
?>
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['prim_vez'] == "N") 
    {
?>
       <iframe id="nmsc_iframe_grid_report_laboratory_total" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_report_laboratory_total" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_grid_report_laboratory_total" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_report_laboratory_total" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_grid_report_laboratory_total_pesq"  name="nm_iframe_grid_report_laboratory_total_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_report_laboratory_total_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_report_laboratory_total').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   nm_campos_between(document.getElementById('id_vis_examination'), document.F1.examination_cond, 'examination');
   document.F1.examination.value = "";
   document.F1.examination_autocomp.value = "";
   $('#select2-id_ac_examination-container').html('<?php echo $this->Val_init_examination['desc'] ?>');;
   nm_campos_between(document.getElementById('id_vis_gender'), document.F1.gender_cond, 'gender');
   for (i = 0; i < document.F1.elements.length; i++)
   {
      if (document.F1.elements[i].name == 'gender[]' && document.F1.elements[i].checked)
      {
          document.F1.elements[i].checked = false;
      }
   }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "LMMS/grid_report_laboratory_total";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_report_laboratory_total/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_examination_cond'] = 'cond';
      $tp_fields['SC_examination'] = 'text_aut';
      $tp_fields['id_ac_examination'] = 'select2_aut';
      $tp_fields['SC_gender_cond'] = 'cond';
      $tp_fields['SC_gender'] = 'checkbox';
   ...
   function trata_campos()
   {
      global $trandate_cond, $trandate, $trandate_dia, $trandate_mes, $trandate_ano, $trandate_input_2_dia, $trandate_input_2_mes, $trandate_input_2_ano,
             $examination_cond, $examination, $examination_autocomp,
             $gender_cond, $gender, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($examination_autocomp) && empty($examination))
      {
          $examination = $examination_autocomp;
      }
      ...
      $examination_cond_salva = $examination_cond; 
      if (!isset($examination_input_2) || $examination_input_2 == "")
      {
          $examination_input_2 = $examination;
      }
      ...
      if (is_array($gender)) {
          foreach ($gender as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['psq_check_ret']['gender'])) {
                  if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Gender : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
                  break;
              }
          }
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['trandate_dia'] = $trandate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['trandate_mes'] = $trandate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['trandate_ano'] = $trandate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['trandate_input_2_dia'] = $trandate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['trandate_input_2_mes'] = $trandate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['trandate_input_2_ano'] = $trandate_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['trandate_cond'] = $trandate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['examination'] = $examination; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['examination_cond'] = $examination_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['gender'] = $gender; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['gender_cond'] = $gender_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($examination != '') {
      ...
      if (!empty($nmgp_def_dados) && isset($cmp2) && !empty($cmp2))
      {
          ...
          $this->cmp_formatado['examination'] = $cmp2;
      }
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['examination'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['examination'] = $examination;
      }
      $this->cmp_formatado['gender'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['gender'];
      $this->cmp_formatado['gender_input_2'] = $gender_input_2;
      ...
      if ($trandate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['trandate'] = $val[0];
          ...
          if ($trandate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']['trandate_input_2'] = $val[1];
          ...
          {
              $this->monta_condicao("b.tranDate", $trandate_cond, $trandate, $trandate_input_2, 'trandate', 'DATETIME');
          }
      }

      //----- $examination
      $this->Date_part = false;
      if (isset($examination) || $examination_cond == "nu" || $examination_cond == "nn" || $examination_cond == "ep" || $examination_cond == "ne")
      {
         $this->monta_condicao("d.`name`", $examination_cond, $examination, "", "examination");
      }
      ...
      $gender = $gender; 
      $nm_aspas = "'";
      if ($gender_cond == "nu" || $gender_cond == "nn" || $gender_cond == "ep" || $gender_cond == "ne")
      {
          $gender = array();
      }
      if (is_array($gender) && count($gender) != 0)
      {
         foreach ($gender as $i => $dados)
         {
      ...
      {
         $this->and_or();
         if ($gender_cond == "df" || $gender_cond == "np")
         {
             $this->comando        .= " c.gender not in (";
             $this->comando_sum    .= " .c.gender not in (";
             $this->comando_filtro .= " c.gender not in (";
         }
         else
         {
             $this->comando        .= " c.gender in (";
             $this->comando_sum    .= " .c.gender in (";
             $this->comando_filtro .= " c.gender in (";
         }
         $x                     = count($gender);
         $xx                    = 0;
         $nm_cond               = "";
         ...
         $Lang_descr_final = isset($Lang_descr[$gender_cond]) ? $Lang_descr[$gender_cond] : $this->Ini->Nm_lang['lang_srch_like'];
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $nmgp_tab_label['gender'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
      elseif (isset($gender) || $gender_cond == "nu" || $gender_cond == "nn" || $gender_cond == "ep" || $gender_cond == "ne")
      {
         $this->monta_condicao("c.gender", $gender_cond, $gender, "", "gender");
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_laboratory_total']['cond_pesq'] .= $this->NM_operador;
