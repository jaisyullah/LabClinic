...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_examination"  <?php echo $str_hide_examination?>><?php
      if ($examination != "")
      {
      $examination_look = substr($this->Db->qstr($examination), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-examination" id="id_ac_examination" name="examination_autocomp"><?php if ('' !=  $examination) { ?><option value="<?php echo $examination ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
