...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_group_name_cond" name="group_name_cond" onChange="nm_campos_between(document.getElementById('id_vis_group_name'), this, 'group_name')">
      ...
      <br><span id="id_hide_group_name"  <?php echo $str_hide_group_name?>><?php
      if ($group_name != "")
      {
      $group_name_look = substr($this->Db->qstr($group_name), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_active_cond" name="active_cond" onChange="nm_campos_between(document.getElementById('id_vis_active'), this, 'active')">
      ...
      <br><span id="id_hide_active"  <?php echo $str_hide_active?>><?php
      if ($active != "")
      {
      $active_look = substr($this->Db->qstr($active), 1, -1); 
      $nmgp_def_dados = array(); 
