...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LMMS_____grid_laboratory_group"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LMMS_____grid_laboratory_group"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_laboratory_group'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_laboratory_group']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_laboratory_group']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_laboratory_group']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_laboratory_group']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_laboratory_group']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_laboratory_group</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_laboratory_group']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_laboratory_group']['embutida_filho'] as $ind => $sc_init)
          {
