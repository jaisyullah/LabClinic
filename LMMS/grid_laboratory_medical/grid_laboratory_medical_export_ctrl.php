<?php
@session_start() ;
$_SESSION['scriptcase']['grid_laboratory_medical']['sc_process_barr'] = true;
require_once('../grid_laboratory_medical/index.php');
unset($_SESSION['scriptcase']['grid_laboratory_medical']['sc_process_barr']);
$ExportCtrl = new grid_laboratory_medical_export_control;
$ExportCtrl->Export_barr();

class grid_laboratory_medical_export_control
{
