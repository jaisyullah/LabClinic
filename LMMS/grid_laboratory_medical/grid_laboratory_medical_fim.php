...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LMMS_____grid_laboratory_medical"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LMMS_____grid_laboratory_medical"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_laboratory_medical']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_laboratory_medical']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_laboratory_medical']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_laboratory_medical']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_laboratory_medical']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_laboratory_medical</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_laboratory_medical']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_laboratory_medical']['embutida_filho'] as $ind => $sc_init)
          {
