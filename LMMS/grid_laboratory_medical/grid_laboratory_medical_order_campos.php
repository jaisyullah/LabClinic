<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_laboratory_medical']['glo_nm_path_imag_temp'] . "/sc_apl_default_LMMS.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_laboratory_medical_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_laboratory_medical_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['ordem_select_orig'] = array();
   }
   ...
   {
       $tab_def_campos['trancode'] = "a.tranCode";
   }
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["trancode"] : "Transaction Code";
   $tab_ger_campos['trandate'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['trandate'] = "trandate";
   }
   else
   {
       $tab_def_campos['trandate'] = "a.tranDate";
   }
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["trandate"] : "Transaction Date";
   $tab_ger_campos['patientid'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['patientid'] = "patientid";
   }
   else
   {
       $tab_def_campos['patientid'] = "a.patientID";
   }
   $tab_labels["patientid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["patientid"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["patientid"] : "Patient No";
   $tab_ger_campos['patientname'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['patientname'] = "patientname";
   }
   else
   {
       $tab_def_campos['patientname'] = "b.name";
   }
   $tab_labels["patientname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["patientname"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["patientname"] : "Patient Name";
   $tab_ger_campos['birthdate'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['birthdate'] = "birthdate";
   }
   else
   {
       $tab_def_campos['birthdate'] = "a.birthDate";
   }
   $tab_labels["birthdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["birthdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["birthdate"] : "Birth Date";
   $tab_ger_campos['icdid'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['icdid'] = "icdid";
   }
   else
   {
       $tab_def_campos['icdid'] = "a.icdID";
   }
   $tab_labels["icdid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["icdid"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["icdid"] : "ICD-10";
   $tab_ger_campos['confirmdate'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['confirmdate'] = "confirmdate";
   }
   else
   {
       $tab_def_campos['confirmdate'] = "a.confirmDate";
   }
   $tab_labels["confirmdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["confirmdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["confirmdate"] : "Confirm Date";
   $tab_ger_campos['finishdate'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['finishdate'] = "finishdate";
   }
   else
   {
       $tab_def_campos['finishdate'] = "a.finishDate";
   }
   $tab_labels["finishdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["finishdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["finishdate"] : "Finish Date";
   $tab_ger_campos['staffid'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['staffid'] = "staffid";
   }
   else
   {
       $tab_def_campos['staffid'] = "a.staffID";
   }
   $tab_labels["staffid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["staffid"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["staffid"] : "Staff";
   $tab_ger_campos['regcode'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['regcode'] = "regcode";
   }
   else
   {
       $tab_def_campos['regcode'] = "a.regCode";
   }
   $tab_labels["regcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["regcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["regcode"] : "Registration Code";
   $tab_ger_campos['statusid'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['statusid'] = "statusid";
   }
   else
   {
       $tab_def_campos['statusid'] = "a.statusID";
   }
   $tab_labels["statusid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["statusid"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['labels']["statusid"] : "Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_title'] ?> laboratory_medical</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_laboratory_medical_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_laboratory_medical']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
