<?php
@session_start() ;
$_SESSION['scriptcase']['grid_payment']['sc_process_barr'] = true;
require_once('../grid_payment/index.php');
unset($_SESSION['scriptcase']['grid_payment']['sc_process_barr']);
$ExportCtrl = new grid_payment_export_control;
$ExportCtrl->Export_barr();

class grid_payment_export_control
{
