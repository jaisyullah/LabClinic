<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_payment']['glo_nm_path_imag_temp'] . "/sc_apl_default_LMMS.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_payment_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_payment_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_payment']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_payment']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["date"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["date"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["date"] : "Date of Transaction";
   ...
   $tab_labels["saleid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["saleid"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["saleid"] : "Transaction Code";
   ...
   $tab_labels["paycode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["paycode"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["paycode"] : "Payment Code";
   ...
   $tab_labels["patientname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["patientname"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["patientname"] : "Patient Name";
...
ORDER BY b.code";
   ...
   $tab_labels["curr1"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["curr1"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["curr1"] : "";
   ...
   $tab_labels["amount"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["amount"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["amount"] : "Amount";
...
ORDER BY b.code";
   ...
   $tab_labels["curr2"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["curr2"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["curr2"] : "";
   ...
   $tab_labels["discount"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["discount"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["discount"] : "Discount";
   ...
   $tab_labels["type"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["type"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["type"] : "Type";
   ...
   $tab_labels["status"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["status"])) ? $_SESSION['sc_session'][$sc_init]['grid_payment']['labels']["status"] : "Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_payment']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_payment']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_payment']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_payment']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_payment']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_payment']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_payment']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_payment']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_payment']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_payment']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_payment']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_payment']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_payment_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_payment']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_payment']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_payment']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_payment']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_payment']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
