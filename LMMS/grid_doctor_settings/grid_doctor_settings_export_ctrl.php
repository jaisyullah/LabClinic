<?php
@session_start() ;
$_SESSION['scriptcase']['grid_doctor_settings']['sc_process_barr'] = true;
require_once('../grid_doctor_settings/index.php');
unset($_SESSION['scriptcase']['grid_doctor_settings']['sc_process_barr']);
$ExportCtrl = new grid_doctor_settings_export_control;
$ExportCtrl->Export_barr();

class grid_doctor_settings_export_control
{
