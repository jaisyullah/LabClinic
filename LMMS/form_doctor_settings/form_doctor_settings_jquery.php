...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_form_doctor_settings_id_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_form_doctor_settings_id_onchange(this, iSeqRow) })
                                .bind('focus', function() { sc_form_doctor_settings_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_name' + iSeqRow).bind('blur', function() { sc_form_doctor_settings_name_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_doctor_settings_name_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_doctor_settings_name_onfocus(this, iSeqRow) });
  $('#id_sc_field_image' + iSeqRow).bind('blur', function() { sc_form_doctor_settings_image_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_doctor_settings_image_onchange(this, iSeqRow) })
                                   .bind('focus', function() { sc_form_doctor_settings_image_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_doctor_settings_id_onblur(oThis, iSeqRow) {
  do_ajax_form_doctor_settings_validate_id();
  scCssBlur(oThis);
}

function sc_form_doctor_settings_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_doctor_settings_id_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doctor_settings_name_onblur(oThis, iSeqRow) {
  do_ajax_form_doctor_settings_validate_name();
  scCssBlur(oThis);
}

function sc_form_doctor_settings_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_doctor_settings_name_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}

function sc_form_doctor_settings_image_onblur(oThis, iSeqRow) {
  scCssBlur(oThis);
}

function sc_form_doctor_settings_image_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_doctor_settings_image_onfocus(oThis, iSeqRow) {
  scCssFocus(oThis);
}
...
function scHidePage(pageNo) {
	$("#id_form_doctor_settings_form" + pageNo).hide();
}
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_image" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_doctor_settings_ul_save.php",
    dropZone: $("#hidden_field_data_image" + iSeqRow),
    formData: function() {
      return [
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_doctor_settings')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
