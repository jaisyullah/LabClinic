...
function scHidePage(pageNo) {
	$("#id_form_doctor_settings_mob_form" + pageNo).hide();
}
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_image" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_doctor_settings_mob_ul_save.php",
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_doctor_settings_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
