...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "Trandate";$Nm_datas[] = "Trandate";$Nm_numeric[] = "service";$Nm_numeric[] = "price";$Nm_numeric[] = "staff";
...
<HTML>
<HEAD>
 <TITLE> bill_laboratory_medical</TITLE>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_service_cond" name="service_cond" onChange="nm_campos_between(document.getElementById('id_vis_service'), this, 'service')">
      ...
      <br><span id="id_hide_service"  <?php echo $str_hide_service?>><INPUT  type="text" id="SC_service" name="service" value="<?php echo NM_encode_input($service) ?>" size=11 alt="{datatype: 'integer', maxLength: 11, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
