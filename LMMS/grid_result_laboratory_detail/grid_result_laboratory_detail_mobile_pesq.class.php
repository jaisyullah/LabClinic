...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tranDate";$Nm_datas[] = "tranDate";$Nm_numeric[] = "id";$Nm_numeric[] = "serviceid";$Nm_numeric[] = "staffid";
...
<HTML>
<HEAD>
 <TITLE> result_laboratory_detail</TITLE>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_id"  <?php echo $str_hide_id?>><INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=15 alt="{datatype: 'integer', maxLength: 15, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_trancode_cond" name="trancode_cond" onChange="nm_campos_between(document.getElementById('id_vis_trancode'), this, 'trancode')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_serviceid_cond" name="serviceid_cond" onChange="nm_campos_between(document.getElementById('id_vis_serviceid'), this, 'serviceid')">
      ...
      <br><span id="id_hide_serviceid"  <?php echo $str_hide_serviceid?>><INPUT  type="text" id="SC_serviceid" name="serviceid" value="<?php echo NM_encode_input($serviceid) ?>" size=5 alt="{datatype: 'integer', maxLength: 5, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_parameter_cond" name="parameter_cond" onChange="nm_campos_between(document.getElementById('id_vis_parameter'), this, 'parameter')">
      ...
      <br><span id="id_hide_parameter"  <?php echo $str_hide_parameter?>><?php
      if ($parameter != "")
      {
      $parameter_look = substr($this->Db->qstr($parameter), 1, -1); 
      $nmgp_def_dados = array(); 
