<?php
@session_start() ;
$_SESSION['scriptcase']['grid_result_laboratory_detail']['sc_process_barr'] = true;
require_once('../grid_result_laboratory_detail/index.php');
unset($_SESSION['scriptcase']['grid_result_laboratory_detail']['sc_process_barr']);
$ExportCtrl = new grid_result_laboratory_detail_export_control;
$ExportCtrl->Export_barr();

class grid_result_laboratory_detail_export_control
{
