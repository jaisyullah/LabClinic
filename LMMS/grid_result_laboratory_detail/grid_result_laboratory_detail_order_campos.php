...
<?php
   ...
   $Ord_Cmp = new grid_result_laboratory_detail_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_result_laboratory_detail_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['parameter'] = "parameter";
   $tab_labels["parameter"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['labels']["parameter"])) ? $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['labels']["parameter"] : "Examination";
   $tab_ger_campos['subparameter'] = "on";
   $tab_def_campos['subparameter'] = "subparameter";
   $tab_labels["subparameter"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['labels']["subparameter"])) ? $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['labels']["subparameter"] : "Detail Examination";
   $tab_ger_campos['result'] = "on";
   $tab_def_campos['result'] = "result";
   $tab_labels["result"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['labels']["result"])) ? $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['labels']["result"] : "Result";
   $tab_ger_campos['marked'] = "on";
   $tab_def_campos['marked'] = "marked";
   $tab_labels["marked"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['labels']["marked"])) ? $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['labels']["marked"] : "Abnormal";
   $tab_ger_campos['standardvalue'] = "on";
   $tab_def_campos['standardvalue'] = "standardValue";
   $tab_labels["standardvalue"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['labels']["standardvalue"])) ? $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['labels']["standardvalue"] : "Ref. Range";
   $tab_ger_campos['unit'] = "on";
   $tab_def_campos['unit'] = "unit";
   $tab_labels["unit"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['labels']["unit"])) ? $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['labels']["unit"] : "Unit";
   $tab_ger_campos['trandate'] = "on";
   $tab_def_campos['trandate'] = "tranDate";
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['labels']["trandate"] : "Result Date";
   $tab_ger_campos['staffid'] = "on";
   $tab_def_campos['staffid'] = "staffID";
   $tab_labels["staffid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['labels']["staffid"])) ? $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['labels']["staffid"] : "Staff Input";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_result_laboratory_detail_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_result_laboratory_detail']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
