  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_normal_laboratory_detail" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_normal_laboratory_detail_form();
	}
  ...
  // ---------- Validate id_
  function do_ajax_form_normal_laboratory_detail_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_detail_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_normal_laboratory_detail_validate_id__cb);
  } // do_ajax_form_normal_laboratory_detail_validate_id_

  function do_ajax_form_normal_laboratory_detail_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_detail_validate_id__cb

  // ---------- Validate detailname_
  function do_ajax_form_normal_laboratory_detail_validate_detailname_(iNumLinha)
  {
    var nomeCampo_detailname_ = "detailname_" + iNumLinha;
    var var_detailname_ = scAjaxGetFieldText(nomeCampo_detailname_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_detail_validate_detailname_(var_detailname_, iNumLinha, var_script_case_init, do_ajax_form_normal_laboratory_detail_validate_detailname__cb);
  } // do_ajax_form_normal_laboratory_detail_validate_detailname_

  function do_ajax_form_normal_laboratory_detail_validate_detailname__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "detailname_" + iLineNumber;
    }
    else
    {
      sFieldValid = "detailname_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "detailname_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "detailname_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_detail_validate_detailname__cb

  // ---------- Validate oper_
  function do_ajax_form_normal_laboratory_detail_validate_oper_(iNumLinha)
  {
    var nomeCampo_oper_ = "oper_" + iNumLinha;
    var var_oper_ = scAjaxGetFieldSelect(nomeCampo_oper_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_detail_validate_oper_(var_oper_, iNumLinha, var_script_case_init, do_ajax_form_normal_laboratory_detail_validate_oper__cb);
  } // do_ajax_form_normal_laboratory_detail_validate_oper_

  function do_ajax_form_normal_laboratory_detail_validate_oper__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "oper_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "oper_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_detail_validate_oper__cb

  // ---------- Validate m1_
  function do_ajax_form_normal_laboratory_detail_validate_m1_(iNumLinha)
  {
    var nomeCampo_m1_ = "m1_" + iNumLinha;
    var var_m1_ = scAjaxGetFieldText(nomeCampo_m1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_detail_validate_m1_(var_m1_, iNumLinha, var_script_case_init, do_ajax_form_normal_laboratory_detail_validate_m1__cb);
  } // do_ajax_form_normal_laboratory_detail_validate_m1_

  function do_ajax_form_normal_laboratory_detail_validate_m1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "m1_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "m1_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_detail_validate_m1__cb

  // ---------- Validate m2_
  function do_ajax_form_normal_laboratory_detail_validate_m2_(iNumLinha)
  {
    var nomeCampo_m2_ = "m2_" + iNumLinha;
    var var_m2_ = scAjaxGetFieldText(nomeCampo_m2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_detail_validate_m2_(var_m2_, iNumLinha, var_script_case_init, do_ajax_form_normal_laboratory_detail_validate_m2__cb);
  } // do_ajax_form_normal_laboratory_detail_validate_m2_

  function do_ajax_form_normal_laboratory_detail_validate_m2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "m2_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "m2_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_detail_validate_m2__cb

  // ---------- Validate f1_
  function do_ajax_form_normal_laboratory_detail_validate_f1_(iNumLinha)
  {
    var nomeCampo_f1_ = "f1_" + iNumLinha;
    var var_f1_ = scAjaxGetFieldText(nomeCampo_f1_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_detail_validate_f1_(var_f1_, iNumLinha, var_script_case_init, do_ajax_form_normal_laboratory_detail_validate_f1__cb);
  } // do_ajax_form_normal_laboratory_detail_validate_f1_

  function do_ajax_form_normal_laboratory_detail_validate_f1__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "f1_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "f1_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_detail_validate_f1__cb

  // ---------- Validate f2_
  function do_ajax_form_normal_laboratory_detail_validate_f2_(iNumLinha)
  {
    var nomeCampo_f2_ = "f2_" + iNumLinha;
    var var_f2_ = scAjaxGetFieldText(nomeCampo_f2_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_detail_validate_f2_(var_f2_, iNumLinha, var_script_case_init, do_ajax_form_normal_laboratory_detail_validate_f2__cb);
  } // do_ajax_form_normal_laboratory_detail_validate_f2_

  function do_ajax_form_normal_laboratory_detail_validate_f2__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "f2_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "f2_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_detail_validate_f2__cb

  // ---------- Validate unit_
  function do_ajax_form_normal_laboratory_detail_validate_unit_(iNumLinha)
  {
    var nomeCampo_unit_ = "unit_" + iNumLinha;
    var var_unit_ = scAjaxGetFieldSelect(nomeCampo_unit_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_detail_validate_unit_(var_unit_, iNumLinha, var_script_case_init, do_ajax_form_normal_laboratory_detail_validate_unit__cb);
  } // do_ajax_form_normal_laboratory_detail_validate_unit_

  function do_ajax_form_normal_laboratory_detail_validate_unit__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_detail_validate_unit__cb

  // ---------- Validate lastupdated_
  function do_ajax_form_normal_laboratory_detail_validate_lastupdated_(iNumLinha)
  {
    var nomeCampo_lastupdated_ = "lastupdated_" + iNumLinha;
    var var_lastupdated_ = scAjaxGetFieldText(nomeCampo_lastupdated_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_detail_validate_lastupdated_(var_lastupdated_, iNumLinha, var_script_case_init, do_ajax_form_normal_laboratory_detail_validate_lastupdated__cb);
  } // do_ajax_form_normal_laboratory_detail_validate_lastupdated_

  function do_ajax_form_normal_laboratory_detail_validate_lastupdated__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "lastupdated_" + iLineNumber;
    }
    else
    {
      sFieldValid = "lastupdated_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "lastupdated_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "lastupdated_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_normal_laboratory_detail_validate_lastupdated__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_normal_laboratory_detail_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_normal_laboratory_detail_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_normal_laboratory_detail_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_normal_laboratory_detail_add_new_line_cb);
  } // do_ajax_form_normal_laboratory_detail_add_new_line

  function do_ajax_form_normal_laboratory_detail_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_normal_laboratory_detail_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_normal_laboratory_detail_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_normal_laboratory_detail_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_normal_laboratory_detail_backup_line_cb);
  } // do_ajax_form_normal_laboratory_detail_backup_line

  function do_ajax_form_normal_laboratory_detail_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_normal_laboratory_detail_backup_line_cb

  function do_ajax_form_normal_laboratory_detail_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_normal_laboratory_detail_cancel_insert

  function do_ajax_form_normal_laboratory_detail_cancel_update(iSeqVert)
  {
    do_ajax_form_normal_laboratory_detail_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_normal_laboratory_detail_cancel_update

  function do_ajax_form_normal_laboratory_detail_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_normal_laboratory_detail_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_normal_laboratory_detail_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_normal_laboratory_detail_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_normal_laboratory_detail_table_refresh_cb);
  } //  do_ajax_form_normal_laboratory_detail_table_refresh

  function do_ajax_form_normal_laboratory_detail_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_normal_laboratory_detail_table_refresh_cb_after_alert);
  } // do_ajax_form_normal_laboratory_detail_table_refresh_cb
  function do_ajax_form_normal_laboratory_detail_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_normal_laboratory_detail_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_normal_laboratory_detail_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_normal_laboratory_detail_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_detailname_ = scAjaxGetFieldText("detailname_" + iNumLinha);
    var var_oper_ = scAjaxGetFieldSelect("oper_" + iNumLinha);
    var var_m1_ = scAjaxGetFieldText("m1_" + iNumLinha);
    var var_m2_ = scAjaxGetFieldText("m2_" + iNumLinha);
    var var_f1_ = scAjaxGetFieldText("f1_" + iNumLinha);
    var var_f2_ = scAjaxGetFieldText("f2_" + iNumLinha);
    var var_unit_ = scAjaxGetFieldSelect("unit_" + iNumLinha);
    var var_lastupdated_ = scAjaxGetFieldText("lastupdated_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_normal_laboratory_detail_submit_form(var_id_, var_detailname_, var_oper_, var_m1_, var_m2_, var_f1_, var_f2_, var_unit_, var_lastupdated_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_normal_laboratory_detail_submit_form_cb);
  } // do_ajax_form_normal_laboratory_detail_submit_form

  function do_ajax_form_normal_laboratory_detail_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("detailname_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("oper_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("m1_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("m2_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("f1_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("f2_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("unit_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("lastupdated_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_normal_laboratory_detail_submit_form_cb_after_alert);
  } // do_ajax_form_normal_laboratory_detail_submit_form_cb
  function do_ajax_form_normal_laboratory_detail_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_normal_laboratory_detail_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_normal_laboratory_detail_navigate_form()
  {
    perform_ajax_form_normal_laboratory_detail_navigate_form();
  }

  function perform_ajax_form_normal_laboratory_detail_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_normal_laboratory_detail_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("detailname_" + iNavForm);
      scAjaxHideErrorDisplay("oper_" + iNavForm);
      scAjaxHideErrorDisplay("m1_" + iNavForm);
      scAjaxHideErrorDisplay("m2_" + iNavForm);
      scAjaxHideErrorDisplay("f1_" + iNavForm);
      scAjaxHideErrorDisplay("f2_" + iNavForm);
      scAjaxHideErrorDisplay("unit_" + iNavForm);
      scAjaxHideErrorDisplay("lastupdated_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_normal_laboratory_detail_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_normal_laboratory_detail_navigate_form_cb);
  } // do_ajax_form_normal_laboratory_detail_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_normal_laboratory_detail']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_normal_laboratory_detail_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_normal_laboratory_detail_navigate_form_cb_after_alert);
  } // do_ajax_form_normal_laboratory_detail_navigate_form_cb
  function do_ajax_form_normal_laboratory_detail_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_normal_laboratory_detail_navigate_form_cb_after_alert
  function sc_hide_form_normal_laboratory_detail_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "detailname_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "oper_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "m1_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "m2_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "f1_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "f2_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "unit_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "lastupdated_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["detailname_" + iNumLinha] = {"label": "Detail Name<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["oper_" + iNumLinha] = {"label": "Range Operator<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["m1_" + iNumLinha] = {"label": "Value from (Male)<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["m2_" + iNumLinha] = {"label": "Value until (Male)<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["f1_" + iNumLinha] = {"label": "Value from (Female)<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["f2_" + iNumLinha] = {"label": "Value until (Female)<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["unit_" + iNumLinha] = {"label": "Units<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["lastupdated_" + iNumLinha] = {"label": "Last Updated<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["detailname_"][iNumLinha] = "detailname_" + iNumLinha;
    ajax_field_mult["oper_"][iNumLinha] = "oper_" + iNumLinha;
    ajax_field_mult["m1_"][iNumLinha] = "m1_" + iNumLinha;
    ajax_field_mult["m2_"][iNumLinha] = "m2_" + iNumLinha;
    ajax_field_mult["f1_"][iNumLinha] = "f1_" + iNumLinha;
    ajax_field_mult["f2_"][iNumLinha] = "f2_" + iNumLinha;
    ajax_field_mult["unit_"][iNumLinha] = "unit_" + iNumLinha;
    ajax_field_mult["lastupdated_"][iNumLinha] = "lastupdated_" + iNumLinha;
    ajax_field_id["detailname_" + iNumLinha] = new Array("hidden_field_label_detailname_", "hidden_field_data_detailname_" + iNumLinha);
    ajax_field_id["oper_" + iNumLinha] = new Array("hidden_field_label_oper_", "hidden_field_data_oper_" + iNumLinha);
    ajax_field_id["m1_" + iNumLinha] = new Array("hidden_field_label_m1_", "hidden_field_data_m1_" + iNumLinha);
    ajax_field_id["m2_" + iNumLinha] = new Array("hidden_field_label_m2_", "hidden_field_data_m2_" + iNumLinha);
    ajax_field_id["f1_" + iNumLinha] = new Array("hidden_field_label_f1_", "hidden_field_data_f1_" + iNumLinha);
    ajax_field_id["f2_" + iNumLinha] = new Array("hidden_field_label_f2_", "hidden_field_data_f2_" + iNumLinha);
    ajax_field_id["unit_" + iNumLinha] = new Array("hidden_field_label_unit_", "hidden_field_data_unit_" + iNumLinha);
    ajax_field_id["lastupdated_" + iNumLinha] = new Array("hidden_field_label_lastupdated_", "hidden_field_data_lastupdated_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["detailname_" + iNumLinha] = "off";
    ajax_error_count["oper_" + iNumLinha] = "off";
    ajax_error_count["m1_" + iNumLinha] = "off";
    ajax_error_count["m2_" + iNumLinha] = "off";
    ajax_error_count["f1_" + iNumLinha] = "off";
    ajax_error_count["f2_" + iNumLinha] = "off";
    ajax_error_count["unit_" + iNumLinha] = "off";
    ajax_error_count["lastupdated_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["detailname_" + iNumLinha] = "off";
    ajax_read_only["oper_" + iNumLinha] = "off";
    ajax_read_only["m1_" + iNumLinha] = "off";
    ajax_read_only["m2_" + iNumLinha] = "off";
    ajax_read_only["f1_" + iNumLinha] = "off";
    ajax_read_only["f2_" + iNumLinha] = "off";
    ajax_read_only["unit_" + iNumLinha] = "off";
    ajax_read_only["lastupdated_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["detailname_" + iNumLinha] = "on";
    ajax_read_only["oper_" + iNumLinha] = "on";
    ajax_read_only["m1_" + iNumLinha] = "on";
    ajax_read_only["m2_" + iNumLinha] = "on";
    ajax_read_only["f1_" + iNumLinha] = "on";
    ajax_read_only["f2_" + iNumLinha] = "on";
    ajax_read_only["unit_" + iNumLinha] = "on";
    ajax_read_only["lastupdated_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["detailname_" + iNumLinha] = null;
    ajax_error_list["oper_" + iNumLinha] = null;
    ajax_error_list["m1_" + iNumLinha] = null;
    ajax_error_list["m2_" + iNumLinha] = null;
    ajax_error_list["f1_" + iNumLinha] = null;
    ajax_error_list["f2_" + iNumLinha] = null;
    ajax_error_list["unit_" + iNumLinha] = null;
    ajax_error_list["lastupdated_" + iNumLinha] = null;
  }
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["detailname_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["detailname_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["detailname_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["detailname_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["detailname_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["oper_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["oper_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["oper_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["oper_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["oper_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["m1_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["m1_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["m1_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["m1_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["m1_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["m2_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["m2_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["m2_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["m2_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["m2_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["f1_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["f1_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["f1_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["f1_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["f1_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["f2_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["f2_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["f2_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["f2_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["f2_" + iNumLinha]["onfocus"] = new Array();
      ...
      ajax_error_list["lastupdated_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["lastupdated_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["lastupdated_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["lastupdated_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["lastupdated_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['detailname_'])) ? $this->nmgp_cmp_readonly['detailname_'] : 'off';
?>
    scAjaxFieldRead("detailname_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['oper_'])) ? $this->nmgp_cmp_readonly['oper_'] : 'off';
?>
    scAjaxFieldRead("oper_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['m1_'])) ? $this->nmgp_cmp_readonly['m1_'] : 'off';
?>
    scAjaxFieldRead("m1_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['m2_'])) ? $this->nmgp_cmp_readonly['m2_'] : 'off';
?>
    scAjaxFieldRead("m2_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['f1_'])) ? $this->nmgp_cmp_readonly['f1_'] : 'off';
?>
    scAjaxFieldRead("f1_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['f2_'])) ? $this->nmgp_cmp_readonly['f2_'] : 'off';
?>
    scAjaxFieldRead("f2_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['unit_'])) ? $this->nmgp_cmp_readonly['unit_'] : 'off';
?>
    scAjaxFieldRead("unit_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['lastupdated_'])) ? $this->nmgp_cmp_readonly['lastupdated_'] : 'off';
?>
    scAjaxFieldRead("lastupdated_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_" + iSeq, "on");
    scAjaxFieldRead("detailname_" + iSeq, "on");
    scAjaxFieldRead("oper_" + iSeq, "on");
    scAjaxFieldRead("m1_" + iSeq, "on");
    scAjaxFieldRead("m2_" + iSeq, "on");
    scAjaxFieldRead("f1_" + iSeq, "on");
    scAjaxFieldRead("f2_" + iSeq, "on");
    scAjaxFieldRead("unit_" + iSeq, "on");
    scAjaxFieldRead("lastupdated_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["detailname_" + iRow] || "on" == ajax_error_count["oper_" + iRow] || "on" == ajax_error_count["m1_" + iRow] || "on" == ajax_error_count["m2_" + iRow] || "on" == ajax_error_count["f1_" + iRow] || "on" == ajax_error_count["f2_" + iRow] || "on" == ajax_error_count["unit_" + iRow] || "on" == ajax_error_count["lastupdated_" + iRow]))
    {
      ...
      $("#hidden_field_data_detailname_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_oper_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_m1_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_m2_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_f1_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_f2_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_unit_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_lastupdated_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["detailname_" + iRow] && "off" == ajax_error_count["oper_" + iRow] && "off" == ajax_error_count["m1_" + iRow] && "off" == ajax_error_count["m2_" + iRow] && "off" == ajax_error_count["f1_" + iRow] && "off" == ajax_error_count["f2_" + iRow] && "off" == ajax_error_count["unit_" + iRow] && "off" == ajax_error_count["lastupdated_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["detailname_" + iRow] = "off";
        ajax_error_count["oper_" + iRow] = "off";
        ajax_error_count["m1_" + iRow] = "off";
        ajax_error_count["m2_" + iRow] = "off";
        ajax_error_count["f1_" + iRow] = "off";
        ajax_error_count["f2_" + iRow] = "off";
        ajax_error_count["unit_" + iRow] = "off";
        ajax_error_count["lastupdated_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_detailname_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_oper_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_m1_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_m2_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_f1_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_f2_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_unit_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_lastupdated_" + iRow).removeClass("scFormErrorLine");
    }
  }
