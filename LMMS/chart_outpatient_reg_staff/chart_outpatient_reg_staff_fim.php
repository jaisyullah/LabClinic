...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LMMS_____chart_outpatient_reg_staff"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LMMS_____chart_outpatient_reg_staff"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_outpatient_reg_staff']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_outpatient_reg_staff']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_outpatient_reg_staff']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_outpatient_reg_staff']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_outpatient_reg_staff']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_outpatient_reg_staff</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_outpatient_reg_staff']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_outpatient_reg_staff']['embutida_filho'] as $ind => $sc_init)
          {
