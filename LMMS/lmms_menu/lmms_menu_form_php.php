...
class lmms_menu_form_php
{
   ...
   function init()
   {
      ...
      if(!isset($_SESSION['scriptcase']['lmms_menu']['glo_nm_path_prod']) || empty($_SESSION['scriptcase']['lmms_menu']['glo_nm_path_prod']))
      {
              /*check prod*/$_SESSION['scriptcase']['lmms_menu']['glo_nm_path_prod'] = $str_path_apl_url . "_lib/prod";
      }
...
<?php
      ...
      if (isset($_GET['sc_apl_menu']))
      {
          ...
          $_SESSION['scriptcase']['sc_apl_menu_link'] = $_SESSION['scriptcase']['lmms_menu']['sc_apl_link'];
...
if (!isset($this->sc_temp_logged_user)) {$this->sc_temp_logged_user = (isset($_SESSION['logged_user'])) ? $_SESSION['logged_user'] : "";}
  if($this->sc_script_name == 'lmms_Login'){
...
if ($this->Db)
{
    $this->Db->Close(); 
      ...
      {
         foreach($_SESSION['scriptcase']['sc_def_menu']['lmms_menu'] as $id_item => $arr_item)
         {
      ...
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("lmms_grid_sec_users") . "/?nm_run_menu=1&nm_apl_menu=lmms_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_3")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("lmms_grid_sec_apps") . "/?nm_run_menu=1&nm_apl_menu=lmms_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_4")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("lmms_grid_sec_groups") . "/?nm_run_menu=1&nm_apl_menu=lmms_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_11")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("lmms_grid_sec_users_groups") . "/?nm_run_menu=1&nm_apl_menu=lmms_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_5")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("lmms_search_sec_groups") . "/?nm_run_menu=1&nm_apl_menu=lmms_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_6")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("lmms_sync_apps") . "/?nm_run_menu=1&nm_apl_menu=lmms_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_9")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("lmms_logged_users") . "/?nm_run_menu=1&nm_apl_menu=lmms_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_7")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("lmms_change_pswd") . "/?nm_run_menu=1&nm_apl_menu=lmms_menu&script_case_init=" . $this->Gera_sc_init($this->sc_menu_item) . "";
      }
      if ($_SESSION['scriptcase']['sc_item_menu'] == "item_8")
      {
          $apl_run = $_SESSION['scriptcase']['sc_apl_menu_link'] . $this->tab_grupo[0] . SC_dir_app_name("lmms_Login") . "/?script_case_init=" . $_SESSION['sc_session'][1]['lmms_menu']['init'] . "";
      }
      }
      if (!$link_url)
      {
...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 3.2 Final//EN">
      ...
      <html><body>
        <form name="fmenu" method="post" action="<?php echo NM_encode_input($apl_run); ?>">
          ...
          <input type=hidden name="nm_apl_menu" value="lmms_menu"> 
<?php
      if (isset($_SESSION['scriptcase']['menu_mobile']) && $_SESSION['scriptcase']['menu_mobile'] == "lmms_menu")
      {
?>
...
<?php
      ...
      {
?>
          window.history.pushState('Object', 'lmms_menu', '<?php echo $this->nm_location ?>');
<?php
      }
      if ($link_url)
      {
...
$controle = new lmms_menu_form_php();
$controle->init();
?>
