<?php
@session_start() ;
$_SESSION['scriptcase']['grid_slider']['sc_process_barr'] = true;
require_once('../grid_slider/index.php');
unset($_SESSION['scriptcase']['grid_slider']['sc_process_barr']);
$ExportCtrl = new grid_slider_export_control;
$ExportCtrl->Export_barr();

class grid_slider_export_control
{
