...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "ordernum";$Nm_numeric[] = "active";$Nm_numeric[] = "id";$Nm_numeric[] = "ordernum";$Nm_numeric[] = "active";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_picture_cond" name="picture_cond" onChange="nm_campos_between(document.getElementById('id_vis_picture'), this, 'picture')">
