...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "birthDate";$Nm_datas[] = "birthDate";$Nm_datas[] = "regDate";$Nm_datas[] = "regDate";$Nm_numeric[] = "id";$Nm_numeric[] = "cityid";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_address_cond" name="address_cond" onChange="nm_campos_between(document.getElementById('id_vis_address'), this, 'address')">
      ...
      <br><span id="id_hide_address"  <?php echo $str_hide_address?>><INPUT  type="text" id="SC_address" name="address" value="<?php echo NM_encode_input($address) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_patientcode_cond" name="patientcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_patientcode'), this, 'patientcode')">
      ...
      <br><span id="id_hide_patientcode"  <?php echo $str_hide_patientcode?>><?php
      if ($patientcode != "")
      {
      $patientcode_look = substr($this->Db->qstr($patientcode), 1, -1); 
      $nmgp_def_dados = array(); 
