<?php
@session_start() ;
$_SESSION['scriptcase']['grid_normal_laboratory']['sc_process_barr'] = true;
require_once('../grid_normal_laboratory/index.php');
unset($_SESSION['scriptcase']['grid_normal_laboratory']['sc_process_barr']);
$ExportCtrl = new grid_normal_laboratory_export_control;
$ExportCtrl->Export_barr();

class grid_normal_laboratory_export_control
{
