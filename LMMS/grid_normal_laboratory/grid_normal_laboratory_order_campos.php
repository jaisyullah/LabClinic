...
<?php
   ...
   $Ord_Cmp = new grid_normal_laboratory_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_normal_laboratory_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['ordem_select_orig'] = array();
   }
   ...
   $tab_def_campos['labcode'] = "labcode";
   $tab_labels["labcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['labels']["labcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['labels']["labcode"] : "Lab Code";
   $tab_ger_campos['category'] = "on";
   $tab_def_campos['category'] = "category";
   $tab_labels["category"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['labels']["category"])) ? $_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['labels']["category"] : "Category";
   $tab_ger_campos['name'] = "on";
   $tab_def_campos['name'] = "name";
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['labels']["name"] : "Name";
   $tab_ger_campos['rate'] = "on";
   $tab_def_campos['rate'] = "rate";
   $tab_labels["rate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['labels']["rate"])) ? $_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['labels']["rate"] : "Rate";
   $tab_ger_campos['resulttype'] = "on";
   $tab_def_campos['resulttype'] = "resulttype";
   $tab_labels["resulttype"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['labels']["resulttype"])) ? $_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['labels']["resulttype"] : "Result Type";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_normal_laboratory_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_normal_laboratory']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
