...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LMMS_____grid_normal_laboratory"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LMMS_____grid_normal_laboratory"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_normal_laboratory'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_normal_laboratory']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_normal_laboratory']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_normal_laboratory']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_normal_laboratory']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_normal_laboratory']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_normal_laboratory</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_normal_laboratory']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_normal_laboratory']['embutida_filho'] as $ind => $sc_init)
          {
