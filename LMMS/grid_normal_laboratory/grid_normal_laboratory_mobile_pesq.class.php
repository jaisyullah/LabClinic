...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "lastupdated";$Nm_datas[] = "lastupdated";$Nm_numeric[] = "id";$Nm_numeric[] = "rate";$Nm_numeric[] = "resulttype";$Nm_numeric[] = "sub";$Nm_numeric[] = "deleted";$Nm_numeric[] = "`order`";$Nm_numeric[] = "ordersub";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_name_cond" name="name_cond" onChange="nm_campos_between(document.getElementById('id_vis_name'), this, 'name')">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_labcode_cond" name="labcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_labcode'), this, 'labcode')">
      ...
      <br><span id="id_hide_labcode"  <?php echo $str_hide_labcode?>><?php
      if ($labcode != "")
      {
      $labcode_look = substr($this->Db->qstr($labcode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_category_cond" name="category_cond" onChange="nm_campos_between(document.getElementById('id_vis_category'), this, 'category')">
      ...
      <br><span id="id_hide_category"  <?php echo $str_hide_category?>><?php
      if ($category != "")
      {
      $category_look = substr($this->Db->qstr($category), 1, -1); 
      $nmgp_def_dados = array(); 
