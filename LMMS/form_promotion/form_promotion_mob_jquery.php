...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_effectivedate_hora' + iSeqRow).bind('blur', function() { sc_form_promotion_effectivedate_onblur(this, iSeqRow) })
                                                .bind('focus', function() { sc_form_promotion_effectivedate_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_expiredate_hora' + iSeqRow).bind('blur', function() { sc_form_promotion_expiredate_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_promotion_expiredate_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_promotion_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_effectivedate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_promotion_mob_validate_effectivedate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_expiredate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_promotion_mob_validate_expiredate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_picture" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_promotion_mob_ul_save.php",
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_promotion_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
