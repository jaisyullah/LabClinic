  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_promotion" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate id
  function do_ajax_form_promotion_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_promotion_validate_id(var_id, var_script_case_init, do_ajax_form_promotion_validate_id_cb);
  } // do_ajax_form_promotion_validate_id

  function do_ajax_form_promotion_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_promotion_validate_id_cb

  // ---------- Validate name
  function do_ajax_form_promotion_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_promotion_validate_name(var_name, var_script_case_init, do_ajax_form_promotion_validate_name_cb);
  } // do_ajax_form_promotion_validate_name

  function do_ajax_form_promotion_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_promotion_validate_name_cb

  // ---------- Validate effectivedate
  function do_ajax_form_promotion_validate_effectivedate()
  {
    var nomeCampo_effectivedate = "effectivedate";
    var var_effectivedate = scAjaxGetFieldText(nomeCampo_effectivedate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_promotion_validate_effectivedate(var_effectivedate, var_script_case_init, do_ajax_form_promotion_validate_effectivedate_cb);
  } // do_ajax_form_promotion_validate_effectivedate

  function do_ajax_form_promotion_validate_effectivedate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_promotion_validate_effectivedate_cb

  // ---------- Validate expiredate
  function do_ajax_form_promotion_validate_expiredate()
  {
    var nomeCampo_expiredate = "expiredate";
    var var_expiredate = scAjaxGetFieldText(nomeCampo_expiredate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_promotion_validate_expiredate(var_expiredate, var_script_case_init, do_ajax_form_promotion_validate_expiredate_cb);
  } // do_ajax_form_promotion_validate_expiredate

  function do_ajax_form_promotion_validate_expiredate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_promotion_validate_expiredate_cb

  // ---------- Validate description
  function do_ajax_form_promotion_validate_description()
  {
    var nomeCampo_description = "description";
    var var_description = scAjaxGetFieldEditorHtml(nomeCampo_description);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_promotion_validate_description(var_description, var_script_case_init, do_ajax_form_promotion_validate_description_cb);
  } // do_ajax_form_promotion_validate_description

  function do_ajax_form_promotion_validate_description_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_promotion_validate_description_cb

  // ---------- Validate picture
  function do_ajax_form_promotion_validate_picture()
  {
    var nomeCampo_picture = "picture";
    var var_picture = scAjaxGetFieldText(nomeCampo_picture);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_promotion_validate_picture(var_picture, var_script_case_init, do_ajax_form_promotion_validate_picture_cb);
  } // do_ajax_form_promotion_validate_picture

  function do_ajax_form_promotion_validate_picture_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "picture";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_promotion_validate_picture_cb

  // ---------- Validate active
  function do_ajax_form_promotion_validate_active()
  {
    var nomeCampo_active = "active";
    var var_active = scAjaxGetFieldCheckbox(nomeCampo_active, ";");
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_promotion_validate_active(var_active, var_script_case_init, do_ajax_form_promotion_validate_active_cb);
  } // do_ajax_form_promotion_validate_active

  function do_ajax_form_promotion_validate_active_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "active";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_promotion_validate_active_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_promotion_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_promotion_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_promotion_submit_form(var_id, var_name, var_effectivedate, var_expiredate, var_description, var_picture, var_active, var_picture_ul_name, var_picture_ul_type, var_picture_salva, var_picture_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_promotion_submit_form_cb);
  } // do_ajax_form_promotion_submit_form

  function do_ajax_form_promotion_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_promotion_submit_form_cb_after_alert);
  } // do_ajax_form_promotion_submit_form_cb
  function do_ajax_form_promotion_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_promotion_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_promotion_navigate_form()
  {
    perform_ajax_form_promotion_navigate_form();
  }

  function perform_ajax_form_promotion_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_promotion_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_promotion_navigate_form_cb);
  } // do_ajax_form_promotion_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_promotion']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_promotion_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_promotion_navigate_form_cb_after_alert);
  } // do_ajax_form_promotion_navigate_form_cb
  function do_ajax_form_promotion_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_promotion_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_promotion_navigate_form_cb_after_alert
  function sc_hide_form_promotion_form()
  {
