...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LMMS_____chart_patient_demographic"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LMMS_____chart_patient_demographic"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_patient_demographic']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['chart_patient_demographic']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['chart_patient_demographic']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['chart_patient_demographic']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['chart_patient_demographic']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>chart_patient_demographic</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['chart_patient_demographic']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['chart_patient_demographic']['embutida_filho'] as $ind => $sc_init)
          {
