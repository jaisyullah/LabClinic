<?php
@session_start() ;
$_SESSION['scriptcase']['chart_patient_demographic']['sc_process_barr'] = true;
require_once('../chart_patient_demographic/index.php');
unset($_SESSION['scriptcase']['chart_patient_demographic']['sc_process_barr']);
$ExportCtrl = new chart_patient_demographic_export_control;
$ExportCtrl->Export_barr();

class chart_patient_demographic_export_control
{
