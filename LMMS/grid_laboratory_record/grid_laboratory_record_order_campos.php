...
<?php
   ...
   $Ord_Cmp = new grid_laboratory_record_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_laboratory_record_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trandate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['labels']["trandate"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['labels']["trandate"] : "Transaction Date";
   $tab_ger_campos['confirmdate'] = "on";
   $tab_def_campos['confirmdate'] = "confirmDate";
   $tab_labels["confirmdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['labels']["confirmdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['labels']["confirmdate"] : "Confirm Date";
   $tab_ger_campos['finishdate'] = "on";
   $tab_def_campos['finishdate'] = "finishDate";
   $tab_labels["finishdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['labels']["finishdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['labels']["finishdate"] : "Finish Date";
   $tab_ger_campos['trancode'] = "on";
   $tab_def_campos['trancode'] = "tranCode";
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['labels']["trancode"] : "Transaction Code";
   $tab_ger_campos['regcode'] = "on";
   $tab_def_campos['regcode'] = "regCode";
   $tab_labels["regcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['labels']["regcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['labels']["regcode"] : "Reg Code";
   $tab_ger_campos['icdid'] = "on";
   $tab_def_campos['icdid'] = "icdID";
   $tab_labels["icdid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['labels']["icdid"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['labels']["icdid"] : "ICD-10";
   $tab_ger_campos['detail'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['detail'] = "Detail";
   }
   else
   {
       $tab_def_campos['detail'] = "";
   }
   $tab_labels["detail"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['labels']["detail"])) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['labels']["detail"] : "Detail";
   $tab_ger_campos['detail'] = "none";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_laboratory_record_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_laboratory_record']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
