  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_result_laboratory_detail" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_result_laboratory_detail_form();
	}
  ...
  // ---------- Validate id_
  function do_ajax_form_result_laboratory_detail_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_detail_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_result_laboratory_detail_validate_id__cb);
  } // do_ajax_form_result_laboratory_detail_validate_id_

  function do_ajax_form_result_laboratory_detail_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_result_laboratory_detail_validate_id__cb

  // ---------- Validate parameter_
  function do_ajax_form_result_laboratory_detail_validate_parameter_(iNumLinha)
  {
    var nomeCampo_parameter_ = "parameter_" + iNumLinha;
    var var_parameter_ = scAjaxGetFieldText(nomeCampo_parameter_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_detail_validate_parameter_(var_parameter_, iNumLinha, var_script_case_init, do_ajax_form_result_laboratory_detail_validate_parameter__cb);
  } // do_ajax_form_result_laboratory_detail_validate_parameter_

  function do_ajax_form_result_laboratory_detail_validate_parameter__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "parameter_" + iLineNumber;
    }
    else
    {
      sFieldValid = "parameter_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "parameter_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "parameter_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_result_laboratory_detail_validate_parameter__cb

  // ---------- Validate subparameter_
  function do_ajax_form_result_laboratory_detail_validate_subparameter_(iNumLinha)
  {
    var nomeCampo_subparameter_ = "subparameter_" + iNumLinha;
    var var_subparameter_ = scAjaxGetFieldText(nomeCampo_subparameter_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_detail_validate_subparameter_(var_subparameter_, iNumLinha, var_script_case_init, do_ajax_form_result_laboratory_detail_validate_subparameter__cb);
  } // do_ajax_form_result_laboratory_detail_validate_subparameter_

  function do_ajax_form_result_laboratory_detail_validate_subparameter__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "subparameter_" + iLineNumber;
    }
    else
    {
      sFieldValid = "subparameter_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "subparameter_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "subparameter_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_result_laboratory_detail_validate_subparameter__cb

  // ---------- Validate result_
  function do_ajax_form_result_laboratory_detail_validate_result_(iNumLinha)
  {
    var nomeCampo_result_ = "result_" + iNumLinha;
    var var_result_ = scAjaxGetFieldText(nomeCampo_result_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_detail_validate_result_(var_result_, iNumLinha, var_script_case_init, do_ajax_form_result_laboratory_detail_validate_result__cb);
  } // do_ajax_form_result_laboratory_detail_validate_result_

  function do_ajax_form_result_laboratory_detail_validate_result__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "result_" + iLineNumber;
    }
    else
    {
      sFieldValid = "result_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "result_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "result_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_result_laboratory_detail_validate_result__cb

  // ---------- Validate marked_
  function do_ajax_form_result_laboratory_detail_validate_marked_(iNumLinha)
  {
    var nomeCampo_marked_ = "marked_" + iNumLinha;
    var var_marked_ = scAjaxGetFieldSelect(nomeCampo_marked_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_detail_validate_marked_(var_marked_, iNumLinha, var_script_case_init, do_ajax_form_result_laboratory_detail_validate_marked__cb);
  } // do_ajax_form_result_laboratory_detail_validate_marked_

  function do_ajax_form_result_laboratory_detail_validate_marked__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "marked_" + iLineNumber;
    }
    else
    {
      sFieldValid = "marked_";
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "marked_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "marked_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_result_laboratory_detail_validate_marked__cb

  // ---------- Validate standardvalue_
  function do_ajax_form_result_laboratory_detail_validate_standardvalue_(iNumLinha)
  {
    var nomeCampo_standardvalue_ = "standardvalue_" + iNumLinha;
    var var_standardvalue_ = scAjaxGetFieldText(nomeCampo_standardvalue_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_detail_validate_standardvalue_(var_standardvalue_, iNumLinha, var_script_case_init, do_ajax_form_result_laboratory_detail_validate_standardvalue__cb);
  } // do_ajax_form_result_laboratory_detail_validate_standardvalue_

  function do_ajax_form_result_laboratory_detail_validate_standardvalue__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "standardvalue_" + iLineNumber;
    }
    else
    {
      sFieldValid = "standardvalue_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "standardvalue_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "standardvalue_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_result_laboratory_detail_validate_standardvalue__cb

  // ---------- Validate unit_
  function do_ajax_form_result_laboratory_detail_validate_unit_(iNumLinha)
  {
    var nomeCampo_unit_ = "unit_" + iNumLinha;
    var var_unit_ = scAjaxGetFieldText(nomeCampo_unit_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_detail_validate_unit_(var_unit_, iNumLinha, var_script_case_init, do_ajax_form_result_laboratory_detail_validate_unit__cb);
  } // do_ajax_form_result_laboratory_detail_validate_unit_

  function do_ajax_form_result_laboratory_detail_validate_unit__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "unit_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "unit_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_result_laboratory_detail_validate_unit__cb

  // ---------- Validate trandate_
  function do_ajax_form_result_laboratory_detail_validate_trandate_(iNumLinha)
  {
    var nomeCampo_trandate_ = "trandate_" + iNumLinha;
    var var_trandate_ = scAjaxGetFieldText(nomeCampo_trandate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_detail_validate_trandate_(var_trandate_, iNumLinha, var_script_case_init, do_ajax_form_result_laboratory_detail_validate_trandate__cb);
  } // do_ajax_form_result_laboratory_detail_validate_trandate_

  function do_ajax_form_result_laboratory_detail_validate_trandate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "trandate_" + iLineNumber;
    }
    else
    {
      sFieldValid = "trandate_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "trandate_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "trandate_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_result_laboratory_detail_validate_trandate__cb

  // ---------- Validate staffid_
  function do_ajax_form_result_laboratory_detail_validate_staffid_(iNumLinha)
  {
    var nomeCampo_staffid_ = "staffid_" + iNumLinha;
    var var_staffid_ = scAjaxGetFieldSelect(nomeCampo_staffid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_detail_validate_staffid_(var_staffid_, iNumLinha, var_script_case_init, do_ajax_form_result_laboratory_detail_validate_staffid__cb);
  } // do_ajax_form_result_laboratory_detail_validate_staffid_

  function do_ajax_form_result_laboratory_detail_validate_staffid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    if ("" != iLineNumber)
    {
      sFieldValid = "staffid_" + iLineNumber;
    }
    else
    {
      sFieldValid = "staffid_";
    }
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    {
      var sImgStatus = sc_img_status_ok;
      scAjaxHideErrorDisplay(sFieldValid);
      scErrorLineOff(iLineNumber, "staffid_");
    }
    else
    {
      var sImgStatus = sc_img_status_err;
      scAjaxShowErrorDisplay(sFieldValid, sFieldErrors);
      scErrorLineOn(iLineNumber, "staffid_");
    }
    var $oImg = $('#id_sc_status_' + sFieldValid);
    if (0 < $oImg.length)
    {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_result_laboratory_detail_validate_staffid__cb

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_result_laboratory_detail_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_result_laboratory_detail_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_result_laboratory_detail_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_result_laboratory_detail_add_new_line_cb);
  } // do_ajax_form_result_laboratory_detail_add_new_line

  function do_ajax_form_result_laboratory_detail_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
    ...
    nm_field_disabled("marked_=disabled", "", iAjaxNewLine);
  } // do_ajax_form_result_laboratory_detail_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_result_laboratory_detail_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_result_laboratory_detail_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_result_laboratory_detail_backup_line_cb);
  } // do_ajax_form_result_laboratory_detail_backup_line

  function do_ajax_form_result_laboratory_detail_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_result_laboratory_detail_backup_line_cb

  function do_ajax_form_result_laboratory_detail_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_result_laboratory_detail_cancel_insert

  function do_ajax_form_result_laboratory_detail_cancel_update(iSeqVert)
  {
    do_ajax_form_result_laboratory_detail_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_result_laboratory_detail_cancel_update

  function do_ajax_form_result_laboratory_detail_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_result_laboratory_detail_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_result_laboratory_detail_table_refresh()
  {
    ...
    scAjaxProcOn();
    x_ajax_form_result_laboratory_detail_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_result_laboratory_detail_table_refresh_cb);
  } //  do_ajax_form_result_laboratory_detail_table_refresh

  function do_ajax_form_result_laboratory_detail_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_result_laboratory_detail_table_refresh_cb_after_alert);
  } // do_ajax_form_result_laboratory_detail_table_refresh_cb
  function do_ajax_form_result_laboratory_detail_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_result_laboratory_detail_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_result_laboratory_detail_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_result_laboratory_detail_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
    ...
    scAjaxHideMessage();
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_parameter_ = scAjaxGetFieldText("parameter_" + iNumLinha);
    var var_subparameter_ = scAjaxGetFieldText("subparameter_" + iNumLinha);
    var var_result_ = scAjaxGetFieldText("result_" + iNumLinha);
    var var_marked_ = scAjaxGetFieldSelect("marked_" + iNumLinha);
    var var_standardvalue_ = scAjaxGetFieldText("standardvalue_" + iNumLinha);
    var var_unit_ = scAjaxGetFieldText("unit_" + iNumLinha);
    var var_trandate_ = scAjaxGetFieldText("trandate_" + iNumLinha);
    var var_staffid_ = scAjaxGetFieldSelect("staffid_" + iNumLinha);
    var var_nm_form_submit = document.F1.nm_form_submit.value;
...
?>
    x_ajax_form_result_laboratory_detail_submit_form(var_id_, var_parameter_, var_subparameter_, var_result_, var_marked_, var_standardvalue_, var_unit_, var_trandate_, var_staffid_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_result_laboratory_detail_submit_form_cb);
  } // do_ajax_form_result_laboratory_detail_submit_form

  function do_ajax_form_result_laboratory_detail_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
      ...
      scAjaxHideErrorDisplay("parameter_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("subparameter_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("result_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("marked_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("standardvalue_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("unit_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("trandate_" + sc_num_ult_line);
      scAjaxHideErrorDisplay("staffid_" + sc_num_ult_line);
<?php
if (isset($this->Embutida_form) && $this->Embutida_form) {
?>
      scAjaxSetReadonly();
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_result_laboratory_detail_submit_form_cb_after_alert);
  } // do_ajax_form_result_laboratory_detail_submit_form_cb
  function do_ajax_form_result_laboratory_detail_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_result_laboratory_detail_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_result_laboratory_detail_navigate_form()
  {
    perform_ajax_form_result_laboratory_detail_navigate_form();
  }

  function perform_ajax_form_result_laboratory_detail_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_result_laboratory_detail_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    for (iNavForm = 1; iNavForm < <?php echo $this->sc_max_reg; ?> + 1; iNavForm++)
    {
      ...
      scAjaxHideErrorDisplay("parameter_" + iNavForm);
      scAjaxHideErrorDisplay("subparameter_" + iNavForm);
      scAjaxHideErrorDisplay("result_" + iNavForm);
      scAjaxHideErrorDisplay("marked_" + iNavForm);
      scAjaxHideErrorDisplay("standardvalue_" + iNavForm);
      scAjaxHideErrorDisplay("unit_" + iNavForm);
      scAjaxHideErrorDisplay("trandate_" + iNavForm);
      scAjaxHideErrorDisplay("staffid_" + iNavForm);
    }
    var var_id_ = document.F2.id_.value;
    var var_nm_form_submit = document.F2.nm_form_submit.value;
    var var_nmgp_opcao = document.F2.nmgp_opcao.value;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_result_laboratory_detail_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_result_laboratory_detail_navigate_form_cb);
  } // do_ajax_form_result_laboratory_detail_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_result_laboratory_detail']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_result_laboratory_detail_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_result_laboratory_detail_navigate_form_cb_after_alert);
  } // do_ajax_form_result_laboratory_detail_navigate_form_cb
  function do_ajax_form_result_laboratory_detail_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_result_laboratory_detail_navigate_form_cb_after_alert
  function sc_hide_form_result_laboratory_detail_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    iTotCampos++;
    ajax_field_list[iTotCampos] = "parameter_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "subparameter_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "result_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "marked_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "standardvalue_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "unit_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "trandate_" + iNumLinha;
    iTotCampos++;
    ajax_field_list[iTotCampos] = "staffid_" + iNumLinha;
    iTotCampos++;
    ...
    ajax_error_list["parameter_" + iNumLinha] = {"label": "Parameter<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["subparameter_" + iNumLinha] = {"label": "Sub Parameter<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["result_" + iNumLinha] = {"label": "Result<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["marked_" + iNumLinha] = {"label": "Marked<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["standardvalue_" + iNumLinha] = {"label": "Ref Range<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["unit_" + iNumLinha] = {"label": "Unit<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["trandate_" + iNumLinha] = {"label": "Transaction Date<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_error_list["staffid_" + iNumLinha] = {"label": "Staff Update<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
    ajax_field_mult["id_"][iNumLinha] = "id_" + iNumLinha;
    ajax_field_mult["parameter_"][iNumLinha] = "parameter_" + iNumLinha;
    ajax_field_mult["subparameter_"][iNumLinha] = "subparameter_" + iNumLinha;
    ajax_field_mult["result_"][iNumLinha] = "result_" + iNumLinha;
    ajax_field_mult["marked_"][iNumLinha] = "marked_" + iNumLinha;
    ajax_field_mult["standardvalue_"][iNumLinha] = "standardvalue_" + iNumLinha;
    ajax_field_mult["unit_"][iNumLinha] = "unit_" + iNumLinha;
    ajax_field_mult["trandate_"][iNumLinha] = "trandate_" + iNumLinha;
    ajax_field_mult["staffid_"][iNumLinha] = "staffid_" + iNumLinha;
    ajax_field_id["parameter_" + iNumLinha] = new Array("hidden_field_label_parameter_", "hidden_field_data_parameter_" + iNumLinha);
    ajax_field_id["subparameter_" + iNumLinha] = new Array("hidden_field_label_subparameter_", "hidden_field_data_subparameter_" + iNumLinha);
    ajax_field_id["result_" + iNumLinha] = new Array("hidden_field_label_result_", "hidden_field_data_result_" + iNumLinha);
    ajax_field_id["marked_" + iNumLinha] = new Array("hidden_field_label_marked_", "hidden_field_data_marked_" + iNumLinha);
    ajax_field_id["standardvalue_" + iNumLinha] = new Array("hidden_field_label_standardvalue_", "hidden_field_data_standardvalue_" + iNumLinha);
    ajax_field_id["unit_" + iNumLinha] = new Array("hidden_field_label_unit_", "hidden_field_data_unit_" + iNumLinha);
    ajax_field_id["trandate_" + iNumLinha] = new Array("hidden_field_label_trandate_", "hidden_field_data_trandate_" + iNumLinha);
    ajax_field_id["staffid_" + iNumLinha] = new Array("hidden_field_label_staffid_", "hidden_field_data_staffid_" + iNumLinha);
    ajax_error_count["id_" + iNumLinha] = "off";
    ajax_error_count["parameter_" + iNumLinha] = "off";
    ajax_error_count["subparameter_" + iNumLinha] = "off";
    ajax_error_count["result_" + iNumLinha] = "off";
    ajax_error_count["marked_" + iNumLinha] = "off";
    ajax_error_count["standardvalue_" + iNumLinha] = "off";
    ajax_error_count["unit_" + iNumLinha] = "off";
    ajax_error_count["trandate_" + iNumLinha] = "off";
    ajax_error_count["staffid_" + iNumLinha] = "off";
<?php
if (!$this->Grid_editavel)
{
?>
    ajax_read_only["id_" + iNumLinha] = "on";
    ajax_read_only["parameter_" + iNumLinha] = "on";
    ajax_read_only["subparameter_" + iNumLinha] = "on";
    ajax_read_only["result_" + iNumLinha] = "off";
    ajax_read_only["marked_" + iNumLinha] = "on";
    ajax_read_only["standardvalue_" + iNumLinha] = "on";
    ajax_read_only["unit_" + iNumLinha] = "on";
    ajax_read_only["trandate_" + iNumLinha] = "off";
    ajax_read_only["staffid_" + iNumLinha] = "off";
<?php
}
else
{
?>
    ...
    ajax_read_only["parameter_" + iNumLinha] = "on";
    ajax_read_only["subparameter_" + iNumLinha] = "on";
    ajax_read_only["result_" + iNumLinha] = "on";
    ajax_read_only["marked_" + iNumLinha] = "on";
    ajax_read_only["standardvalue_" + iNumLinha] = "on";
    ajax_read_only["unit_" + iNumLinha] = "on";
    ajax_read_only["trandate_" + iNumLinha] = "on";
    ajax_read_only["staffid_" + iNumLinha] = "on";
<?php
}
?>
  }
  function ajax_destroy_tables(iNumLinha)
  {
    ...
    ajax_error_list["parameter_" + iNumLinha] = null;
    ajax_error_list["subparameter_" + iNumLinha] = null;
    ajax_error_list["result_" + iNumLinha] = null;
    ajax_error_list["marked_" + iNumLinha] = null;
    ajax_error_list["standardvalue_" + iNumLinha] = null;
    ajax_error_list["unit_" + iNumLinha] = null;
    ajax_error_list["trandate_" + iNumLinha] = null;
    ajax_error_list["staffid_" + iNumLinha] = null;
  }
  ...
  var ajax_field_mult = {
    "id_": new Array(),
    "parameter_": new Array(),
    "subparameter_": new Array(),
    "result_": new Array(),
    "marked_": new Array(),
    "standardvalue_": new Array(),
    "unit_": new Array(),
    "trandate_": new Array(),
    "staffid_": new Array()
  };
  ...
  function scRemoveErrors()
  {
    for (iNumLinha = 1; iNumLinha < Lim_linhas; iNumLinha++)
    {
      ...
      ajax_error_list["parameter_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["parameter_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["parameter_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["parameter_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["parameter_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["subparameter_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["subparameter_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["subparameter_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["subparameter_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["subparameter_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["result_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["result_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["result_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["result_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["result_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["marked_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["marked_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["marked_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["marked_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["marked_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["standardvalue_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["standardvalue_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["standardvalue_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["standardvalue_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["standardvalue_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["unit_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["unit_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["unit_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["unit_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["unit_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["trandate_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["trandate_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["trandate_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["trandate_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["trandate_" + iNumLinha]["onfocus"] = new Array();
      ajax_error_list["staffid_" + iNumLinha]["valid"] = new Array();
      ajax_error_list["staffid_" + iNumLinha]["onblur"] = new Array();
      ajax_error_list["staffid_" + iNumLinha]["onchange"] = new Array();
      ajax_error_list["staffid_" + iNumLinha]["onclick"] = new Array();
      ajax_error_list["staffid_" + iNumLinha]["onfocus"] = new Array();
    }
  }
...
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['parameter_'])) ? $this->nmgp_cmp_readonly['parameter_'] : 'on';
?>
    scAjaxFieldRead("parameter_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['subparameter_'])) ? $this->nmgp_cmp_readonly['subparameter_'] : 'on';
?>
    scAjaxFieldRead("subparameter_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['result_'])) ? $this->nmgp_cmp_readonly['result_'] : 'off';
?>
    scAjaxFieldRead("result_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['marked_'])) ? $this->nmgp_cmp_readonly['marked_'] : 'on';
?>
    scAjaxFieldRead("marked_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['standardvalue_'])) ? $this->nmgp_cmp_readonly['standardvalue_'] : 'on';
?>
    scAjaxFieldRead("standardvalue_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['unit_'])) ? $this->nmgp_cmp_readonly['unit_'] : 'on';
?>
    scAjaxFieldRead("unit_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['trandate_'])) ? $this->nmgp_cmp_readonly['trandate_'] : 'off';
?>
    scAjaxFieldRead("trandate_" + iSeq, "<?php echo $NM_contr_readonly ?>");
<?php
  $NM_contr_readonly = (isset($this->nmgp_cmp_readonly['staffid_'])) ? $this->nmgp_cmp_readonly['staffid_'] : 'off';
?>
    scAjaxFieldRead("staffid_" + iSeq, "<?php echo $NM_contr_readonly ?>");
  }

  function mdCloseObjects(iSeq)
  {
    scAjaxFieldRead("id_" + iSeq, "on");
    scAjaxFieldRead("parameter_" + iSeq, "on");
    scAjaxFieldRead("subparameter_" + iSeq, "on");
    scAjaxFieldRead("result_" + iSeq, "on");
    scAjaxFieldRead("marked_" + iSeq, "on");
    scAjaxFieldRead("standardvalue_" + iSeq, "on");
    scAjaxFieldRead("unit_" + iSeq, "on");
    scAjaxFieldRead("trandate_" + iSeq, "on");
    scAjaxFieldRead("staffid_" + iSeq, "on");
    rerunHeaderDisplay = 1;
    scSetFixedHeaders(true);
  }
...
?>
  ...
  function scErrorLineOn(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("on" == ajax_error_count["id_" + iRow] || "on" == ajax_error_count["parameter_" + iRow] || "on" == ajax_error_count["subparameter_" + iRow] || "on" == ajax_error_count["result_" + iRow] || "on" == ajax_error_count["marked_" + iRow] || "on" == ajax_error_count["standardvalue_" + iRow] || "on" == ajax_error_count["unit_" + iRow] || "on" == ajax_error_count["trandate_" + iRow] || "on" == ajax_error_count["staffid_" + iRow]))
    {
      ...
      $("#hidden_field_data_parameter_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_subparameter_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_result_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_marked_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_standardvalue_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_unit_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_trandate_" + iRow).addClass("scFormErrorLine");
      $("#hidden_field_data_staffid_" + iRow).addClass("scFormErrorLine");
    }
  }
  ...
  function scErrorLineOff(iRow, sIdError)
  {
    ...
    if (bErrorRow || ("off" == ajax_error_count["id_" + iRow] && "off" == ajax_error_count["parameter_" + iRow] && "off" == ajax_error_count["subparameter_" + iRow] && "off" == ajax_error_count["result_" + iRow] && "off" == ajax_error_count["marked_" + iRow] && "off" == ajax_error_count["standardvalue_" + iRow] && "off" == ajax_error_count["unit_" + iRow] && "off" == ajax_error_count["trandate_" + iRow] && "off" == ajax_error_count["staffid_" + iRow]))
    {
      if (bErrorRow)
      {
        ajax_error_count["id_" + iRow] = "off";
        ajax_error_count["parameter_" + iRow] = "off";
        ajax_error_count["subparameter_" + iRow] = "off";
        ajax_error_count["result_" + iRow] = "off";
        ajax_error_count["marked_" + iRow] = "off";
        ajax_error_count["standardvalue_" + iRow] = "off";
        ajax_error_count["unit_" + iRow] = "off";
        ajax_error_count["trandate_" + iRow] = "off";
        ajax_error_count["staffid_" + iRow] = "off";
      }
      ...
      $("#hidden_field_data_parameter_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_subparameter_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_result_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_marked_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_standardvalue_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_unit_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_trandate_" + iRow).removeClass("scFormErrorLine");
      $("#hidden_field_data_staffid_" + iRow).removeClass("scFormErrorLine");
    }
  }
