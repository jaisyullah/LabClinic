  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_bill_laboratory_medical" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_bill_laboratory_medical_form();
	}
  ...
  // ---------- Validate id_
  function do_ajax_form_bill_laboratory_medical_validate_id_(iNumLinha)
  {
    var nomeCampo_id_ = "id_" + iNumLinha;
    var var_id_ = scAjaxGetFieldHidden(nomeCampo_id_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bill_laboratory_medical_validate_id_(var_id_, iNumLinha, var_script_case_init, do_ajax_form_bill_laboratory_medical_validate_id__cb);
  } // do_ajax_form_bill_laboratory_medical_validate_id_

  function do_ajax_form_bill_laboratory_medical_validate_id__cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bill_laboratory_medical_validate_id__cb

  // ---------- Validate serviceid_
  function do_ajax_form_bill_laboratory_medical_validate_serviceid_(iNumLinha)
  {
    var nomeCampo_serviceid_ = "serviceid_" + iNumLinha;
    var var_serviceid_ = scAjaxGetFieldSelect(nomeCampo_serviceid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bill_laboratory_medical_validate_serviceid_(var_serviceid_, iNumLinha, var_script_case_init, do_ajax_form_bill_laboratory_medical_validate_serviceid__cb);
  } // do_ajax_form_bill_laboratory_medical_validate_serviceid_

  function do_ajax_form_bill_laboratory_medical_validate_serviceid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bill_laboratory_medical_validate_serviceid__cb

  // ---------- Validate price_
  function do_ajax_form_bill_laboratory_medical_validate_price_(iNumLinha)
  {
    var nomeCampo_price_ = "price_" + iNumLinha;
    var var_price_ = scAjaxGetFieldText(nomeCampo_price_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bill_laboratory_medical_validate_price_(var_price_, iNumLinha, var_script_case_init, do_ajax_form_bill_laboratory_medical_validate_price__cb);
  } // do_ajax_form_bill_laboratory_medical_validate_price_

  function do_ajax_form_bill_laboratory_medical_validate_price__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bill_laboratory_medical_validate_price__cb

  // ---------- Validate trandate_
  function do_ajax_form_bill_laboratory_medical_validate_trandate_(iNumLinha)
  {
    var nomeCampo_trandate_ = "trandate_" + iNumLinha;
    var var_trandate_ = scAjaxGetFieldText(nomeCampo_trandate_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bill_laboratory_medical_validate_trandate_(var_trandate_, iNumLinha, var_script_case_init, do_ajax_form_bill_laboratory_medical_validate_trandate__cb);
  } // do_ajax_form_bill_laboratory_medical_validate_trandate_

  function do_ajax_form_bill_laboratory_medical_validate_trandate__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bill_laboratory_medical_validate_trandate__cb

  // ---------- Validate staffid_
  function do_ajax_form_bill_laboratory_medical_validate_staffid_(iNumLinha)
  {
    var nomeCampo_staffid_ = "staffid_" + iNumLinha;
    var var_staffid_ = scAjaxGetFieldSelect(nomeCampo_staffid_);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bill_laboratory_medical_validate_staffid_(var_staffid_, iNumLinha, var_script_case_init, do_ajax_form_bill_laboratory_medical_validate_staffid__cb);
  } // do_ajax_form_bill_laboratory_medical_validate_staffid_

  function do_ajax_form_bill_laboratory_medical_validate_staffid__cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_bill_laboratory_medical_validate_staffid__cb

  // ---------- Event onchange serviceid_
  function do_ajax_form_bill_laboratory_medical_event_serviceid__onchange(iSeqForm)
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_bill_laboratory_medical_event_serviceid__onchange(var_serviceid_, var_price_, var_script_case_init, var_nmgp_refresh_row, do_ajax_form_bill_laboratory_medical_event_serviceid__onchange_cb);
  } // do_ajax_form_bill_laboratory_medical_event_serviceid__onchange

  function do_ajax_form_bill_laboratory_medical_event_serviceid__onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    iLineNumber = scAjaxGetLineNumber();
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_bill_laboratory_medical_event_serviceid__onchange_cb_after_alert);
  } // do_ajax_form_bill_laboratory_medical_event_serviceid__onchange_cb
  function do_ajax_form_bill_laboratory_medical_event_serviceid__onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_bill_laboratory_medical_event_serviceid__onchange_cb_after_alert

  var sc_num_ult_line = "";
  var sc_insert_open  = false;

  // ---------- add_new_line
  function do_ajax_form_bill_laboratory_medical_add_new_line(sc_clone, sc_seq_clone)
  {
    if (sc_insert_open)
    {
        if (sc_clone == 'S' && sc_seq_clone != iAjaxNewLine)
        {
          do_ajax_form_bill_laboratory_medical_cancel_insert(iAjaxNewLine);
        }
        else
        {
          return;
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_bill_laboratory_medical_add_new_line(var_sc_clone, var_sc_seq_clone, var_sc_seq_vert, var_script_case_init, do_ajax_form_bill_laboratory_medical_add_new_line_cb);
  } // do_ajax_form_bill_laboratory_medical_add_new_line

  function do_ajax_form_bill_laboratory_medical_add_new_line_cb(sResp)
  {
    scAjaxProcOff(true);
    if ("{" == sResp.substr(0, 1)) {
        oResp = scAjaxResponse(sResp);
  ...
  } // do_ajax_form_bill_laboratory_medical_add_new_line_cb

  // ---------- backup_line
  function do_ajax_form_bill_laboratory_medical_backup_line(iNumLinha)
  {
    var var_id_ = scAjaxGetFieldHidden("id_" + iNumLinha);
    var var_nmgp_refresh_row = iNumLinha;
    var var_nm_form_submit = document.F1.nm_form_submit.value;
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_bill_laboratory_medical_backup_line(var_id_, var_nmgp_refresh_row, var_nm_form_submit, var_script_case_init, do_ajax_form_bill_laboratory_medical_backup_line_cb);
  } // do_ajax_form_bill_laboratory_medical_backup_line

  function do_ajax_form_bill_laboratory_medical_backup_line_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    if (!scAjaxHasError())
  ...
  } // do_ajax_form_bill_laboratory_medical_backup_line_cb

  function do_ajax_form_bill_laboratory_medical_cancel_insert(iSeqVert)
  {
    var oTBodyOld = document.getElementById("hidden_bloco_0").tBodies[0];
  ...
  } // do_ajax_form_bill_laboratory_medical_cancel_insert

  function do_ajax_form_bill_laboratory_medical_cancel_update(iSeqVert)
  {
    do_ajax_form_bill_laboratory_medical_backup_line(iSeqVert);
...
?>
  } // do_ajax_form_bill_laboratory_medical_cancel_update

  function do_ajax_form_bill_laboratory_medical_restore_buttons()
  {
<?php
...
?>
  } // do_ajax_form_bill_laboratory_medical_restore_buttons

  // ---------- table_refresh
  function do_ajax_form_bill_laboratory_medical_table_refresh()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_bill_laboratory_medical_table_refresh(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search, var_nmgp_cond_fast_search, var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_bill_laboratory_medical_table_refresh_cb);
  } //  do_ajax_form_bill_laboratory_medical_table_refresh

  function do_ajax_form_bill_laboratory_medical_table_refresh_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxAlert(do_ajax_form_bill_laboratory_medical_table_refresh_cb_after_alert);
  } // do_ajax_form_bill_laboratory_medical_table_refresh_cb
  function do_ajax_form_bill_laboratory_medical_table_refresh_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    ...
    sc_insert_open = false;
  } // do_ajax_form_bill_laboratory_medical_table_refresh_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  var sc_num_ult_opc  = "";
  var sc_num_ult_tr   = "";
  function do_ajax_form_bill_laboratory_medical_submit_form(iNumLinha, indexTR)
  {
    if (scEventControl_active(iNumLinha)) {
      setTimeout(function() { do_ajax_form_bill_laboratory_medical_submit_form(iNumLinha, indexTR); }, 500);
      return;
    }
...
?>
    x_ajax_form_bill_laboratory_medical_submit_form(var_id_, var_serviceid_, var_price_, var_trandate_, var_staffid_, var_nmgp_refresh_row, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_bill_laboratory_medical_submit_form_cb);
  } // do_ajax_form_bill_laboratory_medical_submit_form

  function do_ajax_form_bill_laboratory_medical_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel(true);
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_bill_laboratory_medical_submit_form_cb_after_alert);
  } // do_ajax_form_bill_laboratory_medical_submit_form_cb
  function do_ajax_form_bill_laboratory_medical_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_bill_laboratory_medical_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_bill_laboratory_medical_navigate_form()
  {
    perform_ajax_form_bill_laboratory_medical_navigate_form();
  }

  function perform_ajax_form_bill_laboratory_medical_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    if (sc_insert_open)
    {
        do_ajax_form_bill_laboratory_medical_cancel_insert(sc_num_ult_line);
    }
    nm_uncheck_delete();
    scAjaxHideMessage();
    scAjaxHideErrorDisplay("table");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_bill_laboratory_medical_navigate_form(var_id_, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_bill_laboratory_medical_navigate_form_cb);
  } // do_ajax_form_bill_laboratory_medical_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_bill_laboratory_medical']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_bill_laboratory_medical_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scErrorLineReset();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_bill_laboratory_medical_navigate_form_cb_after_alert);
  } // do_ajax_form_bill_laboratory_medical_navigate_form_cb
  function do_ajax_form_bill_laboratory_medical_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
<?php
...
?>
  ...
  } // do_ajax_form_bill_laboratory_medical_navigate_form_cb_after_alert
  function sc_hide_form_bill_laboratory_medical_form()
  {
...
?>
  function ajax_create_tables(iNumLinha)
  {
    ...
    ajax_error_list["serviceid_" + iNumLinha] = {"label": "Examination<?php echo $sLineInfo; ?>", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5};
