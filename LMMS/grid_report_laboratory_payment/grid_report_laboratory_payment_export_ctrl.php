<?php
@session_start() ;
$_SESSION['scriptcase']['grid_report_laboratory_payment']['sc_process_barr'] = true;
require_once('../grid_report_laboratory_payment/index.php');
unset($_SESSION['scriptcase']['grid_report_laboratory_payment']['sc_process_barr']);
$ExportCtrl = new grid_report_laboratory_payment_export_control;
$ExportCtrl->Export_barr();

class grid_report_laboratory_payment_export_control
{
