...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_payment"  <?php echo $str_hide_payment?>><?php
      if ($payment != "")
      {
      $payment_look = substr($this->Db->qstr($payment), 1, -1); 
      $nmgp_def_dados = array(); 
...
<select class="sc-js-input scFilterObjectEven sc-ui-autocomp-payment" id="id_ac_payment" name="payment_autocomp"><?php if ('' !=  $payment) { ?><option value="<?php echo $payment ?>" selected><?php echo $sAutocompValue ?></option><?php } ?></select>
 </TD>
