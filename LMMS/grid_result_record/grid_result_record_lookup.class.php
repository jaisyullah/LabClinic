<?php
class grid_result_record_lookup
{
//  
   ...
   {   
      ...
      if (trim($serviceid) === "" || trim($serviceid) == "&nbsp;")
      { 
          $conteudo = "&nbsp;";
          $save_conteudo  = ""; 
          $save_conteudo1 = ""; 
      ...
      $nm_comando = "select labcode from normal_laboratory where id = $serviceid order by labcode, name" ; 
      $conteudo = "" ; 
