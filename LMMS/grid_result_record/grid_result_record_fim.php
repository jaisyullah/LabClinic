...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LMMS_____grid_result_record"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LMMS_____grid_result_record"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_result_record']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_result_record']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_result_record']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_result_record']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_result_record']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_result_record</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_result_record']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_result_record']['embutida_filho'] as $ind => $sc_init)
          {
