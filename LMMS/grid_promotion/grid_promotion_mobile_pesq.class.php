...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "effectivedate";$Nm_datas[] = "effectivedate";$Nm_datas[] = "expiredate";$Nm_datas[] = "expiredate";$Nm_numeric[] = "id";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_description_cond" name="description_cond" onChange="nm_campos_between(document.getElementById('id_vis_description'), this, 'description')">
      ...
      <br><span id="id_hide_description"  <?php echo $str_hide_description?>><INPUT  type="text" id="SC_description" name="description" value="<?php echo NM_encode_input($description) ?>" size="50" maxlength="32767" class="scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_picture_cond" name="picture_cond" onChange="nm_campos_between(document.getElementById('id_vis_picture'), this, 'picture')">
      ...
      <br><span id="id_hide_picture"  <?php echo $str_hide_picture?>><?php
      if ($picture != "")
      {
      $picture_look = substr($this->Db->qstr($picture), 1, -1); 
      $nmgp_def_dados = array(); 
