<?php
@session_start() ;
$_SESSION['scriptcase']['grid_promotion']['sc_process_barr'] = true;
require_once('../grid_promotion/index.php');
unset($_SESSION['scriptcase']['grid_promotion']['sc_process_barr']);
$ExportCtrl = new grid_promotion_export_control;
$ExportCtrl->Export_barr();

class grid_promotion_export_control
{
