  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_profile_settings_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_profile_settings_mob_form();
	}
  ...
  // ---------- Validate id
  function do_ajax_form_profile_settings_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_mob_validate_id(var_id, var_script_case_init, do_ajax_form_profile_settings_mob_validate_id_cb);
  } // do_ajax_form_profile_settings_mob_validate_id

  function do_ajax_form_profile_settings_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_mob_validate_id_cb

  // ---------- Validate companyname
  function do_ajax_form_profile_settings_mob_validate_companyname()
  {
    var nomeCampo_companyname = "companyname";
    var var_companyname = scAjaxGetFieldText(nomeCampo_companyname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_mob_validate_companyname(var_companyname, var_script_case_init, do_ajax_form_profile_settings_mob_validate_companyname_cb);
  } // do_ajax_form_profile_settings_mob_validate_companyname

  function do_ajax_form_profile_settings_mob_validate_companyname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "companyname";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_mob_validate_companyname_cb

  // ---------- Validate companyaddress
  function do_ajax_form_profile_settings_mob_validate_companyaddress()
  {
    var nomeCampo_companyaddress = "companyaddress";
    var var_companyaddress = scAjaxGetFieldText(nomeCampo_companyaddress);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_mob_validate_companyaddress(var_companyaddress, var_script_case_init, do_ajax_form_profile_settings_mob_validate_companyaddress_cb);
  } // do_ajax_form_profile_settings_mob_validate_companyaddress

  function do_ajax_form_profile_settings_mob_validate_companyaddress_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "companyaddress";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_mob_validate_companyaddress_cb

  // ---------- Validate logo
  function do_ajax_form_profile_settings_mob_validate_logo()
  {
    var nomeCampo_logo = "logo";
    var var_logo = scAjaxGetFieldText(nomeCampo_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_mob_validate_logo(var_logo, var_script_case_init, do_ajax_form_profile_settings_mob_validate_logo_cb);
  } // do_ajax_form_profile_settings_mob_validate_logo

  function do_ajax_form_profile_settings_mob_validate_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "logo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_mob_validate_logo_cb

  // ---------- Validate companyphone
  function do_ajax_form_profile_settings_mob_validate_companyphone()
  {
    var nomeCampo_companyphone = "companyphone";
    var var_companyphone = scAjaxGetFieldText(nomeCampo_companyphone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_mob_validate_companyphone(var_companyphone, var_script_case_init, do_ajax_form_profile_settings_mob_validate_companyphone_cb);
  } // do_ajax_form_profile_settings_mob_validate_companyphone

  function do_ajax_form_profile_settings_mob_validate_companyphone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "companyphone";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_mob_validate_companyphone_cb

  // ---------- Validate companyfax
  function do_ajax_form_profile_settings_mob_validate_companyfax()
  {
    var nomeCampo_companyfax = "companyfax";
    var var_companyfax = scAjaxGetFieldText(nomeCampo_companyfax);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_mob_validate_companyfax(var_companyfax, var_script_case_init, do_ajax_form_profile_settings_mob_validate_companyfax_cb);
  } // do_ajax_form_profile_settings_mob_validate_companyfax

  function do_ajax_form_profile_settings_mob_validate_companyfax_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "companyfax";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_mob_validate_companyfax_cb

  // ---------- Validate companymail
  function do_ajax_form_profile_settings_mob_validate_companymail()
  {
    var nomeCampo_companymail = "companymail";
    var var_companymail = scAjaxGetFieldText(nomeCampo_companymail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_mob_validate_companymail(var_companymail, var_script_case_init, do_ajax_form_profile_settings_mob_validate_companymail_cb);
  } // do_ajax_form_profile_settings_mob_validate_companymail

  function do_ajax_form_profile_settings_mob_validate_companymail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "companymail";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_mob_validate_companymail_cb

  // ---------- Validate companyweb
  function do_ajax_form_profile_settings_mob_validate_companyweb()
  {
    var nomeCampo_companyweb = "companyweb";
    var var_companyweb = scAjaxGetFieldText(nomeCampo_companyweb);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_mob_validate_companyweb(var_companyweb, var_script_case_init, do_ajax_form_profile_settings_mob_validate_companyweb_cb);
  } // do_ajax_form_profile_settings_mob_validate_companyweb

  function do_ajax_form_profile_settings_mob_validate_companyweb_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "companyweb";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_mob_validate_companyweb_cb

  // ---------- Validate companyperson
  function do_ajax_form_profile_settings_mob_validate_companyperson()
  {
    var nomeCampo_companyperson = "companyperson";
    var var_companyperson = scAjaxGetFieldText(nomeCampo_companyperson);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_mob_validate_companyperson(var_companyperson, var_script_case_init, do_ajax_form_profile_settings_mob_validate_companyperson_cb);
  } // do_ajax_form_profile_settings_mob_validate_companyperson

  function do_ajax_form_profile_settings_mob_validate_companyperson_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "companyperson";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_mob_validate_companyperson_cb

  // ---------- Validate countrysetting
  function do_ajax_form_profile_settings_mob_validate_countrysetting()
  {
    var nomeCampo_countrysetting = "countrysetting";
    var var_countrysetting = scAjaxGetFieldSelect(nomeCampo_countrysetting);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_mob_validate_countrysetting(var_countrysetting, var_script_case_init, do_ajax_form_profile_settings_mob_validate_countrysetting_cb);
  } // do_ajax_form_profile_settings_mob_validate_countrysetting

  function do_ajax_form_profile_settings_mob_validate_countrysetting_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "countrysetting";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_mob_validate_countrysetting_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_profile_settings_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_profile_settings_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_companyname = scAjaxGetFieldText("companyname");
    var var_companyaddress = scAjaxGetFieldText("companyaddress");
    var var_logo = scAjaxGetFieldText("logo");
    var var_companyphone = scAjaxGetFieldText("companyphone");
    var var_companyfax = scAjaxGetFieldText("companyfax");
    var var_companymail = scAjaxGetFieldText("companymail");
    var var_companyweb = scAjaxGetFieldText("companyweb");
    var var_companyperson = scAjaxGetFieldText("companyperson");
    var var_countrysetting = scAjaxGetFieldSelect("countrysetting");
    ...
    scAjaxProcOn();
    x_ajax_form_profile_settings_mob_submit_form(var_id, var_companyname, var_companyaddress, var_logo, var_companyphone, var_companyfax, var_companymail, var_companyweb, var_companyperson, var_countrysetting, var_logo_ul_name, var_logo_ul_type, var_logo_salva, var_logo_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_profile_settings_mob_submit_form_cb);
  } // do_ajax_form_profile_settings_mob_submit_form

  function do_ajax_form_profile_settings_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("companyname");
      scAjaxHideErrorDisplay("companyaddress");
      scAjaxHideErrorDisplay("logo");
      scAjaxHideErrorDisplay("companyphone");
      scAjaxHideErrorDisplay("companyfax");
      scAjaxHideErrorDisplay("companymail");
      scAjaxHideErrorDisplay("companyweb");
      scAjaxHideErrorDisplay("companyperson");
      scAjaxHideErrorDisplay("countrysetting");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_profile_settings_mob_submit_form_cb_after_alert);
  } // do_ajax_form_profile_settings_mob_submit_form_cb
  function do_ajax_form_profile_settings_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_profile_settings_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_profile_settings_mob_navigate_form()
  {
    perform_ajax_form_profile_settings_mob_navigate_form();
  }

  function perform_ajax_form_profile_settings_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_profile_settings_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_profile_settings_mob_navigate_form_cb);
  } // do_ajax_form_profile_settings_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile_settings_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_profile_settings_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_profile_settings_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_profile_settings_mob_navigate_form_cb
  function do_ajax_form_profile_settings_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_profile_settings_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_profile_settings_mob_navigate_form_cb_after_alert
  function sc_hide_form_profile_settings_mob_form()
  {
  ...
  ajax_field_list[1] = "companyname";
  ajax_field_list[2] = "companyaddress";
  ajax_field_list[3] = "logo";
  ajax_field_list[4] = "companyphone";
  ajax_field_list[5] = "companyfax";
  ajax_field_list[6] = "companymail";
  ajax_field_list[7] = "companyweb";
  ajax_field_list[8] = "companyperson";
  ajax_field_list[9] = "countrysetting";
  ...
  var ajax_error_list = {
    ...
    "companyname": {"label": "Company Name", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "companyaddress": {"label": "Company Address", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "logo": {"label": "Logo", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "companyphone": {"label": "Company Phone", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "companyfax": {"label": "Company Fax", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "companymail": {"label": "Company Mail", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "companyweb": {"label": "Company Web", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "companyperson": {"label": "Company Person", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "countrysetting": {"label": "Country Setting", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  var ajax_field_mult = {
    ...
    "companyaddress": new Array(),
    "logo": new Array(),
    "companyphone": new Array(),
    "companyfax": new Array(),
    "companymail": new Array(),
    "companyweb": new Array(),
    "companyperson": new Array(),
    "countrysetting": new Array()
  };
  ajax_field_mult["id"][1] = "id";
  ajax_field_mult["companyname"][1] = "companyname";
  ajax_field_mult["companyaddress"][1] = "companyaddress";
  ajax_field_mult["logo"][1] = "logo";
  ajax_field_mult["companyphone"][1] = "companyphone";
  ajax_field_mult["companyfax"][1] = "companyfax";
  ajax_field_mult["companymail"][1] = "companymail";
  ajax_field_mult["companyweb"][1] = "companyweb";
  ajax_field_mult["companyperson"][1] = "companyperson";
  ajax_field_mult["countrysetting"][1] = "countrysetting";

  var ajax_field_id = {
    "id": new Array("hidden_field_label_id", "hidden_field_data_id"),
    "companyname": new Array("hidden_field_label_companyname", "hidden_field_data_companyname"),
    "companyaddress": new Array("hidden_field_label_companyaddress", "hidden_field_data_companyaddress"),
    "logo": new Array("hidden_field_label_logo", "hidden_field_data_logo"),
    "companyphone": new Array("hidden_field_label_companyphone", "hidden_field_data_companyphone"),
    "companyfax": new Array("hidden_field_label_companyfax", "hidden_field_data_companyfax"),
    "companymail": new Array("hidden_field_label_companymail", "hidden_field_data_companymail"),
    "companyweb": new Array("hidden_field_label_companyweb", "hidden_field_data_companyweb"),
    "companyperson": new Array("hidden_field_label_companyperson", "hidden_field_data_companyperson"),
    "countrysetting": new Array("hidden_field_label_countrysetting", "hidden_field_data_countrysetting")
  };
