  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_profile_settings" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_profile_settings_form();
	}
  ...
  // ---------- Validate id
  function do_ajax_form_profile_settings_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_validate_id(var_id, var_script_case_init, do_ajax_form_profile_settings_validate_id_cb);
  } // do_ajax_form_profile_settings_validate_id

  function do_ajax_form_profile_settings_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_validate_id_cb

  // ---------- Validate companyname
  function do_ajax_form_profile_settings_validate_companyname()
  {
    var nomeCampo_companyname = "companyname";
    var var_companyname = scAjaxGetFieldText(nomeCampo_companyname);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_validate_companyname(var_companyname, var_script_case_init, do_ajax_form_profile_settings_validate_companyname_cb);
  } // do_ajax_form_profile_settings_validate_companyname

  function do_ajax_form_profile_settings_validate_companyname_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_validate_companyname_cb

  // ---------- Validate companyaddress
  function do_ajax_form_profile_settings_validate_companyaddress()
  {
    var nomeCampo_companyaddress = "companyaddress";
    var var_companyaddress = scAjaxGetFieldText(nomeCampo_companyaddress);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_validate_companyaddress(var_companyaddress, var_script_case_init, do_ajax_form_profile_settings_validate_companyaddress_cb);
  } // do_ajax_form_profile_settings_validate_companyaddress

  function do_ajax_form_profile_settings_validate_companyaddress_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_validate_companyaddress_cb

  // ---------- Validate logo
  function do_ajax_form_profile_settings_validate_logo()
  {
    var nomeCampo_logo = "logo";
    var var_logo = scAjaxGetFieldText(nomeCampo_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_validate_logo(var_logo, var_script_case_init, do_ajax_form_profile_settings_validate_logo_cb);
  } // do_ajax_form_profile_settings_validate_logo

  function do_ajax_form_profile_settings_validate_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "logo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_validate_logo_cb

  // ---------- Validate companyphone
  function do_ajax_form_profile_settings_validate_companyphone()
  {
    var nomeCampo_companyphone = "companyphone";
    var var_companyphone = scAjaxGetFieldText(nomeCampo_companyphone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_validate_companyphone(var_companyphone, var_script_case_init, do_ajax_form_profile_settings_validate_companyphone_cb);
  } // do_ajax_form_profile_settings_validate_companyphone

  function do_ajax_form_profile_settings_validate_companyphone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_validate_companyphone_cb

  // ---------- Validate companyfax
  function do_ajax_form_profile_settings_validate_companyfax()
  {
    var nomeCampo_companyfax = "companyfax";
    var var_companyfax = scAjaxGetFieldText(nomeCampo_companyfax);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_validate_companyfax(var_companyfax, var_script_case_init, do_ajax_form_profile_settings_validate_companyfax_cb);
  } // do_ajax_form_profile_settings_validate_companyfax

  function do_ajax_form_profile_settings_validate_companyfax_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_validate_companyfax_cb

  // ---------- Validate companymail
  function do_ajax_form_profile_settings_validate_companymail()
  {
    var nomeCampo_companymail = "companymail";
    var var_companymail = scAjaxGetFieldText(nomeCampo_companymail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_validate_companymail(var_companymail, var_script_case_init, do_ajax_form_profile_settings_validate_companymail_cb);
  } // do_ajax_form_profile_settings_validate_companymail

  function do_ajax_form_profile_settings_validate_companymail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_validate_companymail_cb

  // ---------- Validate companyweb
  function do_ajax_form_profile_settings_validate_companyweb()
  {
    var nomeCampo_companyweb = "companyweb";
    var var_companyweb = scAjaxGetFieldText(nomeCampo_companyweb);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_validate_companyweb(var_companyweb, var_script_case_init, do_ajax_form_profile_settings_validate_companyweb_cb);
  } // do_ajax_form_profile_settings_validate_companyweb

  function do_ajax_form_profile_settings_validate_companyweb_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_validate_companyweb_cb

  // ---------- Validate companyperson
  function do_ajax_form_profile_settings_validate_companyperson()
  {
    var nomeCampo_companyperson = "companyperson";
    var var_companyperson = scAjaxGetFieldText(nomeCampo_companyperson);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_validate_companyperson(var_companyperson, var_script_case_init, do_ajax_form_profile_settings_validate_companyperson_cb);
  } // do_ajax_form_profile_settings_validate_companyperson

  function do_ajax_form_profile_settings_validate_companyperson_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_validate_companyperson_cb

  // ---------- Validate countrysetting
  function do_ajax_form_profile_settings_validate_countrysetting()
  {
    var nomeCampo_countrysetting = "countrysetting";
    var var_countrysetting = scAjaxGetFieldSelect(nomeCampo_countrysetting);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_settings_validate_countrysetting(var_countrysetting, var_script_case_init, do_ajax_form_profile_settings_validate_countrysetting_cb);
  } // do_ajax_form_profile_settings_validate_countrysetting

  function do_ajax_form_profile_settings_validate_countrysetting_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_settings_validate_countrysetting_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_profile_settings_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_profile_settings_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_profile_settings_submit_form(var_id, var_companyname, var_companyaddress, var_logo, var_companyphone, var_companyfax, var_companymail, var_companyweb, var_companyperson, var_countrysetting, var_logo_ul_name, var_logo_ul_type, var_logo_salva, var_logo_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_profile_settings_submit_form_cb);
  } // do_ajax_form_profile_settings_submit_form

  function do_ajax_form_profile_settings_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_profile_settings_submit_form_cb_after_alert);
  } // do_ajax_form_profile_settings_submit_form_cb
  function do_ajax_form_profile_settings_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_profile_settings_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_profile_settings_navigate_form()
  {
    perform_ajax_form_profile_settings_navigate_form();
  }

  function perform_ajax_form_profile_settings_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_profile_settings_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_profile_settings_navigate_form_cb);
  } // do_ajax_form_profile_settings_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile_settings']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_profile_settings_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_profile_settings_navigate_form_cb_after_alert);
  } // do_ajax_form_profile_settings_navigate_form_cb
  function do_ajax_form_profile_settings_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_profile_settings_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_profile_settings_navigate_form_cb_after_alert
  function sc_hide_form_profile_settings_form()
  {
