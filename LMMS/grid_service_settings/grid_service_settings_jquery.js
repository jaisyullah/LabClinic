...
function ajax_navigate(opc, parm)
{
    ...
    return new Promise(function(resolve, reject) {$.ajax({
     ...
     .done(function(jsonNavigate) {
        ...
        document.getElementById('nmsc_iframe_liga_A_grid_service_settings').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_E_grid_service_settings').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_D_grid_service_settings').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_B_grid_service_settings').src = 'NM_Blank_Page.htm';
        document.getElementById('nmsc_iframe_liga_A_grid_service_settings').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_service_settings').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_service_settings').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_service_settings').style.height = '0px';
        document.getElementById('nmsc_iframe_liga_A_grid_service_settings').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_E_grid_service_settings').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_D_grid_service_settings').style.width  = '0px';
        document.getElementById('nmsc_iframe_liga_B_grid_service_settings').style.width  = '0px';
        if (oResp["setValue"]) {
