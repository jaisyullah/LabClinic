<?php
@session_start() ;
$_SESSION['scriptcase']['chart_laboratory_medical']['sc_process_barr'] = true;
require_once('../chart_laboratory_medical/index.php');
unset($_SESSION['scriptcase']['chart_laboratory_medical']['sc_process_barr']);
$ExportCtrl = new chart_laboratory_medical_export_control;
$ExportCtrl->Export_barr();

class chart_laboratory_medical_export_control
{
