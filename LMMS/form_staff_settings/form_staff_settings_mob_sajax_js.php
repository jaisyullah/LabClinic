  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_staff_settings_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_staff_settings_mob_form();
	}
  ...
  // ---------- Validate id
  function do_ajax_form_staff_settings_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_settings_mob_validate_id(var_id, var_script_case_init, do_ajax_form_staff_settings_mob_validate_id_cb);
  } // do_ajax_form_staff_settings_mob_validate_id

  function do_ajax_form_staff_settings_mob_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_settings_mob_validate_id_cb

  // ---------- Validate name
  function do_ajax_form_staff_settings_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_settings_mob_validate_name(var_name, var_script_case_init, do_ajax_form_staff_settings_mob_validate_name_cb);
  } // do_ajax_form_staff_settings_mob_validate_name

  function do_ajax_form_staff_settings_mob_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_settings_mob_validate_name_cb

  // ---------- Validate usr_login
  function do_ajax_form_staff_settings_mob_validate_usr_login()
  {
    var nomeCampo_usr_login = "usr_login";
    var var_usr_login = scAjaxGetFieldSelect(nomeCampo_usr_login);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_settings_mob_validate_usr_login(var_usr_login, var_script_case_init, do_ajax_form_staff_settings_mob_validate_usr_login_cb);
  } // do_ajax_form_staff_settings_mob_validate_usr_login

  function do_ajax_form_staff_settings_mob_validate_usr_login_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "usr_login";
    scEventControl_onBlur(sFieldValid);
    scAjaxUpdateFieldErrors(sFieldValid, "valid");
    sFieldErrors = scAjaxListFieldErrors(sFieldValid, false);
    if ("" == sFieldErrors)
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_settings_mob_validate_usr_login_cb

  // ---------- Validate image
  function do_ajax_form_staff_settings_mob_validate_image()
  {
    var nomeCampo_image = "image";
    var var_image = scAjaxGetFieldText(nomeCampo_image);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_settings_mob_validate_image(var_image, var_script_case_init, do_ajax_form_staff_settings_mob_validate_image_cb);
  } // do_ajax_form_staff_settings_mob_validate_image

  function do_ajax_form_staff_settings_mob_validate_image_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "image";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_settings_mob_validate_image_cb

  // ---------- Validate esign
  function do_ajax_form_staff_settings_mob_validate_esign()
  {
    var nomeCampo_esign = "esign";
    var var_esign = scAjaxGetFieldText(nomeCampo_esign);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_staff_settings_mob_validate_esign(var_esign, var_script_case_init, do_ajax_form_staff_settings_mob_validate_esign_cb);
  } // do_ajax_form_staff_settings_mob_validate_esign

  function do_ajax_form_staff_settings_mob_validate_esign_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "esign";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_staff_settings_mob_validate_esign_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_staff_settings_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_staff_settings_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_id = scAjaxGetFieldHidden("id");
    var var_name = scAjaxGetFieldText("name");
    var var_usr_login = scAjaxGetFieldSelect("usr_login");
    var var_image = scAjaxGetFieldText("image");
    var var_esign = scAjaxGetFieldText("esign");
    ...
    var var_esign_ul_name = scAjaxSpecCharProtect(document.F1.esign_ul_name.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_esign_ul_type = document.F1.esign_ul_type.value;
    var var_image_salva = scAjaxSpecCharProtect(document.F1.image_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_image_limpa = document.F1.image_limpa.checked ? "S" : "N";
    var var_esign_salva = scAjaxSpecCharProtect(document.F1.esign_salva.value);//.replace(/[+]/g, "__NM_PLUS__");
    var var_esign_limpa = document.F1.esign_limpa.checked ? "S" : "N";
    ...
    scAjaxProcOn();
    x_ajax_form_staff_settings_mob_submit_form(var_id, var_name, var_usr_login, var_image, var_esign, var_image_ul_name, var_image_ul_type, var_esign_ul_name, var_esign_ul_type, var_image_salva, var_image_limpa, var_esign_salva, var_esign_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_staff_settings_mob_submit_form_cb);
  } // do_ajax_form_staff_settings_mob_submit_form

  function do_ajax_form_staff_settings_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("usr_login");
      scAjaxHideErrorDisplay("image");
      scAjaxHideErrorDisplay("esign");
      scLigEditLookupCall();
<?php
...
?>
    ...
    if (!scAjaxHasError())
    {
      ...
      if (document.F1.esign_limpa && document.F1.esign_limpa.checked)
      {
        var oImgTemp = {0: {"value" : ""}};
        scAjaxSetFieldImage("esign", oImgTemp, "", "", "", "N");
      }
    document.F1.image_ul_name.value = '';
    document.F1.image_ul_type.value = '';
    document.F1.esign_ul_name.value = '';
    document.F1.esign_ul_type.value = '';
    }
    scAjaxShowDebug();
    scAjaxSetDisplay();
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_staff_settings_mob_submit_form_cb_after_alert);
  } // do_ajax_form_staff_settings_mob_submit_form_cb
  function do_ajax_form_staff_settings_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_staff_settings_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_staff_settings_mob_navigate_form()
  {
    perform_ajax_form_staff_settings_mob_navigate_form();
  }

  function perform_ajax_form_staff_settings_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_staff_settings_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_staff_settings_mob_navigate_form_cb);
  } // do_ajax_form_staff_settings_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_staff_settings_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_staff_settings_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_staff_settings_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_staff_settings_mob_navigate_form_cb
  function do_ajax_form_staff_settings_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_staff_settings_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_staff_settings_mob_navigate_form_cb_after_alert
  function sc_hide_form_staff_settings_mob_form()
  {
  ...
  ajax_field_list[2] = "usr_login";
  ajax_field_list[3] = "image";
  ajax_field_list[4] = "esign";
  ...
  var ajax_error_list = {
    ...
    "usr_login": {"label": "User Login", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "image": {"label": "Image", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "esign": {"label": "Staff (Signature and Stamp)", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
