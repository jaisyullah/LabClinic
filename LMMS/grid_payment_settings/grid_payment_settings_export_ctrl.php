<?php
@session_start() ;
$_SESSION['scriptcase']['grid_payment_settings']['sc_process_barr'] = true;
require_once('../grid_payment_settings/index.php');
unset($_SESSION['scriptcase']['grid_payment_settings']['sc_process_barr']);
$ExportCtrl = new grid_payment_settings_export_control;
$ExportCtrl->Export_barr();

class grid_payment_settings_export_control
{
