<?php
   ...
   if (!isset($_SESSION['sc_session']))
   {
       ...
       if (is_file($root . $_SESSION['scriptcase']['grid_outpatient_reg']['glo_nm_path_imag_temp'] . "/sc_apl_default_LMMS.txt"))
       {
?>
...
<?php
   ...
   $Ord_Cmp = new grid_outpatient_reg_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_outpatient_reg_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["trancode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["trancode"])) ? $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["trancode"] : "Transaction Code";
   ...
   $tab_labels["patientid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["patientid"])) ? $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["patientid"] : "Patient No";
   ...
   $tab_labels["patientname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["patientname"])) ? $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["patientname"] : "Patient Name";
   $tab_ger_campos['deptid'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['deptid'] = "deptid";
   }
   else
   {
       $tab_def_campos['deptid'] = "a.deptID";
   }
   $tab_labels["deptid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["deptid"])) ? $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["deptid"] : "Clinic";
   $tab_ger_campos['doctorid'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['doctorid'] = "doctorid";
   }
   else
   {
       $tab_def_campos['doctorid'] = "a.doctorID";
   }
   $tab_labels["doctorid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["doctorid"])) ? $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["doctorid"] : "Doctor";
   $tab_ger_campos['regdate'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['regdate'] = "regdate";
   }
   else
   {
       $tab_def_campos['regdate'] = "a.regDate";
   }
   $tab_labels["regdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["regdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["regdate"] : "Register Date";
   $tab_ger_campos['regtime'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['regtime'] = "regtime";
   }
   else
   {
       $tab_def_campos['regtime'] = "a.regTime";
   }
   $tab_labels["regtime"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["regtime"])) ? $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["regtime"] : "Register Time";
   $tab_ger_campos['queueno'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['queueno'] = "queueno";
   }
   else
   {
       $tab_def_campos['queueno'] = "a.queueNo";
   }
   $tab_labels["queueno"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["queueno"])) ? $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["queueno"] : "Queue No";
   $tab_ger_campos['paymentid'] = "on";
   if ($use_alias == "S")
   {
       $tab_def_campos['paymentid'] = "paymentid";
   }
   else
   {
       $tab_def_campos['paymentid'] = "a.paymentID";
   }
   $tab_labels["paymentid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["paymentid"])) ? $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["paymentid"] : "Payment";
   ...
   $tab_labels["staffid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["staffid"])) ? $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["staffid"] : "Staff";
   ...
   $tab_labels["statusid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["statusid"])) ? $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['labels']["statusid"] : "Status";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
<HEAD>
 <TITLE><?php echo $this->Nm_lang['lang_othr_grid_titl'] ?> outpatient register</TITLE>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_outpatient_reg_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_outpatient_reg']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
