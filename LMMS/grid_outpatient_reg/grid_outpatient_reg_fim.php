...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LMMS_____grid_outpatient_reg"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LMMS_____grid_outpatient_reg"]);
   }
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_outpatient_reg']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_outpatient_reg']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_outpatient_reg']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_outpatient_reg']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_outpatient_reg']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_outpatient_reg</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_outpatient_reg']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_outpatient_reg']['embutida_filho'] as $ind => $sc_init)
          {
