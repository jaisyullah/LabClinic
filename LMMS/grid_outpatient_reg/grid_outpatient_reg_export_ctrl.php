<?php
@session_start() ;
$_SESSION['scriptcase']['grid_outpatient_reg']['sc_process_barr'] = true;
require_once('../grid_outpatient_reg/index.php');
unset($_SESSION['scriptcase']['grid_outpatient_reg']['sc_process_barr']);
$ExportCtrl = new grid_outpatient_reg_export_control;
$ExportCtrl->Export_barr();

class grid_outpatient_reg_export_control
{
