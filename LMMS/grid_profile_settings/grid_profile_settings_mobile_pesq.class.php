...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "registrationfee";$Nm_numeric[] = "id";$Nm_numeric[] = "registrationfee";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_logo_cond" name="logo_cond" onChange="nm_campos_between(document.getElementById('id_vis_logo'), this, 'logo')">
      ...
      <br><span id="id_hide_logo"  <?php echo $str_hide_logo?>><?php
      if ($logo != "")
      {
      $logo_look = substr($this->Db->qstr($logo), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_companyname_cond" name="companyname_cond" onChange="nm_campos_between(document.getElementById('id_vis_companyname'), this, 'companyname')">
      ...
      <br><span id="id_hide_companyname"  <?php echo $str_hide_companyname?>><?php
      if ($companyname != "")
      {
      $companyname_look = substr($this->Db->qstr($companyname), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_companyaddress_cond" name="companyaddress_cond" onChange="nm_campos_between(document.getElementById('id_vis_companyaddress'), this, 'companyaddress')">
      ...
      <br><span id="id_hide_companyaddress"  <?php echo $str_hide_companyaddress?>><INPUT  type="text" id="SC_companyaddress" name="companyaddress" value="<?php echo NM_encode_input($companyaddress) ?>" size="50" maxlength="32767" class="scFilterObjectEven">
 </TD>
