...
<?php
   ...
   $Ord_Cmp = new grid_profile_settings_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_profile_settings_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_profile_settings']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["logo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_profile_settings']['labels']["logo"])) ? $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['labels']["logo"] : "Logo";
   $tab_ger_campos['companyname'] = "on";
   $tab_def_campos['companyname'] = "companyName";
   $tab_labels["companyname"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_profile_settings']['labels']["companyname"])) ? $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['labels']["companyname"] : "Company Name";
   $tab_ger_campos['companyaddress'] = "on";
   $tab_def_campos['companyaddress'] = "companyAddress";
   $tab_labels["companyaddress"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_profile_settings']['labels']["companyaddress"])) ? $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['labels']["companyaddress"] : "Company Address";
   $tab_ger_campos['companyphone'] = "on";
   $tab_def_campos['companyphone'] = "companyPhone";
   $tab_labels["companyphone"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_profile_settings']['labels']["companyphone"])) ? $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['labels']["companyphone"] : "Company Phone";
   $tab_ger_campos['companymail'] = "on";
   $tab_def_campos['companymail'] = "companyMail";
   $tab_labels["companymail"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_profile_settings']['labels']["companymail"])) ? $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['labels']["companymail"] : "Company Mail";
   $tab_ger_campos['currency'] = "on";
   $tab_def_campos['currency'] = "currency";
   $tab_labels["currency"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_profile_settings']['labels']["currency"])) ? $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['labels']["currency"] : "Currency";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_profile_settings']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_profile_settings']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_profile_settings']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_profile_settings']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_profile_settings']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_profile_settings']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_profile_settings_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_profile_settings']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_profile_settings']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
