<?php
@session_start() ;
$_SESSION['scriptcase']['chart_outpatient_reg_payment']['sc_process_barr'] = true;
require_once('../chart_outpatient_reg_payment/index.php');
unset($_SESSION['scriptcase']['chart_outpatient_reg_payment']['sc_process_barr']);
$ExportCtrl = new chart_outpatient_reg_payment_export_control;
$ExportCtrl->Export_barr();

class chart_outpatient_reg_payment_export_control
{
