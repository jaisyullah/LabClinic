...
<?php
   ...
   $Ord_Cmp = new grid_group_product_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_group_product_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_group_product']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_group_product']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_group_product']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['grid_group_product']['labels']["name"] : "Name";
   $tab_ger_campos['ordernum'] = "on";
   $tab_def_campos['ordernum'] = "ordernum";
   $tab_labels["ordernum"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_group_product']['labels']["ordernum"])) ? $_SESSION['sc_session'][$sc_init]['grid_group_product']['labels']["ordernum"] : "Order Number";
   $tab_ger_campos['active'] = "on";
   $tab_def_campos['active'] = "active";
   $tab_labels["active"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_group_product']['labels']["active"])) ? $_SESSION['sc_session'][$sc_init]['grid_group_product']['labels']["active"] : "Active";
   $tab_ger_campos['picture'] = "on";
   $tab_def_campos['picture'] = "picture";
   $tab_labels["picture"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_group_product']['labels']["picture"])) ? $_SESSION['sc_session'][$sc_init]['grid_group_product']['labels']["picture"] : "Picture";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_group_product']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_group_product']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_group_product']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_group_product']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_group_product']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_group_product']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_group_product']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_group_product']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_group_product']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_group_product']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_group_product']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_group_product']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_group_product_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_group_product']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_group_product']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_group_product']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_group_product']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_group_product']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
