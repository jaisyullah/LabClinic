...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LMMS_____grid_group_product"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LMMS_____grid_group_product"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_group_product'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_group_product']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_group_product']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_group_product']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_group_product']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_group_product']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_group_product</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_group_product']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_group_product']['embutida_filho'] as $ind => $sc_init)
          {
