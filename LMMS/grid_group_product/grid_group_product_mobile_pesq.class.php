...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "id";$Nm_numeric[] = "active";$Nm_numeric[] = "ordernum";$Nm_numeric[] = "id";$Nm_numeric[] = "active";$Nm_numeric[] = "ordernum";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_ordernum_cond" name="ordernum_cond" onChange="nm_campos_between(document.getElementById('id_vis_ordernum'), this, 'ordernum')">
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_active"  <?php echo $str_hide_active?>><INPUT  type="text" id="SC_active" name="active" value="<?php echo NM_encode_input($active) ?>" size=1 alt="{datatype: 'integer', maxLength: 1, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
