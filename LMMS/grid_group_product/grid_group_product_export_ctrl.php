<?php
@session_start() ;
$_SESSION['scriptcase']['grid_group_product']['sc_process_barr'] = true;
require_once('../grid_group_product/index.php');
unset($_SESSION['scriptcase']['grid_group_product']['sc_process_barr']);
$ExportCtrl = new grid_group_product_export_control;
$ExportCtrl->Export_barr();

class grid_group_product_export_control
{
