  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_outpatient_reg" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_outpatient_reg_form();
	}
  ...
  // ---------- Validate trancode
  function do_ajax_form_outpatient_reg_validate_trancode()
  {
    var nomeCampo_trancode = "trancode";
    var var_trancode = scAjaxGetFieldText(nomeCampo_trancode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outpatient_reg_validate_trancode(var_trancode, var_script_case_init, do_ajax_form_outpatient_reg_validate_trancode_cb);
  } // do_ajax_form_outpatient_reg_validate_trancode

  function do_ajax_form_outpatient_reg_validate_trancode_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outpatient_reg_validate_trancode_cb

  // ---------- Validate patientid
  function do_ajax_form_outpatient_reg_validate_patientid()
  {
    var nomeCampo_patientid = "patientid";
    var var_patientid = scAjaxGetFieldText(nomeCampo_patientid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outpatient_reg_validate_patientid(var_patientid, var_script_case_init, do_ajax_form_outpatient_reg_validate_patientid_cb);
  } // do_ajax_form_outpatient_reg_validate_patientid

  function do_ajax_form_outpatient_reg_validate_patientid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outpatient_reg_validate_patientid_cb

  // ---------- Validate regdate
  function do_ajax_form_outpatient_reg_validate_regdate()
  {
    var nomeCampo_regdate = "regdate";
    var var_regdate = scAjaxGetFieldText(nomeCampo_regdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outpatient_reg_validate_regdate(var_regdate, var_script_case_init, do_ajax_form_outpatient_reg_validate_regdate_cb);
  } // do_ajax_form_outpatient_reg_validate_regdate

  function do_ajax_form_outpatient_reg_validate_regdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "regdate";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outpatient_reg_validate_regdate_cb

  // ---------- Validate regtime
  function do_ajax_form_outpatient_reg_validate_regtime()
  {
    var nomeCampo_regtime = "regtime";
    var var_regtime = scAjaxGetFieldText(nomeCampo_regtime);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outpatient_reg_validate_regtime(var_regtime, var_script_case_init, do_ajax_form_outpatient_reg_validate_regtime_cb);
  } // do_ajax_form_outpatient_reg_validate_regtime

  function do_ajax_form_outpatient_reg_validate_regtime_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "regtime";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outpatient_reg_validate_regtime_cb

  // ---------- Validate queueno
  function do_ajax_form_outpatient_reg_validate_queueno()
  {
    var nomeCampo_queueno = "queueno";
    var var_queueno = scAjaxGetFieldText(nomeCampo_queueno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outpatient_reg_validate_queueno(var_queueno, var_script_case_init, do_ajax_form_outpatient_reg_validate_queueno_cb);
  } // do_ajax_form_outpatient_reg_validate_queueno

  function do_ajax_form_outpatient_reg_validate_queueno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "queueno";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outpatient_reg_validate_queueno_cb

  // ---------- Validate deptid
  function do_ajax_form_outpatient_reg_validate_deptid()
  {
    var nomeCampo_deptid = "deptid";
    var var_deptid = scAjaxGetFieldSelect(nomeCampo_deptid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outpatient_reg_validate_deptid(var_deptid, var_script_case_init, do_ajax_form_outpatient_reg_validate_deptid_cb);
  } // do_ajax_form_outpatient_reg_validate_deptid

  function do_ajax_form_outpatient_reg_validate_deptid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "deptid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outpatient_reg_validate_deptid_cb

  // ---------- Validate doctorid
  function do_ajax_form_outpatient_reg_validate_doctorid()
  {
    var nomeCampo_doctorid = "doctorid";
    var var_doctorid = scAjaxGetFieldSelect(nomeCampo_doctorid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outpatient_reg_validate_doctorid(var_doctorid, var_script_case_init, do_ajax_form_outpatient_reg_validate_doctorid_cb);
  } // do_ajax_form_outpatient_reg_validate_doctorid

  function do_ajax_form_outpatient_reg_validate_doctorid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outpatient_reg_validate_doctorid_cb

  // ---------- Validate finishdate
  function do_ajax_form_outpatient_reg_validate_finishdate()
  {
    var nomeCampo_finishdate = "finishdate";
    var var_finishdate = scAjaxGetFieldText(nomeCampo_finishdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outpatient_reg_validate_finishdate(var_finishdate, var_script_case_init, do_ajax_form_outpatient_reg_validate_finishdate_cb);
  } // do_ajax_form_outpatient_reg_validate_finishdate

  function do_ajax_form_outpatient_reg_validate_finishdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outpatient_reg_validate_finishdate_cb

  // ---------- Validate servicedate
  function do_ajax_form_outpatient_reg_validate_servicedate()
  {
    var nomeCampo_servicedate = "servicedate";
    var var_servicedate = scAjaxGetFieldText(nomeCampo_servicedate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outpatient_reg_validate_servicedate(var_servicedate, var_script_case_init, do_ajax_form_outpatient_reg_validate_servicedate_cb);
  } // do_ajax_form_outpatient_reg_validate_servicedate

  function do_ajax_form_outpatient_reg_validate_servicedate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outpatient_reg_validate_servicedate_cb

  // ---------- Validate paymentid
  function do_ajax_form_outpatient_reg_validate_paymentid()
  {
    var nomeCampo_paymentid = "paymentid";
    var var_paymentid = scAjaxGetFieldSelect(nomeCampo_paymentid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outpatient_reg_validate_paymentid(var_paymentid, var_script_case_init, do_ajax_form_outpatient_reg_validate_paymentid_cb);
  } // do_ajax_form_outpatient_reg_validate_paymentid

  function do_ajax_form_outpatient_reg_validate_paymentid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outpatient_reg_validate_paymentid_cb

  // ---------- Validate institutionid
  function do_ajax_form_outpatient_reg_validate_institutionid()
  {
    var nomeCampo_institutionid = "institutionid";
    var var_institutionid = scAjaxGetFieldSelect(nomeCampo_institutionid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outpatient_reg_validate_institutionid(var_institutionid, var_script_case_init, do_ajax_form_outpatient_reg_validate_institutionid_cb);
  } // do_ajax_form_outpatient_reg_validate_institutionid

  function do_ajax_form_outpatient_reg_validate_institutionid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outpatient_reg_validate_institutionid_cb

  // ---------- Validate institutionno
  function do_ajax_form_outpatient_reg_validate_institutionno()
  {
    var nomeCampo_institutionno = "institutionno";
    var var_institutionno = scAjaxGetFieldText(nomeCampo_institutionno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outpatient_reg_validate_institutionno(var_institutionno, var_script_case_init, do_ajax_form_outpatient_reg_validate_institutionno_cb);
  } // do_ajax_form_outpatient_reg_validate_institutionno

  function do_ajax_form_outpatient_reg_validate_institutionno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outpatient_reg_validate_institutionno_cb

  // ---------- Validate statusid
  function do_ajax_form_outpatient_reg_validate_statusid()
  {
    var nomeCampo_statusid = "statusid";
    var var_statusid = scAjaxGetFieldSelect(nomeCampo_statusid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outpatient_reg_validate_statusid(var_statusid, var_script_case_init, do_ajax_form_outpatient_reg_validate_statusid_cb);
  } // do_ajax_form_outpatient_reg_validate_statusid

  function do_ajax_form_outpatient_reg_validate_statusid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outpatient_reg_validate_statusid_cb

  // ---------- Validate staffid
  function do_ajax_form_outpatient_reg_validate_staffid()
  {
    var nomeCampo_staffid = "staffid";
    var var_staffid = scAjaxGetFieldSelect(nomeCampo_staffid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_outpatient_reg_validate_staffid(var_staffid, var_script_case_init, do_ajax_form_outpatient_reg_validate_staffid_cb);
  } // do_ajax_form_outpatient_reg_validate_staffid

  function do_ajax_form_outpatient_reg_validate_staffid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "staffid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_outpatient_reg_validate_staffid_cb

  // ---------- Event onchange doctorid
  function do_ajax_form_outpatient_reg_event_doctorid_onchange()
  {
    ...
    scAjaxProcOn(true);
    x_ajax_form_outpatient_reg_event_doctorid_onchange(var_regdate, var_doctorid, var_queueno, var_script_case_init, do_ajax_form_outpatient_reg_event_doctorid_onchange_cb);
  } // do_ajax_form_outpatient_reg_event_doctorid_onchange

  function do_ajax_form_outpatient_reg_event_doctorid_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "doctorid";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_outpatient_reg_event_doctorid_onchange_cb_after_alert);
  } // do_ajax_form_outpatient_reg_event_doctorid_onchange_cb
  function do_ajax_form_outpatient_reg_event_doctorid_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_outpatient_reg_event_doctorid_onchange_cb_after_alert

  // ---------- Event onchange regdate
  function do_ajax_form_outpatient_reg_event_regdate_onchange()
  {
    var var_regdate = scAjaxGetFieldText("regdate");
    var var_doctorid = scAjaxGetFieldSelect("doctorid");
    var var_queueno = scAjaxGetFieldText("queueno");
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_outpatient_reg_event_regdate_onchange(var_regdate, var_doctorid, var_queueno, var_script_case_init, do_ajax_form_outpatient_reg_event_regdate_onchange_cb);
  } // do_ajax_form_outpatient_reg_event_regdate_onchange

  function do_ajax_form_outpatient_reg_event_regdate_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "regdate";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_outpatient_reg_event_regdate_onchange_cb_after_alert);
  } // do_ajax_form_outpatient_reg_event_regdate_onchange_cb
  function do_ajax_form_outpatient_reg_event_regdate_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_outpatient_reg_event_regdate_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_outpatient_reg_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_outpatient_reg_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_outpatient_reg_submit_form(var_trancode, var_patientid, var_regdate, var_regtime, var_queueno, var_deptid, var_doctorid, var_finishdate, var_servicedate, var_paymentid, var_institutionid, var_institutionno, var_statusid, var_staffid, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_outpatient_reg_submit_form_cb);
  } // do_ajax_form_outpatient_reg_submit_form

  function do_ajax_form_outpatient_reg_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_outpatient_reg_submit_form_cb_after_alert);
  } // do_ajax_form_outpatient_reg_submit_form_cb
  function do_ajax_form_outpatient_reg_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_outpatient_reg_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_outpatient_reg_navigate_form()
  {
    perform_ajax_form_outpatient_reg_navigate_form();
  }

  function perform_ajax_form_outpatient_reg_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn();
    x_ajax_form_outpatient_reg_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_outpatient_reg_navigate_form_cb);
  } // do_ajax_form_outpatient_reg_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_outpatient_reg_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_outpatient_reg_navigate_form_cb_after_alert);
  } // do_ajax_form_outpatient_reg_navigate_form_cb
  function do_ajax_form_outpatient_reg_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_outpatient_reg_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_outpatient_reg_navigate_form_cb_after_alert
  function sc_hide_form_outpatient_reg_form()
  {
