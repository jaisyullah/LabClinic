...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('change', function() { sc_form_outpatient_reg_id_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_deptid' + iSeqRow).bind('blur', function() { sc_form_outpatient_reg_deptid_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_outpatient_reg_deptid_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_queueno' + iSeqRow).bind('blur', function() { sc_form_outpatient_reg_queueno_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_outpatient_reg_queueno_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_regtime' + iSeqRow).bind('blur', function() { sc_form_outpatient_reg_regtime_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_outpatient_reg_regtime_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_finishdate' + iSeqRow).bind('blur', function() { sc_form_outpatient_reg_finishdate_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_outpatient_reg_finishdate_onchange(this, iSeqRow) })
                                        .bind('focus', function() { sc_form_outpatient_reg_finishdate_onfocus(this, iSeqRow) });
  $('#id_sc_field_finishdate_hora' + iSeqRow).bind('blur', function() { sc_form_outpatient_reg_finishdate_hora_onblur(this, iSeqRow) })
                                             .bind('change', function() { sc_form_outpatient_reg_finishdate_hora_onchange(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_outpatient_reg_finishdate_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_servicedate' + iSeqRow).bind('blur', function() { sc_form_outpatient_reg_servicedate_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_outpatient_reg_servicedate_onchange(this, iSeqRow) })
                                         .bind('focus', function() { sc_form_outpatient_reg_servicedate_onfocus(this, iSeqRow) });
  $('#id_sc_field_servicedate_hora' + iSeqRow).bind('blur', function() { sc_form_outpatient_reg_servicedate_hora_onblur(this, iSeqRow) })
                                              .bind('change', function() { sc_form_outpatient_reg_servicedate_hora_onchange(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_outpatient_reg_servicedate_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_trancode' + iSeqRow).bind('blur', function() { sc_form_outpatient_reg_trancode_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_outpatient_reg_trancode_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_statusid' + iSeqRow).bind('blur', function() { sc_form_outpatient_reg_statusid_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_outpatient_reg_statusid_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_paymentid' + iSeqRow).bind('blur', function() { sc_form_outpatient_reg_paymentid_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_outpatient_reg_paymentid_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_institutionid' + iSeqRow).bind('blur', function() { sc_form_outpatient_reg_institutionid_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_outpatient_reg_institutionid_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_institutionno' + iSeqRow).bind('blur', function() { sc_form_outpatient_reg_institutionno_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_outpatient_reg_institutionno_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_staffid' + iSeqRow).bind('blur', function() { sc_form_outpatient_reg_staffid_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_outpatient_reg_staffid_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_outpatient_reg_staffid_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_outpatient_reg_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_outpatient_reg_deptid_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_outpatient_reg_queueno_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_outpatient_reg_regtime_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_outpatient_reg_finishdate_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_outpatient_reg_validate_finishdate();
  scCssBlur(oThis);
}

function sc_form_outpatient_reg_finishdate_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_outpatient_reg_finishdate_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_outpatient_reg_finishdate_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_outpatient_reg_servicedate_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_outpatient_reg_validate_servicedate();
  scCssBlur(oThis);
}

function sc_form_outpatient_reg_servicedate_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_outpatient_reg_servicedate_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_outpatient_reg_servicedate_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_outpatient_reg_trancode_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_outpatient_reg_statusid_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_outpatient_reg_paymentid_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_outpatient_reg_institutionid_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_outpatient_reg_institutionno_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_outpatient_reg_staffid_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_outpatient_reg_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_regdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_outpatient_reg_validate_regdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_finishdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_outpatient_reg_validate_finishdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_servicedate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_outpatient_reg_validate_servicedate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_outpatient_reg')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
