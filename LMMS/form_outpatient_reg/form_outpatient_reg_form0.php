...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['embutida_pdf']))
 {
 ?>
...
?>
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>form_outpatient_reg/form_outpatient_reg_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
...
include_once('form_outpatient_reg_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['recarga'];
}
if ('' != $this->patientid)
{
    ...
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_outpatient_reg_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/nm_rpc.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_outpatient_reg'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_outpatient_reg'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['fast_search'][2] : "";
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_patientid_line" id="hidden_field_data_patientid" style="<?php echo $sStyleHidden_patientid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_patientid_line" style="vertical-align: top;padding: 0px">
...
<span id="id_read_on_patientid" class="sc-ui-readonly-patientid css_patientid_line" style="<?php echo $sStyleReadLab_patientid; ?>"><?php echo $this->form_format_readonly("patientid", $this->form_encode_input($this->patientid)); ?></span><span id="id_read_off_patientid" class="css_read_off_patientid" style="white-space: nowrap;<?php echo $sStyleReadInp_patientid; ?>">
 ...
 size=15 maxlength=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_outpatient_reg*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_patient_settings"]) && $this->Ini->sc_lig_md5["grid_patient_settings"] == "S") {
       $Parms_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,patientid,patientcode*scoutnm_evt_ret_busca*scinsc_form_outpatient_reg_patientid_onchange(this)*scoutjs_lookup*scinlookup_patientid*scout" . $Sc_iframe_master;
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_outpatient_reg@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
       $Md5_Lig  = "nmgp_url_saida*scin*scoutnmgp_parms_ret*scinF1,patientid,patientcode*scoutnm_evt_ret_busca*scinsc_form_outpatient_reg_patientid_onchange(this)*scoutjs_lookup*scinlookup_patientid*scout" . $Sc_iframe_master;
   }
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_regdate_label" id="hidden_field_label_regdate" style="<?php echo $sStyleHidden_regdate; ?>"><span id="id_label_regdate"><?php echo $this->nm_new_label['regdate']; ?></span></TD>
    <TD class="scFormDataOdd css_regdate_line" id="hidden_field_data_regdate" style="<?php echo $sStyleHidden_regdate; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_regdate_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_regtime_label" id="hidden_field_label_regtime" style="<?php echo $sStyleHidden_regtime; ?>"><span id="id_label_regtime"><?php echo $this->nm_new_label['regtime']; ?></span></TD>
    <TD class="scFormDataOdd css_regtime_line" id="hidden_field_data_regtime" style="<?php echo $sStyleHidden_regtime; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_regtime_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_queueno_label" id="hidden_field_label_queueno" style="<?php echo $sStyleHidden_queueno; ?>"><span id="id_label_queueno"><?php echo $this->nm_new_label['queueno']; ?></span></TD>
    <TD class="scFormDataOdd css_queueno_line" id="hidden_field_data_queueno" style="<?php echo $sStyleHidden_queueno; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_queueno_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_deptid_label" id="hidden_field_label_deptid" style="<?php echo $sStyleHidden_deptid; ?>"><span id="id_label_deptid"><?php echo $this->nm_new_label['deptid']; ?></span></TD>
    <TD class="scFormDataOdd css_deptid_line" id="hidden_field_data_deptid" style="<?php echo $sStyleHidden_deptid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_deptid_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['Lookup_deptid'][] = ''; ?>
 <option value=""></option>
 <option  value="1" <?php  if ($this->deptid == "1") { echo " selected" ;} ?><?php  if (empty($this->deptid)) { echo " selected" ;} ?>>Laboratory</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['Lookup_deptid'][] = '1'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_doctorid_label" id="hidden_field_label_doctorid" style="<?php echo $sStyleHidden_doctorid; ?>"><span id="id_label_doctorid"><?php echo $this->nm_new_label['doctorid']; ?></span></TD>
    <TD class="scFormDataOdd css_doctorid_line" id="hidden_field_data_doctorid" style="<?php echo $sStyleHidden_doctorid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_doctorid_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_finishdate_line" id="hidden_field_data_finishdate" style="<?php echo $sStyleHidden_finishdate; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_finishdate_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_servicedate_label" id="hidden_field_label_servicedate" style="<?php echo $sStyleHidden_servicedate; ?>"><span id="id_label_servicedate"><?php echo $this->nm_new_label['servicedate']; ?></span></TD>
    <TD class="scFormDataOdd css_servicedate_line" id="hidden_field_data_servicedate" style="<?php echo $sStyleHidden_servicedate; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_servicedate_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_paymentid_label" id="hidden_field_label_paymentid" style="<?php echo $sStyleHidden_paymentid; ?>"><span id="id_label_paymentid"><?php echo $this->nm_new_label['paymentid']; ?></span></TD>
    <TD class="scFormDataOdd css_paymentid_line" id="hidden_field_data_paymentid" style="<?php echo $sStyleHidden_paymentid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_paymentid_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_institutionid_label" id="hidden_field_label_institutionid" style="<?php echo $sStyleHidden_institutionid; ?>"><span id="id_label_institutionid"><?php echo $this->nm_new_label['institutionid']; ?></span></TD>
    <TD class="scFormDataOdd css_institutionid_line" id="hidden_field_data_institutionid" style="<?php echo $sStyleHidden_institutionid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_institutionid_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_institutionno_label" id="hidden_field_label_institutionno" style="<?php echo $sStyleHidden_institutionno; ?>"><span id="id_label_institutionno"><?php echo $this->nm_new_label['institutionno']; ?></span></TD>
    <TD class="scFormDataOdd css_institutionno_line" id="hidden_field_data_institutionno" style="<?php echo $sStyleHidden_institutionno; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_institutionno_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_statusid_line" id="hidden_field_data_statusid" style="<?php echo $sStyleHidden_statusid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_statusid_line" style="vertical-align: top;padding: 0px">
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['Lookup_statusid'][] = '1'; ?>
 <option  value="2" <?php  if ($this->statusid == "2") { echo " selected" ;} ?>>Handled</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['Lookup_statusid'][] = '2'; ?>
 <option  value="3" <?php  if ($this->statusid == "3") { echo " selected" ;} ?>>Done</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['Lookup_statusid'][] = '3'; ?>
 <option  value="4" <?php  if ($this->statusid == "4") { echo " selected" ;} ?>>Completed</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['Lookup_statusid'][] = '4'; ?>
 <option  value="0" <?php  if ($this->statusid == "0") { echo " selected" ;} ?>>Cancel</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['Lookup_statusid'][] = '0'; ?>
 </select></span>
</span><?php  }?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_staffid_line" id="hidden_field_data_staffid" style="<?php echo $sStyleHidden_staffid; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_staffid_line" style="vertical-align: top;padding: 0px">
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_outpatient_reg");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_outpatient_reg");
 parent.scAjaxDetailHeight("form_outpatient_reg", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_outpatient_reg']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
