<?php
@session_start() ;
$_SESSION['scriptcase']['grid_patient_settings']['sc_process_barr'] = true;
require_once('../grid_patient_settings/index.php');
unset($_SESSION['scriptcase']['grid_patient_settings']['sc_process_barr']);
$ExportCtrl = new grid_patient_settings_export_control;
$ExportCtrl->Export_barr();

class grid_patient_settings_export_control
{
