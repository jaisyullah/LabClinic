...
<?php
   ...
   $Ord_Cmp = new grid_patient_settings_Ord_cmp(); 
   $Ord_Cmp->Ord_cmp_init();
   
class grid_patient_settings_Ord_cmp
{
function Ord_cmp_init()
{
  global $sc_init, $path_img, $path_btn, $use_alias, $tab_ger_campos, $tab_def_campos, $tab_def_seq, $tab_labels, $embbed, $tbar_pos, $_POST, $_GET;
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_patient_settings']['ordem_select_orig']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['ordem_select_orig'] = array();
   }
   ...
   $tab_labels["patientcode"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patient_settings']['labels']["patientcode"])) ? $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['labels']["patientcode"] : "Patient Code";
   $tab_ger_campos['name'] = "on";
   $tab_def_campos['name'] = "name";
   $tab_labels["name"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patient_settings']['labels']["name"])) ? $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['labels']["name"] : "Name";
   $tab_ger_campos['birthdate'] = "on";
   $tab_def_campos['birthdate'] = "birthDate";
   $tab_labels["birthdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patient_settings']['labels']["birthdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['labels']["birthdate"] : "Birth Date";
   $tab_ger_campos['gender'] = "on";
   $tab_def_campos['gender'] = "gender";
   $tab_labels["gender"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patient_settings']['labels']["gender"])) ? $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['labels']["gender"] : "Gender";
   $tab_ger_campos['address'] = "on";
   $tab_def_campos['address'] = "address";
   $tab_labels["address"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patient_settings']['labels']["address"])) ? $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['labels']["address"] : "Address";
   $tab_ger_campos['cityid'] = "on";
   $tab_def_campos['cityid'] = "cityID";
   $tab_labels["cityid"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patient_settings']['labels']["cityid"])) ? $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['labels']["cityid"] : "City Name";
   $tab_ger_campos['regdate'] = "on";
   $tab_def_campos['regdate'] = "regDate";
   $tab_labels["regdate"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patient_settings']['labels']["regdate"])) ? $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['labels']["regdate"] : "Reg Date";
   $tab_ger_campos['photo'] = "on";
   $tab_def_campos['photo'] = "photo";
   $tab_labels["photo"]   = (isset($_SESSION['sc_session'][$sc_init]['grid_patient_settings']['labels']["photo"])) ? $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['labels']["photo"] : "Photo";
   ...
   if (isset($_SESSION['sc_session'][$sc_init]['grid_patient_settings']['php_cmp_sel']) && !empty($_SESSION['sc_session'][$sc_init]['grid_patient_settings']['php_cmp_sel']))
   {
       foreach ($_SESSION['sc_session'][$sc_init]['grid_patient_settings']['php_cmp_sel'] as $NM_cada_field => $NM_cada_opc)
       {
           if ($NM_cada_opc == "off")
           {
              $tab_ger_campos[$NM_cada_field] = "none";
   ...
   if (!isset($_SESSION['sc_session'][$sc_init]['grid_patient_settings']['ordem_select']))
   {
       $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['ordem_select'] = array();
   }
...
function Sel_processa_out_sel($campos_sel)
{
   ...
   $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['ordem_select'] = array();
   $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['ordem_grid']   = "";
   $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['ordem_cmp']    = "";
   foreach ($campos_sel as $campo_sort)
   {
       ...
       if (isset($tab_def_campos[$campo]))
       {
           ...
           if (isset($_SESSION['sc_session'][$sc_init]['grid_patient_settings']['ordem_quebra']))
           {
               foreach($_SESSION['sc_session'][$sc_init]['grid_patient_settings']['ordem_quebra'] as $campo_quebra => $resto) 
               {
                   foreach($resto as $sqldef => $ordem_ant) 
                   {
                       if ($sqldef == $tab_def_campos[$campo]) 
                       { 
                           $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['ordem_quebra'][$campo][$sqldef] = $ordem;
           ...
           if (!$Ordem_tem_quebra)
           {
               $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['ordem_select'][$tab_def_campos[$campo]] = $ordem;
           }   
       }
   }
?>
...
?>
  function scSubmitOrderCampos(sPos, sType) {
   ...
   return new Promise(function(resolve, reject) {$.ajax({
    type: "POST",
    url: "grid_patient_settings_order_campos.php",
    data: {
...
<?php
   ...
   $arr_order = ($this->restore) ? $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['ordem_select_orig'] : $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['ordem_select'];
...
<?php
  $disp_rest = "none";
  if (isset($_SESSION['sc_session'][$sc_init]['grid_patient_settings']['ordem_select']) && $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['ordem_select'] != $_SESSION['sc_session'][$sc_init]['grid_patient_settings']['ordem_select_orig']) {
      $disp_rest = "";
  }
   if (!$embbed)
   {
