...
class grid_report_response_time_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['path_libs_php'] = $this->Ini->path_lib_php;
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['prim_vez']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['prim_vez'] = "S";
      }
   ...
   function init()
   {
    ...
    {
      $_SESSION['scriptcase']['grid_report_response_time']['contr_erro'] = 'on';
 $this->nmgp_botoes["exit"] = "off";;
$_SESSION['scriptcase']['grid_report_response_time']['contr_erro'] = 'off'; 
      if (isset($processed_day))
      {
          $processed_dia = $processed_day; 
      }
      if (isset($processed_month))
      {
          $processed_mes = $processed_month; 
      }
      if (isset($processed_year))
      {
          $processed_ano = $processed_year; 
      }
      if (isset($processed))
      {
          $processed = str_replace("0000", "", $processed);
          $processed = str_replace("-00", "-", $processed);
          $processedXX = explode("-", $processed);
          if (isset($processedXX[2]))
          {
              $processed_dia = $processedXX[2]; 
          }
          if (isset($processedXX[1]))
          {
              $processed_mes = $processedXX[1]; 
          }
          if (isset($processedXX[0]))
          {
              $processed_ano = $processedXX[0]; 
          }
      }
      if (isset($processed_input_2_day))
      {
          $processed_input_2_dia = $processed_input_2_day; 
      }
      if (isset($processed_input_2_month))
      {
          $processed_input_2_mes = $processed_input_2_month; 
      }
      if (isset($processed_input_2_year))
      {
          $processed_input_2_ano = $processed_input_2_year; 
      }
      if (isset($processed_2))
      {
          $processed_2 = str_replace("0000", "", $processed_2);
          $processed_2 = str_replace("-00", "-", $processed_2);
          $processedXX = explode("-", $processed_2);
          if (isset($processedXX[2]))
          {
              $processed_input_2_dia = $processedXX[2]; 
          }
          if (isset($processedXX[1]))
          {
              $processed_input_2_mes = $processedXX[1]; 
          }
          if (isset($processedXX[0]))
          {
              $processed_input_2_ano = $processedXX[0]; 
          }
      }
    }
   }
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_report_response_time_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_report_response_time_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_report_response_time_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "a.time";$Nm_datas[] = "a_time";$Nm_datas[] = "b.time";$Nm_datas[] = "b_time";$Nm_datas[] = "c.time";$Nm_datas[] = "c_time";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['proc_res'])) 
    {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['prim_vez'] == "N" && !$_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_report_response_time').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_report_response_time').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_report_response_time').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>';
}
<?php
    }
    else
...
<?php
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['prim_vez'] = "N";
?>
</SCRIPT>
</BODY>
</HTML>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_report_response_time/grid_report_response_time_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_report_response_time_ajax_search.js"></script>
 <script type="text/javascript" src="grid_report_response_time_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_report_response_time_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_report_response_time']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_report_response_time']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_processed_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_processed_dia').value + '/';
          var_dt_ini += document.getElementById('SC_processed_mes').value + '/';
          var_dt_ini += document.getElementById('SC_processed_ano').value;
          document.getElementById('sc_processed_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_processed_dia').value = aParts[0];
          document.getElementById('SC_processed_mes').value = aParts[1];
          document.getElementById('SC_processed_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_processed_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_processed_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_processed_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_processed_input_2_ano').value;
          document.getElementById('sc_processed_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_processed_input_2_dia').value = aParts[0];
          document.getElementById('SC_processed_input_2_mes').value = aParts[1];
          document.getElementById('SC_processed_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  var str_out = "";
  str_out += 'SC_processed_cond#NMF#' + search_get_sel_txt('SC_processed_cond') + '@NMF@';
  str_out += 'SC_processed_dia#NMF#' + search_get_sel_txt('SC_processed_dia') + '@NMF@';
  str_out += 'SC_processed_mes#NMF#' + search_get_sel_txt('SC_processed_mes') + '@NMF@';
  str_out += 'SC_processed_ano#NMF#' + search_get_sel_txt('SC_processed_ano') + '@NMF@';
  str_out += 'SC_processed_input_2_dia#NMF#' + search_get_sel_txt('SC_processed_input_2_dia') + '@NMF@';
  str_out += 'SC_processed_input_2_mes#NMF#' + search_get_sel_txt('SC_processed_input_2_mes') + '@NMF@';
  str_out += 'SC_processed_input_2_ano#NMF#' + search_get_sel_txt('SC_processed_input_2_ano') + '@NMF@';
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $processed_cond, $processed, $processed_dia, $processed_mes, $processed_ano, $processed_input_2_dia, $processed_input_2_mes, $processed_input_2_ano,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $processed_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['processed_dia']; 
          $processed_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['processed_mes']; 
          $processed_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['processed_ano']; 
          $processed_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['processed_input_2_dia']; 
          $processed_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['processed_input_2_mes']; 
          $processed_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['processed_input_2_ano']; 
          $processed_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['processed_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['NM_operador']; 
      } 
      if (!isset($processed_cond) || empty($processed_cond))
      {
         $processed_cond = "bw";
      }
      ...
      $str_hide_processed = (in_array($processed_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;

      $str_display_processed = ('bw' == $processed_cond) ? $display_aberto : $display_fechado;

      if (!isset($processed) || $processed == "")
      {
          $processed = "";
      }
      if (isset($processed) && !empty($processed))
      {
         $tmp_pos = strpos($processed, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $processed = substr($processed, 0, $tmp_pos);
         }
      }
?>
 <TR align="center">
  ...
  <TD width="100%" height="">
   ...
   <tr>
      ...
      <TD id='SC_processed_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['processed'])) ? $this->New_label['processed'] : "Date of Transcation"; ?></TD>
      
      <INPUT type="hidden" id="SC_processed_cond" name="processed_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_processed" <?php echo $str_hide_processed?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['processed'])) ? $this->New_label['processed'] : "Date of Transcation";
 $nmgp_tab_label .= "processed?#?" . $SC_Label . "?@?";
...
<?php
  ...
  {
?>
<span id='id_date_part_processed_DD' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_processed_dia" name="processed_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $processed_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $processed_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $processed_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $processed_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $processed_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $processed_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $processed_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $processed_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $processed_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $processed_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $processed_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $processed_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $processed_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $processed_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $processed_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $processed_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $processed_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $processed_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $processed_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $processed_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $processed_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $processed_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $processed_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $processed_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $processed_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $processed_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $processed_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $processed_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $processed_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $processed_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $processed_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_processed_MM' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_processed_mes" name="processed_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $processed_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $processed_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $processed_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $processed_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $processed_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $processed_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $processed_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $processed_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $processed_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $processed_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $processed_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $processed_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_processed_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_processed_ano" name="processed_ano" value="<?php echo NM_encode_input($processed_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_processed_jq">
</span>
...
?>
        <SPAN id="id_css_processed" class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_processed"  <?php echo $str_display_processed; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_processed_input_2_DD' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_processed_input_2_dia" name="processed_input_2_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $processed_input_2_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $processed_input_2_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $processed_input_2_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $processed_input_2_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $processed_input_2_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $processed_input_2_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $processed_input_2_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $processed_input_2_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $processed_input_2_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $processed_input_2_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $processed_input_2_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $processed_input_2_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $processed_input_2_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $processed_input_2_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $processed_input_2_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $processed_input_2_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $processed_input_2_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $processed_input_2_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $processed_input_2_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $processed_input_2_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $processed_input_2_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $processed_input_2_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $processed_input_2_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $processed_input_2_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $processed_input_2_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $processed_input_2_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $processed_input_2_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $processed_input_2_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $processed_input_2_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $processed_input_2_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $processed_input_2_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_processed_input_2_MM' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_processed_input_2_mes" name="processed_input_2_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $processed_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $processed_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $processed_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $processed_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $processed_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $processed_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $processed_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $processed_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $processed_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $processed_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $processed_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $processed_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_processed_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_processed_input_2_ano" name="processed_input_2_ano" value="<?php echo NM_encode_input($processed_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_processed_jq2">
</span>
...
?>
<?php
   if (is_file("grid_report_response_time_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['opc_psq'])
   {
...
<?php
    if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['prim_vez'] == "N") 
    {
?>
       <iframe id="nmsc_iframe_grid_report_response_time" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_report_response_time" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>" width="100%"></iframe>
<?php
    }
    else
    {
?>
       <iframe id="nmsc_iframe_grid_report_response_time" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_report_response_time" scrolling="auto" src="" width="100%"></iframe>
<?php
    }
?>
<iframe id="nmsc_iframe_grid_report_response_time_pesq"  name="nm_iframe_grid_report_response_time_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_report_response_time_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_report_response_time').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   document.F1.processed_cond.value = 'bw';
   nm_campos_between(document.getElementById('id_vis_processed'), document.F1.processed_cond, 'processed');
   document.F1.processed_dia.value = "";
   document.F1.processed_mes.value = "";
   document.F1.processed_ano.value = "";
   document.F1.processed_input_2_dia.value = "";
   document.F1.processed_input_2_mes.value = "";
   document.F1.processed_input_2_ano.value = "";
 }
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "LMMS/grid_report_response_time";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_report_response_time/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_processed_cond'] = 'cond';
      $tp_fields['SC_processed_dia'] = 'text';
      $tp_fields['SC_processed_mes'] = 'text';
      $tp_fields['SC_processed_ano'] = 'text';
      $tp_fields['SC_processed_input_2_dia'] = 'text';
      $tp_fields['SC_processed_input_2_mes'] = 'text';
      $tp_fields['SC_processed_input_2_ano'] = 'text';
   ...
   {
      global $processed_cond, $processed, $processed_dia, $processed_mes, $processed_ano, $processed_input_2_dia, $processed_input_2_mes, $processed_input_2_ano, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      $processed_cond_salva = $processed_cond; 
      if (!isset($processed_input_2_dia) || $processed_input_2_dia == "")
      {
          $processed_input_2_dia = $processed_dia;
      }
      if (!isset($processed_input_2_mes) || $processed_input_2_mes == "")
      {
          $processed_input_2_mes = $processed_mes;
      }
      if (!isset($processed_input_2_ano) || $processed_input_2_ano == "")
      {
          $processed_input_2_ano = $processed_ano;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['processed_dia'] = $processed_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['processed_mes'] = $processed_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['processed_ano'] = $processed_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['processed_input_2_dia'] = $processed_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['processed_input_2_mes'] = $processed_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['processed_input_2_ano'] = $processed_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['processed_cond'] = $processed_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
      ...
      if ($processed_cond != "bi_TP")
      {
          $processed_cond = strtoupper($processed_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $processed_ano;
          $Dtxt .= $processed_mes;
          $Dtxt .= $processed_dia;
          $val[0]['ano'] = $processed_ano;
          $val[0]['mes'] = $processed_mes;
          $val[0]['dia'] = $processed_dia;
          if ($processed_cond == "BW")
          {
              $val[1]['ano'] = $processed_input_2_ano;
              $val[1]['mes'] = $processed_input_2_mes;
              $val[1]['dia'] = $processed_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATETIME", $processed_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $processed = $val[0];
          $this->cmp_formatado['processed'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['processed'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['processed'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['processed'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          if ($processed_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $processed_input_2     = $val[1];
              $this->cmp_formatado['processed_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']['processed_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['processed_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['processed_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          }
          if (!empty($Dtxt) || $processed_cond == "NU" || $processed_cond == "NN"|| $processed_cond == "EP"|| $processed_cond == "NE")
          {
              $this->monta_condicao("a.time", $processed_cond, $processed, $processed_input_2, 'processed', 'DATETIME');
          }
      }
   }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_report_response_time']['cond_pesq'] .= $this->NM_operador;
