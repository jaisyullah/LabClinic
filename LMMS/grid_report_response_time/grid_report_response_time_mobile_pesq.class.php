...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "a.time";$Nm_datas[] = "a_time";$Nm_datas[] = "b.time";$Nm_datas[] = "b_time";$Nm_datas[] = "c.time";$Nm_datas[] = "c_time";$Nm_numeric[] = "round( time_to_sec(( timediff( b_time,a_time ))) / 60 )";$Nm_numeric[] = "round( time_to_sec(( timediff( c_time,a_time ))) / 60 )";
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_processed"  <?php echo $str_hide_processed?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
          ...
          <BR>
        <SPAN id="id_vis_processed"  <?php echo $str_display_processed; ?> class="scFilterFieldFontOdd">
