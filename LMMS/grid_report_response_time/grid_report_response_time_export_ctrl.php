<?php
@session_start() ;
$_SESSION['scriptcase']['grid_report_response_time']['sc_process_barr'] = true;
require_once('../grid_report_response_time/index.php');
unset($_SESSION['scriptcase']['grid_report_response_time']['sc_process_barr']);
$ExportCtrl = new grid_report_response_time_export_control;
$ExportCtrl->Export_barr();

class grid_report_response_time_export_control
{
