...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_lng_cond" name="lng_cond" onChange="nm_campos_between(document.getElementById('id_vis_lng'), this, 'lng')">
      ...
      <br><span id="id_hide_lng"  <?php echo $str_hide_lng?>><?php
      if ($lng != "")
      {
      $lng_look = substr($this->Db->qstr($lng), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_city_cond" name="city_cond" onChange="nm_campos_between(document.getElementById('id_vis_city'), this, 'city')">
      ...
      <br><span id="id_hide_city"  <?php echo $str_hide_city?>><?php
      if ($city != "")
      {
      $city_look = substr($this->Db->qstr($city), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_city_ascii_cond" name="city_ascii_cond" onChange="nm_campos_between(document.getElementById('id_vis_city_ascii'), this, 'city_ascii')">
      ...
      <br><span id="id_hide_city_ascii"  <?php echo $str_hide_city_ascii?>><?php
      if ($city_ascii != "")
      {
      $city_ascii_look = substr($this->Db->qstr($city_ascii), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_lat_cond" name="lat_cond" onChange="nm_campos_between(document.getElementById('id_vis_lat'), this, 'lat')">
      ...
      <br><span id="id_hide_lat"  <?php echo $str_hide_lat?>><?php
      if ($lat != "")
      {
      $lat_look = substr($this->Db->qstr($lat), 1, -1); 
      $nmgp_def_dados = array(); 
