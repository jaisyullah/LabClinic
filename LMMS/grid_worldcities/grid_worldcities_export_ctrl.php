<?php
@session_start() ;
$_SESSION['scriptcase']['grid_worldcities']['sc_process_barr'] = true;
require_once('../grid_worldcities/index.php');
unset($_SESSION['scriptcase']['grid_worldcities']['sc_process_barr']);
$ExportCtrl = new grid_worldcities_export_control;
$ExportCtrl->Export_barr();

class grid_worldcities_export_control
{
