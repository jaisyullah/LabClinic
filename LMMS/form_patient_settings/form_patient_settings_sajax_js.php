  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_patient_settings" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_patient_settings_form();
	}
  ...
  // ---------- Validate id
  function do_ajax_form_patient_settings_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldHidden(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_settings_validate_id(var_id, var_script_case_init, do_ajax_form_patient_settings_validate_id_cb);
  } // do_ajax_form_patient_settings_validate_id

  function do_ajax_form_patient_settings_validate_id_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_settings_validate_id_cb

  // ---------- Validate patientcode
  function do_ajax_form_patient_settings_validate_patientcode()
  {
    var nomeCampo_patientcode = "patientcode";
    var var_patientcode = scAjaxGetFieldText(nomeCampo_patientcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_settings_validate_patientcode(var_patientcode, var_script_case_init, do_ajax_form_patient_settings_validate_patientcode_cb);
  } // do_ajax_form_patient_settings_validate_patientcode

  function do_ajax_form_patient_settings_validate_patientcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_settings_validate_patientcode_cb

  // ---------- Validate name
  function do_ajax_form_patient_settings_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_settings_validate_name(var_name, var_script_case_init, do_ajax_form_patient_settings_validate_name_cb);
  } // do_ajax_form_patient_settings_validate_name

  function do_ajax_form_patient_settings_validate_name_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "name";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_settings_validate_name_cb

  // ---------- Validate birthdate
  function do_ajax_form_patient_settings_validate_birthdate()
  {
    ...
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_settings_validate_birthdate(var_birthdate, var_birthdate_dia, var_birthdate_mes, var_birthdate_ano, var_script_case_init, do_ajax_form_patient_settings_validate_birthdate_cb);
  } // do_ajax_form_patient_settings_validate_birthdate

  function do_ajax_form_patient_settings_validate_birthdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_settings_validate_birthdate_cb

  // ---------- Validate gender
  function do_ajax_form_patient_settings_validate_gender()
  {
    var nomeCampo_gender = "gender";
    var var_gender = scAjaxGetFieldSelect(nomeCampo_gender);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_settings_validate_gender(var_gender, var_script_case_init, do_ajax_form_patient_settings_validate_gender_cb);
  } // do_ajax_form_patient_settings_validate_gender

  function do_ajax_form_patient_settings_validate_gender_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "gender";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_settings_validate_gender_cb

  // ---------- Validate address
  function do_ajax_form_patient_settings_validate_address()
  {
    var nomeCampo_address = "address";
    var var_address = scAjaxGetFieldText(nomeCampo_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_settings_validate_address(var_address, var_script_case_init, do_ajax_form_patient_settings_validate_address_cb);
  } // do_ajax_form_patient_settings_validate_address

  function do_ajax_form_patient_settings_validate_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "address";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_settings_validate_address_cb

  // ---------- Validate zipcode
  function do_ajax_form_patient_settings_validate_zipcode()
  {
    var nomeCampo_zipcode = "zipcode";
    var var_zipcode = scAjaxGetFieldText(nomeCampo_zipcode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_settings_validate_zipcode(var_zipcode, var_script_case_init, do_ajax_form_patient_settings_validate_zipcode_cb);
  } // do_ajax_form_patient_settings_validate_zipcode

  function do_ajax_form_patient_settings_validate_zipcode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "zipcode";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_settings_validate_zipcode_cb

  // ---------- Validate cityid
  function do_ajax_form_patient_settings_validate_cityid()
  {
    var nomeCampo_cityid = "cityid";
    var var_cityid = scAjaxGetFieldSelect(nomeCampo_cityid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_settings_validate_cityid(var_cityid, var_script_case_init, do_ajax_form_patient_settings_validate_cityid_cb);
  } // do_ajax_form_patient_settings_validate_cityid

  function do_ajax_form_patient_settings_validate_cityid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cityid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_settings_validate_cityid_cb

  // ---------- Validate photo
  function do_ajax_form_patient_settings_validate_photo()
  {
    var nomeCampo_photo = "photo";
    var var_photo = scAjaxGetFieldText(nomeCampo_photo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_settings_validate_photo(var_photo, var_script_case_init, do_ajax_form_patient_settings_validate_photo_cb);
  } // do_ajax_form_patient_settings_validate_photo

  function do_ajax_form_patient_settings_validate_photo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "photo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_settings_validate_photo_cb

  // ---------- Validate regdate
  function do_ajax_form_patient_settings_validate_regdate()
  {
    var nomeCampo_regdate = "regdate";
    var var_regdate = scAjaxGetFieldText(nomeCampo_regdate);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_patient_settings_validate_regdate(var_regdate, var_script_case_init, do_ajax_form_patient_settings_validate_regdate_cb);
  } // do_ajax_form_patient_settings_validate_regdate

  function do_ajax_form_patient_settings_validate_regdate_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "regdate";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_patient_settings_validate_regdate_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_patient_settings_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_patient_settings_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_patient_settings_submit_form(var_id, var_patientcode, var_name, var_birthdate_mes, var_birthdate_dia, var_birthdate_ano, var_gender, var_address, var_zipcode, var_cityid, var_photo, var_regdate, var_photo_ul_name, var_photo_ul_type, var_photo_salva, var_photo_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_patient_settings_submit_form_cb);
  } // do_ajax_form_patient_settings_submit_form

  function do_ajax_form_patient_settings_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_patient_settings_submit_form_cb_after_alert);
  } // do_ajax_form_patient_settings_submit_form_cb
  function do_ajax_form_patient_settings_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_patient_settings_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_patient_settings_navigate_form()
  {
    perform_ajax_form_patient_settings_navigate_form();
  }

  function perform_ajax_form_patient_settings_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_patient_settings_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_patient_settings_navigate_form_cb);
  } // do_ajax_form_patient_settings_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_patient_settings']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_patient_settings_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_patient_settings_navigate_form_cb_after_alert);
  } // do_ajax_form_patient_settings_navigate_form_cb
  function do_ajax_form_patient_settings_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_patient_settings_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_patient_settings_navigate_form_cb_after_alert
  function sc_hide_form_patient_settings_form()
  {
