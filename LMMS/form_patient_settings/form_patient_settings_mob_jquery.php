...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_regdate_hora' + iSeqRow).bind('blur', function() { sc_form_patient_settings_regdate_onblur(this, iSeqRow) })
                                          .bind('focus', function() { sc_form_patient_settings_regdate_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_patient_settings_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_dummy_birthdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      ...
      do_ajax_form_patient_settings_mob_validate_birthdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_regdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_patient_settings_mob_validate_regdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
function scJQUploadAdd(iSeqRow) {
  $("#id_sc_field_photo" + iSeqRow).fileupload({
    datatype: "json",
    url: "form_patient_settings_mob_ul_save.php",
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_patient_settings_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
