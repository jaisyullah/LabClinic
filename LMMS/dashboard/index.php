...
if ($Sem_Session && (!isset($nmgp_start) || $nmgp_start != "SC")) {
    ...
    elseif (is_file($root . $_SESSION['scriptcase']['dashboard']['glo_nm_path_imag_temp'] . "/sc_apl_default_LMMS.txt")) {
        $apl_def = explode(",", file_get_contents($root . $_SESSION['scriptcase']['dashboard']['glo_nm_path_imag_temp'] . "/sc_apl_default_LMMS.txt"));
    }
    if (isset($apl_def)) {
        ...
        if (isset($_COOKIE['sc_actual_lang_LMMS'])) {
            $_SESSION['scriptcase']['dashboard']['session_timeout']['lang'] = $_COOKIE['sc_actual_lang_LMMS'];
        }
    }
}
...
class dashboard_ini {
    ...
    function init()
    {
        ...
        $this->nm_hr_criacao   = "160831";
        $this->nm_autor_alt    = "admin";
        $this->nm_dt_ult_alt   = "20211011";
        $this->nm_hr_ult_alt   = "160452";
...
// 
  function conectDB()
  {
      ...
      { 
          $this->Db = db_conect_devel($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'], $this->root . $this->path_prod, 'LMMS', 1, $this->force_db_utf8); 
      } 
      else 
      { 
  ...
  function setConnectionHash() {
    if (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && isset($_SESSION['scriptcase']['dashboard']['glo_nm_conexao']) && !empty($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'])) {
      list($connectionDbms, $connectionHost, $connectionUser, $connectionPassword, $connectionDatabase) = db_conect_devel($_SESSION['scriptcase']['dashboard']['glo_nm_conexao'], $this->root . $this->path_prod, 'LMMS', 1, $this->force_db_utf8);
    }
    else {
...
class dashboard_control {
    ...
    function init()
    {
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['spedo_chart'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['chart_laboratory_medical'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['chart_outpatient_reg_payment'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['chart_outpatient_reg_provider'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
        ...
        $_SESSION['scriptcase']['dashboard_toolbar']['dashboard']['chart_outpatient_reg_staff'] = array(
            'form_update'     => true,
            'form_insert'     => true,
            'form_delete'     => true,
            'form_copy'       => true,
...
<div class='grid-stack'>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="3" data-gs-width="12" data-gs-height="6"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-0">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-0">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">SPEEDOCHART</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-0"><iframe id="id-iframe-0" name="dbifrm_widget1" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('spedo_chart'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget1"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget1&compact_mode=1&remove_margin=1&remove_border=0"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="0" data-gs-width="3" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-1">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-1">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">REGISTERED</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                ...
                <div  class="grid-stack-item" data-gs-x="3" data-gs-y="0" data-gs-width="3" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-2">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-2">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">SPECIMEN</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                ...
                <div  class="grid-stack-item" data-gs-x="6" data-gs-y="0" data-gs-width="3" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-3">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-3">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">PAYMENT</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                ...
                <div  class="grid-stack-item" data-gs-x="9" data-gs-y="0" data-gs-width="3" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-4">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-4">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">CANCELLED</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                ...
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="9" data-gs-width="4" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-5">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-5">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">GROSS INCOME</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                ...
                <div  class="grid-stack-item" data-gs-x="4" data-gs-y="9" data-gs-width="4" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-6">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-6">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">DISCOUNTS</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                ...
                <div  class="grid-stack-item" data-gs-x="8" data-gs-y="9" data-gs-width="4" data-gs-height="3"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-7">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-7">
                        <div class="widget-head" style="display:none">
                            <a href="#" class="collapse">COLLAPSE</a>
                            <a href="#" class="maximize" onclick="maximizeWidget('7');"><img src="<?php echo $this->Ini->path_icones . '/' . $this->Widget_max; ?>" style="border: 0; float: left; margin-top: 3px" class="sc-widget-maximize" alt="OUTSTANDING" /></a>
                            <h3 class="scContainerTitle">OUTSTANDING</h3>
                            <a href="#" class="remove">CLOSE</a>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none scContainerIndexMoldura scContainerIndexMoldura_widget8' style="height: 100%" id="id-div-iframe-7"><?php echo $this->getIndexContent_widget8(); ?></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="12" data-gs-width="6" data-gs-height="6"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-8">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-8">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">TOP BY DIAGNOSIS</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-8"><iframe id="id-iframe-8" name="dbifrm_widget9" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_laboratory_medical'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget9"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget9&compact_mode=1&remove_margin=1&remove_border=0"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="6" data-gs-y="12" data-gs-width="6" data-gs-height="6"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-9">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-9">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">REGISTERED BY PAYMENT</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-9"><iframe id="id-iframe-9" name="dbifrm_widget10" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_outpatient_reg_payment'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget10"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget10&compact_mode=1&remove_margin=1&remove_border=0"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="0" data-gs-y="18" data-gs-width="6" data-gs-height="6"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-10">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-10">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">COLLECTION BY PROVIDER</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-10"><iframe id="id-iframe-10" name="dbifrm_widget11" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_outpatient_reg_provider'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget11"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget11&compact_mode=1&remove_margin=1&remove_border=0"></iframe></div>
                    </div>
                </div>
                <div  class="grid-stack-item" data-gs-x="6" data-gs-y="18" data-gs-width="6" data-gs-height="6"  data-gs-no-resize="1" data-gs-no-move="1" id="id-father-11">
                    <div  class="grid-stack-item-content scContainerWidget" id="id-div-11">
                        <div class="widget-head" style="display:none">
                            <h3 class="scContainerTitle">STAFF PERFORMANCE</h3>
                            <a href="#" class="remove removeModal" style="display:none">CLOSE</a>
                        </div>
                        <div class='widget-content widget-content-title-none' id="id-div-iframe-11"><iframe id="id-iframe-11" name="dbifrm_widget12" class="sc-iframe-widget" style="height: 100%; width: 100%; border: 0px" src="<?php echo $this->Ini->path_link . SC_dir_app_name('chart_outpatient_reg_staff'); ?>/?script_case_init=<?php echo $_SESSION["scriptcase"]["dashboard_scinit"]["dashboard"]["dbifrm_widget12"] ?>&under_dashboard=1&dashboard_app=dashboard&own_widget=dbifrm_widget12&compact_mode=1&remove_margin=1&remove_border=0"></iframe></div>
                    </div>
                </div></div>
...
<?php
    ...
    function getIndexContentData_widget2() {
        ...
        {
            $sSql = "SELECT COUNT(ID), MONTH(regDate) FROM outpatient_reg GROUP BY MONTH(regDate) ORDER BY MONTH(regDate) DESC";
        }
        ...
        {
            $sSql = "SELECT COUNT(\"ID\"), EXTRACT(MONTH FROM \"regDate\") FROM outpatient_reg GROUP BY EXTRACT(MONTH FROM \"regDate\") ORDER BY EXTRACT(MONTH FROM \"regDate\") DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT COUNT(\"ID\"), EXTRACT(MONTH FROM \"regDate\") FROM outpatient_reg GROUP BY 2 ORDER BY EXTRACT(MONTH FROM \"regDate\") DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
        {
            $sSql = "SELECT COUNT(`ID`), MONTH(`regDate`) FROM outpatient_reg GROUP BY 2 ORDER BY MONTH(`regDate`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT COUNT(`ID`), strftime('%m', `regDate`) FROM outpatient_reg GROUP BY 2 ORDER BY strftime('%m', `regDate`) DESC";
        }
        ...
        {
            $sSql = "SELECT COUNT(ID), MM(regDate) FROM outpatient_reg GROUP BY 2 ORDER BY MM(regDate) DESC";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget2">Registered</span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget3() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT COUNT(ID), MONTH(tranDate) FROM laboratory_medical GROUP BY MONTH(tranDate) ORDER BY MONTH(tranDate) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
        {
            $sSql = "SELECT COUNT(\"ID\"), MONTH(\"tranDate\") FROM laboratory_medical GROUP BY MONTH(\"tranDate\") ORDER BY MONTH(\"tranDate\") DESC";
        ...
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
        {
            $sSql = "SELECT COUNT(\"ID\"), EXTRACT(MONTH FROM \"tranDate\") FROM laboratory_medical GROUP BY EXTRACT(MONTH FROM \"tranDate\") ORDER BY EXTRACT(MONTH FROM \"tranDate\") DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT COUNT(\"ID\"), EXTRACT(MONTH FROM \"tranDate\") FROM laboratory_medical GROUP BY 2 ORDER BY EXTRACT(MONTH FROM \"tranDate\") DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
        {
            $sSql = "SELECT COUNT(`ID`), MONTH(`tranDate`) FROM laboratory_medical GROUP BY 2 ORDER BY MONTH(`tranDate`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT COUNT(`ID`), strftime('%m', `tranDate`) FROM laboratory_medical GROUP BY 2 ORDER BY strftime('%m', `tranDate`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
        {
            $sSql = "SELECT COUNT(\"ID\"), EXTRACT(MONTH FROM \"tranDate\") FROM laboratory_medical GROUP BY 2 ORDER BY EXTRACT(MONTH FROM \"tranDate\") DESC";
        ...
        {
            $sSql = "SELECT COUNT(ID), MM(tranDate) FROM laboratory_medical GROUP BY 2 ORDER BY MM(tranDate) DESC";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget3">Speciment Taken</span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget4() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT COUNT(id), MONTH(date) FROM payment GROUP BY MONTH(date) ORDER BY MONTH(date) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
        {
            $sSql = "SELECT COUNT(\"id\"), MONTH(\"date\") FROM payment GROUP BY MONTH(\"date\") ORDER BY MONTH(\"date\") DESC";
        ...
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
        {
            $sSql = "SELECT COUNT(\"id\"), EXTRACT(MONTH FROM \"date\") FROM payment GROUP BY EXTRACT(MONTH FROM \"date\") ORDER BY EXTRACT(MONTH FROM \"date\") DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT COUNT(\"id\"), EXTRACT(MONTH FROM \"date\") FROM payment GROUP BY 2 ORDER BY EXTRACT(MONTH FROM \"date\") DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
        {
            $sSql = "SELECT COUNT(`id`), MONTH(`date`) FROM payment GROUP BY 2 ORDER BY MONTH(`date`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT COUNT(`id`), strftime('%m', `date`) FROM payment GROUP BY 2 ORDER BY strftime('%m', `date`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
        {
            $sSql = "SELECT COUNT(\"id\"), EXTRACT(MONTH FROM \"date\") FROM payment GROUP BY 2 ORDER BY EXTRACT(MONTH FROM \"date\") DESC";
        ...
        {
            $sSql = "SELECT COUNT(id), MM(date) FROM payment GROUP BY 2 ORDER BY MM(date) DESC";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget4">Payment</span></div>
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget5">Cancelled</span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget6() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT SUM(amount), MONTH(date) FROM payment WHERE (status = '2') GROUP BY MONTH(date) ORDER BY MONTH(date) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
        {
            $sSql = "SELECT SUM(\"amount\"), MONTH(\"date\") FROM payment WHERE (\"status\" = '2') GROUP BY MONTH(\"date\") ORDER BY MONTH(\"date\") DESC";
        ...
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
        {
            $sSql = "SELECT SUM(\"amount\"), EXTRACT(MONTH FROM \"date\") FROM payment WHERE (\"status\" = '2') GROUP BY EXTRACT(MONTH FROM \"date\") ORDER BY EXTRACT(MONTH FROM \"date\") DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT SUM(\"amount\"), EXTRACT(MONTH FROM \"date\") FROM payment WHERE (\"status\" = '2') GROUP BY 2 ORDER BY EXTRACT(MONTH FROM \"date\") DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
        {
            $sSql = "SELECT SUM(`amount`), MONTH(`date`) FROM payment WHERE (`status` = '2') GROUP BY 2 ORDER BY MONTH(`date`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT SUM(`amount`), strftime('%m', `date`) FROM payment WHERE (`status` = '2') GROUP BY 2 ORDER BY strftime('%m', `date`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
        {
            $sSql = "SELECT SUM(\"amount\"), EXTRACT(MONTH FROM \"date\") FROM payment WHERE (\"status\" = '2') GROUP BY 2 ORDER BY EXTRACT(MONTH FROM \"date\") DESC";
        ...
        {
            $sSql = "SELECT SUM(amount), MM(date) FROM payment WHERE (status = '2') GROUP BY 2 ORDER BY MM(date) DESC";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget6">Gross Income</span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget7() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT SUM(discount), MONTH(date) FROM payment WHERE (status = '2') GROUP BY MONTH(date) ORDER BY MONTH(date) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
        {
            $sSql = "SELECT SUM(\"discount\"), MONTH(\"date\") FROM payment WHERE (\"status\" = '2') GROUP BY MONTH(\"date\") ORDER BY MONTH(\"date\") DESC";
        ...
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
        {
            $sSql = "SELECT SUM(\"discount\"), EXTRACT(MONTH FROM \"date\") FROM payment WHERE (\"status\" = '2') GROUP BY EXTRACT(MONTH FROM \"date\") ORDER BY EXTRACT(MONTH FROM \"date\") DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT SUM(\"discount\"), EXTRACT(MONTH FROM \"date\") FROM payment WHERE (\"status\" = '2') GROUP BY 2 ORDER BY EXTRACT(MONTH FROM \"date\") DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
        {
            $sSql = "SELECT SUM(`discount`), MONTH(`date`) FROM payment WHERE (`status` = '2') GROUP BY 2 ORDER BY MONTH(`date`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT SUM(`discount`), strftime('%m', `date`) FROM payment WHERE (`status` = '2') GROUP BY 2 ORDER BY strftime('%m', `date`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
        {
            $sSql = "SELECT SUM(\"discount\"), EXTRACT(MONTH FROM \"date\") FROM payment WHERE (\"status\" = '2') GROUP BY 2 ORDER BY EXTRACT(MONTH FROM \"date\") DESC";
        ...
        {
            $sSql = "SELECT SUM(discount), MM(date) FROM payment WHERE (status = '2') GROUP BY 2 ORDER BY MM(date) DESC";
        }
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget7">Discounts</span></div>
        ...
        <div class="clearfix"><span class="{$this->indexData['index_class']}Size {$this->indexData['index_class']}Size_widget7"><span class="{$this->indexData['index_class']} {$this->indexData['index_class']}_widget7">{$this->indexData['new_metric_formatted']}</span> {$this->indexData['icon']}</span></div>
...
IDXHTML;
    ...
    function getIndexContentData_widget8() {
        if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
        {
            $sSql = "SELECT SUM(amount), MONTH(date) FROM payment GROUP BY MONTH(date) ORDER BY MONTH(date) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
        {
            $sSql = "SELECT SUM(\"amount\"), MONTH(\"date\") FROM payment GROUP BY MONTH(\"date\") ORDER BY MONTH(\"date\") DESC";
        ...
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_oracle))
        {
            $sSql = "SELECT SUM(\"amount\"), EXTRACT(MONTH FROM \"date\") FROM payment GROUP BY EXTRACT(MONTH FROM \"date\") ORDER BY EXTRACT(MONTH FROM \"date\") DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_postgres))
        {
            $sSql = "SELECT SUM(\"amount\"), EXTRACT(MONTH FROM \"date\") FROM payment GROUP BY 2 ORDER BY EXTRACT(MONTH FROM \"date\") DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mysql))
        {
            $sSql = "SELECT SUM(`amount`), MONTH(`date`) FROM payment GROUP BY 2 ORDER BY MONTH(`date`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_sqlite))
        {
            $sSql = "SELECT SUM(`amount`), strftime('%m', `date`) FROM payment GROUP BY 2 ORDER BY strftime('%m', `date`) DESC";
        }
        elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
        {
            $sSql = "SELECT SUM(\"amount\"), EXTRACT(MONTH FROM \"date\") FROM payment GROUP BY 2 ORDER BY EXTRACT(MONTH FROM \"date\") DESC";
        ...
        {
            $sSql = "SELECT SUM(amount), MM(date) FROM payment GROUP BY 2 ORDER BY MM(date) DESC";
        }
        ...
        $this->indexData['new_metric']    = $oRs->fields[0];
        $this->indexData['new_dimension'] = $this->formatIndexDimension_widget8($oRs->fields[1]);
        ...
        if ($oRs->EOF) {
            ...
            $this->indexData['has_old_data']  = true;
            $this->indexData['old_metric']    = $oRs->fields[0];
            $this->indexData['old_dimension'] = $this->formatIndexDimension_widget8($oRs->fields[1]);
        }
        ...
        if ($this->indexData['has_old_data']) {
            ...
            $this->indexData['old_metric_formatted'] = $this->formatIndexMetric_widget8($this->indexData['old_metric']);
            $this->indexData['difference_formatted'] = $this->formatIndexMetric_widget8($this->indexData['difference']);
            $this->indexData['percentage_formatted'] = sprintf('%.2f', $this->indexData['percentage']) . '%';
        }
        else {
            $this->indexData['new_metric_formatted'] = $this->formatIndexMetric_widget8($this->indexData['new_metric']);
...
<div style="text-align: center; padding-top: 15px">
    <div style="display: inline-block">
        <div class="clearfix"><span style="" class="scContainerIndexTitle scContainerIndexTitle_widget8">Outstanding</span></div>
        <div class="clearfix"><span style="float: right"><span class="scContainerIndexDimension scContainerIndexDimension_widget8">{$this->indexData['new_dimension']}{$this->indexData['new_metric_sep']}</span>{$this->indexData['new_metric_value']}</span></div>
        <div class="clearfix"><span class="{$this->indexData['index_class']}Size {$this->indexData['index_class']}Size_widget8"><span class="{$this->indexData['index_class']} {$this->indexData['index_class']}_widget8">{$this->indexData['new_metric_formatted']}</span> {$this->indexData['icon']}</span></div>
...
IDXHTML;
        ...
        if ($this->indexData['has_old_data']) {
            ...
            $html .= <<<IDXHTML
        <div class="clearfix"><span style="float: right"><span class="scContainerIndexDimension scContainerIndexDimension_widget8">{$this->indexData['old_dimension']}:</span> <span class="{$this->indexData['old_metric_class']} {$this->indexData['old_metric_class']}_widget8">{$this->indexData['old_metric_formatted']}</span></span></div>
...
IDXHTML;
    ...
    function formatIndexDimension_widget8($value) {
        if (1 == $value) {
            $value = $this->Ini->Nm_lang['lang_mnth_janu'];
        }
        elseif (2 == $value) {
