...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_type"  <?php echo $str_hide_type?>>
<?php
...
?>
   <span id="idAjaxSelect_type">
      <SELECT class="scFilterObjectEven" id="SC_type" name="type"  size="1">
<?php
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_status"  <?php echo $str_hide_status?>> 
<?php
...
<?php
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "type" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
