...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LMMS_____grid_his_payment"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LMMS_____grid_his_payment"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_payment'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_his_payment']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_his_payment']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_his_payment']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_his_payment']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_his_payment']['sc_modal']);
           if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_his_payment']['opc_psq']))
           {
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_his_payment']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_his_payment']['embutida_filho'] as $ind => $sc_init)
          {
