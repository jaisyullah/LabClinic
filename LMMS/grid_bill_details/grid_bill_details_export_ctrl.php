<?php
@session_start() ;
$_SESSION['scriptcase']['grid_bill_details']['sc_process_barr'] = true;
require_once('../grid_bill_details/index.php');
unset($_SESSION['scriptcase']['grid_bill_details']['sc_process_barr']);
$ExportCtrl = new grid_bill_details_export_control;
$ExportCtrl->Export_barr();

class grid_bill_details_export_control
{
