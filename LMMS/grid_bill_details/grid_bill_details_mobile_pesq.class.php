...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_numeric[] = "total";$Nm_numeric[] = "total";
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_kode_cond" name="kode_cond" onChange="nm_campos_between(document.getElementById('id_vis_kode'), this, 'kode')">
      ...
      <br><span id="id_hide_kode"  <?php echo $str_hide_kode?>><?php
      if ($kode != "")
      {
      $kode_look = substr($this->Db->qstr($kode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_nama_cond" name="nama_cond" onChange="nm_campos_between(document.getElementById('id_vis_nama'), this, 'nama')">
      ...
      <br><span id="id_hide_nama"  <?php echo $str_hide_nama?>><?php
      if ($nama != "")
      {
      $nama_look = substr($this->Db->qstr($nama), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_total_cond" name="total_cond" onChange="nm_campos_between(document.getElementById('id_vis_total'), this, 'total')">
