...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_id' + iSeqRow).bind('change', function() { sc_form_payment_id_onchange(this, iSeqRow) });
  ...
  $('#id_sc_field_paycode' + iSeqRow).bind('blur', function() { sc_form_payment_paycode_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_payment_paycode_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_type' + iSeqRow).bind('blur', function() { sc_form_payment_type_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_payment_type_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_picture' + iSeqRow).bind('blur', function() { sc_form_payment_picture_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_payment_picture_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_cardno' + iSeqRow).bind('blur', function() { sc_form_payment_cardno_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_payment_cardno_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_payment_cardno_onfocus(this, iSeqRow) });
  $('#id_sc_field_status' + iSeqRow).bind('change', function() { sc_form_payment_status_onchange(this, iSeqRow) });
  $('#id_sc_field_date' + iSeqRow).bind('blur', function() { sc_form_payment_date_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_payment_date_onchange(this, iSeqRow) })
                                  .bind('focus', function() { sc_form_payment_date_onfocus(this, iSeqRow) });
  $('#id_sc_field_date_hora' + iSeqRow).bind('blur', function() { sc_form_payment_date_hora_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_payment_date_hora_onchange(this, iSeqRow) })
                                       .bind('focus', function() { sc_form_payment_date_hora_onfocus(this, iSeqRow) });
  $('#id_sc_field_institution' + iSeqRow).bind('blur', function() { sc_form_payment_institution_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_payment_institution_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_sc_field_0' + iSeqRow).bind('blur', function() { sc_form_payment_sc_field_0_onblur(this, iSeqRow) })
                                        .bind('change', function() { sc_form_payment_sc_field_0_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_patient' + iSeqRow).bind('blur', function() { sc_form_payment_patient_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_payment_patient_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_bill' + iSeqRow).bind('blur', function() { sc_form_payment_bill_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_payment_bill_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_change' + iSeqRow).bind('blur', function() { sc_form_payment_change_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_payment_change_onchange(this, iSeqRow) })
                                    .bind('focus', function() { sc_form_payment_change_onfocus(this, iSeqRow) });
} // scJQEventsAdd

function sc_form_payment_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_payment_paycode_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_payment_type_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_payment_picture_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_payment_cardno_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_payment_status_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_payment_date_hora_onblur(oThis, iSeqRow) {
  do_ajax_form_payment_validate_date();
  scCssBlur(oThis);
}

function sc_form_payment_date_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_payment_date_hora_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_payment_date_hora_onfocus(oThis, iSeqRow) {
  scEventControl_onFocus(oThis, iSeqRow);
  scCssFocus(oThis);
}
...
function sc_form_payment_institution_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_payment_sc_field_0_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_payment_patient_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_payment_bill_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_payment_change_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_payment_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_payment')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
