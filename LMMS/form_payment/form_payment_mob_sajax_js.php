  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_payment_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate date
  function do_ajax_form_payment_mob_validate_date()
  {
    var nomeCampo_date = "date";
    var var_date = scAjaxGetFieldText(nomeCampo_date);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_mob_validate_date(var_date, var_script_case_init, do_ajax_form_payment_mob_validate_date_cb);
  } // do_ajax_form_payment_mob_validate_date

  function do_ajax_form_payment_mob_validate_date_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_mob_validate_date_cb

  // ---------- Validate saleid
  function do_ajax_form_payment_mob_validate_saleid()
  {
    var nomeCampo_saleid = "saleid";
    var var_saleid = scAjaxGetFieldText(nomeCampo_saleid);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_mob_validate_saleid(var_saleid, var_script_case_init, do_ajax_form_payment_mob_validate_saleid_cb);
  } // do_ajax_form_payment_mob_validate_saleid

  function do_ajax_form_payment_mob_validate_saleid_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "saleid";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_mob_validate_saleid_cb

  // ---------- Validate paycode
  function do_ajax_form_payment_mob_validate_paycode()
  {
    var nomeCampo_paycode = "paycode";
    var var_paycode = scAjaxGetFieldText(nomeCampo_paycode);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_mob_validate_paycode(var_paycode, var_script_case_init, do_ajax_form_payment_mob_validate_paycode_cb);
  } // do_ajax_form_payment_mob_validate_paycode

  function do_ajax_form_payment_mob_validate_paycode_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "paycode";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_mob_validate_paycode_cb

  // ---------- Validate patient
  function do_ajax_form_payment_mob_validate_patient()
  {
    var nomeCampo_patient = "patient";
    var var_patient = scAjaxGetFieldText(nomeCampo_patient);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_mob_validate_patient(var_patient, var_script_case_init, do_ajax_form_payment_mob_validate_patient_cb);
  } // do_ajax_form_payment_mob_validate_patient

  function do_ajax_form_payment_mob_validate_patient_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "patient";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_mob_validate_patient_cb

  // ---------- Validate bill
  function do_ajax_form_payment_mob_validate_bill()
  {
    var nomeCampo_bill = "bill";
    var var_bill = scAjaxGetFieldText(nomeCampo_bill);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_mob_validate_bill(var_bill, var_script_case_init, do_ajax_form_payment_mob_validate_bill_cb);
  } // do_ajax_form_payment_mob_validate_bill

  function do_ajax_form_payment_mob_validate_bill_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "bill";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_mob_validate_bill_cb

  // ---------- Validate amount
  function do_ajax_form_payment_mob_validate_amount()
  {
    var nomeCampo_amount = "amount";
    var var_amount = scAjaxGetFieldText(nomeCampo_amount);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_mob_validate_amount(var_amount, var_script_case_init, do_ajax_form_payment_mob_validate_amount_cb);
  } // do_ajax_form_payment_mob_validate_amount

  function do_ajax_form_payment_mob_validate_amount_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "amount";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_mob_validate_amount_cb

  // ---------- Validate discount
  function do_ajax_form_payment_mob_validate_discount()
  {
    var nomeCampo_discount = "discount";
    var var_discount = scAjaxGetFieldText(nomeCampo_discount);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_mob_validate_discount(var_discount, var_script_case_init, do_ajax_form_payment_mob_validate_discount_cb);
  } // do_ajax_form_payment_mob_validate_discount

  function do_ajax_form_payment_mob_validate_discount_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_mob_validate_discount_cb

  // ---------- Validate change
  function do_ajax_form_payment_mob_validate_change()
  {
    var nomeCampo_change = "change";
    var var_change = scAjaxGetFieldText(nomeCampo_change);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_mob_validate_change(var_change, var_script_case_init, do_ajax_form_payment_mob_validate_change_cb);
  } // do_ajax_form_payment_mob_validate_change

  function do_ajax_form_payment_mob_validate_change_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "change";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_mob_validate_change_cb

  // ---------- Validate type
  function do_ajax_form_payment_mob_validate_type()
  {
    var nomeCampo_type = "type";
    var var_type = scAjaxGetFieldSelect(nomeCampo_type);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_mob_validate_type(var_type, var_script_case_init, do_ajax_form_payment_mob_validate_type_cb);
  } // do_ajax_form_payment_mob_validate_type

  function do_ajax_form_payment_mob_validate_type_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "type";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_mob_validate_type_cb

  // ---------- Validate institution
  function do_ajax_form_payment_mob_validate_institution()
  {
    var nomeCampo_institution = "institution";
    var var_institution = scAjaxGetFieldSelect(nomeCampo_institution);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_mob_validate_institution(var_institution, var_script_case_init, do_ajax_form_payment_mob_validate_institution_cb);
  } // do_ajax_form_payment_mob_validate_institution

  function do_ajax_form_payment_mob_validate_institution_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_mob_validate_institution_cb

  // ---------- Validate cardno
  function do_ajax_form_payment_mob_validate_cardno()
  {
    var nomeCampo_cardno = "cardno";
    var var_cardno = scAjaxGetFieldText(nomeCampo_cardno);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_mob_validate_cardno(var_cardno, var_script_case_init, do_ajax_form_payment_mob_validate_cardno_cb);
  } // do_ajax_form_payment_mob_validate_cardno

  function do_ajax_form_payment_mob_validate_cardno_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "cardno";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_mob_validate_cardno_cb

  // ---------- Validate picture
  function do_ajax_form_payment_mob_validate_picture()
  {
    var nomeCampo_picture = "picture";
    var var_picture = scAjaxGetFieldText(nomeCampo_picture);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_mob_validate_picture(var_picture, var_script_case_init, do_ajax_form_payment_mob_validate_picture_cb);
  } // do_ajax_form_payment_mob_validate_picture

  function do_ajax_form_payment_mob_validate_picture_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "picture";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_mob_validate_picture_cb

  // ---------- Validate sc_field_0
  function do_ajax_form_payment_mob_validate_sc_field_0()
  {
    var nomeCampo_sc_field_0 = "sc_field_0";
    var var_sc_field_0 = scAjaxGetFieldText(nomeCampo_sc_field_0);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_payment_mob_validate_sc_field_0(var_sc_field_0, var_script_case_init, do_ajax_form_payment_mob_validate_sc_field_0_cb);
  } // do_ajax_form_payment_mob_validate_sc_field_0

  function do_ajax_form_payment_mob_validate_sc_field_0_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_mob_validate_sc_field_0_cb

  // ---------- Refresh saleid
  function do_ajax_form_payment_mob_refresh_saleid()
  {
    var var_saleid = scAjaxGetFieldText("saleid");
    var var_nmgp_refresh_fields = "change";
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_payment_mob_refresh_saleid(var_saleid, var_nmgp_refresh_fields, var_script_case_init, do_ajax_form_payment_mob_refresh_saleid_cb);
  } // do_ajax_form_payment_mob_refresh_saleid

  function do_ajax_form_payment_mob_refresh_saleid_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_payment_mob_refresh_saleid_cb

  // ---------- Event onchange amount
  function do_ajax_form_payment_mob_event_amount_onchange()
  {
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_payment_mob_event_amount_onchange(var_change, var_amount, var_bill, var_discount, var_script_case_init, do_ajax_form_payment_mob_event_amount_onchange_cb);
  } // do_ajax_form_payment_mob_event_amount_onchange

  function do_ajax_form_payment_mob_event_amount_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "amount";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_payment_mob_event_amount_onchange_cb_after_alert);
  } // do_ajax_form_payment_mob_event_amount_onchange_cb
  function do_ajax_form_payment_mob_event_amount_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_payment_mob_event_amount_onchange_cb_after_alert

  // ---------- Event onchange discount
  function do_ajax_form_payment_mob_event_discount_onchange()
  {
    var var_change = scAjaxGetFieldText("change");
    var var_amount = scAjaxGetFieldText("amount");
    var var_bill = scAjaxGetFieldText("bill");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_payment_mob_event_discount_onchange(var_change, var_amount, var_bill, var_discount, var_script_case_init, do_ajax_form_payment_mob_event_discount_onchange_cb);
  } // do_ajax_form_payment_mob_event_discount_onchange

  function do_ajax_form_payment_mob_event_discount_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "discount";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_payment_mob_event_discount_onchange_cb_after_alert);
  } // do_ajax_form_payment_mob_event_discount_onchange_cb
  function do_ajax_form_payment_mob_event_discount_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  } // do_ajax_form_payment_mob_event_discount_onchange_cb_after_alert

  // ---------- Event onchange saleid
  function do_ajax_form_payment_mob_event_saleid_onchange()
  {
    var var_saleid = scAjaxGetFieldText("saleid");
    var var_bill = scAjaxGetFieldText("bill");
    ...
    var var_script_case_init = document.F2.script_case_init.value;
    scAjaxProcOn(true);
    x_ajax_form_payment_mob_event_saleid_onchange(var_saleid, var_bill, var_patient, var_amount, var_change, var_script_case_init, do_ajax_form_payment_mob_event_saleid_onchange_cb);
  } // do_ajax_form_payment_mob_event_saleid_onchange

  function do_ajax_form_payment_mob_event_saleid_onchange_cb(sResp)
  {
    scAjaxProcOff(true);
    oResp = scAjaxResponse(sResp);
    sFieldValid = "saleid";
    ...
    scAjaxSetReadonly();
    scAjaxSetMaster();
    scAjaxAlert(do_ajax_form_payment_mob_event_saleid_onchange_cb_after_alert);
  } // do_ajax_form_payment_mob_event_saleid_onchange_cb
  function do_ajax_form_payment_mob_event_saleid_onchange_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    do_ajax_form_payment_mob_refresh_saleid();
  ...
  } // do_ajax_form_payment_mob_event_saleid_onchange_cb_after_alert
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_payment_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_payment_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_payment_mob_submit_form(var_date, var_saleid, var_paycode, var_patient, var_bill, var_amount, var_discount, var_change, var_type, var_institution, var_cardno, var_picture, var_id, var_picture_ul_name, var_picture_ul_type, var_picture_salva, var_picture_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_payment_mob_submit_form_cb);
  } // do_ajax_form_payment_mob_submit_form

  function do_ajax_form_payment_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_payment_mob_submit_form_cb_after_alert);
  } // do_ajax_form_payment_mob_submit_form_cb
  function do_ajax_form_payment_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_payment_mob_submit_form_cb_after_alert

  var scStatusDetail = {};
  scStatusDetail["grid_bill_details"] = "off";

  function do_ajax_form_payment_mob_navigate_form()
  {
    perform_ajax_form_payment_mob_navigate_form();
  }

  function perform_ajax_form_payment_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    x_ajax_form_payment_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_payment_mob_navigate_form_cb);
  } // do_ajax_form_payment_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_payment_mob_navigate_form_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_payment_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_payment_mob_navigate_form_cb
  function do_ajax_form_payment_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_payment_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
    scAjaxProcOff();
  } // do_ajax_form_payment_mob_navigate_form_cb_after_alert
  function sc_hide_form_payment_mob_form()
  {
