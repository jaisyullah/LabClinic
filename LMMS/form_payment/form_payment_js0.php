...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_payment"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
function sc_btn_sc_btn_0()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('Are you sure to do this ? This action cant undone', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_sc_btn_0_ok, sc_btn_sc_btn_0_cancel)
}
...
var var_btn_sc_btn_1_payno_cf = "<?php echo $this->form_encode_input($this->nmgp_dados_form['paycode']); ?>";
function sc_btn_sc_btn_1()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('Do you want to printout this invoice ?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_sc_btn_1_ok, sc_btn_sc_btn_1_cancel);
}
...
{
      nm_gp_submit('<?php echo $this->Ini->link_print_invoice_cf; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "payno_cf*scin' + var_btn_sc_btn_1_payno_cf + '*scout"; ?>', '', '_blank', '0', '0', 'print_invoice_cf');
}
var var_btn_sc_btn_2_payno_59 = "<?php echo $this->form_encode_input($this->nmgp_dados_form['paycode']); ?>";
function sc_btn_sc_btn_2()
{
    ...
    scJs_confirm("<?php echo html_entity_decode('Do you want to printout this invoice ?', ENT_COMPAT, $_SESSION['scriptcase']['charset']); ?>", sc_btn_sc_btn_2_ok, sc_btn_sc_btn_2_cancel);
}
...
{
      nm_gp_submit('<?php echo $this->Ini->link_print_invoice_59; ?>', '<?php echo $this->nm_location; ?>', '<?php echo "payno_59*scin' + var_btn_sc_btn_2_payno_59 + '*scout"; ?>', '', '_blank', '0', '0', 'print_invoice_59');
}
 NM_tp_critica(1);
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['where_detal']))
  {
?>  
...
{
   nm_field_disabled("date=disabled;paycode=disabled;bill=disabled;change=disabled", "");
   nm_field_disabled("saleid=disabled", "U");
