...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['embutida_pdf']))
 {
 ?>
...
include_once('form_payment_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['recarga'];
}
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_payment_js0.php");
?>
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_payment'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_payment'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['fast_search'][2] : "";
...
<?php
    ...
    if (($opcao_botoes == "novo") && (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && ($nm_apl_dependente != 1 || $this->nm_Start_new) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] != "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes == "novo") && (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] == "R") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['under_dashboard']))) {
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if (($opcao_botoes != "novo") && (!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_date_label" id="hidden_field_label_date" style="<?php echo $sStyleHidden_date; ?>"><span id="id_label_date"><?php echo $this->nm_new_label['date']; ?></span></TD>
    <TD class="scFormDataOdd css_date_line" id="hidden_field_data_date" style="<?php echo $sStyleHidden_date; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_date_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_saleid_label" id="hidden_field_label_saleid" style="<?php echo $sStyleHidden_saleid; ?>"><span id="id_label_saleid"><?php echo $this->nm_new_label['saleid']; ?></span></TD>
    <TD class="scFormDataOdd css_saleid_line" id="hidden_field_data_saleid" style="<?php echo $sStyleHidden_saleid; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_saleid_line" style="vertical-align: top;padding: 0px">
...
<span id="id_read_on_saleid" class="sc-ui-readonly-saleid css_saleid_line" style="<?php echo $sStyleReadLab_saleid; ?>"><?php echo $this->form_format_readonly("saleid", $this->form_encode_input($this->saleid)); ?></span><span id="id_read_off_saleid" class="css_read_off_saleid" style="white-space: nowrap;<?php echo $sStyleReadInp_saleid; ?>">
 ...
 size=15 maxlength=50 alt="{datatype: 'text', maxLength: 50, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_payment*scout' : '';
   if (isset($this->Ini->sc_lig_md5["select_laboratory_medical"]) && $this->Ini->sc_lig_md5["select_laboratory_medical"] == "S") {
       ...
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_payment@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_paycode_label" id="hidden_field_label_paycode" style="<?php echo $sStyleHidden_paycode; ?>"><span id="id_label_paycode"><?php echo $this->nm_new_label['paycode']; ?></span></TD>
    <TD class="scFormDataOdd css_paycode_line" id="hidden_field_data_paycode" style="<?php echo $sStyleHidden_paycode; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_paycode_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_patient_label" id="hidden_field_label_patient" style="<?php echo $sStyleHidden_patient; ?>"><span id="id_label_patient"><?php echo $this->nm_new_label['patient']; ?></span></TD>
    <TD class="scFormDataOdd css_patient_line" id="hidden_field_data_patient" style="<?php echo $sStyleHidden_patient; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_patient_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_bill_label" id="hidden_field_label_bill" style="<?php echo $sStyleHidden_bill; ?>"><span id="id_label_bill"><?php echo $this->nm_new_label['bill']; ?></span></TD>
    <TD class="scFormDataOdd css_bill_line" id="hidden_field_data_bill" style="<?php echo $sStyleHidden_bill; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_bill_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_amount_label" id="hidden_field_label_amount" style="<?php echo $sStyleHidden_amount; ?>"><span id="id_label_amount"><?php echo $this->nm_new_label['amount']; ?></span></TD>
    <TD class="scFormDataOdd css_amount_line" id="hidden_field_data_amount" style="<?php echo $sStyleHidden_amount; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_amount_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_discount_line" id="hidden_field_data_discount" style="<?php echo $sStyleHidden_discount; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_discount_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_change_label" id="hidden_field_label_change" style="<?php echo $sStyleHidden_change; ?>"><span id="id_label_change"><?php echo $this->nm_new_label['change']; ?></span></TD>
    <TD class="scFormDataOdd css_change_line" id="hidden_field_data_change" style="<?php echo $sStyleHidden_change; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_change_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_type_line" id="hidden_field_data_type" style="<?php echo $sStyleHidden_type; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_type_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_institution_label" id="hidden_field_label_institution" style="<?php echo $sStyleHidden_institution; ?>"><span id="id_label_institution"><?php echo $this->nm_new_label['institution']; ?></span></TD>
    <TD class="scFormDataOdd css_institution_line" id="hidden_field_data_institution" style="<?php echo $sStyleHidden_institution; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_institution_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_cardno_label" id="hidden_field_label_cardno" style="<?php echo $sStyleHidden_cardno; ?>"><span id="id_label_cardno"><?php echo $this->nm_new_label['cardno']; ?></span></TD>
    <TD class="scFormDataOdd css_cardno_line" id="hidden_field_data_cardno" style="<?php echo $sStyleHidden_cardno; ?>vertical-align: top;"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_cardno_line" style="vertical-align: top;padding: 0px">
...
<?php
 if (isset($_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_0'] ]) && '' != $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_0'] ]) {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['grid_bill_details_script_case_init'] = $_SESSION['scriptcase']['dashboard_scinit'][ $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] ][ $this->Ini->sc_lig_target['C_@scinf_sc_field_0'] ];
 }
 else {
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['grid_bill_details_script_case_init'] = $this->Ini->sc_page;
 }
 ...
 $sDetailSrc = ('novo' == $this->nmgp_opcao) ? 'form_payment_empty.htm' : $this->Ini->link_grid_bill_details_cons . '?script_case_init=' . $this->form_encode_input($this->Ini->sc_page) . '&script_case_detail=Y' . $parms_lig_cons;
if (isset($this->Ini->sc_lig_target['C_@scinf_sc_field_0']) && 'nmsc_iframe_liga_grid_bill_details' != $this->Ini->sc_lig_target['C_@scinf_sc_field_0'])
{
    ...
    {
        $sDetailSrc .= '&under_dashboard=1&dashboard_app=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['dashboard_app'] . '&own_widget=' . $this->Ini->sc_lig_target['C_@scinf_sc_field_0'] . '&parent_widget=' . $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['own_widget'];
        $sDetailSrc  = $this->addUrlParam($sDetailSrc, 'script_case_init', $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['grid_bill_details_script_case_init']);
    }
?>
<script type="text/javascript">
$(function() {
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_payment");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_payment");
 parent.scAjaxDetailHeight("form_payment", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_payment']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
