...
//----- 
   ...
   if (isset($_SESSION['session_sec_aplicacao']["LMMS_____grid_icd10_settings"]))
   {
      unset($_SESSION['session_sec_aplicacao']["LMMS_____grid_icd10_settings"]);
   }
   ...
   $_SESSION['sc_session'][$script_case_init]['form_icd10_settings'] = array();
   $fecha_janela = false;
   ...
   if ((isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_icd10_settings']['opc_psq']) && $_SESSION['sc_session'][$script_case_init]['grid_icd10_settings']['opc_psq']) || $fecha_janela)
   {
       if (isset($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['grid_icd10_settings']['sc_modal']) && $_SESSION['sc_session'][$script_case_init]['grid_icd10_settings']['sc_modal'])
       {
           unset($_SESSION['sc_session'][$script_case_init]['grid_icd10_settings']['sc_modal']);
...
<HTML>
<HEAD>
 <TITLE>grid_icd10_settings</TITLE>
...
<?php
   ...
   function nm_limpa_arr_session()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['grid_icd10_settings']['embutida_filho']))
      {
          foreach ($_SESSION['sc_session'][$script_case_init]['grid_icd10_settings']['embutida_filho'] as $ind => $sc_init)
          {
