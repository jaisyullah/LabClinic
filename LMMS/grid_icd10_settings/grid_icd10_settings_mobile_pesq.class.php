...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_icd_cond" name="icd_cond" onChange="nm_campos_between(document.getElementById('id_vis_icd'), this, 'icd')">
      ...
      <br><span id="id_hide_icd"  <?php echo $str_hide_icd?>><?php
      if ($icd != "")
      {
      $icd_look = substr($this->Db->qstr($icd), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_desceng_cond" name="desceng_cond" onChange="nm_campos_between(document.getElementById('id_vis_desceng'), this, 'desceng')">
      ...
      <br><span id="id_hide_desceng"  <?php echo $str_hide_desceng?>><?php
      if ($desceng != "")
      {
      $desceng_look = substr($this->Db->qstr($desceng), 1, -1); 
      $nmgp_def_dados = array(); 
