...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "tranDate";$Nm_datas[] = "tranDate";$Nm_numeric[] = "id";$Nm_numeric[] = "regcode";$Nm_numeric[] = "staffid";$Nm_numeric[] = "serviceid";
...
<HTML>
<HEAD>
 <TITLE> result_laboratory_medical</TITLE>
...
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      ...
      <br><span id="id_hide_id"  <?php echo $str_hide_id?>><INPUT  type="text" id="SC_id" name="id" value="<?php echo NM_encode_input($id) ?>" size=25 alt="{datatype: 'integer', maxLength: 25, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectOdd">
 </TD>
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_trandate_cond" name="trandate_cond" onChange="nm_campos_between(document.getElementById('id_vis_trandate'), this, 'trandate')">
      ...
      <br><span id="id_hide_trandate"  <?php echo $str_hide_trandate?>>
<?php
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
                  <br />
        <SPAN id="id_vis_trandate"  <?php echo $str_display_trandate; ?> class="scFilterFieldFontEven">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectOdd" id="SC_trancode_cond" name="trancode_cond" onChange="nm_campos_between(document.getElementById('id_vis_trancode'), this, 'trancode')">
      ...
      <br><span id="id_hide_trancode"  <?php echo $str_hide_trancode?>><?php
      if ($trancode != "")
      {
      $trancode_look = substr($this->Db->qstr($trancode), 1, -1); 
      $nmgp_def_dados = array(); 
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br>
      <SELECT class="SC_Cond_Selector scFilterObjectEven" id="SC_regcode_cond" name="regcode_cond" onChange="nm_campos_between(document.getElementById('id_vis_regcode'), this, 'regcode')">
      ...
      <br><span id="id_hide_regcode"  <?php echo $str_hide_regcode?>><INPUT  type="text" id="SC_regcode" name="regcode" value="<?php echo NM_encode_input($regcode) ?>" size=15 alt="{datatype: 'integer', maxLength: 15, thousandsSep: '<?php echo $_SESSION['scriptcase']['reg_conf']['grup_num'] ?>', allowNegative: false, onlyNegative: false, enterTab: false}" class="sc-js-input scFilterObjectEven">
 </TD>
