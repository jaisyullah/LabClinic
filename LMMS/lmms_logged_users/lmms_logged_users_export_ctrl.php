<?php
@session_start() ;
$_SESSION['scriptcase']['lmms_logged_users']['sc_process_barr'] = true;
require_once('../lmms_logged_users/index.php');
unset($_SESSION['scriptcase']['lmms_logged_users']['sc_process_barr']);
$ExportCtrl = new lmms_logged_users_export_control;
$ExportCtrl->Export_barr();

class lmms_logged_users_export_control
{
