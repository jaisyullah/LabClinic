...
<form name="F5" method="post" 
  ...
  <input type="hidden" name="nmgp_parms" value="<?php echo $this->form_encode_input($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['parms']); ?>"/>
  <input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"/> 
</form> 
...
<form name="FCAP" action="" method="post" target="_blank"> 
  <input type="hidden" name="SC_lig_apl_orig" value="form_his_outpatient_reg"/>
  <input type="hidden" name="nmgp_parms" value=""> 
...
<?php
  if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_detal']))
  {
?>  
...
function lookup_patientid(campo)
{
   dados  = document.F1.patientid.value;
   jsrsExecute("<?php  echo $this->Ini->path_link . SC_dir_app_name('form_his_outpatient_reg')?>/form_his_outpatient_reg.php?script_case_init=<?php echo $this->form_encode_input($this->Ini->sc_page); ?>&nmgp_opcao=lookup", recebe_patientid, "patientid", dados, false);
}
function recebe_patientid(string)
{
   document.getElementById('id_lookup_patientid').innerHTML = string;
}
<?php 
...
{
   nm_field_disabled("trancode=disabled;queueno=disabled;finishdate=disabled;servicedate=disabled", "");
   nm_field_disabled("regdate=disabled;regtime=disabled;staffid=disabled", "U");
