...
<script type="text/javascript" src="<?php echo $this->Ini->path_prod ?>/third/jquery_plugin/select2/js/select2.full.min.js"></script>
 ...
 <?php
 if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_pdf']))
 {
 ?>
...
<?php
include_once("form_his_outpatient_reg_sajax_js.php");
?>
<script type="text/javascript">
...
include_once('form_his_outpatient_reg_jquery.php');
...
<?php
$str_iframe_body = ('F' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] || 'R' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe']) ? 'margin: 2px;' : '';
...
if ($GLOBALS["erro_incl"] == 1)
{
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['opc_ant'] = "novo";
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['recarga'] = "novo";
}
if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['recarga']))
{
    $opcao_botoes = $this->nmgp_opcao;
}
else
{
    $opcao_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['recarga'];
}
if ('' != $this->patientid)
{
    ...
    $remove_margin = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['remove_margin']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['remove_margin'] ? 'margin: 0; ' : '';
    $remove_border = '';
    $vertical_center = '';
?>
...
<?php
 include_once("form_his_outpatient_reg_js0.php");
?>
<script type="text/javascript" src="<?php  echo $this->Ini->path_js . "/nm_rpc.js" ?>"> 
</script> 
<script type="text/javascript"> 
...
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['insert_validation'] = md5(time() . rand(1, 99999));
?>
<input type="hidden" name="nmgp_ins_valid" value="<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['insert_validation']; ?>">
<?php
}
?>
...
<?php
$_SESSION['scriptcase']['error_span_title']['form_his_outpatient_reg'] = $this->Ini->Error_icon_span;
$_SESSION['scriptcase']['error_icon_title']['form_his_outpatient_reg'] = '' != $this->Ini->Err_ico_title ? $this->Ini->path_icones . '/' . $this->Ini->Err_ico_title : '';
?>
...
<?php
  if (!$this->Embutida_call && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['mostra_cab']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['mostra_cab'] != "N") && (!$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['under_dashboard'] || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['compact_mode'] || $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['maximized']))
  {
?>
<tr><td>
<style>
...
<tr><td>
<?php
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] != "R")
{
?>
...
if (($this->Embutida_form || !$this->Embutida_call || $this->Grid_editavel || $this->Embutida_multi || ($this->Embutida_call && 'on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_btn_nav'])) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] != "R")
{
    $NM_btn = false;
      ...
      {
          $OPC_cmp = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['fast_search'][0] : "";
          $OPC_arg = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['fast_search'][1] : "";
          $OPC_dat = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['fast_search'])) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['fast_search'][2] : "";
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (isset($_SESSION['scriptcase']['nm_sc_retorno']) && !empty($_SESSION['scriptcase']['nm_sc_retorno']) && $nm_apl_dependente != 1 && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] != "F" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] != "R" && !$this->aba_iframe && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<?php
    ...
    if ((!$this->Embutida_call) && ((!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['under_dashboard']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['under_dashboard'] || (isset($this->is_calendar_app) && $this->is_calendar_app)))) {
        $sCondStyle = (!isset($_SESSION['scriptcase']['nm_sc_retorno']) || empty($_SESSION['scriptcase']['nm_sc_retorno']) || $nm_apl_dependente == 1 || $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] == "R" || $this->aba_iframe || $this->nmgp_botoes['exit'] != "on") && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] != "F" && $this->nmgp_botoes['exit'] == "on") && ($nm_apl_dependente == 1 && $this->nmgp_botoes['exit'] == "on") ? '' : 'display: none;';
?>
...
<span id="id_read_on_patientid" class="sc-ui-readonly-patientid css_patientid_line" style="<?php echo $sStyleReadLab_patientid; ?>"><?php echo $this->form_format_readonly("patientid", $this->form_encode_input($this->patientid)); ?></span><span id="id_read_off_patientid" class="css_read_off_patientid" style="white-space: nowrap;<?php echo $sStyleReadInp_patientid; ?>">
 ...
 size=15 maxlength=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '<?php echo $this->allowedCharsCharset("") ?>', lettersCase: '', enterTab: false, enterSubmit: false, autoTab: false, selectOnFocus: true, watermark: '', watermarkClass: 'scFormObjectOddWm', maskChars: '(){}[].,;:-+/ '}" ></span><?php
   $Sc_iframe_master = ($this->Embutida_call) ? 'nmgp_iframe_ret*scinnmsc_iframe_liga_form_his_outpatient_reg*scout' : '';
   if (isset($this->Ini->sc_lig_md5["grid_patient_settings"]) && $this->Ini->sc_lig_md5["grid_patient_settings"] == "S") {
       ...
       $Md5_Lig    = "@SC_par@" . $this->form_encode_input($this->Ini->sc_page) . "@SC_par@form_his_outpatient_reg@SC_par@" . md5($Parms_Lig);
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lig_Md5'][md5($Parms_Lig)] = $Parms_Lig;
   } else {
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_deptid'][] = ''; ?>
 <option value=""></option>
 <option  value="1" <?php  if ($this->deptid == "1") { echo " selected" ;} ?><?php  if (empty($this->deptid)) { echo " selected" ;} ?>>Laboratory</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_deptid'][] = '1'; ?>
 </select></span>
</span><?php  }?>
...
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_statusid'][] = '1'; ?>
 <option  value="2" <?php  if ($this->statusid == "2") { echo " selected" ;} ?>>Handled</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_statusid'][] = '2'; ?>
 <option  value="3" <?php  if ($this->statusid == "3") { echo " selected" ;} ?>>Done</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_statusid'][] = '3'; ?>
 <option  value="4" <?php  if ($this->statusid == "4") { echo " selected" ;} ?>>Completed</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_statusid'][] = '4'; ?>
 <option  value="5" <?php  if ($this->statusid == "5") { echo " selected" ;} ?>>Cancel</option>
<?php $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_statusid'][] = '5'; ?>
 </select></span>
</span><?php  }?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_his_outpatient_reg");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_his_outpatient_reg");
 parent.scAjaxDetailHeight("form_his_outpatient_reg", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
