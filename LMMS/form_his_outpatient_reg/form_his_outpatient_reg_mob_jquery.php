...
function scJQEventsAdd(iSeqRow) {
  ...
  $('#id_sc_field_finishdate_hora' + iSeqRow).bind('blur', function() { sc_form_his_outpatient_reg_finishdate_onblur(this, iSeqRow) })
                                             .bind('focus', function() { sc_form_his_outpatient_reg_finishdate_onfocus(this, iSeqRow) });
  ...
  $('#id_sc_field_servicedate_hora' + iSeqRow).bind('blur', function() { sc_form_his_outpatient_reg_servicedate_onblur(this, iSeqRow) })
                                              .bind('focus', function() { sc_form_his_outpatient_reg_servicedate_onfocus(this, iSeqRow) });
...
function scHidePage(pageNo) {
	$("#id_form_his_outpatient_reg_mob_form" + pageNo).hide();
}
...
function scJQCalendarAdd(iSeqRow) {
  $("#id_sc_field_regdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_his_outpatient_reg_mob_validate_regdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_finishdate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_his_outpatient_reg_mob_validate_finishdate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
...
?>
  ...
  $("#id_sc_field_servicedate" + iSeqRow).datepicker({
    ...
    onClose: function(dateText, inst) {
      do_ajax_form_his_outpatient_reg_mob_validate_servicedate(iSeqRow);
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_his_outpatient_reg_mob')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
