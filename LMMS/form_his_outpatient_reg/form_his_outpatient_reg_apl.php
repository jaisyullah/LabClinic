<?php
//
class form_his_outpatient_reg_apl
{
...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_his_outpatient_reg']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_his_outpatient_reg']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_his_outpatient_reg']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_his_outpatient_reg']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_his_outpatient_reg']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_his_outpatient_reg']['sc_redir_insert'] = $this->sc_redir_insert;
          }
          if (isset($this->usr_login)) 
          {
              $_SESSION['usr_login'] = $this->usr_login;
      ...
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_his_outpatient_reg']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_his_outpatient_reg']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_his_outpatient_reg']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_his_outpatient_reg']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_his_outpatient_reg']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_his_outpatient_reg']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_his_outpatient_reg']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_his_outpatient_reg']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_his_outpatient_reg']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_his_outpatient_reg_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("en_us");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_his_outpatient_reg']['upload_field_info'] = array();

      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_his_outpatient_reg']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_his_outpatient_reg'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_his_outpatient_reg']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_his_outpatient_reg']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_his_outpatient_reg') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_his_outpatient_reg']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " outpatient register";
          ...
          elseif ($this->Ini->sc_page == $this->sc_init_menu)
          {
              ...
              {
                  if ($apl == "form_his_outpatient_reg")
                  {
                      $achou = true;
                  }
                  elseif ($achou)
      ...
      $_SESSION['scriptcase']['error_icon']['form_his_outpatient_reg']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_his_outpatient_reg'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_his_outpatient_reg']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_his_outpatient_reg'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_his_outpatient_reg'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_form'];
          if (!isset($this->id)){$this->id = $this->nmgp_dados_form['id'];} 
          if ($this->nmgp_opcao == "incluir" && $this->nmgp_dados_form['queueno'] != "null"){$this->queueno = $this->nmgp_dados_form['queueno'];} 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (isset($_GET['nm_cal_display']))
      {
          ...
          { 
              include_once($this->Ini->path_embutida . 'form_his_outpatient_reg/form_his_outpatient_reg_calendar.php');
          }
          else
          { 
              include_once($this->Ini->path_aplicacao . 'form_his_outpatient_reg_calendar.php');
          }
          exit;
      }

      if (is_file($this->Ini->path_aplicacao . 'form_his_outpatient_reg_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_his_outpatient_reg_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      if ($this->Embutida_proc)
      { 
          require_once($this->Ini->path_embutida . 'form_his_outpatient_reg/form_his_outpatient_reg_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_his_outpatient_reg_erro.class.php"); 
      }
      $this->Erro      = new form_his_outpatient_reg_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['opcao']))
         { 
             if ($this->id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_his_outpatient_reg']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['final'];
      }
      else
      {
      }
...
//
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
      }
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "recarga_mobile" || $this->nmgp_opcao == "muda_form") 
      {
          $this->nm_tira_formatacao();
          $this->nm_converte_datas();
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select']['trancode']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->trancode = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select']['trancode'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select']['regdate']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->regdate = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select']['regdate'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select']['regtime']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->regtime = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select']['regtime'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select']['queueno']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->queueno = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select']['queueno'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select']['finishdate']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->finishdate = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select']['finishdate'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select']['servicedate']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->servicedate = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select']['servicedate'];
          } 
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select']['staffid']) && !isset($this->nmgp_refresh_fields))
          { 
              $this->staffid = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select']['staffid'];
          } 
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_his_outpatient_reg.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_his_outpatient_reg_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_his_outpatient_reg"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_his_outpatient_reg']) || !is_array($this->NM_ajax_info['errList']['geral_form_his_outpatient_reg']))
              {
                  $this->NM_ajax_info['errList']['geral_form_his_outpatient_reg'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_his_outpatient_reg'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
...
//---
    ...
    function ValidateField_trancode(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
              ...
              if ($teste_validade->Valor($this->trancode, 15, 0, 0, 0, "N") == false)  
              { 
                  $hasError = true;
    ...
    function ValidateField_doctorid(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->doctorid) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_doctorid']) && !in_array($this->doctorid, $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_doctorid']))
               {
                   $hasError = true;
    ...
    function ValidateField_paymentid(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->paymentid) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_paymentid']) && !in_array($this->paymentid, $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_paymentid']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_institutionid(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->institutionid) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_institutionid']) && !in_array($this->institutionid, $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_institutionid']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_staffid(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->staffid) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_staffid']) && !in_array($this->staffid, $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_staffid']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_form'] = $this->nmgp_dados_form;
   }
...
//-- 
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_his_outpatient_reg_pack_protect_string($this->nmgp_dados_form['id']);
          }
   } // ajax_return_values
   ...
   function ajax_return_values_patientid($bForce = false)
   {
          ...
          $this->NM_ajax_info['fldList']['patientid'] = array(
              ...
              $this->NM_ajax_info['fldList']['patientid']['lookupCons'] = form_his_outpatient_reg_pack_protect_string(NM_charset_to_utf8($conteudo));
          }
   }
...
$aLookup[] = array(form_his_outpatient_reg_pack_protect_string('1') => str_replace('<', '&lt;',form_his_outpatient_reg_pack_protect_string("Laboratory")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_deptid'][] = '1';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['deptid']['valList'][$i] = form_his_outpatient_reg_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_doctorid']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_doctorid'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_doctorid']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_doctorid'] = array(); 
}
$aLookup[] = array(form_his_outpatient_reg_pack_protect_string('-') => str_replace('<', '&lt;',form_his_outpatient_reg_pack_protect_string('-')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_doctorid'][] = '-';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $aLookup[] = array(form_his_outpatient_reg_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_his_outpatient_reg_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_doctorid'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['doctorid']['valList'][$i] = form_his_outpatient_reg_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_paymentid']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_paymentid'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_paymentid']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_paymentid'] = array(); 
}
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_paymentid'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['paymentid']['valList'][$i] = form_his_outpatient_reg_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_institutionid']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_institutionid'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_institutionid']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_institutionid'] = array(); 
}
$aLookup[] = array(form_his_outpatient_reg_pack_protect_string('') => str_replace('<', '&lt;',form_his_outpatient_reg_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_institutionid'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_institutionid'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['institutionid']['valList'][$i] = form_his_outpatient_reg_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$aLookup[] = array(form_his_outpatient_reg_pack_protect_string('1') => str_replace('<', '&lt;',form_his_outpatient_reg_pack_protect_string("Register")));
$aLookup[] = array(form_his_outpatient_reg_pack_protect_string('2') => str_replace('<', '&lt;',form_his_outpatient_reg_pack_protect_string("Handled")));
$aLookup[] = array(form_his_outpatient_reg_pack_protect_string('3') => str_replace('<', '&lt;',form_his_outpatient_reg_pack_protect_string("Done")));
$aLookup[] = array(form_his_outpatient_reg_pack_protect_string('4') => str_replace('<', '&lt;',form_his_outpatient_reg_pack_protect_string("Completed")));
$aLookup[] = array(form_his_outpatient_reg_pack_protect_string('5') => str_replace('<', '&lt;',form_his_outpatient_reg_pack_protect_string("Cancel")));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_statusid'][] = '1';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_statusid'][] = '2';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_statusid'][] = '3';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_statusid'][] = '4';
$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_statusid'][] = '5';
          $aLookupOrig = $aLookup;
          ...
          {
              $this->NM_ajax_info['fldList']['statusid']['valList'][$i] = form_his_outpatient_reg_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_staffid']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_staffid'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_staffid']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_staffid'] = array(); 
}
$aLookup[] = array(form_his_outpatient_reg_pack_protect_string('') => str_replace('<', '&lt;',form_his_outpatient_reg_pack_protect_string('(AUTO)')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_staffid'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['Lookup_staffid'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['staffid']['valList'][$i] = form_his_outpatient_reg_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   function return_after_insert()
   {
      ...
      if ('' != $this->id)
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start'] = $rsc->fields[0];
          $rsc->Close();
      }
   }
   ...
   { 
    ...
    if ("incluir" == $this->nmgp_opcao) {
      $this->sc_evento = $this->nmgp_opcao;
      $_SESSION['scriptcase']['form_his_outpatient_reg']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_his_outpatient_reg']['contr_erro'] = 'off'; 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
              }
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao   = "igual"; 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['parms'] = "id?#?$this->id?@?"; 
      }
      $this->NM_commit_db(); 
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] == "R")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_his_outpatient_reg = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['total'] = $qt_geral_reg_form_his_outpatient_reg;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_his_outpatient_reg = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start'] > $qt_geral_reg_form_his_outpatient_reg)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start'] = $qt_geral_reg_form_his_outpatient_reg; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_his_outpatient_reg) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] == "R")
          {
              ...
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          { 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['empty_filter'] = true;
                  return; 
              }
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start'] < $qt_geral_reg_form_his_outpatient_reg;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['reg_start'] + 1;
       ...
       foreach ($Arr_result as $Ind_result => $Lin_result)
       {
        ...
        function initializeRecordState() {
                $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['record_state'] = array();
        }

        function storeRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['record_state'])) {
                        $this->initializeRecordState();
                }
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['record_state'][$sc_seq_vert])) {
                        $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['record_state'][$sc_seq_vert] = array();
                }

                $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['record_state'][$sc_seq_vert]['buttons'] = array(
        ...
        function loadRecordState($sc_seq_vert = 0) {
                if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['record_state']) || !isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['record_state'][$sc_seq_vert])) {
                        return;
                }

                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['record_state'][$sc_seq_vert]['buttons']['delete'])) {
                        $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['record_state'][$sc_seq_vert]['buttons']['delete'];
                }
                if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['record_state'][$sc_seq_vert]['buttons']['update'])) {
                        $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['record_state'][$sc_seq_vert]['buttons']['update'];
                }
        }
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
<?php
        ...
        $this->initFormPages();
    include_once("form_his_outpatient_reg_form0.php");
        $this->hideFormPages();
 }
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['table_refresh'])
        {
   ...
   function jqueryButtonText($sModule)
   {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_his_outpatient_reg = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['total'] = $qt_geral_reg_form_his_outpatient_reg;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_his_outpatient_reg_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
         ...
         if (isset($Nm_datas[$campo_join]))
         {
          ...
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_access))
          {
             ...
             $nm_aspas1 = "#";
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['SC_sep_date']))
              {
                  $nm_aspas  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['SC_sep_date'];
                  $nm_aspas1 = $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['SC_sep_date1'];
              }
          }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_his_outpatient_reg_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_his_outpatient_reg_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_his_outpatient_reg']['masterValue'] as $cmp_master => $val_master)
        {
?>
