  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_icd10_settings" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_icd10_settings_form();
	}
  ...
  // ---------- Validate icd
  function do_ajax_form_icd10_settings_validate_icd()
  {
    var nomeCampo_icd = "icd";
    var var_icd = scAjaxGetFieldText(nomeCampo_icd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_icd10_settings_validate_icd(var_icd, var_script_case_init, do_ajax_form_icd10_settings_validate_icd_cb);
  } // do_ajax_form_icd10_settings_validate_icd

  function do_ajax_form_icd10_settings_validate_icd_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_icd10_settings_validate_icd_cb

  // ---------- Validate desceng
  function do_ajax_form_icd10_settings_validate_desceng()
  {
    var nomeCampo_desceng = "desceng";
    var var_desceng = scAjaxGetFieldText(nomeCampo_desceng);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_icd10_settings_validate_desceng(var_desceng, var_script_case_init, do_ajax_form_icd10_settings_validate_desceng_cb);
  } // do_ajax_form_icd10_settings_validate_desceng

  function do_ajax_form_icd10_settings_validate_desceng_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "desceng";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_icd10_settings_validate_desceng_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_icd10_settings_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_icd10_settings_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_icd10_settings_submit_form(var_icd, var_desceng, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_icd10_settings_submit_form_cb);
  } // do_ajax_form_icd10_settings_submit_form

  function do_ajax_form_icd10_settings_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_icd10_settings_submit_form_cb_after_alert);
  } // do_ajax_form_icd10_settings_submit_form_cb
  function do_ajax_form_icd10_settings_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_icd10_settings_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_icd10_settings_navigate_form()
  {
    perform_ajax_form_icd10_settings_navigate_form();
  }

  function perform_ajax_form_icd10_settings_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_icd10_settings_navigate_form(var_icd, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_icd10_settings_navigate_form_cb);
  } // do_ajax_form_icd10_settings_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_icd10_settings']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_icd10_settings_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_icd10_settings_navigate_form_cb_after_alert);
  } // do_ajax_form_icd10_settings_navigate_form_cb
  function do_ajax_form_icd10_settings_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_icd10_settings_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
  ...
  } // do_ajax_form_icd10_settings_navigate_form_cb_after_alert
  function sc_hide_form_icd10_settings_form()
  {
