  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_icd10_settings_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  function scMoveMasterDetail(widget)
  {
	...
	function scAjax_displayEmptyForm() {
        ...
        sc_hide_form_icd10_settings_mob_form();
	}
  ...
  // ---------- Validate icd
  function do_ajax_form_icd10_settings_mob_validate_icd()
  {
    var nomeCampo_icd = "icd";
    var var_icd = scAjaxGetFieldText(nomeCampo_icd);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_icd10_settings_mob_validate_icd(var_icd, var_script_case_init, do_ajax_form_icd10_settings_mob_validate_icd_cb);
  } // do_ajax_form_icd10_settings_mob_validate_icd

  function do_ajax_form_icd10_settings_mob_validate_icd_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_icd10_settings_mob_validate_icd_cb

  // ---------- Validate desceng
  function do_ajax_form_icd10_settings_mob_validate_desceng()
  {
    var nomeCampo_desceng = "desceng";
    var var_desceng = scAjaxGetFieldText(nomeCampo_desceng);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_icd10_settings_mob_validate_desceng(var_desceng, var_script_case_init, do_ajax_form_icd10_settings_mob_validate_desceng_cb);
  } // do_ajax_form_icd10_settings_mob_validate_desceng

  function do_ajax_form_icd10_settings_mob_validate_desceng_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "desceng";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_icd10_settings_mob_validate_desceng_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_icd10_settings_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_icd10_settings_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    var var_icd = scAjaxGetFieldText("icd");
    var var_desceng = scAjaxGetFieldText("desceng");
    ...
    scAjaxProcOn();
    x_ajax_form_icd10_settings_mob_submit_form(var_icd, var_desceng, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_icd10_settings_mob_submit_form_cb);
  } // do_ajax_form_icd10_settings_mob_submit_form

  function do_ajax_form_icd10_settings_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    ...
    if (scAjaxIsOk())
    {
      ...
      scAjaxHideErrorDisplay("table");
      scAjaxHideErrorDisplay("icd");
      scAjaxHideErrorDisplay("desceng");
      scLigEditLookupCall();
<?php
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_icd10_settings_mob_submit_form_cb_after_alert);
  } // do_ajax_form_icd10_settings_mob_submit_form_cb
  function do_ajax_form_icd10_settings_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_icd10_settings_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_icd10_settings_mob_navigate_form()
  {
    perform_ajax_form_icd10_settings_mob_navigate_form();
  }

  function perform_ajax_form_icd10_settings_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxHideErrorDisplay("icd");
    scAjaxHideErrorDisplay("desceng");
    var var_icd = document.F2.icd.value;
    ...
    scAjaxProcOn();
    x_ajax_form_icd10_settings_mob_navigate_form(var_icd, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_icd10_settings_mob_navigate_form_cb);
  } // do_ajax_form_icd10_settings_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_icd10_settings_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_icd10_settings_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetFields(false);
    scAjaxSetVariables();
    document.F2.icd.value = scAjaxGetKeyValue("icd");
    scAjaxSetSummary();
    scAjaxShowDebug();
    scAjaxSetLabel(true);
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_icd10_settings_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_icd10_settings_mob_navigate_form_cb
  function do_ajax_form_icd10_settings_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_icd10_settings_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_icd10_settings_mob_navigate_form_cb_after_alert
  function sc_hide_form_icd10_settings_mob_form()
  {
  ...
  ajax_field_list[0] = "icd";
  ajax_field_list[1] = "desceng";

  var ajax_block_list = new Array();
  ajax_block_list[0] = "0";

  var ajax_error_list = {
    "icd": {"label": "Icd", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5},
    "desceng": {"label": "Desc Eng", "valid": new Array(), "onblur": new Array(), "onchange": new Array(), "onclick": new Array(), "onfocus": new Array(), "timeout": 5}
  };
  ...
  ajax_field_mult["icd"][1] = "icd";
  ajax_field_mult["desceng"][1] = "desceng";

  var ajax_field_id = {
    "icd": new Array("hidden_field_label_icd", "hidden_field_data_icd"),
    "desceng": new Array("hidden_field_label_desceng", "hidden_field_data_desceng")
  };
