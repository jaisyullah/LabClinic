...
class grid_his_laboratory_medical_pesq
{
   var $Db;
   var $Erro;
   var $Ini;
   ...
   function monta_busca()
   {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['path_libs_php'] = $this->Ini->path_lib_php;
...
//-- ajax metodos ---
      if ($this->NM_ajax_opcao == "ajax_filter_save")
      {
          ...
          foreach ($this->NM_fil_ant as $Cada_filter => $Tipo_filter)
          {
              ...
              if ($Tipo_filter[1] != $Nome_filter)
              {
                  ...
                  $Opt_filter .= "<option value=\"\">" . grid_his_laboratory_medical_pack_protect_string($Nome_filter) . "</option>\r\n";
              }
              $Opt_filter .= "<option value=\"" . grid_his_laboratory_medical_pack_protect_string($Tipo_filter[0]) . "\">.." . grid_his_laboratory_medical_pack_protect_string($Cada_filter) .  "</option>\r\n";
          }
      ...
      if ($this->NM_ajax_opcao == 'autocomp_icdid')
      {
          $icdid = ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($_GET['q'])) ? sc_convert_encoding($_GET['q'], $_SESSION['scriptcase']['charset'], "UTF-8") : $_GET['q'];
          $nmgp_def_dados = $this->lookup_ajax_icdid($icdid);
          ob_end_clean();
          ob_end_clean();
          $count_aut_comp = 0;
          $resp_aut_comp  = array();
   ...
   function lookup_ajax_icdid($icdid)
   {
      ...
      $nm_comando = "select icd, descEng from icd10_settings where  descEng like '%" . $icdid . "%' order by descEng"; 
      unset($cmp1,$cmp2);
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $Nm_datas[] = "a.tranDate";$Nm_datas[] = "a_tranDate";$Nm_datas[] = "a.birthDate";$Nm_datas[] = "a_birthDate";$Nm_datas[] = "a.finishDate";$Nm_datas[] = "a_finishDate";$Nm_datas[] = "a.confirmDate";$Nm_datas[] = "a_confirmDate";
      if (in_array($campo_join, $Nm_datas))
      {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['SC_sep_date']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['SC_sep_date']))
          {
      ...
      else
      {
         ...
         $nome_sum = "laboratory_medical.$nome";
         ...
         switch ($condicao)
         {
            case "EQ":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "II":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_strt'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
             case "QP";     // 
             case "NP";     // 
               ...
               if ($this->Date_part)
               {
                   if (!empty($NM_cmd))
                   {
                       ...
                       $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . ": " . $NM_cond . "##*@@";
                   }
               }
               else
               {
                   ...
                   $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . $op_all . $nm_ini_lower . "'%" . $campo . "%'" . $nm_fim_lower;
                   $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $lang_like . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
               }
            break;
            case "DF":     // 
               $this->comando        .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_sum    .= $nm_ini_lower . $nome_sum . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $this->comando_filtro .= $nm_ini_lower . $nome . $nm_fim_lower . " <> " . $nm_ini_lower . $nm_aspas . $campo . $nm_aspas1 . $nm_fim_lower;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_diff'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GT":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "GE":     // 
               $this->comando        .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum >= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome >= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_grtr_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LT":     // 
               $this->comando        .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum < " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome < " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "LE":     // 
               $this->comando        .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_sum    .= " $nome_sum <= " . $nm_aspas . $campo . $nm_aspas1;
               $this->comando_filtro .= " $nome <= " . $nm_aspas . $campo . $nm_aspas1;
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_less_equl'] . " " . $this->cmp_formatado[$nome_campo] . "##*@@";
            break;
            case "BW":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_betw'] . " " . $this->cmp_formatado[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_and_cond'] . " " . $this->cmp_formatado[$nome_campo . "_input_2"] . "##*@@";
            break;
            case "IN":     // 
               ...
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
            break;
            case "NU":     // 
               $this->comando        .= " $nome IS NULL ";
               $this->comando_sum    .= " $nome_sum IS NULL ";
               $this->comando_filtro .= " $nome IS NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_null'] . "##*@@";
            break;
            case "NN":     // 
               $this->comando        .= " $nome IS NOT NULL ";
               $this->comando_sum    .= " $nome_sum IS NOT NULL ";
               $this->comando_filtro .= " $nome IS NOT NULL ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nnul'] . "##*@@";
            break;
            case "EP":     // 
               $this->comando        .= " $nome = '' ";
               $this->comando_sum    .= " $nome_sum = '' ";
               $this->comando_filtro .= " $nome = '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_empty'] . "##*@@";
            break;
            case "NE":     // 
               $this->comando        .= " $nome <> '' ";
               $this->comando_sum    .= " $nome_sum <> '' ";
               $this->comando_filtro .= " $nome <> '' ";
               $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $nmgp_tab_label[$nome_campo] . " " . $this->Ini->Nm_lang['lang_srch_nempty'] . "##*@@";
            break;
         }
      }
   }
   ...
   $NM_retorno = "./";
    if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['proc_res'])) 
    {
...
<?php
    if (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['proc_res']) 
    {
?>
if (parent.document.getElementById('nmsc_iframe_grid_his_laboratory_medical').contentWindow.nm_gp_submit_ajax)
{
   parent.document.getElementById('nmsc_iframe_grid_his_laboratory_medical').contentWindow.nm_gp_submit_ajax('inicio', 'save_grid');
}
else
{
   parent.document.getElementById('nmsc_iframe_grid_his_laboratory_medical').src = 'index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>';
}
<?php
    }
    else
...
<HEAD>
 <TITLE><?php echo $this->Ini->Nm_lang['lang_othr_grid_title'] ?> laboratory_medical</TITLE>
...
?>
 ...
 <link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_filter<?php echo $_SESSION['scriptcase']['reg_conf']['css_dir'] ?>.css" /> 
  ...
  ?> 
 <link rel="stylesheet" type="text/css" href="<?php echo $this->Ini->path_link ?>grid_his_laboratory_medical/grid_his_laboratory_medical_fil_<?php echo strtolower($_SESSION['scriptcase']['reg_conf']['css_dir']) ?>.css" />
</HEAD>
<?php
$vertical_center = '';
?>
...
<SCRIPT type="text/javascript" src="<?php echo $this->Ini->path_js . "/browserSniffer.js" ?>"></SCRIPT>
 ...
 <script type="text/javascript" src="grid_his_laboratory_medical_ajax_search.js"></script>
 <script type="text/javascript" src="grid_his_laboratory_medical_ajax.js"></script>
 <script type="text/javascript">
...
<script type="text/javascript" src="grid_his_laboratory_medical_message.js"></script>
<link rel="stylesheet" type="text/css" href="../_lib/css/<?php echo $this->Ini->str_schema_filter ?>_sweetalert.css" />
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_his_laboratory_medical']['glo_nm_path_prod']; ?>/third/sweetalert/sweetalert2.all.min.js"></script>
<script type="text/javascript" src="<?php echo $_SESSION['scriptcase']['grid_his_laboratory_medical']['glo_nm_path_prod']; ?>/third/sweetalert/polyfill.min.js"></script>
...
function scJQCalendarAdd() {
  $("#sc_trandate_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_trandate_dia').value + '/';
          var_dt_ini += document.getElementById('SC_trandate_mes').value + '/';
          var_dt_ini += document.getElementById('SC_trandate_ano').value;
          document.getElementById('sc_trandate_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_trandate_dia').value = aParts[0];
          document.getElementById('SC_trandate_mes').value = aParts[1];
          document.getElementById('SC_trandate_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_trandate_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_trandate_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_trandate_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_trandate_input_2_ano').value;
          document.getElementById('sc_trandate_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_trandate_input_2_dia').value = aParts[0];
          document.getElementById('SC_trandate_input_2_mes').value = aParts[1];
          document.getElementById('SC_trandate_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_confirmdate_jq").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_confirmdate_dia').value + '/';
          var_dt_ini += document.getElementById('SC_confirmdate_mes').value + '/';
          var_dt_ini += document.getElementById('SC_confirmdate_ano').value;
          document.getElementById('sc_confirmdate_jq').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_confirmdate_dia').value = aParts[0];
          document.getElementById('SC_confirmdate_mes').value = aParts[1];
          document.getElementById('SC_confirmdate_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
  ...
  $("#sc_confirmdate_jq2").datepicker({
    beforeShow: function(input, inst) {
          var_dt_ini  = document.getElementById('SC_confirmdate_input_2_dia').value + '/';
          var_dt_ini += document.getElementById('SC_confirmdate_input_2_mes').value + '/';
          var_dt_ini += document.getElementById('SC_confirmdate_input_2_ano').value;
          document.getElementById('sc_confirmdate_jq2').value = var_dt_ini;
    },
    onClose: function(dateText, inst) {
          aParts  = dateText.split("/");
          document.getElementById('SC_confirmdate_input_2_dia').value = aParts[0];
          document.getElementById('SC_confirmdate_input_2_mes').value = aParts[1];
          document.getElementById('SC_confirmdate_input_2_ano').value = aParts[2];
    },
    showWeek: true,
    numberOfMonths: 1,
    changeMonth: true,
 ...
 function nm_save_form(pos)
 {
  ...
  str_out += 'SC_confirmdate_cond#NMF#' + search_get_sel_txt('SC_confirmdate_cond') + '@NMF@';
  str_out += 'SC_confirmdate_dia#NMF#' + search_get_sel_txt('SC_confirmdate_dia') + '@NMF@';
  str_out += 'SC_confirmdate_mes#NMF#' + search_get_sel_txt('SC_confirmdate_mes') + '@NMF@';
  str_out += 'SC_confirmdate_ano#NMF#' + search_get_sel_txt('SC_confirmdate_ano') + '@NMF@';
  str_out += 'SC_confirmdate_input_2_dia#NMF#' + search_get_sel_txt('SC_confirmdate_input_2_dia') + '@NMF@';
  str_out += 'SC_confirmdate_input_2_mes#NMF#' + search_get_sel_txt('SC_confirmdate_input_2_mes') + '@NMF@';
  str_out += 'SC_confirmdate_input_2_ano#NMF#' + search_get_sel_txt('SC_confirmdate_input_2_ano') + '@NMF@';
  ...
  str_out += 'SC_icdid_cond#NMF#' + search_get_sel_txt('SC_icdid_cond') + '@NMF@';
  str_out += 'SC_icdid#NMF#' + search_get_text('SC_icdid') + '@NMF@';
  str_out += 'id_ac_icdid#NMF#' + search_get_text('id_ac_icdid') + '@NMF@';
...
<script type="text/javascript">
 $(function() {
   scClass = $("#id_ac_icdid").attr('class').split(' ');
   scClass = scClass[ scClass.length-1 ];
   $("#id_ac_icdid").autocomplete({
     minLength: 1,
...
<?php
   ...
   {
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['dashboard_info']['compact_mode'])
      {
          return;
      }
...
<?php
   ...
   {
      global 
             $trandate_cond, $trandate, $trandate_dia, $trandate_mes, $trandate_ano, $trandate_input_2_dia, $trandate_input_2_mes, $trandate_input_2_ano,
             $confirmdate_cond, $confirmdate, $confirmdate_dia, $confirmdate_mes, $confirmdate_ano, $confirmdate_input_2_dia, $confirmdate_input_2_mes, $confirmdate_input_2_ano,
             ...
             $icdid_cond, $icdid, $icdid_autocomp,
      ...
      $nmgp_tab_label = "";
      $delimitador = "##@@";
      if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      {
      }
      if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']) && $bprocessa != "recarga" && $bprocessa != "save_form" && $bprocessa != "filter_save" && $bprocessa != "filter_delete")
      { 
          if ($_SESSION['scriptcase']['charset'] != "UTF-8")
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca'], $_SESSION['scriptcase']['charset'], "UTF-8");
          }
          $trandate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['trandate_dia']; 
          $trandate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['trandate_mes']; 
          $trandate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['trandate_ano']; 
          $trandate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['trandate_input_2_dia']; 
          $trandate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['trandate_input_2_mes']; 
          $trandate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['trandate_input_2_ano']; 
          $trandate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['trandate_cond']; 
          $confirmdate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['confirmdate_dia']; 
          $confirmdate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['confirmdate_mes']; 
          $confirmdate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['confirmdate_ano']; 
          $confirmdate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['confirmdate_input_2_dia']; 
          $confirmdate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['confirmdate_input_2_mes']; 
          $confirmdate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['confirmdate_input_2_ano']; 
          $confirmdate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['confirmdate_cond']; 
          $finishdate_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['finishdate_dia']; 
          $finishdate_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['finishdate_mes']; 
          $finishdate_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['finishdate_ano']; 
          $finishdate_input_2_dia = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['finishdate_input_2_dia']; 
          $finishdate_input_2_mes = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['finishdate_input_2_mes']; 
          $finishdate_input_2_ano = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['finishdate_input_2_ano']; 
          $finishdate_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['finishdate_cond']; 
          $icdid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['icdid']; 
          $icdid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['icdid_cond']; 
          $staffid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['staffid']; 
          $staffid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['staffid_cond']; 
          $statusid = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['statusid']; 
          $statusid_cond = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['statusid_cond']; 
          $this->NM_operador = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['NM_operador']; 
      } 
      if (!isset($trandate_cond) || empty($trandate_cond))
      {
         $trandate_cond = "bw";
      }
      if (!isset($confirmdate_cond) || empty($confirmdate_cond))
      {
         $confirmdate_cond = "bw";
      }
      ...
      $str_hide_confirmdate = (in_array($confirmdate_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_finishdate = (in_array($finishdate_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      $str_hide_icdid = (in_array($icdid_cond, $opc_hide_input)) ? $display_fechado : $display_aberto;
      ...
      $str_display_trandate = ('bw' == $trandate_cond) ? $display_aberto : $display_fechado;
      $str_display_confirmdate = ('bw' == $confirmdate_cond) ? $display_aberto : $display_fechado;
      $str_display_finishdate = ('bw' == $finishdate_cond) ? $display_aberto : $display_fechado;
      $str_display_icdid = ('bw' == $icdid_cond) ? $display_aberto : $display_fechado;
      ...
      if (!isset($confirmdate) || $confirmdate == "")
      {
          $confirmdate = "";
      }
      if (isset($confirmdate) && !empty($confirmdate))
      {
         $tmp_pos = strpos($confirmdate, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $confirmdate = substr($confirmdate, 0, $tmp_pos);
         }
      }
      ...
      if (!isset($icdid) || $icdid == "")
      {
          $icdid = "";
      }
      if (isset($icdid) && !empty($icdid))
      {
         $tmp_pos = strpos($icdid, "##@@");
         if ($tmp_pos === false)
         { }
         else
         {
         $icdid = substr($icdid, 0, $tmp_pos);
         }
      }
 ...
 <TR align="center">
  ...
  <TD width="60%" height="">
   ...
   <tr>
      ...
      <TD id='SC_trandate_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['trandate'])) ? $this->New_label['trandate'] : "Transaction Date"; ?></TD>
      
      <INPUT type="hidden" id="SC_trandate_cond" name="trandate_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_trandate" <?php echo $str_hide_trandate?> valign="top">
...
<span id='id_date_part_trandate_DD' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectOdd" id="SC_trandate_dia" name="trandate_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $trandate_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $trandate_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $trandate_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $trandate_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $trandate_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $trandate_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $trandate_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $trandate_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $trandate_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $trandate_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $trandate_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $trandate_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $trandate_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $trandate_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $trandate_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $trandate_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $trandate_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $trandate_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $trandate_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $trandate_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $trandate_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $trandate_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $trandate_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $trandate_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $trandate_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $trandate_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $trandate_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $trandate_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $trandate_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $trandate_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $trandate_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<span id='id_date_part_trandate_MM' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectOdd" id="SC_trandate_mes" name="trandate_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $trandate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $trandate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $trandate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $trandate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $trandate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $trandate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $trandate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $trandate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $trandate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $trandate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $trandate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $trandate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_trandate_ano" name="trandate_ano" value="<?php echo NM_encode_input($trandate_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_trandate_jq">
</span>
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
       ...
       <TR valign="top">
        <TD id="id_vis_trandate"  <?php echo $str_display_trandate; ?> class="scFilterFieldFontOdd">
...
<?php
  ...
  {
?>
<span id='id_date_part_trandate_input_2_DD' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_trandate_input_2_dia" name="trandate_input_2_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $trandate_input_2_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $trandate_input_2_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $trandate_input_2_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $trandate_input_2_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $trandate_input_2_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $trandate_input_2_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $trandate_input_2_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $trandate_input_2_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $trandate_input_2_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $trandate_input_2_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $trandate_input_2_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $trandate_input_2_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $trandate_input_2_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $trandate_input_2_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $trandate_input_2_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $trandate_input_2_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $trandate_input_2_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $trandate_input_2_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $trandate_input_2_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $trandate_input_2_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $trandate_input_2_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $trandate_input_2_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $trandate_input_2_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $trandate_input_2_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $trandate_input_2_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $trandate_input_2_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $trandate_input_2_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $trandate_input_2_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $trandate_input_2_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $trandate_input_2_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $trandate_input_2_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_trandate_input_2_MM' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_trandate_input_2_mes" name="trandate_input_2_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $trandate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $trandate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $trandate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $trandate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $trandate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $trandate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $trandate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $trandate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $trandate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $trandate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $trandate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $trandate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_trandate_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_trandate_input_2_ano" name="trandate_input_2_ano" value="<?php echo NM_encode_input($trandate_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_trandate_jq2">
</span>
...
?>
      ...
      <TD id='SC_confirmdate_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['confirmdate'])) ? $this->New_label['confirmdate'] : "Confirm Date"; ?></TD>
      
      <INPUT type="hidden" id="SC_confirmdate_cond" name="confirmdate_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_confirmdate" <?php echo $str_hide_confirmdate?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['confirmdate'])) ? $this->New_label['confirmdate'] : "Confirm Date";
 $nmgp_tab_label .= "confirmdate?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
  ...
  {
?>
<span id='id_date_part_confirmdate_DD' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_confirmdate_dia" name="confirmdate_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $confirmdate_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $confirmdate_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $confirmdate_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $confirmdate_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $confirmdate_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $confirmdate_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $confirmdate_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $confirmdate_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $confirmdate_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $confirmdate_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $confirmdate_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $confirmdate_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $confirmdate_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $confirmdate_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $confirmdate_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $confirmdate_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $confirmdate_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $confirmdate_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $confirmdate_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $confirmdate_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $confirmdate_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $confirmdate_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $confirmdate_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $confirmdate_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $confirmdate_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $confirmdate_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $confirmdate_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $confirmdate_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $confirmdate_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $confirmdate_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $confirmdate_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_confirmdate_MM' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_confirmdate_mes" name="confirmdate_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $confirmdate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $confirmdate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $confirmdate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $confirmdate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $confirmdate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $confirmdate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $confirmdate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $confirmdate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $confirmdate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $confirmdate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $confirmdate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $confirmdate_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_confirmdate_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_confirmdate_ano" name="confirmdate_ano" value="<?php echo NM_encode_input($confirmdate_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_confirmdate_jq">
</span>
...
?>
        <SPAN id="id_css_confirmdate" class="scFilterFieldFontOdd">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_confirmdate"  <?php echo $str_display_confirmdate; ?> class="scFilterFieldFontOdd">
         <?php echo $date_sep_bw ?>
         <BR>
         <?php
...
<?php
  ...
  {
?>
<span id='id_date_part_confirmdate_input_2_DD' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_confirmdate_input_2_dia" name="confirmdate_input_2_dia">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $confirmdate_input_2_dia) { echo "selected"; } ?>>01</OPTION>
          <OPTION value="02" <?php if ("02" == $confirmdate_input_2_dia) { echo "selected"; } ?>>02</OPTION>
          <OPTION value="03" <?php if ("03" == $confirmdate_input_2_dia) { echo "selected"; } ?>>03</OPTION>
          <OPTION value="04" <?php if ("04" == $confirmdate_input_2_dia) { echo "selected"; } ?>>04</OPTION>
          <OPTION value="05" <?php if ("05" == $confirmdate_input_2_dia) { echo "selected"; } ?>>05</OPTION>
          <OPTION value="06" <?php if ("06" == $confirmdate_input_2_dia) { echo "selected"; } ?>>06</OPTION>
          <OPTION value="07" <?php if ("07" == $confirmdate_input_2_dia) { echo "selected"; } ?>>07</OPTION>
          <OPTION value="08" <?php if ("08" == $confirmdate_input_2_dia) { echo "selected"; } ?>>08</OPTION>
          <OPTION value="09" <?php if ("09" == $confirmdate_input_2_dia) { echo "selected"; } ?>>09</OPTION>
          <OPTION value="10" <?php if ("10" == $confirmdate_input_2_dia) { echo "selected"; } ?>>10</OPTION>
          <OPTION value="11" <?php if ("11" == $confirmdate_input_2_dia) { echo "selected"; } ?>>11</OPTION>
          <OPTION value="12" <?php if ("12" == $confirmdate_input_2_dia) { echo "selected"; } ?>>12</OPTION>
          <OPTION value="13" <?php if ("13" == $confirmdate_input_2_dia) { echo "selected"; } ?>>13</OPTION>
          <OPTION value="14" <?php if ("14" == $confirmdate_input_2_dia) { echo "selected"; } ?>>14</OPTION>
          <OPTION value="15" <?php if ("15" == $confirmdate_input_2_dia) { echo "selected"; } ?>>15</OPTION>
          <OPTION value="16" <?php if ("16" == $confirmdate_input_2_dia) { echo "selected"; } ?>>16</OPTION>
          <OPTION value="17" <?php if ("17" == $confirmdate_input_2_dia) { echo "selected"; } ?>>17</OPTION>
          <OPTION value="18" <?php if ("18" == $confirmdate_input_2_dia) { echo "selected"; } ?>>18</OPTION>
          <OPTION value="19" <?php if ("19" == $confirmdate_input_2_dia) { echo "selected"; } ?>>19</OPTION>
          <OPTION value="20" <?php if ("20" == $confirmdate_input_2_dia) { echo "selected"; } ?>>20</OPTION>
          <OPTION value="21" <?php if ("21" == $confirmdate_input_2_dia) { echo "selected"; } ?>>21</OPTION>
          <OPTION value="22" <?php if ("22" == $confirmdate_input_2_dia) { echo "selected"; } ?>>22</OPTION>
          <OPTION value="23" <?php if ("23" == $confirmdate_input_2_dia) { echo "selected"; } ?>>23</OPTION>
          <OPTION value="24" <?php if ("24" == $confirmdate_input_2_dia) { echo "selected"; } ?>>24</OPTION>
          <OPTION value="25" <?php if ("25" == $confirmdate_input_2_dia) { echo "selected"; } ?>>25</OPTION>
          <OPTION value="26" <?php if ("26" == $confirmdate_input_2_dia) { echo "selected"; } ?>>26</OPTION>
          <OPTION value="27" <?php if ("27" == $confirmdate_input_2_dia) { echo "selected"; } ?>>27</OPTION>
          <OPTION value="28" <?php if ("28" == $confirmdate_input_2_dia) { echo "selected"; } ?>>28</OPTION>
          <OPTION value="29" <?php if ("29" == $confirmdate_input_2_dia) { echo "selected"; } ?>>29</OPTION>
          <OPTION value="30" <?php if ("30" == $confirmdate_input_2_dia) { echo "selected"; } ?>>30</OPTION>
          <OPTION value="31" <?php if ("31" == $confirmdate_input_2_dia) { echo "selected"; } ?>>31</OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_confirmdate_input_2_MM' style='display: inline-block'>

         <SELECT class="scFilterObjectOdd" id="SC_confirmdate_input_2_mes" name="confirmdate_input_2_mes">
          <OPTION value=""></OPTION>
          <OPTION value="01" <?php if ("01" == $confirmdate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][0] ?></OPTION>
          <OPTION value="02" <?php if ("02" == $confirmdate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][1] ?></OPTION>
          <OPTION value="03" <?php if ("03" == $confirmdate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][2] ?></OPTION>
          <OPTION value="04" <?php if ("04" == $confirmdate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][3] ?></OPTION>
          <OPTION value="05" <?php if ("05" == $confirmdate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][4] ?></OPTION>
          <OPTION value="06" <?php if ("06" == $confirmdate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][5] ?></OPTION>
          <OPTION value="07" <?php if ("07" == $confirmdate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][6] ?></OPTION>
          <OPTION value="08" <?php if ("08" == $confirmdate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][7] ?></OPTION>
          <OPTION value="09" <?php if ("09" == $confirmdate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][8] ?></OPTION>
          <OPTION value="10" <?php if ("10" == $confirmdate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][9] ?></OPTION>
          <OPTION value="11" <?php if ("11" == $confirmdate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][10] ?></OPTION>
          <OPTION value="12" <?php if ("12" == $confirmdate_input_2_mes) { echo "selected"; } ?>><?php echo $_SESSION['scriptcase']['sc_tab_meses']['int'][11] ?></OPTION>
         </SELECT>
         </span>
...
<?php
  ...
  {
?>
<span id='id_date_part_confirmdate_input_2_AAAA' style='display: inline-block'>
<INPUT class="sc-js-input scFilterObjectOdd" type="text" id="SC_confirmdate_input_2_ano" name="confirmdate_input_2_ano" value="<?php echo NM_encode_input($confirmdate_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
 <INPUT type="hidden" id="sc_confirmdate_jq2">
</span>
...
?>
      ...
      <TD id='SC_finishdate_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['finishdate'])) ? $this->New_label['finishdate'] : "Finish Date"; ?></TD>
      
      <INPUT type="hidden" id="SC_finishdate_cond" name="finishdate_cond" value="bw">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_finishdate" <?php echo $str_hide_finishdate?> valign="top">
...
<span id='id_date_part_finishdate_DD' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectEven" id="SC_finishdate_dia" name="finishdate_dia">
          <OPTION value=""></OPTION>
...
<span id='id_date_part_finishdate_MM' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectEven" id="SC_finishdate_mes" name="finishdate_mes">
          <OPTION value=""></OPTION>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_finishdate_ano" name="finishdate_ano" value="<?php echo NM_encode_input($finishdate_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
        <SPAN id="id_css_finishdate" class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                 </TD>
       </TR>
       <TR valign="top">
        <TD id="id_vis_finishdate"  <?php echo $str_display_finishdate; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>
         <BR>
         <?php
...
<span id='id_date_part_finishdate_input_2_DD' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectEven" id="SC_finishdate_input_2_dia" name="finishdate_input_2_dia">
          <OPTION value=""></OPTION>
...
<span id='id_date_part_finishdate_input_2_MM' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectEven" id="SC_finishdate_input_2_mes" name="finishdate_input_2_mes">
          <OPTION value=""></OPTION>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_finishdate_input_2_ano" name="finishdate_input_2_ano" value="<?php echo NM_encode_input($finishdate_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
  ...
  <TD width="40%" height="">
   ...
   <tr>
      ...
      <TD id='SC_icdid_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['icdid'])) ? $this->New_label['icdid'] : "ICD-10"; ?></TD>
      
      <INPUT type="hidden" id="SC_icdid_cond" name="icdid_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_icdid" <?php echo $str_hide_icdid?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
 $SC_Label = (isset($this->New_label['icdid'])) ? $this->New_label['icdid'] : "ICD-10";
 $nmgp_tab_label .= "icdid?#?" . $SC_Label . "?@?";
 $date_sep_bw = " " . $this->Ini->Nm_lang['lang_srch_between_values'] . " ";
 if ($_SESSION['scriptcase']['charset'] != "UTF-8" && NM_is_utf8($date_sep_bw))
 {
     $date_sep_bw = sc_convert_encoding($date_sep_bw, $_SESSION['scriptcase']['charset'], "UTF-8");
...
<?php
      ...
      $icdid_look = substr($this->Db->qstr($icdid), 1, -1); 
      $nmgp_def_dados = array(); 
      $nm_comando = "select icd, descEng from icd10_settings where icd = '$icdid_look' order by descEng"; 
      unset($cmp1,$cmp2);
      $_SESSION['scriptcase']['sc_sql_ult_comando'] = $nm_comando; 
      $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
      if ($rs = $this->Db->Execute($nm_comando)) 
      ...
      {
          $sAutocompValue = $icdid;
      }
?>
<INPUT  type="text" id="SC_icdid" name="icdid" value="<?php echo NM_encode_input($icdid) ?>"  size=15 alt="{datatype: 'text', maxLength: 15, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}" style="display: none">
<input class="sc-js-input scFilterObjectOdd" type="text" id="id_ac_icdid" name="icdid_autocomp" size="30"  value="<?php echo NM_encode_input($sAutocompValue); ?>" alt="{datatype: 'text', maxLength: 30, allowedChars: '', lettersCase: 'upper', autoTab: false, enterTab: false}">
      ...
      <TD id='SC_staffid_label' class="scFilterLabelEven"><?php echo (isset($this->New_label['staffid'])) ? $this->New_label['staffid'] : "Staff Input"; ?></TD>
      
      <INPUT type="hidden" id="SC_staffid_cond" name="staffid_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldEven">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_staffid" <?php echo $str_hide_staffid?> valign="top">
        <TD class="scFilterFieldFontEven">
           <?php
...
<?php
      ...
      if ($rs = $this->Db->Execute($nm_comando)) 
      { 
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['psq_check_ret']['staffid'] = array();
         while (!$rs->EOF) 
         { 
            $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['psq_check_ret']['staffid'][] = trim($rs->fields[0]);
...
?>
   <span id="idAjaxSelect_staffid">
      <SELECT class="scFilterObjectEven" id="SC_staffid" name="staffid"  size="1">
       <OPTION value=""></OPTION>
<?php
...
?>
      ...
      <TD id='SC_statusid_label' class="scFilterLabelOdd"><?php echo (isset($this->New_label['statusid'])) ? $this->New_label['statusid'] : "Status"; ?></TD>
      
      <INPUT type="hidden" id="SC_statusid_cond" name="statusid_cond" value="eq">
 
     <TD colspan=2 class="scFilterFieldOdd">
      <TABLE  border="0" cellpadding="0" cellspacing="0">
       <TR id="id_hide_statusid" <?php echo $str_hide_statusid?> valign="top">
        <TD class="scFilterFieldFontOdd">
           <?php
...
<?php
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['psq_check_ret']['statusid'] = array();
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['psq_check_ret']['statusid'][] = "1";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['psq_check_ret']['statusid'][] = "2";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['psq_check_ret']['statusid'][] = "3";
  $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['psq_check_ret']['statusid'][] = "0";
 ?>

<TABLE style="padding: 0px; spacing: 0px; border-width: 0px;"><TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_statusid" name="statusid[]" value="1##@@Process"  <?php if (in_array("1", $statusid))  { echo " checked" ;} ?>>Process</TD>
</TR>
<TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_statusid" name="statusid[]" value="2##@@Finished"  <?php if (in_array("2", $statusid))  { echo " checked" ;} ?>>Finished</TD>
</TR>
<TR>
  <TD class="scFilterFieldFontOdd"><INPUT class="scFilterObjectOdd" type="checkbox" id="SC_statusid" name="statusid[]" value="3##@@Confirmed"  <?php if (in_array("3", $statusid))  { echo " checked" ;} ?>>Confirmed</TD>
</TR>
<TR>
...
?>
<?php
   if (is_file("grid_his_laboratory_medical_help.txt"))
   {
...
?>
<?php
   if ($nm_apl_dependente == 1 || (!$_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['opc_psq'] && !$this->aba_iframe))
   {
...
<?php
       ...
       elseif (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['dashboard_info']['under_dashboard'])
       { }
       else 
       { 
?>
...
<?php
   ...
   elseif ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['opc_psq'])
   {
...
{
?>
<iframe id="nmsc_iframe_grid_his_laboratory_medical" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" align="center" height="1500px" name="nm_iframe_grid_his_laboratory_medical" scrolling="auto" src="index.php?nmgp_opcao=pesq&script_case_init=<?php echo NM_encode_input($this->Ini->sc_page) ?>" width="100%"></iframe>
<?php
}
else
{
...
?>
<iframe id="nmsc_iframe_grid_his_laboratory_medical_pesq"  name="nm_iframe_grid_his_laboratory_medical_pesq" style= "display: none;" frameborder="0" marginwidth="0px" marginheight="0px" topmargin="0px" leftmargin="0px" src=""></iframe>
</td></tr></table></td></tr>
</TABLE>
   ...
   <INPUT type="hidden" name="script_case_init" value="<?php echo NM_encode_input($this->Ini->sc_page); ?>"> 
<?php
   if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['orig_pesq'] == "grid")
   {
...
?>
 ...
 {
    document.F1.target = "nm_iframe_grid_his_laboratory_medical_pesq";
    document.F1.submit();
 }
 function nm_move()
 {
     document.getElementById('nmsc_iframe_grid_his_laboratory_medical').contentWindow.nm_move('igual');
 }
 function limpa_form()
 {
   document.F1.reset();
   ...
   document.F1.trandate_cond.value = 'bw';
   ...
   document.F1.trandate_input_2_dia.value = "";
   document.F1.trandate_input_2_mes.value = "";
   document.F1.trandate_input_2_ano.value = "";
   document.F1.confirmdate_cond.value = 'bw';
   nm_campos_between(document.getElementById('id_vis_confirmdate'), document.F1.confirmdate_cond, 'confirmdate');
   document.F1.confirmdate_dia.value = "";
   document.F1.confirmdate_mes.value = "";
   document.F1.confirmdate_ano.value = "";
   document.F1.confirmdate_input_2_dia.value = "";
   document.F1.confirmdate_input_2_mes.value = "";
   document.F1.confirmdate_input_2_ano.value = "";
   ...
   nm_campos_between(document.getElementById('id_vis_icdid'), document.F1.icdid_cond, 'icdid');
   document.F1.icdid.value = "";
   document.F1.icdid_autocomp.value = "";
...
<?php
   ...
   function gera_array_filtros()
   {
       ...
       $NM_patch   = "LMMS/grid_his_laboratory_medical";
   ...
   function inicializa_vars()
   {
      ...
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['where_orig']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['where_orig'] = "";
      }
      $this->comando        = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['where_orig'];
      $this->comando_sum    = "";
      $this->comando_filtro = "";
   ...
   function salva_filtro($nmgp_save_origem)
   {
      global $NM_filters_save, $nmgp_save_name, $nmgp_save_option, $script_case_init;
          ...
          $NM_patch .= "grid_his_laboratory_medical/";
          if (!is_dir($NM_patch))
          {
              $NMdir = mkdir($NM_patch, 0755);
          }
   ...
   function recupera_filtro($NM_filters)
   {
      ...
      $tp_fields['SC_confirmdate_cond'] = 'cond';
      $tp_fields['SC_confirmdate_dia'] = 'text';
      $tp_fields['SC_confirmdate_mes'] = 'text';
      $tp_fields['SC_confirmdate_ano'] = 'text';
      $tp_fields['SC_confirmdate_input_2_dia'] = 'text';
      $tp_fields['SC_confirmdate_input_2_mes'] = 'text';
      $tp_fields['SC_confirmdate_input_2_ano'] = 'text';
      ...
      $tp_fields['SC_icdid_cond'] = 'cond';
      $tp_fields['SC_icdid'] = 'text_aut';
      $tp_fields['id_ac_icdid'] = 'text_aut';
   ...
   {
      global $trandate_cond, $trandate, $trandate_dia, $trandate_mes, $trandate_ano, $trandate_input_2_dia, $trandate_input_2_mes, $trandate_input_2_ano,
             $confirmdate_cond, $confirmdate, $confirmdate_dia, $confirmdate_mes, $confirmdate_ano, $confirmdate_input_2_dia, $confirmdate_input_2_mes, $confirmdate_input_2_ano,
             $finishdate_cond, $finishdate, $finishdate_dia, $finishdate_mes, $finishdate_ano, $finishdate_input_2_dia, $finishdate_input_2_mes, $finishdate_input_2_ano,
             $icdid_cond, $icdid, $icdid_autocomp,
             $staffid_cond, $staffid,
             $statusid_cond, $statusid, $nmgp_tab_label;

      $C_formatado = true;
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_gp_limpa.php", "F", "nm_limpa_valor") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_conv_dados.php", "F", "nm_conv_limpa_dado") ; 
      $this->Ini->sc_Include($this->Ini->path_lib_php . "/nm_edit.php", "F", "nmgp_Form_Num_Val") ; 
      if (!empty($icdid_autocomp) && empty($icdid))
      {
          $icdid = $icdid_autocomp;
      }
      $trandate_cond_salva = $trandate_cond; 
      if (!isset($trandate_input_2_dia) || $trandate_input_2_dia == "")
      {
          $trandate_input_2_dia = $trandate_dia;
      }
      if (!isset($trandate_input_2_mes) || $trandate_input_2_mes == "")
      {
          $trandate_input_2_mes = $trandate_mes;
      }
      if (!isset($trandate_input_2_ano) || $trandate_input_2_ano == "")
      {
          $trandate_input_2_ano = $trandate_ano;
      }
      $confirmdate_cond_salva = $confirmdate_cond; 
      if (!isset($confirmdate_input_2_dia) || $confirmdate_input_2_dia == "")
      {
          $confirmdate_input_2_dia = $confirmdate_dia;
      }
      if (!isset($confirmdate_input_2_mes) || $confirmdate_input_2_mes == "")
      {
          $confirmdate_input_2_mes = $confirmdate_mes;
      }
      if (!isset($confirmdate_input_2_ano) || $confirmdate_input_2_ano == "")
      {
          $confirmdate_input_2_ano = $confirmdate_ano;
      }
      ...
      $icdid_cond_salva = $icdid_cond; 
      if (!isset($icdid_input_2) || $icdid_input_2 == "")
      {
          $icdid_input_2 = $icdid;
      }
      ...
      if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && !empty($L_lookup) && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['psq_check_ret']['staffid'])) {
          if (!empty($this->Campos_Mens_erro)) {$this->Campos_Mens_erro .= "<br>";}$this->Campos_Mens_erro .= "Staff Input : " . $this->Ini->Nm_lang['lang_errm_ajax_data'];
      }
      if (is_array($statusid)) {
          foreach ($statusid as $I => $Val) {
              ...
              if ($this->NM_ajax_opcao != "ajax_grid_search_change_fil" && trim($L_lookup) != '' && !in_array($L_lookup, $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['psq_check_ret']['statusid'])) {
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']  = array(); 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['trandate_dia'] = $trandate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['trandate_mes'] = $trandate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['trandate_ano'] = $trandate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['trandate_input_2_dia'] = $trandate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['trandate_input_2_mes'] = $trandate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['trandate_input_2_ano'] = $trandate_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['trandate_cond'] = $trandate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['confirmdate_dia'] = $confirmdate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['confirmdate_mes'] = $confirmdate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['confirmdate_ano'] = $confirmdate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['confirmdate_input_2_dia'] = $confirmdate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['confirmdate_input_2_mes'] = $confirmdate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['confirmdate_input_2_ano'] = $confirmdate_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['confirmdate_cond'] = $confirmdate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['finishdate_dia'] = $finishdate_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['finishdate_mes'] = $finishdate_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['finishdate_ano'] = $finishdate_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['finishdate_input_2_dia'] = $finishdate_input_2_dia; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['finishdate_input_2_mes'] = $finishdate_input_2_mes; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['finishdate_input_2_ano'] = $finishdate_input_2_ano; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['finishdate_cond'] = $finishdate_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['icdid'] = $icdid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['icdid_cond'] = $icdid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['staffid'] = $staffid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['staffid_cond'] = $staffid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['statusid'] = $statusid; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['statusid_cond'] = $statusid_cond_salva; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['NM_operador'] = $this->NM_operador; 
      if ($this->NM_ajax_flag && $this->NM_ajax_opcao == "ajax_grid_search")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca'] = $Temp_Busca;
      }
      if (!empty($this->Campos_Mens_erro)) 
      {
          return;
    ...
    if ($icdid != '') {
      ...
      elseif (!empty($nmgp_def_dados) && isset($cmp1) && !empty($cmp1))
      {
          ...
          $this->cmp_formatado['icdid'] = $cmp1;
      }
      else
      {
          $this->cmp_formatado['icdid'] = $icdid;
      }
      $Conteudo = $staffid;
      ...
      $this->cmp_formatado['statusid'] = $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['statusid'];
      ...
      if ($trandate_cond != "bi_TP")
      {
          ...
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATETIME", $trandate_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $trandate = $val[0];
          $this->cmp_formatado['trandate'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['trandate'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['trandate'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['trandate'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          if ($trandate_cond == "BW")
          {
              if (!$this->Date_part) {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['trandate_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['trandate_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['trandate_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          }
          if (!empty($Dtxt) || $trandate_cond == "NU" || $trandate_cond == "NN"|| $trandate_cond == "EP"|| $trandate_cond == "NE")
          {
              $this->monta_condicao("a.tranDate", $trandate_cond, $trandate, $trandate_input_2, 'trandate', 'DATETIME');
          }
      }

      //----- $confirmdate
      $this->Date_part = false;
      if ($confirmdate_cond != "bi_TP")
      {
          $confirmdate_cond = strtoupper($confirmdate_cond);
          $Dtxt = "";
          $val  = array();
          $Dtxt .= $confirmdate_ano;
          $Dtxt .= $confirmdate_mes;
          $Dtxt .= $confirmdate_dia;
          $val[0]['ano'] = $confirmdate_ano;
          $val[0]['mes'] = $confirmdate_mes;
          $val[0]['dia'] = $confirmdate_dia;
          if ($confirmdate_cond == "BW")
          {
              $val[1]['ano'] = $confirmdate_input_2_ano;
              $val[1]['mes'] = $confirmdate_input_2_mes;
              $val[1]['dia'] = $confirmdate_input_2_dia;
          }
          $this->Operador_date_part = "";
          $this->Lang_date_part     = "";
          $this->nm_prep_date($val, "DT", "DATETIME", $confirmdate_cond, "", "data");
          if (!$this->Date_part) {
              $val[0] = $this->Ini->sc_Date_Protect($val[0]);
          }
          $confirmdate = $val[0];
          $this->cmp_formatado['confirmdate'] = $val[0];
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['confirmdate'] = $val[0];
          $this->nm_data->SetaData($this->cmp_formatado['confirmdate'], "YYYY-MM-DD HH:II:SS");
          $this->cmp_formatado['confirmdate'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          if ($confirmdate_cond == "BW")
          {
              if (!$this->Date_part) {
                  $val[1] = $this->Ini->sc_Date_Protect($val[1]);
              }
              $confirmdate_input_2     = $val[1];
              $this->cmp_formatado['confirmdate_input_2'] = $val[1];
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['confirmdate_input_2'] = $val[1];
              $this->nm_data->SetaData($this->cmp_formatado['confirmdate_input_2'], "YYYY-MM-DD HH:II:SS");
              $this->cmp_formatado['confirmdate_input_2'] = $this->nm_data->FormataSaida($this->nm_data->FormatRegion("DH", "dmY"));
          }
          if (!empty($Dtxt) || $confirmdate_cond == "NU" || $confirmdate_cond == "NN"|| $confirmdate_cond == "EP"|| $confirmdate_cond == "NE")
          {
              $this->monta_condicao("a.confirmDate", $confirmdate_cond, $confirmdate, $confirmdate_input_2, 'confirmdate', 'DATETIME');
          }
      }
      ...
      if ($finishdate_cond != "bi_TP")
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['finishdate'] = $val[0];
          ...
          if ($finishdate_cond == "BW")
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']['finishdate_input_2'] = $val[1];
      ...
      if (isset($icdid) && !empty($icdid))
      { 
           $icdid = strtoupper($icdid);
      } 
      if (isset($icdid) || $icdid_cond == "nu" || $icdid_cond == "nn" || $icdid_cond == "ep" || $icdid_cond == "ne")
      {
         $this->monta_condicao("a.icdID", $icdid_cond, $icdid, "", "icdid");
      }
      ...
      if (is_array($statusid) && count($statusid) != 0)
      {
         ...
         if ($statusid_cond == "df" || $statusid_cond == "np")
         {
             ...
             $this->comando_sum    .= " laboratory_medical.a.statusID not in (";
             $this->comando_filtro .= " a.statusID not in (";
         }
         else
         {
             $this->comando        .= " a.statusID in (";
             $this->comando_sum    .= " laboratory_medical.a.statusID in (";
         ...
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $nmgp_tab_label['statusid'] . " " . $this->Ini->Nm_lang['lang_srch_like'] . " " . $nm_cond . "##*@@";
      }
   ...
   {
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['dyn_search']      = array();
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_dyn_search'] = "";
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca']) && $_SESSION['scriptcase']['charset'] != "UTF-8")
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca'] = NM_conv_charset($_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['campos_busca'], "UTF-8", $_SESSION['scriptcase']['charset']);
      }

      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['where_pesq_lookup']  = $this->comando_sum . $this->comando_fim;
      $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['where_pesq']         = $this->comando . $this->comando_fim;
      ...
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['where_pesq_filtro'] = " (" . $this->comando_filtro . ")";
      }
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['where_pesq'] != $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['where_pesq_ant'])
      {
         $_SESSION['sc_session'][$this->Ini->sc_page]['grid_his_laboratory_medical']['cond_pesq'] .= $this->NM_operador;
   ...
   function css_obj_select_ajax($Obj)
   {
      switch ($Obj)
      {
         case "staffid" : return ('class="scFilterObjectEven"'); break;
         default       : return ("");
      }
   }
