...
//-- ajax metodos ---
   ...
   function monta_condicao($nome, $condicao, $campo, $campo2 = "", $nome_campo="", $tp_campo="")
   {
      ...
      $nm_ini_lower = "";
      $nm_fim_lower = "";
      $Nm_datas[] = "a.tranDate";$Nm_datas[] = "a_tranDate";$Nm_datas[] = "a.birthDate";$Nm_datas[] = "a_birthDate";$Nm_datas[] = "a.finishDate";$Nm_datas[] = "a_finishDate";$Nm_datas[] = "a.confirmDate";$Nm_datas[] = "a_confirmDate";$Nm_numeric[] = "a_id";$Nm_numeric[] = "a_statusid";$Nm_numeric[] = "a_staffid";
    ...
    <TR>
     <TD colspan="1" height="20" class="scFilterBlockBack">
      <TABLE border="0" cellpadding="0" cellspacing="0" width="100%" height="100%">
       <TR>
        <TD class="scFilterBlockFont css_blk_0"><?php echo $Img_tit_blk_i ?>grid_laboratory_medical<?php echo $Img_tit_blk_f ?></TD>
...
?>
 ...
 <?php echo $date_format_show ?>         </SPAN>
          ...
          <BR>
        <SPAN id="id_vis_trandate"  <?php echo $str_display_trandate; ?> class="scFilterFieldFontOdd">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_confirmdate"  <?php echo $str_hide_confirmdate?>>
<?php
  $Form_base = "ddmmyyyy";
  $date_format_show = "";
  $Str_date = str_replace("a", "y", strtolower($_SESSION['scriptcase']['reg_conf']['date_format']));
...
<span id='id_date_part_confirmdate_DD' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectEven" id="SC_confirmdate_dia" name="confirmdate_dia">
          <OPTION value=""></OPTION>
...
<span id='id_date_part_confirmdate_MM' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectEven" id="SC_confirmdate_mes" name="confirmdate_mes">
          <OPTION value=""></OPTION>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_confirmdate_ano" name="confirmdate_ano" value="<?php echo NM_encode_input($confirmdate_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
        <SPAN id="id_css_confirmdate" class="scFilterFieldFontEven">
 <?php echo $date_format_show ?>         </SPAN>
                  </span>
          <BR>
        <SPAN id="id_vis_confirmdate"  <?php echo $str_display_confirmdate; ?> class="scFilterFieldFontEven">
         <?php echo $date_sep_bw ?>&nbsp;
         <BR>
         <?php
...
<span id='id_date_part_confirmdate_input_2_DD' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectEven" id="SC_confirmdate_input_2_dia" name="confirmdate_input_2_dia">
          <OPTION value=""></OPTION>
...
<span id='id_date_part_confirmdate_input_2_MM' style='display: inline-block'>
         ...
         <SELECT class="scFilterObjectEven" id="SC_confirmdate_input_2_mes" name="confirmdate_input_2_mes">
          <OPTION value=""></OPTION>
...
<INPUT class="sc-js-input scFilterObjectEven" type="text" id="SC_confirmdate_input_2_ano" name="confirmdate_input_2_ano" value="<?php echo NM_encode_input($confirmdate_input_2_ano); ?>" size="4" alt="{datatype: 'mask', maskList: '9999', alignRight: true, maxLength: 4, autoTab: true, enterTab: false}">
...
?>
<span class="SC_Field_label_Mob"><?php echo $SC_Label ?></span><br><span id="id_hide_icdid"  <?php echo $str_hide_icdid?>><?php
      if ($icdid != "")
      {
      $icdid_look = substr($this->Db->qstr($icdid), 1, -1); 
      $nmgp_def_dados = array(); 
