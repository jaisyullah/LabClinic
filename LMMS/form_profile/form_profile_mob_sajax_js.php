  ...
  function scAjaxUpdateErrors(sType)
  {
    ...
    if (oResp["errList"])
    {
      for (iFieldErrors = 0; iFieldErrors < oResp["errList"].length; iFieldErrors++)
      {
        ...
        if ("geral_form_profile_mob" == sTestField)
        {
...
//    return document.F1.elements[sFieldName].value.replace(/[+]/g, "__NM_PLUS__");
  ...
  // ---------- Validate name
  function do_ajax_form_profile_mob_validate_name()
  {
    var nomeCampo_name = "name";
    var var_name = scAjaxGetFieldText(nomeCampo_name);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_name(var_name, var_script_case_init, do_ajax_form_profile_mob_validate_name_cb);
  } // do_ajax_form_profile_mob_validate_name

  function do_ajax_form_profile_mob_validate_name_cb(sResp)
  {
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_name_cb

  // ---------- Validate headline
  function do_ajax_form_profile_mob_validate_headline()
  {
    var nomeCampo_headline = "headline";
    var var_headline = scAjaxGetFieldText(nomeCampo_headline);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_headline(var_headline, var_script_case_init, do_ajax_form_profile_mob_validate_headline_cb);
  } // do_ajax_form_profile_mob_validate_headline

  function do_ajax_form_profile_mob_validate_headline_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_headline_cb

  // ---------- Validate currency
  function do_ajax_form_profile_mob_validate_currency()
  {
    var nomeCampo_currency = "currency";
    var var_currency = scAjaxGetFieldSelect(nomeCampo_currency);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_currency(var_currency, var_script_case_init, do_ajax_form_profile_mob_validate_currency_cb);
  } // do_ajax_form_profile_mob_validate_currency

  function do_ajax_form_profile_mob_validate_currency_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_currency_cb

  // ---------- Validate footer
  function do_ajax_form_profile_mob_validate_footer()
  {
    var nomeCampo_footer = "footer";
    var var_footer = scAjaxGetFieldText(nomeCampo_footer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_footer(var_footer, var_script_case_init, do_ajax_form_profile_mob_validate_footer_cb);
  } // do_ajax_form_profile_mob_validate_footer

  function do_ajax_form_profile_mob_validate_footer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "footer";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_footer_cb

  // ---------- Validate country
  function do_ajax_form_profile_mob_validate_country()
  {
    var nomeCampo_country = "country";
    var var_country = scAjaxGetFieldSelect(nomeCampo_country);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_country(var_country, var_script_case_init, do_ajax_form_profile_mob_validate_country_cb);
  } // do_ajax_form_profile_mob_validate_country

  function do_ajax_form_profile_mob_validate_country_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "country";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_country_cb

  // ---------- Validate officer
  function do_ajax_form_profile_mob_validate_officer()
  {
    var nomeCampo_officer = "officer";
    var var_officer = scAjaxGetFieldText(nomeCampo_officer);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_officer(var_officer, var_script_case_init, do_ajax_form_profile_mob_validate_officer_cb);
  } // do_ajax_form_profile_mob_validate_officer

  function do_ajax_form_profile_mob_validate_officer_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "officer";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_officer_cb

  // ---------- Validate id
  function do_ajax_form_profile_mob_validate_id()
  {
    var nomeCampo_id = "id";
    var var_id = scAjaxGetFieldText(nomeCampo_id);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_id(var_id, var_script_case_init, do_ajax_form_profile_mob_validate_id_cb);
  } // do_ajax_form_profile_mob_validate_id

  function do_ajax_form_profile_mob_validate_id_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "id";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_id_cb

  // ---------- Validate logo
  function do_ajax_form_profile_mob_validate_logo()
  {
    var nomeCampo_logo = "logo";
    var var_logo = scAjaxGetFieldText(nomeCampo_logo);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_logo(var_logo, var_script_case_init, do_ajax_form_profile_mob_validate_logo_cb);
  } // do_ajax_form_profile_mob_validate_logo

  function do_ajax_form_profile_mob_validate_logo_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "logo";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_logo_cb

  // ---------- Validate facebook
  function do_ajax_form_profile_mob_validate_facebook()
  {
    var nomeCampo_facebook = "facebook";
    var var_facebook = scAjaxGetFieldText(nomeCampo_facebook);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_facebook(var_facebook, var_script_case_init, do_ajax_form_profile_mob_validate_facebook_cb);
  } // do_ajax_form_profile_mob_validate_facebook

  function do_ajax_form_profile_mob_validate_facebook_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_facebook_cb

  // ---------- Validate instagram
  function do_ajax_form_profile_mob_validate_instagram()
  {
    var nomeCampo_instagram = "instagram";
    var var_instagram = scAjaxGetFieldText(nomeCampo_instagram);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_instagram(var_instagram, var_script_case_init, do_ajax_form_profile_mob_validate_instagram_cb);
  } // do_ajax_form_profile_mob_validate_instagram

  function do_ajax_form_profile_mob_validate_instagram_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_instagram_cb

  // ---------- Validate twitter
  function do_ajax_form_profile_mob_validate_twitter()
  {
    var nomeCampo_twitter = "twitter";
    var var_twitter = scAjaxGetFieldText(nomeCampo_twitter);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_twitter(var_twitter, var_script_case_init, do_ajax_form_profile_mob_validate_twitter_cb);
  } // do_ajax_form_profile_mob_validate_twitter

  function do_ajax_form_profile_mob_validate_twitter_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "twitter";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_twitter_cb

  // ---------- Validate youtube
  function do_ajax_form_profile_mob_validate_youtube()
  {
    var nomeCampo_youtube = "youtube";
    var var_youtube = scAjaxGetFieldText(nomeCampo_youtube);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_youtube(var_youtube, var_script_case_init, do_ajax_form_profile_mob_validate_youtube_cb);
  } // do_ajax_form_profile_mob_validate_youtube

  function do_ajax_form_profile_mob_validate_youtube_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "youtube";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_youtube_cb

  // ---------- Validate address
  function do_ajax_form_profile_mob_validate_address()
  {
    var nomeCampo_address = "address";
    var var_address = scAjaxGetFieldText(nomeCampo_address);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_address(var_address, var_script_case_init, do_ajax_form_profile_mob_validate_address_cb);
  } // do_ajax_form_profile_mob_validate_address

  function do_ajax_form_profile_mob_validate_address_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "address";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_address_cb

  // ---------- Validate phone
  function do_ajax_form_profile_mob_validate_phone()
  {
    var nomeCampo_phone = "phone";
    var var_phone = scAjaxGetFieldText(nomeCampo_phone);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_phone(var_phone, var_script_case_init, do_ajax_form_profile_mob_validate_phone_cb);
  } // do_ajax_form_profile_mob_validate_phone

  function do_ajax_form_profile_mob_validate_phone_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "phone";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_phone_cb

  // ---------- Validate mail
  function do_ajax_form_profile_mob_validate_mail()
  {
    var nomeCampo_mail = "mail";
    var var_mail = scAjaxGetFieldText(nomeCampo_mail);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_mail(var_mail, var_script_case_init, do_ajax_form_profile_mob_validate_mail_cb);
  } // do_ajax_form_profile_mob_validate_mail

  function do_ajax_form_profile_mob_validate_mail_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "mail";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_mail_cb

  // ---------- Validate long
  function do_ajax_form_profile_mob_validate_long()
  {
    var nomeCampo_long = "long";
    var var_long = scAjaxGetFieldText(nomeCampo_long);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_long(var_long, var_script_case_init, do_ajax_form_profile_mob_validate_long_cb);
  } // do_ajax_form_profile_mob_validate_long

  function do_ajax_form_profile_mob_validate_long_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "long";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_long_cb

  // ---------- Validate lat
  function do_ajax_form_profile_mob_validate_lat()
  {
    var nomeCampo_lat = "lat";
    var var_lat = scAjaxGetFieldText(nomeCampo_lat);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_lat(var_lat, var_script_case_init, do_ajax_form_profile_mob_validate_lat_cb);
  } // do_ajax_form_profile_mob_validate_lat

  function do_ajax_form_profile_mob_validate_lat_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "lat";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_lat_cb

  // ---------- Validate aboutus
  function do_ajax_form_profile_mob_validate_aboutus()
  {
    var nomeCampo_aboutus = "aboutus";
    var var_aboutus = scAjaxGetFieldEditorHtml(nomeCampo_aboutus);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_aboutus(var_aboutus, var_script_case_init, do_ajax_form_profile_mob_validate_aboutus_cb);
  } // do_ajax_form_profile_mob_validate_aboutus

  function do_ajax_form_profile_mob_validate_aboutus_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "aboutus";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_aboutus_cb

  // ---------- Validate privacypolicy
  function do_ajax_form_profile_mob_validate_privacypolicy()
  {
    var nomeCampo_privacypolicy = "privacypolicy";
    var var_privacypolicy = scAjaxGetFieldEditorHtml(nomeCampo_privacypolicy);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_privacypolicy(var_privacypolicy, var_script_case_init, do_ajax_form_profile_mob_validate_privacypolicy_cb);
  } // do_ajax_form_profile_mob_validate_privacypolicy

  function do_ajax_form_profile_mob_validate_privacypolicy_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_privacypolicy_cb

  // ---------- Validate terms
  function do_ajax_form_profile_mob_validate_terms()
  {
    var nomeCampo_terms = "terms";
    var var_terms = scAjaxGetFieldEditorHtml(nomeCampo_terms);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_terms(var_terms, var_script_case_init, do_ajax_form_profile_mob_validate_terms_cb);
  } // do_ajax_form_profile_mob_validate_terms

  function do_ajax_form_profile_mob_validate_terms_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    sFieldValid = "terms";
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_terms_cb

  // ---------- Validate healthguide
  function do_ajax_form_profile_mob_validate_healthguide()
  {
    var nomeCampo_healthguide = "healthguide";
    var var_healthguide = scAjaxGetFieldEditorHtml(nomeCampo_healthguide);
    var var_script_case_init = document.F1.script_case_init.value;
    x_ajax_form_profile_mob_validate_healthguide(var_healthguide, var_script_case_init, do_ajax_form_profile_mob_validate_healthguide_cb);
  } // do_ajax_form_profile_mob_validate_healthguide

  function do_ajax_form_profile_mob_validate_healthguide_cb(sResp)
  {
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetMaster();
    scAjaxSetFocus();
  } // do_ajax_form_profile_mob_validate_healthguide_cb
...
function scJs_sweetalert_params(params) {
  ...
  // ---------- Form
  function do_ajax_form_profile_mob_submit_form()
  {
    if (scEventControl_active("")) {
      setTimeout(function() { do_ajax_form_profile_mob_submit_form(); }, 500);
      return;
    }
    scAjaxHideMessage();
    ...
    scAjaxProcOn();
    x_ajax_form_profile_mob_submit_form(var_name, var_headline, var_currency, var_footer, var_country, var_officer, var_id, var_logo, var_facebook, var_instagram, var_twitter, var_youtube, var_address, var_phone, var_mail, var_long, var_lat, var_aboutus, var_privacypolicy, var_terms, var_healthguide, var_logo_ul_name, var_logo_ul_type, var_officer_ul_name, var_officer_ul_type, var_officer_salva, var_officer_limpa, var_logo_salva, var_logo_limpa, var_nm_form_submit, var_nmgp_url_saida, var_nmgp_opcao, var_nmgp_ancora, var_nmgp_num_form, var_nmgp_parms, var_script_case_init, var_csrf_token, do_ajax_form_profile_mob_submit_form_cb);
  } // do_ajax_form_profile_mob_submit_form

  function do_ajax_form_profile_mob_submit_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
...
?>
    ...
    scAjaxSetLabel();
    scAjaxSetReadonly();
    scAjaxAlert(do_ajax_form_profile_mob_submit_form_cb_after_alert);
  } // do_ajax_form_profile_mob_submit_form_cb
  function do_ajax_form_profile_mob_submit_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
    scAjaxSetFocus();
    scAjaxRedir();
  ...
  } // do_ajax_form_profile_mob_submit_form_cb_after_alert

  var scStatusDetail = {};

  function do_ajax_form_profile_mob_navigate_form()
  {
    perform_ajax_form_profile_mob_navigate_form();
  }

  function perform_ajax_form_profile_mob_navigate_form()
  {
    if (scRefreshTable())
    {
      return;
    ...
    scAjaxProcOn();
    x_ajax_form_profile_mob_navigate_form(var_id, var_nm_form_submit, var_nmgp_opcao, var_nmgp_ordem, var_nmgp_fast_search,  var_nmgp_cond_fast_search,  var_nmgp_arg_fast_search, var_nmgp_arg_dyn_search, var_script_case_init, do_ajax_form_profile_mob_navigate_form_cb);
  } // do_ajax_form_profile_mob_navigate_form

  var scMasterDetailParentIframe = "<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile_mob']['dashboard_info']['parent_widget'] ?>";
...
?>
  function do_ajax_form_profile_mob_navigate_form_cb(sResp)
  {
    scAjaxProcOff();
    oResp = scAjaxResponse(sResp);
    scAjaxRedir();
    ...
    scAjaxSetBtnVars();
    $('.sc-js-ui-statusimg').css('display', 'none');
    scAjaxAlert(do_ajax_form_profile_mob_navigate_form_cb_after_alert);
  } // do_ajax_form_profile_mob_navigate_form_cb
  function do_ajax_form_profile_mob_navigate_form_cb_after_alert() {
    scAjaxMessage();
    scAjaxJavascript();
...
{
?>
    do_ajax_form_profile_mob_restore_buttons();
<?php
}
?>
    if (hasJsFormOnload)
    ...
    SC_btn_grp_text();
  } // do_ajax_form_profile_mob_navigate_form_cb_after_alert
  function sc_hide_form_profile_mob_form()
  {
