<div id="form_profile_mob_form1" style='<?php echo ($this->tabCssClass["form_profile_mob_form1"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_facebook_line" id="hidden_field_data_facebook" style="<?php echo $sStyleHidden_facebook; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_facebook_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_facebook_label" style=""><span id="id_label_facebook"><?php echo $this->nm_new_label['facebook']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_instagram_line" id="hidden_field_data_instagram" style="<?php echo $sStyleHidden_instagram; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_instagram_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_instagram_label" style=""><span id="id_label_instagram"><?php echo $this->nm_new_label['instagram']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_twitter_line" id="hidden_field_data_twitter" style="<?php echo $sStyleHidden_twitter; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_twitter_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_twitter_label" style=""><span id="id_label_twitter"><?php echo $this->nm_new_label['twitter']; ?></span></span><br>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormDataOdd css_youtube_line" id="hidden_field_data_youtube" style="<?php echo $sStyleHidden_youtube; ?>"> <table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_youtube_line" style="vertical-align: top;padding: 0px"><span class="scFormLabelOddFormat css_youtube_label" style=""><span id="id_label_youtube"><?php echo $this->nm_new_label['youtube']; ?></span></span><br>
