...
//----- 
   function ini_controle()
   {
      ...
      if (isset($_SESSION['sc_session'][$script_case_init]['form_profile']['embutida_parms']))
      { 
          $this->nmgp_parms = $_SESSION['sc_session'][$script_case_init]['form_profile']['embutida_parms'];
      ...
      { 
          ...
          {
              $_SESSION['sc_session'][$script_case_init]['form_profile']['where_filter_form'] = $this->NM_where_filter_form;
              unset($_SESSION['sc_session'][$script_case_init]['form_profile']['total']);
          }
          if (isset($this->sc_redir_atualiz))
          {
              $_SESSION['sc_session'][$script_case_init]['form_profile']['sc_redir_atualiz'] = $this->sc_redir_atualiz;
          }
          if (isset($this->sc_redir_insert))
          {
              $_SESSION['sc_session'][$script_case_init]['form_profile']['sc_redir_insert'] = $this->sc_redir_insert;
          }
      } 
      elseif (isset($script_case_init) && !empty($script_case_init) && isset($_SESSION['sc_session'][$script_case_init]['form_profile']['parms']))
      {
      ...
      { 
          $_SESSION['sc_session'][$script_case_init]['form_profile']['nm_run_menu'] = 1;
      } 
      ...
      {
          $_SESSION['sc_session'][$script_case_init]['form_profile']['lig_edit_lookup']     = true;
          $_SESSION['sc_session'][$script_case_init]['form_profile']['lig_edit_lookup_cb']  = $this->nm_evt_ret_edit;
          $_SESSION['sc_session'][$script_case_init]['form_profile']['lig_edit_lookup_row'] = isset($this->nm_evt_ret_row) ? $this->nm_evt_ret_row : '';
      }
      if (isset($_SESSION['sc_session'][$script_case_init]['form_profile']['lig_edit_lookup']) && $_SESSION['sc_session'][$script_case_init]['form_profile']['lig_edit_lookup'])
      {
          $this->lig_edit_lookup     = true;
          $this->lig_edit_lookup_cb  = $_SESSION['sc_session'][$script_case_init]['form_profile']['lig_edit_lookup_cb'];
          $this->lig_edit_lookup_row = $_SESSION['sc_session'][$script_case_init]['form_profile']['lig_edit_lookup_row'];
      }
      if (!$this->Ini)
      { 
          $this->Ini = new form_profile_ini(); 
          $this->Ini->init();
          $this->nm_data = new nm_data("en_us");
          $this->app_is_initializing = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['initialize'];
      } 
      else 
      { 
         $this->nm_data = new nm_data("en_us");
      } 
      $_SESSION['sc_session'][$script_case_init]['form_profile']['upload_field_info'] = array();

      $_SESSION['sc_session'][$script_case_init]['form_profile']['upload_field_info']['officer'] = array(
      ...
      $_SESSION['sc_session'][$script_case_init]['form_profile']['upload_field_info']['logo'] = array(
          'app_dir'            => $this->Ini->path_aplicacao,
          'app_name'           => 'form_profile',
          'upload_dir'         => $this->Ini->root . $this->Ini->path_imag_temp . '/',
          'upload_url'         => $this->Ini->path_imag_temp . '/',
      ...
      unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['masterValue']);
      $this->Change_Menu = false;
      $run_iframe = (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe']) && ($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] == "R")) ? true : false;
      if (!$run_iframe && isset($_SESSION['scriptcase']['menu_atual']) && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_call'] && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['sc_outra_jan']) || !$_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['sc_outra_jan']))
      {
          $this->sc_init_menu = "x";
          if (isset($_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_profile']))
          {
              $this->sc_init_menu = $_SESSION['scriptcase'][$_SESSION['scriptcase']['menu_atual']]['sc_init']['form_profile'];
          }
          ...
          if ($this->Ini->sc_page == $this->sc_init_menu && !isset($_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_profile']))
          {
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_profile']['link'] = $this->Ini->sc_protocolo . $this->Ini->server . $this->Ini->path_link . "" . SC_dir_app_name('form_profile') . "/";
               $_SESSION['scriptcase']['menu_apls'][$_SESSION['scriptcase']['menu_atual']][$this->sc_init_menu]['form_profile']['label'] = "" . $this->Ini->Nm_lang['lang_othr_frmu_title'] . " profile";
      ...
      $_SESSION['scriptcase']['error_icon']['form_profile']  = "<img src=\"" . $this->Ini->path_icones . "/scriptcase__NM__btn__NM__scriptcase9_Rhino__NM__nm_scriptcase9_Rhino_error.png\" style=\"border-width: 0px\" align=\"top\">&nbsp;";
      $_SESSION['scriptcase']['error_close']['form_profile'] = "<td>" . nmButtonOutput($this->arr_buttons, "berrm_clse", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "document.getElementById('id_error_display_fixed').style.display = 'none'; document.getElementById('id_error_message_fixed').innerHTML = ''; return false", "", "", "", "", "", "", "", $this->Ini->path_botoes, "", "", "", "", "") . "</td>";

      $this->Embutida_proc = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_proc']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_proc'] : $this->Embutida_proc;
      $this->Embutida_form = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_form']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_form'] : $this->Embutida_form;
      $this->Embutida_call = isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_call']) ? $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_call'] : $this->Embutida_call;

       $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['table_refresh'] = false;

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_grid_edit']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_grid_edit'])
      {
          $this->Grid_editavel = ('on' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_grid_edit']) ? true : false;
      }
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_multi']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_multi'])
      {
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_tp_pag']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_tp_pag'])
      {
          $this->form_paginacao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_tp_pag'];
      }

      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_form']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_form'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_form'] = $this->Embutida_form;
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_grid_edit'] = $this->Grid_editavel ? 'on' : 'off';
      }
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_grid_edit']) || '' == $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_grid_edit'])
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_grid_edit'] = $this->Embutida_call;
      }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['upload_field_ul_name'][$this->logo_ul_name]))
          {
              $this->NM_ajax_info['param']['logo_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['upload_field_ul_name'][$this->logo_ul_name];
          }
      ...
      elseif (isset($this->logo_ul_name) && '' != $this->logo_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['upload_field_ul_name'][$this->logo_ul_name]))
          {
              $this->logo_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['upload_field_ul_name'][$this->logo_ul_name];
          }
      ...
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['upload_field_ul_name'][$this->officer_ul_name]))
          {
              $this->NM_ajax_info['param']['officer_ul_name'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['upload_field_ul_name'][$this->officer_ul_name];
          }
      ...
      elseif (isset($this->officer_ul_name) && '' != $this->officer_ul_name)
      {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['upload_field_ul_name'][$this->officer_ul_name]))
          {
              $this->officer_ul_name = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['upload_field_ul_name'][$this->officer_ul_name];
          }
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['first_time'])
      {
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['insert']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['new']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['update']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['delete']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['first']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['back']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['forward']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['last']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['qsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['dynsearch']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['summary']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['navpage']);
          unset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['goto']);
      }
      $this->NM_cancel_return_new = (isset($this->NM_cancel_return_new) && $this->NM_cancel_return_new == 1) ? "1" : "";
      $this->NM_cancel_insert_new = ((isset($this->NM_cancel_insert_new) && $this->NM_cancel_insert_new == 1) || $this->NM_cancel_return_new == 1) ? "document.F5.action='" . $nm_url_saida . "';" : "";
      if (isset($this->NM_btn_insert) && '' != $this->NM_btn_insert && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['insert']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_profile']['insert']))
      {
          if ('N' == $this->NM_btn_insert)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['insert'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['insert'] = 'on';
          }
      }
      if (isset($this->NM_btn_new) && 'N' == $this->NM_btn_new)
      {
          $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['new'] = 'off';
      }
      if (isset($this->NM_btn_update) && '' != $this->NM_btn_update && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['update']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_profile']['update']))
      {
          if ('N' == $this->NM_btn_update)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['update'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['update'] = 'on';
          }
      }
      if (isset($this->NM_btn_delete) && '' != $this->NM_btn_delete && (!isset($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['delete']) || '' == $_SESSION['scriptcase']['sc_apl_conf']['form_profile']['delete']))
      {
          if ('N' == $this->NM_btn_delete)
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['delete'] = 'off';
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['delete'] = 'on';
          }
      }
      if (isset($this->NM_btn_navega) && '' != $this->NM_btn_navega)
      {
          ...
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['first']     = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['back']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['forward']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['last']      = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['qsearch']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['dynsearch'] = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['summary']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['navpage']   = 'off';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['goto']      = 'off';
              $this->Nav_permite_ava = false;
              $this->Nav_permite_ret = false;
          }
          else
          {
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['first']     = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['back']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['forward']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['last']      = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['qsearch']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['dynsearch'] = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['summary']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['navpage']   = 'on';
              $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['goto']      = 'on';
          }
      }
      ...
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_orig'] = "";
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_pesq']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_pesq'] = "";
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_pesq_filtro'] = "";
      }
      $this->sc_where_orig   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_orig'];
      $this->sc_where_atual  = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_pesq'];
      $this->sc_where_filtro = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_pesq_filtro'];
      if ($this->NM_ajax_flag && 'event_' == substr($this->NM_ajax_opcao, 0, 6)) {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['buttonStatus'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['iframe_filtro']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['iframe_filtro'] == "S")
      {
          $this->nmgp_botoes['exit'] = "off";
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['btn_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['btn_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['btn_display'] as $NM_cada_btn => $NM_cada_opc)
          {
              $this->nmgp_botoes[$NM_cada_btn] = $NM_cada_opc;
          }
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['insert']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['new']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['new'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['new'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['update']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['delete']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['delete'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['first']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['first'] != '')
      {
          $this->nmgp_botoes['first'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['first'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['back']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['back'] != '')
      {
          $this->nmgp_botoes['back'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['back'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['forward']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['forward'] != '')
      {
          $this->nmgp_botoes['forward'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['forward'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['last']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['last'] != '')
      {
          $this->nmgp_botoes['last'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['last'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['qsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['qsearch'] != '')
      {
          $this->nmgp_botoes['qsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['qsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['dynsearch']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['dynsearch'] != '')
      {
          $this->nmgp_botoes['dynsearch'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['dynsearch'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['summary']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['summary'] != '')
      {
          $this->nmgp_botoes['summary'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['summary'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['navpage']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['navpage'] != '')
      {
          $this->nmgp_botoes['navpage'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['navpage'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['goto']) && $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['goto'] != '')
      {
          $this->nmgp_botoes['goto'] = $_SESSION['scriptcase']['sc_apl_conf_lig']['form_profile']['goto'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_form_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_form_insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_form_insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_form_insert'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_form_update']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_form_update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_form_update'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_form_delete']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_form_delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_form_delete'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_form_btn_nav']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_form_btn_nav'] != '')
      {
          $this->nmgp_botoes['first']   = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['back']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['forward'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_form_btn_nav'];
          $this->nmgp_botoes['last']    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['embutida_liga_form_btn_nav'];
      }

      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['dashboard_info']['under_dashboard'] && !$_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['dashboard_info']['maximized']) {
          $tmpDashboardApp = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['dashboard_info']['dashboard_app'];
          if (isset($_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_profile'])) {
              $tmpDashboardButtons = $_SESSION['scriptcase']['dashboard_toolbar'][$tmpDashboardApp]['form_profile'];
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['insert']) && $_SESSION['scriptcase']['sc_apl_conf']['form_profile']['insert'] != '')
      {
          $this->nmgp_botoes['new']    = $_SESSION['scriptcase']['sc_apl_conf']['form_profile']['insert'];
          $this->nmgp_botoes['insert'] = $_SESSION['scriptcase']['sc_apl_conf']['form_profile']['insert'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['update']) && $_SESSION['scriptcase']['sc_apl_conf']['form_profile']['update'] != '')
      {
          $this->nmgp_botoes['update'] = $_SESSION['scriptcase']['sc_apl_conf']['form_profile']['update'];
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['delete']) && $_SESSION['scriptcase']['sc_apl_conf']['form_profile']['delete'] != '')
      {
          $this->nmgp_botoes['delete'] = $_SESSION['scriptcase']['sc_apl_conf']['form_profile']['delete'];
      }

      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['field_display']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['field_display']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['field_display'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_hidden[$NM_cada_field] = $NM_cada_opc;
              $this->NM_ajax_info['fieldDisplay'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['field_readonly']) && !empty($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['field_readonly']))
      {
          foreach ($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['field_readonly'] as $NM_cada_field => $NM_cada_opc)
          {
              $this->nmgp_cmp_readonly[$NM_cada_field] = "on";
              $this->NM_ajax_info['readOnly'][$NM_cada_field] = $NM_cada_opc;
          }
      }
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['exit']) && $_SESSION['scriptcase']['sc_apl_conf']['form_profile']['exit'] != '')
      {
          $_SESSION['scriptcase']['sc_url_saida'][$this->Ini->sc_page]       = $_SESSION['scriptcase']['sc_apl_conf']['form_profile']['exit'];
          $_SESSION['scriptcase']['sc_force_url_saida'][$this->Ini->sc_page] = true;
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['dados_form']))
      {
          $this->nmgp_dados_form = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['dados_form'];
      ...
      if (isset($_SESSION['scriptcase']['sc_aba_iframe']))
      {
          ...
          {
              if (in_array("form_profile", $apls_aba))
              {
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['iframe_menu'] && (!isset($_SESSION['scriptcase']['menu_mobile']) || empty($_SESSION['scriptcase']['menu_mobile'])))
      {
          $this->aba_iframe = true;
      }
      ...
      if (is_file($this->Ini->path_aplicacao . 'form_profile_help.txt'))
      {
          $arr_link_webhelp = file($this->Ini->path_aplicacao . 'form_profile_help.txt');
          if ($arr_link_webhelp)
          {
      ...
      { 
          require_once($this->Ini->path_embutida . 'form_profile/form_profile_erro.class.php');
      }
      else
      { 
          require_once($this->Ini->path_aplicacao . "form_profile_erro.class.php"); 
      }
      $this->Erro      = new form_profile_erro();
      $this->Erro->Ini = $this->Ini;
      $this->proc_fast_search = false;
      if ($this->nmgp_opcao == "fast_search")  
      {
          $this->SC_fast_search($this->nmgp_fast_search, $this->nmgp_cond_fast_search, $this->nmgp_arg_fast_search);
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['opcao'] = "inicio";
          $this->nmgp_opcao = "inicio";
          $this->proc_fast_search = true;
      } 
      if ($nm_opc_lookup != "lookup" && $nm_opc_php != "formphp")
      { 
         if (empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['opcao']))
         { 
             if ($this->id != "")   
             { 
                 $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['opcao'] = "igual" ;  
             }   
         }   
      } 
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['opcao']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['opcao']) && empty($this->nmgp_refresh_fields))
      {
          $this->nmgp_opcao = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['opcao'];  
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['opcao'] = "" ;  
      ...
      if (isset($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['start']) && $_SESSION['scriptcase']['sc_apl_conf']['form_profile']['start'] == 'new')
      {
          $this->nmgp_opcao = "novo";
          $this->nm_Start_new = true;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['opcao'] = "novo";
          unset($_SESSION['scriptcase']['sc_apl_conf']['form_profile']['start']);
      }
      ...
      {
          $this->nmgp_opc_ant = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['opc_ant'];
      } 
      if ($this->nmgp_opcao == "recarga" || $this->nmgp_opcao == "muda_form")  
      {
          $this->nmgp_botoes = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['botoes'];
          $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['inicio'];
          $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['total'] != $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['final'];
      }
      else
      {
      }
...
//
      ...
      {
      $_SESSION['scriptcase']['form_profile']['contr_erro'] = 'on';
...
$_SESSION['scriptcase']['form_profile']['contr_erro'] = 'off'; 
      ...
      $dir_raiz          =  substr($_SERVER['PHP_SELF'], 0, $dir_raiz + 1) ;  
      $this->nm_location = $this->Ini->sc_protocolo . $this->Ini->server . $dir_raiz; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['opc_edit'] = true;  
     if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['dados_select'])) 
     {
        $this->nmgp_dados_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['dados_select'];
     }
   }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['inline_form_seq'] = $this->sc_seq_row;
          $this->nm_tira_formatacao();
      }
...
//
      ...
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['recarga'] = $this->nmgp_opcao;
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['sc_redir_insert']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['sc_redir_insert'] == "ok")
          {
          ...
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['sc_redir_atualiz']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['sc_redir_atualiz'] == "ok")
          {
...
<?php
  ...
  function html_export_print($nm_arquivo_html, $nmgp_password)
  {
      $Html_password = "";
          ...
          $Zip_name = "sc_prt_" . date("YmdHis") . "_" . rand(0, 1000) . "form_profile.zip";
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile'][$path_doc_md5][0] = $Arq_htm;
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile'][$path_doc_md5][1] = $Zip_name;
?>
...
<form name="Fdown" method="get" action="form_profile_download.php" target="_self" style="display: none"> 
<input type="hidden" name="script_case_init" value="<?php echo $this->form_encode_input($this->Ini->sc_page); ?>"> 
<input type="hidden" name="nm_tit_doc" value="form_profile"> 
...
//---------------------------------------------------------
     ...
     if ('' == $filtro && isset($this->nm_form_submit) && '1' == $this->nm_form_submit && $this->scCsrfGetToken() != $this->csrf_token)
     {
          ...
          if ($this->NM_ajax_flag)
          {
              if (!isset($this->NM_ajax_info['errList']['geral_form_profile']) || !is_array($this->NM_ajax_info['errList']['geral_form_profile']))
              {
                  $this->NM_ajax_info['errList']['geral_form_profile'] = array();
              }
              $this->NM_ajax_info['errList']['geral_form_profile'][] = "CSRF: " . $this->Ini->Nm_lang['lang_errm_ajax_csrf'];
          }
     }
    ...
    function ValidateField_name(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        ...
        $hasError = false;
      if ($this->nmgp_opcao != "excluir" && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['php_cmp_required']['name']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['php_cmp_required']['name'] == "on")) 
      { 
          if ($this->name == "")  
          { 
              $hasError = true;
    ...
    function ValidateField_currency(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->currency) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['Lookup_currency']) && !in_array($this->currency, $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['Lookup_currency']))
               {
                   $hasError = true;
    ...
    function ValidateField_country(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
        global $teste_validade;
        $hasError = false;
               if (!empty($this->country) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['Lookup_country']) && !in_array($this->country, $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['Lookup_country']))
               {
                   $hasError = true;
                   $Campos_Crit .= $this->Ini->Nm_lang['lang_errm_ajax_data'];
    ...
    function ValidateField_id(&$Campos_Crit, &$Campos_Falta, &$Campos_Erros)
    {
      ...
      { 
          ...
          { 
           ...
           elseif (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['php_cmp_required']['id']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['php_cmp_required']['id'] == "on") 
           { 
              $hasError = true;
              $Campos_Falta[] = "ID" ; 
              if (!isset($Campos_Erros['id']))
...
//--------------------------------------------------------------------------------------
     ...
     if (!empty($Campos_Crit) || !empty($Campos_Falta))
     {
      ...
      { 
          ...
          { 
              ...
              {
                  include_once 'form_profile_doc_name.php';
              }
   ...
   function nm_guardar_campos()
   {
    ...
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['dados_form'] = $this->nmgp_dados_form;
   }
...
//
   ...
   function ajax_return_values()
   {
          ...
          if ('navigate_form' == $this->NM_ajax_opcao)
          {
              ...
              $this->NM_ajax_info['fldList']['id']['keyVal'] = form_profile_pack_protect_string($this->nmgp_dados_form['id']);
          }
   } // ajax_return_values
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['Lookup_currency']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['Lookup_currency'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['Lookup_currency']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['Lookup_currency'] = array(); 
}
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       while (!$rs->EOF) 
       { 
              $aLookup[] = array(form_profile_pack_protect_string(NM_charset_to_utf8($rs->fields[0])) => str_replace('<', '&lt;', form_profile_pack_protect_string(NM_charset_to_utf8($rs->fields[1]))));
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['Lookup_currency'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['currency']['valList'][$i] = form_profile_pack_protect_string($v);
          }
...
$nmgp_def_dados = "" ; 
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['Lookup_country']))
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['Lookup_country'] = array_unique($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['Lookup_country']); 
}
else
{
    $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['Lookup_country'] = array(); 
}
$aLookup[] = array(form_profile_pack_protect_string('') => str_replace('<', '&lt;',form_profile_pack_protect_string(' ')));
$_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['Lookup_country'][] = '';
   if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
   { 
       $GLOBALS["NM_ERRO_IBASE"] = 1;  
   } 
   ...
   if ($nm_comando != "" && $rs = $this->Db->Execute($nm_comando))
   {
       ...
       { 
              ...
              $nmgp_def_dados .= $rs->fields[1] . "?#?" ; 
              $nmgp_def_dados .= $rs->fields[0] . "?#?N?@?" ; 
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['Lookup_country'][] = $rs->fields[0];
              $rs->MoveNext() ; 
       } 
       $rs->Close() ; 
   } 
   ...
   $GLOBALS["NM_ERRO_IBASE"] = 0; 
          ...
          {
              $this->NM_ajax_info['fldList']['country']['valList'][$i] = form_profile_pack_protect_string($v);
          }
          foreach ($aLookupOrig as $aValData)
          {
   ...
   function ajax_return_values_healthguide($bForce = false)
   {
    ...
    function fetchUniqueUploadName($originalName, $uploadDir, $fieldName)
    {
        ...
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['upload_dir'][$fieldName] = array();
            ...
            while (false !== ($fileName = @readdir($resDir)))
            {
                ...
                {
                    $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['upload_dir'][$fieldName][] = $fileName;
                }
            }
            @closedir($resDir);
        }
        if (!in_array($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['upload_dir'][$fieldName]))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['upload_dir'][$fieldName][] = $originalName;
            return $originalName;
        }
        else
        {
            $newName = $this->fetchFileNextName($originalName, $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['upload_dir'][$fieldName]);
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['upload_dir'][$fieldName][] = $newName;
            return $newName;
        }
...
//----------- 
   ...
   { 
      ...
      if ($this->nmgp_opcao == "alterar") 
      {
          ...
          if (($this->Embutida_form || $this->Embutida_multi) && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['foreign_key']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['foreign_key']))
          {
              foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['foreign_key'] as $sFKName => $sFKValue)
              {
          ...
          { 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['db_changed'] = true;
              if ($this->NM_ajax_flag) {
                  $this->NM_ajax_info['clearUpload'] = 'S';
                  $this->NM_ajax_info['fldList']['logo_salva'] = array(
                      'row'     => '',
              ...
              $this->nmgp_refresh_fields = array_diff(array('name', 'headline', 'currency', 'footer', 'country', 'id', 'facebook', 'instagram', 'twitter', 'youtube', 'address', 'phone', 'mail', 'long', 'lat', 'aboutus', 'privacypolicy', 'terms', 'healthguide'), $aDoNotUpdate);
              $this->ajax_return_values();
      ...
      { 
          ...
          if (!isset($_POST['nmgp_ins_valid']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['insert_validation'] != $_POST['nmgp_ins_valid'])
          {
              $bInsertOk = false;
          ...
          { 
              ...
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['total']))
              {
                  unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['total']);
              }
              ...
              if ('refresh_insert' != $this->nmgp_opcao && (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['sc_redir_insert']) || $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['sc_redir_insert'] != "S"))
              {
              $this->nmgp_opcao = "novo"; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] == "R")
              { 
                   $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['return_edit'] = "new";
              } 
              }
              $this->nm_flag_iframe = true;
          } 
      ...
      { 
          ...
          { 
              ...
              $this->nm_flag_iframe = true;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start']--; 
              if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start'] < 0)
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start'] = 0; 
              }
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['parms'] = "id?#?$this->id?@?"; 
      }
      ...
      if (isset($this->NM_where_filter))
      {
          ...
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_filter'] = trim($this->NM_where_filter);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['total']))
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['total']);
          }
      ...
      $sc_where_filter = '';
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_filter_form'])
      {
          $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_filter_form'];
      }
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_filter']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_filter'] && $sc_where_filter != $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_filter'])
      {
          if (empty($sc_where_filter))
          {
              $sc_where_filter = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_filter'];
          }
          else
          {
              $sc_where_filter .= " and (" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_filter'] . ")";
          }
      }
//------------ 
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] == "R")
      {
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['iframe_evento'] == "insert") 
          { 
               $this->nmgp_opcao = "novo"; 
               $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['select'] = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['iframe_evento'] = $this->sc_evento; 
      } 
      ...
      if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] == "F" && $this->sc_evento == "insert")
      {
          $this->nmgp_opcao = "final";
      }
      $sc_where = trim("");
      ...
      { 
          ...
          $qt_geral_reg_form_profile = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['total'] = $qt_geral_reg_form_profile;
          $rt->Close(); 
          if ($this->nmgp_opcao == "igual" && isset($this->NM_btn_navega) && 'S' == $this->NM_btn_navega && !empty($this->id))
          {
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start'] = $rt->fields[0];
              $rt->Close(); 
          }
      } 
      else 
      { 
          $qt_geral_reg_form_profile = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['total'];
      } 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start']++; 
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start'] > $qt_geral_reg_form_profile)
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start'] = $qt_geral_reg_form_profile; 
          }
      } 
      ...
      if ($this->nmgp_opcao == "navpage" && ($this->nmgp_ordem - 1) <= $qt_geral_reg_form_profile) 
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start'] = $this->nmgp_ordem - 1; 
      } 
      if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start']) || empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start']))
      {
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start'] = 0;
      }
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start'] + 1;
      $this->NM_ajax_info['navSummary']['reg_ini'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start'] + 1; 
      $this->NM_ajax_info['navSummary']['reg_qtd'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_qtd']; 
      $this->NM_ajax_info['navSummary']['reg_tot'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['total'] + 1; 
...
//---------- 
      ...
      { 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['parms'] = ""; 
          if (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_ibase))
          { 
              $GLOBALS["NM_ERRO_IBASE"] = 1;  
          } 
          ...
          if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] == "R")
          {
              if ($this->sc_evento == "update")
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['select'] = $nmgp_select;
                  $this->nm_gera_html();
              } 
              elseif (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['select']))
              { 
                  $nmgp_select = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['select'];
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['select'] = ""; 
              } 
          } 
          if ($this->nmgp_opcao == "igual") 
          ...
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start'] . ")" ; 
              $rs = $this->Db->SelectLimit($nmgp_select, 1, $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start']) ; 
          } 
          elseif (in_array(strtolower($this->Ini->nm_tpbanco), $this->Ini->nm_bases_mssql))
          { 
              $_SESSION['scriptcase']['sc_sql_ult_comando'] = "SelectLimit($nmgp_select, 1, " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start'] . ")" ; 
          ...
          { 
              ...
              if (!$rs === false && !$rs->EOF) 
              { 
                  $rs->Move($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start']) ;  
              } 
          } 
          ...
          if ($rs->EOF) 
          { 
              if (!empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_filter']))
              {
                  ...
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['empty_filter'] = true;
                  return; 
              }
          ...
          $GLOBALS["NM_ERRO_IBASE"] = 0; 
              ...
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['parms'] = "id?#?$this->id?@?";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['sub_dir'][0]  = "";
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['sub_dir'][1]  = "";
          } 
          $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['dados_select'] = $this->nmgp_dados_select;
          if (!$this->NM_ajax_flag || 'backup_line' != $this->NM_ajax_opcao)
          {
              $this->Nav_permite_ret = 0 != $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start'];
              $this->Nav_permite_ava = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start'] < $qt_geral_reg_form_profile;
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['opcao']   = '';
          }
      } 
...
//-- 
   ...
   function NM_gera_nav_page() 
   {
       ...
       $rec_tot    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['total'] + 1;
       $rec_fim    = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start'] + 1;
...
//
 function nm_gera_html()
 {
    global
     ...
     $_SESSION['scriptcase']['sc_sql_ult_conexao'] = ''; 
     $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['botoes'] = $this->nmgp_botoes;
     if ($this->nmgp_opcao != "recarga" && $this->nmgp_opcao != "muda_form")
     {
         $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['opc_ant'] = $this->nmgp_opcao;
     }
     else
     {
     ...
     if (($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] == "F" || $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] == "R") && $this->nm_flag_iframe && empty($this->nm_todas_criticas))
     {
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe_ajax']))
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['retorno_edit'] = array("edit", "");
          }
          else
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['retorno_edit'] .= "&nmgp_opcao=edit";
          }
          if ($this->sc_evento == "insert" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] == "F")
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe_ajax']))
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['retorno_edit'] = array("edit", "fim");
              }
              else
              {
                  $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['retorno_edit'] .= "&rec=fim";
              }
          }
          $this->NM_close_db(); 
          $sJsParent = '';
          if ($this->NM_ajax_flag && isset($this->NM_ajax_info['param']['buffer_output']) && $this->NM_ajax_info['param']['buffer_output'])
          {
              if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe_ajax']))
              {
                  $this->NM_ajax_info['ajaxJavascript'][] = array("parent.ajax_navigate", $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['retorno_edit']);
              }
              else
              {
                  $sJsParent .= 'parent';
                  $this->NM_ajax_info['redir']['metodo'] = 'location';
                  $this->NM_ajax_info['redir']['action'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['retorno_edit'];
...
<?php
    ...
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe_ajax']))
    {
        $opc = ($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] == "F" && $this->sc_evento == "insert") ? "fim" : "";
        echo "parent.ajax_navigate('edit', '" .$opc . "');";
    }
    else
    {
        echo $sJsParent . "parent.location = '" . $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['retorno_edit'] . "';";
    }
?>
         </script>
         </body></html>
...
//-- 
   ...
   if (isset($_POST['nmgp_opcao']) && 'excluir' == $_POST['nmgp_opcao'] && $this->sc_evento != "delete" && (!isset($this->sc_evento_old) || 'delete' != $this->sc_evento_old))
   {
       ...
       if (isset($temp_out_logo))
       {
        ...
        $this->initFormPages();
        include_once("form_profile_form0.php");
        include_once("form_profile_form1.php");
        include_once("form_profile_form2.php");
        include_once("form_profile_form3.php");
        $this->hideFormPages();
 }
...
<?php
    ...
    {
        if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['table_refresh']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['table_refresh'])
        {
    ...
    {
        if (!isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['csrf_token']))
        {
            $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['csrf_token'] = $this->scCsrfGenerateToken();
        }

        return $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['csrf_token'];
    }
...
else
{
   ...
   function SC_fast_search($in_fields, $arg_search, $data_search)
   {
      ...
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_filter']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['total']);
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['fast_search']);
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_detal'])) 
          {
              $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_filter'] = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_detal'];
          }
          if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['empty_filter'])
          {
              unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['empty_filter']);
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_detal']) && !empty($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_detal']) && !empty($comando)) 
      {
          $comando = $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_detal'] . " and (" .  $comando . ")";
      }
      if (empty($comando)) 
      {
          $comando = " 1 <> 1 "; 
      ...
      if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_filter_form']) && '' != $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_filter_form'])
      {
          $sc_where = " where " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_filter_form'] . " and (" . $comando . ")";
      }
      else
      {
      ...
      $qt_geral_reg_form_profile = isset($rt->fields[0]) ? $rt->fields[0] - 1 : 0; 
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['total'] = $qt_geral_reg_form_profile;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['where_filter'] = $comando;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['fast_search'][0] = $field;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['fast_search'][1] = $arg_search;
      $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['fast_search'][2] = $sv_data;
      $rt->Close(); 
      if (isset($rt->fields[0]) && $rt->fields[0] > 0 &&  isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['empty_filter']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['empty_filter'])
      {
          unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['empty_filter']);
          $this->NM_ajax_info['empty_filter'] = 'ok';
          form_profile_pack_ajax_response();
   ...
   function SC_monta_condicao(&$comando, $nome, $condicao, $campo, $tp_campo="")
   {
      ...
      {
         if ($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['decimal_db'] == ".")
         {
             $nm_aspas  = "";
             $nm_aspas1 = "";
         }
...
function nmgp_redireciona($tipo=0)
{
   ...
   if ($tipo == 2)
   {
       $nmgp_saida_form = "form_profile_fim.php";
   }
   if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['redir']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['redir'] == 'redir')
   {
       unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']);
   }
   unset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['opc_ant']);
   if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['nm_run_menu']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['nm_run_menu'] == 1)
   {
       $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['nm_run_menu'] = 2;
       $nmgp_saida_form = "form_profile_fim.php";
   }
...
?>
   ...
   <SCRIPT type="text/javascript">
      ...
      {
<?php
   if ($this->lig_edit_lookup && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['sc_modal']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['sc_modal'])
   {
?>
...
<?php
if ($tipo == 2 && isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['masterValue']))
{
    if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['dashboard_info']['under_dashboard']) && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['dashboard_info']['under_dashboard']) {
?>
var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['dashboard_info']['parent_widget']; ?>']");
if (dbParentFrame && dbParentFrame[0] && dbParentFrame[0].contentWindow.scAjaxDetailValue)
{
<?php
        foreach ($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['masterValue'] as $cmp_master => $val_master)
        {
?>
