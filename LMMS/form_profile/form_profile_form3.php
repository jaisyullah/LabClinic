<div id="form_profile_form3" style='<?php echo ($this->tabCssClass["form_profile_form3"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_aboutus_label" id="hidden_field_label_aboutus" style="<?php echo $sStyleHidden_aboutus; ?>"><span id="id_label_aboutus"><?php echo $this->nm_new_label['aboutus']; ?></span></TD>
    <TD class="scFormDataOdd css_aboutus_line" id="hidden_field_data_aboutus" style="<?php echo $sStyleHidden_aboutus; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_aboutus_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_aboutus" style="<?php echo $sStyleReadLab_aboutus; ?>"><?php echo $this->form_format_readonly("aboutus", sc_strip_script($this->aboutus)); ?></span><span id="id_read_off_aboutus" class="css_read_off_aboutus" style="<?php echo $sStyleReadInp_aboutus; ?>"><textarea id="aboutus" name="aboutus" cols="50" rows="10" class="mceEditor_aboutus" style="width: 100%; height:350px;"><?php echo $this->form_encode_input($this->aboutus); ?></textarea>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_privacypolicy_label" id="hidden_field_label_privacypolicy" style="<?php echo $sStyleHidden_privacypolicy; ?>"><span id="id_label_privacypolicy"><?php echo $this->nm_new_label['privacypolicy']; ?></span></TD>
    <TD class="scFormDataOdd css_privacypolicy_line" id="hidden_field_data_privacypolicy" style="<?php echo $sStyleHidden_privacypolicy; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_privacypolicy_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_privacypolicy" style="<?php echo $sStyleReadLab_privacypolicy; ?>"><?php echo $this->form_format_readonly("privacypolicy", sc_strip_script($this->privacypolicy)); ?></span><span id="id_read_off_privacypolicy" class="css_read_off_privacypolicy" style="<?php echo $sStyleReadInp_privacypolicy; ?>"><textarea id="privacypolicy" name="privacypolicy" cols="50" rows="10" class="mceEditor_privacypolicy" style="width: 100%; height:350px;"><?php echo $this->form_encode_input($this->privacypolicy); ?></textarea>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_terms_label" id="hidden_field_label_terms" style="<?php echo $sStyleHidden_terms; ?>"><span id="id_label_terms"><?php echo $this->nm_new_label['terms']; ?></span></TD>
    <TD class="scFormDataOdd css_terms_line" id="hidden_field_data_terms" style="<?php echo $sStyleHidden_terms; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_terms_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_terms" style="<?php echo $sStyleReadLab_terms; ?>"><?php echo $this->form_format_readonly("terms", sc_strip_script($this->terms)); ?></span><span id="id_read_off_terms" class="css_read_off_terms" style="<?php echo $sStyleReadInp_terms; ?>"><textarea id="terms" name="terms" cols="50" rows="10" class="mceEditor_terms" style="width: 100%; height:350px;"><?php echo $this->form_encode_input($this->terms); ?></textarea>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_healthguide_label" id="hidden_field_label_healthguide" style="<?php echo $sStyleHidden_healthguide; ?>"><span id="id_label_healthguide"><?php echo $this->nm_new_label['healthguide']; ?></span></TD>
    <TD class="scFormDataOdd css_healthguide_line" id="hidden_field_data_healthguide" style="<?php echo $sStyleHidden_healthguide; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_healthguide_line" style="vertical-align: top;padding: 0px"><span id="id_read_on_healthguide" style="<?php echo $sStyleReadLab_healthguide; ?>"><?php echo $this->form_format_readonly("healthguide", sc_strip_script($this->healthguide)); ?></span><span id="id_read_off_healthguide" class="css_read_off_healthguide" style="<?php echo $sStyleReadInp_healthguide; ?>"><textarea id="healthguide" name="healthguide" cols="50" rows="10" class="mceEditor_healthguide" style="width: 100%; height:350px;"><?php echo $this->form_encode_input($this->healthguide); ?></textarea>
...
?>
       <?php echo nmButtonOutput($this->arr_buttons, "bretorna", "scBtnFn_sys_format_ret()", "scBtnFn_sys_format_ret()", "sc_b_ret_b", "", "", "" . $sCondStyle . "", "", "", "", $this->Ini->path_botoes, "", "__NM_HINT__ (Ctrl + &#8592;)", "sc-unique-btn-6", "", "");?>
...
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] != "F") { if ('parcial' == $this->form_paginacao) {?><script>summary_atualiza(<?php echo ($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_start'] + 1). ", " . $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['reg_qtd'] . ", " . ($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['total'] + 1)?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] != "F") { if ('total' == $this->form_paginacao) {?><script>summary_atualiza(1, <?php echo $this->sc_max_reg . ", " . $this->sc_max_reg?>);</script><?php }} ?>
<?php if (('novo' != $this->nmgp_opcao || $this->Embutida_form) && !$this->nmgp_form_empty && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] != "R" && $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['run_iframe'] != "F") { ?><script>navpage_atualiza('<?php echo $this->SC_nav_page ?>');</script><?php } ?>
</td></tr> 
</table> 
</div> 
</td> 
...
<script> 
<?php
 $NM_pag_atual = "form_profile_form0";
 if (isset($this->nmgp_ancora) && $this->nmgp_ancora != "")
 {
     $NM_pag_atual = "form_profile_form" . $this->nmgp_ancora;
 }
?>
<?php
...
<script>
<?php
if (isset($_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['masterValue']))
{
...
<script>
 var dbParentFrame = $(parent.document).find("[name='<?php echo $_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['dashboard_info']['parent_widget']; ?>']");
 dbParentFrame[0].contentWindow.scAjaxDetailStatus("form_profile");
</script>
<?php
    }
    else {
...
?>
<script>
 parent.scAjaxDetailStatus("form_profile");
 parent.scAjaxDetailHeight("form_profile", <?php echo $sTamanhoIframe; ?>);
</script>
<?php
    }
}
...
?>
<?php
$_SESSION['sc_session'][$this->Ini->sc_page]['form_profile']['buttonStatus'] = $this->nmgp_botoes;
?>
<script type="text/javascript">
