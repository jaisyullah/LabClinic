<div id="form_profile_form2" style='<?php echo ($this->tabCssClass["form_profile_form2"]['class'] == 'scTabInactive' ? 'display: none; width: 1px; height: 0px; overflow: scroll' : ''); ?>'>
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_mail_label" id="hidden_field_label_mail" style="<?php echo $sStyleHidden_mail; ?>"><span id="id_label_mail"><?php echo $this->nm_new_label['mail']; ?></span></TD>
    <TD class="scFormDataOdd css_mail_line" id="hidden_field_data_mail" style="<?php echo $sStyleHidden_mail; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_mail_line" style="vertical-align: top;padding: 0px">
...
<?php } else { $sc_hidden_no++; ?>
    ...
    <TD class="scFormLabelOdd scUiLabelWidthFix css_long_label" id="hidden_field_label_long" style="<?php echo $sStyleHidden_long; ?>"><span id="id_label_long"><?php echo $this->nm_new_label['long']; ?></span></TD>
    <TD class="scFormDataOdd css_long_line" id="hidden_field_data_long" style="<?php echo $sStyleHidden_long; ?>"><table style="border-width: 0px; border-collapse: collapse; width: 100%"><tr><td  class="scFormDataFontOdd css_long_line" style="vertical-align: top;padding: 0px">
