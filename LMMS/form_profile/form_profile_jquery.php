...
function scFocusField(sField) {
  ...
  if ($oField.length > 0) {
    switch ($oField[0].name) {
      ...
      case 'id':
      case 'logo':
        sc_exib_ocult_pag('form_profile_form0');
        break;
      case 'facebook':
      case 'instagram':
      case 'twitter':
      case 'youtube':
        sc_exib_ocult_pag('form_profile_form1');
        break;
      case 'address':
      case 'phone':
      case 'mail':
      case 'long':
      case 'lat':
        sc_exib_ocult_pag('form_profile_form2');
        break;
      case 'aboutus':
      case 'privacypolicy':
      case 'terms':
      case 'healthguide':
        sc_exib_ocult_pag('form_profile_form3');
        break;
    }
  }
...
function scJQEventsAdd(iSeqRow) {
  $('#id_sc_field_name' + iSeqRow).bind('blur', function() { sc_form_profile_name_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_profile_name_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_headline' + iSeqRow).bind('blur', function() { sc_form_profile_headline_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_profile_headline_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_address' + iSeqRow).bind('blur', function() { sc_form_profile_address_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_profile_address_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_long' + iSeqRow).bind('blur', function() { sc_form_profile_long_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_profile_long_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_lat' + iSeqRow).bind('blur', function() { sc_form_profile_lat_onblur(this, iSeqRow) })
                                 .bind('change', function() { sc_form_profile_lat_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_logo' + iSeqRow).bind('blur', function() { sc_form_profile_logo_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_profile_logo_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_aboutus' + iSeqRow).bind('blur', function() { sc_form_profile_aboutus_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_profile_aboutus_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_privacypolicy' + iSeqRow).bind('blur', function() { sc_form_profile_privacypolicy_onblur(this, iSeqRow) })
                                           .bind('change', function() { sc_form_profile_privacypolicy_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_healthguide' + iSeqRow).bind('blur', function() { sc_form_profile_healthguide_onblur(this, iSeqRow) })
                                         .bind('change', function() { sc_form_profile_healthguide_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_terms' + iSeqRow).bind('blur', function() { sc_form_profile_terms_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_profile_terms_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_footer' + iSeqRow).bind('blur', function() { sc_form_profile_footer_onblur(this, iSeqRow) })
                                    .bind('change', function() { sc_form_profile_footer_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_phone' + iSeqRow).bind('blur', function() { sc_form_profile_phone_onblur(this, iSeqRow) })
                                   .bind('change', function() { sc_form_profile_phone_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_mail' + iSeqRow).bind('blur', function() { sc_form_profile_mail_onblur(this, iSeqRow) })
                                  .bind('change', function() { sc_form_profile_mail_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_facebook' + iSeqRow).bind('blur', function() { sc_form_profile_facebook_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_profile_facebook_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_instagram' + iSeqRow).bind('blur', function() { sc_form_profile_instagram_onblur(this, iSeqRow) })
                                       .bind('change', function() { sc_form_profile_instagram_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_twitter' + iSeqRow).bind('blur', function() { sc_form_profile_twitter_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_profile_twitter_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_youtube' + iSeqRow).bind('blur', function() { sc_form_profile_youtube_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_profile_youtube_onchange(this, iSeqRow) })
                                     .bind('focus', function() { sc_form_profile_youtube_onfocus(this, iSeqRow) });
  $('#id_sc_field_slidertype' + iSeqRow).bind('change', function() { sc_form_profile_slidertype_onchange(this, iSeqRow) });
  $('#id_sc_field_id' + iSeqRow).bind('blur', function() { sc_form_profile_id_onblur(this, iSeqRow) })
                                .bind('change', function() { sc_form_profile_id_onchange(this, iSeqRow) })
                                .bind('focus', function() { sc_form_profile_id_onfocus(this, iSeqRow) });
  $('#id_sc_field_whatsappurl' + iSeqRow).bind('change', function() { sc_form_profile_whatsappurl_onchange(this, iSeqRow) });
  $('#id_sc_field_deliverytype' + iSeqRow).bind('change', function() { sc_form_profile_deliverytype_onchange(this, iSeqRow) });
  $('#id_sc_field_currency' + iSeqRow).bind('blur', function() { sc_form_profile_currency_onblur(this, iSeqRow) })
                                      .bind('change', function() { sc_form_profile_currency_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_country' + iSeqRow).bind('blur', function() { sc_form_profile_country_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_profile_country_onchange(this, iSeqRow) })
  ...
  $('#id_sc_field_officer' + iSeqRow).bind('blur', function() { sc_form_profile_officer_onblur(this, iSeqRow) })
                                     .bind('change', function() { sc_form_profile_officer_onchange(this, iSeqRow) })
...
function sc_form_profile_name_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_headline_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_address_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_long_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_lat_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_logo_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_aboutus_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_privacypolicy_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_healthguide_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_terms_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_footer_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_phone_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_mail_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_facebook_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_instagram_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_twitter_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_youtube_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_slidertype_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_id_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_whatsappurl_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}

function sc_form_profile_deliverytype_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_currency_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_country_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function sc_form_profile_officer_onchange(oThis, iSeqRow) {
  scMarkFormAsChanged();
}
...
function scHidePage(pageNo) {
	$("#id_form_profile_form" + pageNo).hide();
}
            ...
            if(!$(t).is('img')){
                ...
                switch(field){
                     ...
                     if(usa_read_only && $('a',$('#id_read_on_'+field+iSeqRow)).length == 0){
                         $(t).html("<a href=\"javascript:nm_mostra_doc('0', '"+rs2+"', 'form_profile')\">"+$('#id_read_on_'+field+iSeqRow).text()+"</a>");
                     }
                }
